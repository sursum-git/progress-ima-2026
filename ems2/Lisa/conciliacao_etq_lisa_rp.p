...
RUN lisa/getDadosEtqLisaPorSituacao.p(tt-param.itCodigo,
                           tt-param.codRefer, 
                           NO,
                           01.01.2001,
                           01.01.2999,
                           tt-param.logApenasEstoq, 
...
IF  tt-param.logApenasEstoq THEN
DO:
    RUN esapi/getDadosEtqMedEstoque.p('505', // estab. LISA
                           tt-param.itCodigo,
                           tt-param.codRefer, 
