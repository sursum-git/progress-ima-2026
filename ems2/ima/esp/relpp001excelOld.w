...
DEFINE TEMP-TABLE tt NO-UNDO
    ...
    FIELD dtPrevChegadaLoja LIKE pp-container.dt_prev_chegada_loja
    ...
    FIELD precoUnitario     AS DECIMAL FORMAT '>>>,>>9.99'
    FIELD valorTotal        AS DECIMAL FORMAT '>>>,>>>,>>9.99'
    FIELD desconto          AS DECIMAL FORMAT '>>>,>>>,>>9.99'
    FIELD nrPedido          AS INT
    FIELD moeda             AS CHAR
    FIELD precoReal         AS DECIMAL FORMAT '>>>,>>>,>>9.99'
    FIELD precoDolar        AS DECIMAL FORMAT '>>>,>>>,>>9.99' 
    FIELD precoMedioReal    AS DECIMAL FORMAT '>>>,>>>,>>9.99'
    FIELD precoMedioDolar   AS DECIMAL FORMAT '>>>,>>>,>>9.99'
    FIELD precoId           AS INTEGER
    FIELD preco90Dolar      AS DECIMAL FORMAT '>>>,>>>,>>9.99'
    FIELD preco90Real       AS DECIMAL FORMAT '>>>,>>>,>>9.99'
    FIELD preco90Id         AS DECIMAL
    FIELD precoOutlet       AS DECIMAL 
    FIELD idOutlet          AS INT64
...
DEFINE TEMP-TABLE ttVlsItemRefContainer NO-UNDO
    ...
    FIELD vlPercPorValor        AS DECIMAL
    ...
    FIELD dtPrevChegadaLoja     AS DATE
    FIELD un                    AS CHAR
...
DEFINE FRAME f-cad
     ...
     tgAberto AT ROW 4.83 COL 22 WIDGET-ID 8
     btExcel AT ROW 5.75 COL 22 WIDGET-ID 2
...
DO:
  ...
  ASSIGN cModelo = SEARCH('excel\relpp001excel.xlsx').
...
------------------------------------------------------------------------------*/
  DISPLAY fiNrContainerIni fiNrContainerFim tgAberto 
      WITH FRAME f-cad IN WINDOW w-livre.
  ENABLE rt-button fiNrContainerIni fiNrContainerFim tgAberto btExcel 
      WITH FRAME f-cad IN WINDOW w-livre.
...
FOR EACH ttVlsItemRefContainer.
    EXPORT DELIMITER "|" 
        ...
        IF ttVlsItemRefContainer.logCambioFinal THEN "SIM" ELSE "N«O"
