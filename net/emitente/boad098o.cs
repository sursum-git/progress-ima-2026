...
//
    ...
    public class boad098o : Procedure
    {
	...
	public boad098o(ProObject appObj) : base(appObj)
	{
		...
		// Run procedure
		PersistProcObj = RunPersistentProcedure("boad098o.p", parms);
...
/// <summary>
	/// 
	/// </summary> 
	public string findFirstDefault()
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		// Run procedure
		base.runProcedure("findFirstDefault", parms);
...
/// <summary>
	...
	public string findLastDefault()
	{
		...
		// Run procedure
		base.runProcedure("findLastDefault", parms);
...
/// <summary>
	...
	public string findNextDefault()
	{
		...
		// Run procedure
		base.runProcedure("findNextDefault", parms);
...
/// <summary>
	...
	public string findPrevDefault()
	{
		...
		// Run procedure
		base.runProcedure("findPrevDefault", parms);
