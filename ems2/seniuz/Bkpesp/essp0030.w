...
*******************************************************************************/
{include/i-prgvrs.i ESSP0030 2.04.00.000}
...
ON END-ERROR OF w-cadsim /* M quinas da Mecƒnica */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* M quinas da Mecƒnica */
DO:
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es019.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01es019 ).
       RUN set-position IN h_q01es019 ( 1.50 , 65.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_v01es019 ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0030" "2.04.00.000"}
