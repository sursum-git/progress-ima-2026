...
*******************************************************************************/
{include/i-prgvrs.i es001isf 2.04.00.001}
...
DEFINE VARIABLE fi-emb-fim AS INTEGER FORMAT ">>,>>>,>>9":U INITIAL 99999999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fi-emb-ini AS INTEGER FORMAT ">>,>>>,>>9":U INITIAL 0 
     LABEL "Embarque" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE fi-ped-fim AS INTEGER FORMAT ">>>>>>>9":U INITIAL 99999999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE fi-ped-ini AS INTEGER FORMAT ">>>>>>>9":U INITIAL 0 
...
DEFINE VARIABLE rs-imprime AS LOGICAL 
...
DEFINE FRAME f-relat
     ...
     im-pg-imp AT ROW 1.5 COL 17.57
...
DEFINE FRAME f-pg-sel
     fi-emb-ini AT ROW 1.75 COL 15 COLON-ALIGNED
     fi-emb-fim AT ROW 1.75 COL 48.14 COLON-ALIGNED NO-LABEL
     fi-ped-ini AT ROW 2.92 COL 15 COLON-ALIGNED
     fi-ped-fim AT ROW 2.92 COL 48.14 COLON-ALIGNED NO-LABEL
     rs-imprime AT ROW 5 COL 11 NO-LABEL
     "Imprime:" VIEW-AS TEXT
          SIZE 6.43 BY .79 AT ROW 4.96 COL 4.57
          FONT 1
     RECT-10 AT ROW 4.75 COL 2
     IMAGE-1 AT ROW 1.75 COL 31.86
     IMAGE-2 AT ROW 1.75 COL 47.29
     IMAGE-5 AT ROW 2.92 COL 31.86
     IMAGE-6 AT ROW 2.92 COL 47.29
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR RECTANGLE RECT-10 IN FRAME f-pg-sel
   NO-ENABLE                                                            */
...
&Scoped-define SELF-NAME fi-emb-fim
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-emb-fim w-relat
ON RETURN OF fi-emb-fim IN FRAME f-pg-sel
DO:
...
&Scoped-define SELF-NAME fi-emb-ini
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-emb-ini w-relat
ON LEAVE OF fi-emb-ini IN FRAME f-pg-sel /* Embarque */
DO:
   IF SELF:SCREEN-VALUE <> '0' THEN
      ASSIGN fi-emb-fim:SCREEN-VALUE = SELF:SCREEN-VALUE.
END.
...
{utp/ut9000.i "es001isf" "2.04.00.001"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ON 'return':U OF fi-emb-ini IN FRAME f-pg-sel, fi-emb-fim IN FRAME f-pg-sel,
                     fi-ped-ini IN FRAME f-pg-sel, fi-ped-fim IN FRAME f-pg-sel,
                     rs-imprime IN FRAME f-pg-sel
    DO:
        RUN pi-executar.
    END.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-emb-ini fi-emb-fim fi-ped-ini fi-ped-fim rs-imprime 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-5 IMAGE-6 fi-emb-ini fi-emb-fim fi-ped-ini 
         fi-ped-fim rs-imprime 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
   ...
   */ 
    ...
    /*:T Coloque aqui a/l¢gica de gravaá∆o dos demais campos que devem ser passados
       como parÉmetros para o programa RP.P, atravÇs da temp-table tt-param */
        ...
        ASSIGN tt-param.fi-emb-ini    = INPUT FRAME f-pg-sel  fi-emb-ini
               tt-param.fi-emb-fim    = INPUT FRAME f-pg-sel  fi-emb-fim
               /*tt-param.fi-cod-ini    = INPUT FRAME f-pg-sel  fi-cod-ini
               tt-param.fi-cod-fim    = INPUT FRAME f-pg-sel  fi-cod-fim*/
               tt-param.fi-ped-ini    = INPUT FRAME f-pg-sel  fi-ped-ini
               tt-param.fi-ped-fim    = INPUT FRAME f-pg-sel  fi-ped-fim 
               tt-param.rs-imprime    = INPUT FRAME f-pg-sel  rs-imprime.
               /*tt-param.tg-observacao = INPUT FRAME f-pg-par  tg-observacao*/.
    ...
    {include/i-rprun.i esrp/es001isfrp.p}
