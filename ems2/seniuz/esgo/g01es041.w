...
&Scoped-define FIELDS-IN-QUERY-d-vapara teste-astm.fm-codigo ~
teste-astm.ano-mes teste-astm.num-amostra 
&Scoped-define ENABLED-FIELDS-IN-QUERY-d-vapara teste-astm.fm-codigo ~
teste-astm.ano-mes teste-astm.num-amostra 
&Scoped-define ENABLED-TABLES-IN-QUERY-d-vapara teste-astm
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-d-vapara teste-astm
&Scoped-define QUERY-STRING-d-vapara FOR EACH teste-astm SHARE-LOCK
&Scoped-define OPEN-QUERY-d-vapara OPEN QUERY d-vapara FOR EACH teste-astm SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-d-vapara teste-astm
&Scoped-define FIRST-TABLE-IN-QUERY-d-vapara teste-astm


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS teste-astm.fm-codigo teste-astm.ano-mes ~
...
&Scoped-Define DISPLAYED-FIELDS teste-astm.fm-codigo teste-astm.ano-mes ~
teste-astm.num-amostra 
&Scoped-define DISPLAYED-TABLES teste-astm
&Scoped-define FIRST-DISPLAYED-TABLE teste-astm
&Scoped-Define DISPLAYED-OBJECTS fi-desc-familia 
...
DEFINE FRAME d-vapara
     teste-astm.fm-codigo AT ROW 1.17 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10.14 BY .88
     fi-desc-familia AT ROW 1.17 COL 22.29 COLON-ALIGNED NO-LABEL
     teste-astm.ano-mes AT ROW 2.17 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9.14 BY .88
     teste-astm.num-amostra AT ROW 3.17 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 3.43 BY .88
...
ON GO OF FRAME d-vapara /* V  Para Teste de ASTM */
DO:
  find teste-astm no-lock 
      where teste-astm.fm-codigo   = input frame {&frame-name} teste-astm.fm-codigo
        ...
        AND teste-astm.num-amostra = INPUT FRAME {&FRAME-NAME} teste-astm.num-amostra
      no-error.
  if  not avail teste-astm then do:
      {utp/ut-table.i espec teste-astm 1}
      run utp/ut-msgs.p (input "show",
                         input 2,
                         input RETURN-VALUE).
      RETURN NO-APPLY.
  end.
  assign p-row-tabela = rowid(teste-astm).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Teste de ASTM */
DO:  
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL teste-astm.fm-codigo d-vapara
ON LEAVE OF teste-astm.fm-codigo IN FRAME d-vapara /* Familia */
DO:
  FIND familia WHERE familia.fm-codigo = INPUT FRAME {&FRAME-NAME} teste-astm.fm-codigo NO-LOCK NO-ERROR.
...
------------------------------------------------------------------------------*/
  DISPLAY fi-desc-familia 
      WITH FRAME d-vapara.
  IF AVAILABLE teste-astm THEN 
    DISPLAY teste-astm.fm-codigo teste-astm.ano-mes teste-astm.num-amostra 
      WITH FRAME d-vapara.
  ENABLE teste-astm.fm-codigo teste-astm.ano-mes teste-astm.num-amostra bt-ok 
