...
*******************************************************************************/
{include/i-prgvrs.i ESSP0064 2.04.00.000}
...
ON END-ERROR OF w-consim /* Invent rio de Ötens Acabados */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-consim w-consim
ON WINDOW-CLOSE OF w-consim /* Invent rio de Ötens Acabados */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v01es012 ).
       RUN set-position IN h_v01es012 ( 2.75 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es012.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01es012 ).
       RUN set-position IN h_q01es012 ( 1.50 , 58.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0064" "2.04.00.000"}
