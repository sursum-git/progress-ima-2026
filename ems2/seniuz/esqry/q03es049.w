...
&Scoped-define QUERY-STRING-Query-Main FOR EACH ob-etiqueta ~
      WHERE ob-etiqueta.situacao = 3 NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH ob-etiqueta ~
      WHERE ob-etiqueta.situacao = 3 NO-LOCK INDEXED-REPOSITION.
