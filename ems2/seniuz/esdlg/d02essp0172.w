...
*******************************************************************************/
{include/i-prgvrs.i D02ESSP0172 2.04.00.000}
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "D02ESSP0172" "2.04.00.000"}
  ...
  ASSIGN fi-arq-saida:SCREEN-VALUE IN FRAME {&FRAME-NAME} = SESSION:TEMP-DIRECTORY + "Evolu‡Æo do Estoque.xls".
END PROCEDURE.
