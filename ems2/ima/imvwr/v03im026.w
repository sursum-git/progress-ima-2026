...
INDEX ch-itemtab IS PRIMARY it-codigo cod-refer nr-tabpre dt-inival quant-min.
...
&Scoped-Define ENABLED-FIELDS tt-preco-item.it-codigo tt-preco-item.char-1 ~
tt-preco-item.dec-1 tt-preco-item.preco-venda tt-preco-item.preco-fob 
...
&Scoped-Define DISPLAYED-FIELDS tt-preco-item.it-codigo ~
tt-preco-item.char-1 tt-preco-item.dec-1 tt-preco-item.preco-venda ~
...
DEFINE FRAME F-Main
     tt-preco-item.it-codigo AT ROW 1.25 COL 18 COLON-ALIGNED
          LABEL "Item":R5
          VIEW-AS FILL-IN 
          SIZE 17.14 BY .88
     tt-preco-item.char-1 AT ROW 2.5 COL 9.57
          LABEL "Descri‡Æo" FORMAT "x(45)"
          VIEW-AS FILL-IN 
          SIZE 48 BY .88
     tt-preco-item.dec-1 AT ROW 3.75 COL 18 COLON-ALIGNED
          LABEL "Qt Minima" FORMAT ">>>>>>>>9.9999"
          VIEW-AS FILL-IN 
          SIZE 21 BY .88
     tt-preco-item.preco-venda AT ROW 5 COL 18 COLON-ALIGNED FORMAT ">>,>>>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 15.57 BY .88
     tt-preco-item.preco-fob AT ROW 6.25 COL 18 COLON-ALIGNED FORMAT ">>,>>>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 15 BY .88
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt-preco-item T "?" NO-UNDO mgdis preco-item
   END-TABLES.
 */
...
/* SETTINGS FOR FILL-IN tt-preco-item.preco-fob IN FRAME F-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN tt-preco-item.preco-venda IN FRAME F-Main
   EXP-FORMAT                                                           */
