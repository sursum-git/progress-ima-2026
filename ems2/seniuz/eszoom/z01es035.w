...
DEFINE VARIABLE h_b01es035 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b02es035 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     ...
     bt-ok AT ROW 16.13 COL 3
     bt-cancela AT ROW 16.13 COL 14
     bt-ajuda AT ROW 16.13 COL 79
     rt-button AT ROW 15.88 COL 2
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Testes de Produtos"
         HEIGHT             = 16.29
         WIDTH              = 90
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 90
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Testes de Produtos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Testes de Produtos */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'N£mero-OF|Data' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b01es035.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01es035 ).
       RUN set-position IN h_b01es035 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.25 , 88.00 ) */

       /* Links to SmartBrowser h_b01es035. */
       RUN add-link IN adm-broker-hdl ( h_b01es035 , 'State':U , THIS-PROCEDURE ).

    END. /* Page 1 */

    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b02es035.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b02es035 ).
       RUN set-position IN h_b02es035 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.25 , 88.00 ) */

       /* Links to SmartBrowser h_b02es035. */
       RUN add-link IN adm-broker-hdl ( h_b02es035 , 'State':U , THIS-PROCEDURE ).
