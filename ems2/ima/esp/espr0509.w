...
*******************************************************************************/
{include/i-prgvrs.i esrp0509 9.99.99.999}
...
&Scoped-Define ENABLED-OBJECTS br-digita bt-recuperar 
...
DEFINE VARIABLE fiCodRefer AS CHARACTER FORMAT "X(15)":U 
     LABEL "Referància" 
     VIEW-AS FILL-IN 
     SIZE 7 BY 1 NO-UNDO.
...
DEFINE FRAME f-pg-par
     fiItem AT ROW 2 COL 24 COLON-ALIGNED WIDGET-ID 2
     fiCodRefer AT ROW 3.75 COL 24 COLON-ALIGNED WIDGET-ID 4
     "Deixar Em Branco Para Todos os preáos" VIEW-AS TEXT
          SIZE 58 BY 1.25 AT ROW 6.5 COL 10.57 WIDGET-ID 6
          FGCOLOR 4 FONT 9
     RECT-10 AT ROW 1.25 COL 11 WIDGET-ID 8
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.14 ROW 3.21
         SIZE 76.57 BY 10 WIDGET-ID 100.
...
ON END-ERROR OF w-relat /* Preáos Por Item/Ref. */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Preáos Por Item/Ref. */
DO:
...
{utp/ut9000.i "esrp0509" "9.99.99.999"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fiItem fiCodRefer 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-10 fiItem fiCodRefer 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-par}
  ENABLE br-digita bt-recuperar 
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.it-codigo       = fiItem:SCREEN-VALUE IN FRAME f-pg-par
           tt-param.cod-refer       = fiCodRefer:SCREEN-VALUE IN FRAME f-pg-par
    ...
    {include/i-rprun.i esrp/espr0509rp.p}
