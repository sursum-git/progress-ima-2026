...
*******************************************************************************/
{include/i-prgvrs.i ESSP0083 2.04.00.000}
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Incidˆncia de Manuten‡Æo por Operador"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Incidˆncia de Manuten‡Æo por Operador */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Incidˆncia de Manuten‡Æo por Operador */
DO:
...
{utp/ut9000.i "ESSP0083" "2.04.00.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/essp0083rp.p}
