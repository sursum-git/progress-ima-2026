...
*******************************************************************************/
{include/i-prgvrs.i ESFT0024 2.04.00.000}
...
DEFINE VARIABLE rs-tipo-nota AS INTEGER INITIAL 2 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Todas", 1,
"Somente Notas sem Data de Sa¡da", 2
...
DEFINE FRAME f-pg-par
     ...
     rs-tipo-nota AT ROW 1.88 COL 8 NO-LABEL
...
DEFINE FRAME f-pg-sel
     ...
     fi-ini-dt-saida AT ROW 3.54 COL 15.29 COLON-ALIGNED HELP
          "Data de sa¡da das mercadorias"
     fi-fin-dt-saida AT ROW 3.54 COL 46.43 COLON-ALIGNED HELP
          "Data de sa¡da das mercadorias" NO-LABEL
     fi-ini-transp AT ROW 4.54 COL 15.29 COLON-ALIGNED
     fi-fin-transp AT ROW 4.54 COL 46.43 COLON-ALIGNED NO-LABEL
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Notas Fiscais para Consulta de Sintegra"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Notas Fiscais para Consulta de Sintegra */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Notas Fiscais para Consulta de Sintegra */
DO:
...
{utp/ut9000.i "ESFT0024" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY to-imp-param rs-tipo-nota 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE to-imp-param rs-tipo-nota RECT-27 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ...
  ENABLE fi-cod-estabel fi-ini-dt-emissao fi-fin-dt-emissao fi-ini-dt-saida 
         fi-fin-dt-saida fi-ini-transp fi-fin-transp IMAGE-1 IMAGE-13 IMAGE-14 
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario        = c-seg-usuario
           ...
           tt-param.tipo-nota      = INPUT FRAME f-pg-par rs-tipo-nota
           tt-param.desc-tipo-nota = entry((tt-param.tipo-nota - 1) * 2 + 1, 
                                           rs-tipo-nota:radio-buttons in frame f-pg-par)
    ...
    {include/i-rprun.i esrp/esft0024rp.p}
