...
DEFINE FRAME f-pg-sel
     bt-arq-imp AT ROW 4.46 COL 64 HELP
          "Escolha do nome do arquivo" WIDGET-ID 2
     c-arq AT ROW 4.5 COL 14.86 COLON-ALIGNED WIDGET-ID 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Integra Clientes com EMS 5"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Integra Clientes com EMS 5 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Integra Clientes com EMS 5 */
DO:
...
ON CHOOSE OF bt-arq-imp IN FRAME f-pg-sel
DO:
    ...
    IF lg-ok THEN
        ASSIGN c-arq:SCREEN-VALUE IN FRAME f-pg-sel = REPLACE(c-arq-imp, "\", "/").
END.
...
{utp/ut9000.i "ESCD1607" "2.00.06.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/escd1607rp.p}
