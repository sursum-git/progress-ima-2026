...
*******************************************************************************/
{include/i-prgvrs.i ESSP0120 2.04.00.000}
...
DEFINE VARIABLE fi-cod-refer-fin AS CHARACTER FORMAT "X(8)" INITIAL "ZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 TOOLTIP "Cod¡go de Referˆncia" NO-UNDO.
...
DEFINE VARIABLE fi-dt-trans-fin AS DATE FORMAT "99/99/9999" INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-dt-trans-ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/001 
     LABEL "Data Inicial":R12 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 TOOLTIP "Data de entrega inicial" NO-UNDO.

DEFINE VARIABLE fi-it-codigo-fin AS CHARACTER FORMAT "X(16)" INITIAL "9999999999999999" 
     VIEW-AS FILL-IN 
     SIZE 15.72 BY .79 TOOLTIP "Cod¡go do Ötem" NO-UNDO.
...
DEFINE FRAME f-pg-sel
     fi-dt-trans-ini AT ROW 1.54 COL 14.72 COLON-ALIGNED HELP
          "Data prevista para entrega do Pedido"
     fi-dt-trans-fin AT ROW 1.54 COL 48.29 COLON-ALIGNED HELP
          "Data prevista para entrega do Pedido" NO-LABEL
     fi-it-codigo-ini AT ROW 2.54 COL 14.72 COLON-ALIGNED
     fi-it-codigo-fin AT ROW 2.54 COL 48.29 COLON-ALIGNED NO-LABEL
     fi-cod-refer-ini AT ROW 3.54 COL 14.72 COLON-ALIGNED
     fi-cod-refer-fin AT ROW 3.54 COL 48.29 COLON-ALIGNED NO-LABEL
     IMAGE-1 AT ROW 1.54 COL 32.57
     IMAGE-13 AT ROW 3.54 COL 32.57
     IMAGE-14 AT ROW 2.54 COL 46.72
     IMAGE-15 AT ROW 3.54 COL 46.72
     IMAGE-2 AT ROW 1.54 COL 46.72
     IMAGE-5 AT ROW 2.54 COL 32.57
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 4 ROW 3.21
         SIZE 75.86 BY 10.25
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Rela‡Æo da Produ‡Æo X Etiquetas"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.71
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Rela‡Æo da Produ‡Æo X Etiquetas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Rela‡Æo da Produ‡Æo X Etiquetas */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-it-codigo-fin w-relat
ON MOUSE-SELECT-DBLCLICK OF fi-it-codigo-fin IN FRAME f-pg-sel
DO:
...
ON MOUSE-SELECT-DBLCLICK OF fi-it-codigo-ini IN FRAME f-pg-sel /* Item */
DO:
    {include/zoomvar.i &prog-zoom=inzoom/z01in172.w
...
{utp/ut9000.i "ESSP0120" "2.04.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN fi-dt-trans-ini:SCREEN-VALUE IN FRAME f-pg-sel = STRING(DATE(MONTH(TODAY),1,YEAR(TODAY)),"99/99/9999")
           fi-dt-trans-fin:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY,"99/99/9999").
    
    {include/i-rpmbl.i}

    fi-it-codigo-ini:LOAD-MOUSE-POINTER("image/lupa.cur") IN FRAME f-pg-sel.
    fi-it-codigo-fin:LOAD-MOUSE-POINTER("image/lupa.cur") IN FRAME f-pg-sel.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-dt-trans-ini fi-dt-trans-fin fi-it-codigo-ini fi-it-codigo-fin 
          fi-cod-refer-ini fi-cod-refer-fin 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-dt-trans-ini fi-dt-trans-fin fi-it-codigo-ini fi-it-codigo-fin 
         fi-cod-refer-ini fi-cod-refer-fin IMAGE-1 IMAGE-13 IMAGE-14 IMAGE-15 
         IMAGE-2 IMAGE-5 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.dt-trans-ini   = INPUT FRAME f-pg-sel fi-dt-trans-ini                
           tt-param.dt-trans-fin   = INPUT FRAME f-pg-sel fi-dt-trans-fin             
    ...
    {include/i-rprun.i esrp/essp0120rp.p}
