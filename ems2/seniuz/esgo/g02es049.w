...
DEF VAR c-etq AS CHAR FORMAT "x(10)".
...
DEFINE FRAME d-vapara
     ob-etiqueta.cod-estabel AT ROW 1.75 COL 17.57 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 3.29 BY .88
     fi-num-etiqueta AT ROW 2.75 COL 17.57 COLON-ALIGNED
     bt-ok AT ROW 4.75 COL 2.14
     bt-cancela AT ROW 4.75 COL 13
     bt-ajuda AT ROW 4.75 COL 58
     rt-button AT ROW 4.5 COL 1
     RECT-12 AT ROW 1 COL 1 WIDGET-ID 4
     SPACE(0.13) SKIP(1.66)
...
DO:
  FIND ob-etiqueta WHERE
       ...
       ob-etiqueta.num-etiqueta  = INT(INPUT FRAME {&FRAME-NAME} fi-num-etiqueta) 
       NO-LOCK NO-ERROR.
  ...
  IF ob-etiqueta.situacao <> 3 THEN DO.
     MESSAGE 'Situacao da Etiqueta n∆o permite Corte...'
  ...
  IF NOT AVAIL ob-localiz THEN DO.
     MESSAGE 'Localizaá∆o da Etiqueta N∆o Cadastrada....'
         VIEW-AS ALERT-BOX INFO BUTTONS OK.
     RETURN NO-APPLY.
  END.

  IF ob-localiz.tipo <> 2 AND ob-localiz.tipo <> 9 THEN DO.
     MESSAGE 'Localizacao da Etiqueta n∆o permite Corte...'
         VIEW-AS ALERT-BOX ERROR BUTTONS OK.
     RETURN NO-APPLY.
  END.
...
ON LEAVE OF fi-num-etiqueta IN FRAME d-vapara /* Num Etiqueta */
DO:
   IF LOOKUP(c-seg-usuario,'super,esoares') = 0 THEN DO.
       IF i-digito <> INT(fn-calc-digito(SELF:SCREEN-VALUE)) THEN DO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-num-etiqueta d-vapara
ON VALUE-CHANGED OF fi-num-etiqueta IN FRAME d-vapara /* Num Etiqueta */
DO:
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE ob-etiqueta THEN 
    DISPLAY ob-etiqueta.cod-estabel 
      WITH FRAME d-vapara.
  ENABLE ob-etiqueta.cod-estabel fi-num-etiqueta bt-ok bt-cancela bt-ajuda 
         rt-button RECT-12 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "G02ES049" "2.04.00.000"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  /* Code placed here will execute AFTER standard behavior.    */
  ASSIGN ob-etiqueta.cod-estabel:SCREEN-VALUE = '1'.
