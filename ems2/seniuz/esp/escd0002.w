...
*******************************************************************************/
{include/i-prgvrs.i ESCD0002 2.04.00.000}
...
DEFINE VARIABLE h_q04ad098 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-cadsi2 /* Manuten‡Æo de Clientes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsi2 w-cadsi2
ON WINDOW-CLOSE OF w-cadsi2 /* Manuten‡Æo de Clientes */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esvwr/v04ad098.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v04ad098 ).
       RUN set-position IN h_v04ad098 ( 2.75 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.00 , 88.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esqry/q04ad098.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q04ad098 ).
       RUN set-position IN h_q04ad098 ( 1.50 , 63.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-cadsi2 , 'TableIO':U , h_v04ad098 ).
       RUN add-link IN adm-broker-hdl ( h_q04ad098 , 'Record':U , h_v04ad098 ).

       /* Links to SmartQuery h_q04ad098. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_q04ad098 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_q04ad098 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_q04ad098 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsi2 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v04ad098 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCD0002" "2.04.00.000"}
