...
&Scoped-Define ENABLED-FIELDS item.it-codigo item.desc-item 
...
DEFINE FRAME f-main
     item.it-codigo AT ROW 1.17 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.14 BY .88
          FONT 1
     item.desc-item AT ROW 2.17 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 61.14 BY .88
          FONT 1
...
------------------------------------------------------------------------------*/
    ...
    IF AVAIL ITEM THEN
       RUN pi-popula-browse IN WIDGET-HANDLE(c-container) (INPUT ITEM.it-codigo).
