...
*******************************************************************************/
{include/i-prgvrs.i Q02AD098 2.04.00.000}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH emitente ~
 ...
 AND emitente.cod-rep <= i-cod-rep-fin NO-LOCK INDEXED-REPOSITION
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "cod-banco,cod-canal-venda,nome-abrev,cod-cond-pag,categoria,cod-emitente,cod-gr-cli,cod-gr-forn,cod-isencao,cod-mensagem,nat-operacao,cod-rep,nr-tab-progr,nr-tabpre,cod-tip-ent,cod-tax,cod-transp"':U).
