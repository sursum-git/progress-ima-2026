...
&Scoped-Define ENABLED-FIELDS bc-etiqueta.cod-estabel bc-etiqueta.it-codigo ~
bc-etiqueta.referencia bc-etiqueta.num-pedido bc-etiqueta.qt-item 
&Scoped-define ENABLED-TABLES bc-etiqueta
&Scoped-define FIRST-ENABLED-TABLE bc-etiqueta
&Scoped-Define ENABLED-OBJECTS rt-key rt-mold 
&Scoped-Define DISPLAYED-FIELDS bc-etiqueta.cod-estabel ~
bc-etiqueta.it-codigo bc-etiqueta.referencia bc-etiqueta.num-pedido ~
bc-etiqueta.qt-item 
&Scoped-define DISPLAYED-TABLES bc-etiqueta
&Scoped-define FIRST-DISPLAYED-TABLE bc-etiqueta
&Scoped-Define DISPLAYED-OBJECTS fi-num-etiqueta c-desc-estabelec 
...
DEFINE FRAME f-main
     bc-etiqueta.cod-estabel AT ROW 1.25 COL 26 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5 BY .88
     fi-num-etiqueta AT ROW 2.25 COL 26 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN bc-etiqueta.progressivo   = STRING(i-ep-codigo-usuario,"9") + trim(string(bc-etiqueta.cod-estabel,"x(03)")) + STRING(i-seq,"999999999")
           bc-etiqueta.cod-estado    = INTEGER(bc-etiqueta.cod-estabel:SCREEN-VALUE) 
    ...
    ASSIGN ob-etiqueta.cod-estabel     = bc-etiqueta.cod-estabel
           ...
           ob-etiqueta.nr-container    = bc-etiqueta.nr-pedido
