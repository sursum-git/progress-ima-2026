...
*******************************************************************************/
{include/i-prgvrs.i esra001 2.04.00.000}
...
DEFINE VARIABLE h_q01ra001 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v01ra001 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esvwr/v01ra001.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v01ra001 ).
       RUN set-position IN h_v01ra001 ( 2.75 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.83 , 89.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esqry/q01ra001.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = eszoom\z01ra001.w,
                     ProgVaPara = esgo\g01ra001.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_q01ra001 ).
       RUN set-position IN h_q01ra001 ( 1.00 , 60.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_v01ra001. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_v01ra001 ).
       RUN add-link IN adm-broker-hdl ( h_q01ra001 , 'Record':U , h_v01ra001 ).

       /* Links to SmartQuery h_q01ra001. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_q01ra001 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_q01ra001 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_q01ra001 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v01ra001 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esra001" "2.04.00.000"}
