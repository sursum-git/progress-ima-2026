...
*******************************************************************************/
{include/i-prgvrs.i espd004A 9.99.99.999}
...
DEFINE VARIABLE tgDtPend AS LOGICAL INITIAL no 
     LABEL "Atualizar Datas Pendentes" 
     VIEW-AS TOGGLE-BOX
     SIZE 44 BY 1.08 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     fiDtIni AT ROW 4.83 COL 15 COLON-ALIGNED
     fidtFim AT ROW 4.83 COL 48.14 COLON-ALIGNED NO-LABEL
     tgDtPend AT ROW 6.75 COL 17 WIDGET-ID 22
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Atualizaá∆o de Tabelas de Faturamento Customizadas"
         HEIGHT             = 15.46
         WIDTH              = 82.29
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Atualizaá∆o de Tabelas de Faturamento Customizadas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Atualizaá∆o de Tabelas de Faturamento Customizadas */
DO:
...
&Scoped-define SELF-NAME tgDtPend
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tgDtPend w-relat
ON VALUE-CHANGED OF tgDtPend IN FRAME f-pg-sel /* Atualizar Datas Pendentes */
DO:
     ASSIGN fiDtIni:SENSITIVE IN FRAME f-pg-sel = SELF:SCREEN-VALUE <> "YES"
            fiDtFim:SENSITIVE IN FRAME f-pg-sel = SELF:SCREEN-VALUE <> "YES".
...
{utp/ut9000.i "espd004A" "9.99.99.999"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN fiDtIni:SENSITIVE IN FRAME f-pg-sel = YES
           fiDtFim:SENSITIVE IN FRAME f-pg-sel = YES
           fiDtIni:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY - 30)
           fiDtFim:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY)
           .
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fiDtIni fidtFim tgDtPend 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 fiDtIni fidtFim tgDtPend 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    IF tgDtPend:SCREEN-VALUE IN FRAME f-pg-sel   = 'no' THEN DO:
       IF INPUT FRAME f-pg-sel fiDtIni = ? OR
          INPUT FRAME f-pg-sel fiDtFim = ? THEN DO:
          MESSAGE 'ê necess†rio informar a data inicial e final de emiss∆o...'
    ...
    create tt-param.
    assign tt-param.dtInicial       = INPUT FRAME f-pg-sel fiDtIni
           tt-param.dtFinal         = INPUT FRAME f-pg-sel fiDtFim
           tt-param.logDtPends      = INPUT FRAME f-pg-sel tgDtPend
    ...
    {include/i-rprun.i esrp/espd004Arp.p}
