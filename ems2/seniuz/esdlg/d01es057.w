...
*******************************************************************************/
{include/i-prgvrs.i D01ES057 2.04.00.000}
...
DEFINE INPUT-OUTPUT PARAMETER i-tipo-saida  AS INT.
...
&Scoped-Define ENABLED-OBJECTS fi-cod-estabel rs-tipo-saida bt-ok ~
...
DEFINE VARIABLE rs-tipo-saida AS INTEGER INITIAL 1 
     VIEW-AS RADIO-SET VERTICAL
     RADIO-BUTTONS 
          "Sem data de sa°da", 1,
"Com data de sa°da", 2,
"Todos", 3
     SIZE 18 BY 3.13 NO-UNDO.
...
DEFINE FRAME D-Dialog
     ...
     fi-nome-estabel AT ROW 1.75 COL 18.72 COLON-ALIGNED NO-LABEL
     rs-tipo-saida AT ROW 3.5 COL 23 NO-LABEL
     bt-ok AT ROW 7.79 COL 3
     bt-cancela AT ROW 7.79 COL 14
     bt-ajuda AT ROW 7.79 COL 59
     RECT-3 AT ROW 3.08 COL 20
     rt-buttom AT ROW 7.63 COL 2
     SPACE(0.99) SKIP(0.11)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 1
         TITLE "Seleá∆o de Caminh‰es"
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Seleá∆o de Caminh‰es */
DO:  
...
DO:
   ASSIGN i-tipo-saida  = INPUT FRAME {&FRAME-NAME} rs-tipo-saida
...
------------------------------------------------------------------------------*/
  DISPLAY fi-cod-estabel fi-nome-estabel rs-tipo-saida 
      WITH FRAME D-Dialog.
  ENABLE fi-cod-estabel rs-tipo-saida bt-ok bt-cancela bt-ajuda RECT-3 
         rt-buttom 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "D01ES057" "2.04.00.000"}
  ...
  ASSIGN rs-tipo-saida:SCREEN-VALUE IN FRAME {&FRAME-NAME} = STRING(i-tipo-saida)
         fi-cod-estabel:SCREEN-VALUE IN FRAME {&FRAME-NAME} = c-cod-estabel.
  FIND estabelec WHERE
       estabelec.cod-estabel = INPUT FRAME {&FRAME-NAME} fi-cod-estabel
       NO-LOCK NO-ERROR.
  IF AVAIL estabelec THEN
