...
*******************************************************************************/
{include/i-prgvrs.i ESSP0066 2.04.00.000}
...
DEFINE FRAME f-pg-sel
     ...
     IMAGE-1 AT ROW 1.25 COL 29.29
     IMAGE-10 AT ROW 2.29 COL 47.29
     IMAGE-17 AT ROW 3.29 COL 47.29
     IMAGE-18 AT ROW 3.29 COL 29.29
     IMAGE-2 AT ROW 1.25 COL 47.29
     IMAGE-9 AT ROW 2.29 COL 29.29
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
ON END-ERROR OF w-relat /* Testes ASTM */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Testes ASTM */
DO:
...
{utp/ut9000.i "ESSP0066" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE fi-ini-fm-codigo fi-fin-fm-codigo fi-ini-it-codigo fi-fin-it-codigo 
         fi-ini-ano-mes fi-fin-ano-mes IMAGE-1 IMAGE-10 IMAGE-17 IMAGE-18 
         IMAGE-2 IMAGE-9 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
if tt-param.destino = 1 
    ...
    {include/i-rprun.i esrp/essp0066rp.p}
