...
IF contador < 10 THEN DO:
    RETURN "0000" + string(contador).
END.
IF contador < 100 THEN DO:
    RETURN "000" + string(contador).
END.
IF contador < 1000 THEN DO:
    RETURN "00" + string(contador).
END.
ELSE DO:
    RETURN "0" + string(contador).
END.
