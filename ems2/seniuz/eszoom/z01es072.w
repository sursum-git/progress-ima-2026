...
*******************************************************************************/
{include/i-prgvrs.i Z01ES072 2.04.00.000}
...
DEFINE VARIABLE h_b01es072 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     ...
     bt-ajuda AT ROW 13.5 COL 76.86
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Transforma‡äes"
         HEIGHT             = 13.79
         WIDTH              = 87.72
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 90
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Transforma‡äes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Transforma‡äes */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Transforma‡Æo' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b01es072.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01es072 ).
       RUN set-position IN h_b01es072 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 84.57 ) */

       /* Links to SmartBrowser h_b01es072. */
       RUN add-link IN adm-broker-hdl ( h_b01es072 , 'State':U , THIS-PROCEDURE ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "Z01ES072" "2.04.00.000"}
