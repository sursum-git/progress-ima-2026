...
&Scoped-Define ENABLED-OBJECTS rt-button RECT-1 fiEstab fiSerie fiNota ~
btGerar 
&Scoped-Define DISPLAYED-OBJECTS fiEstab fiSerie fiNota 
...
DEFINE VARIABLE fiNota AS CHARACTER FORMAT "9999999":U INITIAL "0000000" 
     LABEL "Nota" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-cad
     fiEstab AT ROW 3.25 COL 9 COLON-ALIGNED WIDGET-ID 2
     fiSerie AT ROW 3.25 COL 19 COLON-ALIGNED WIDGET-ID 4
     fiNota AT ROW 3.25 COL 29.57 COLON-ALIGNED WIDGET-ID 6
     btGerar AT ROW 3.25 COL 66 WIDGET-ID 8
     rt-button AT ROW 1 COL 1
     RECT-1 AT ROW 2.75 COL 1.29 WIDGET-ID 10
...
ON CHOOSE OF btGerar IN FRAME f-cad /* Gerar Comis.BKP */
DO:
  ASSIGN btGerar:SENSITIVE = NO.
  FIND FIRST nota-fiscal
        WHERE nota-fiscal.cod-estabel = INPUT FRAME {&FRAME-NAME} fiEstab
        AND   nota-fiscal.serie       = INPUT FRAME {&FRAME-NAME} fiSerie
        AND   nota-fiscal.nr-nota-fis = INPUT FRAME {&FRAME-NAME} fiNota
        NO-LOCK NO-ERROR.
  IF AVAIL nota-fiscal THEN DO:
     ...
     IF AVAIL ped-venda THEN DO:
        ASSIGN dPerc = IF ped-venda.cod-priori = 10 THEN 0 ELSE 20 - dperc.   
     END.
     ELSE DO:   
       ASSIGN dPerc = 0.     
     END.
         ...
         ASSIGN cEstab = IF nota-fiscal.cod-estabel = '5' THEN '501' ELSE '101'.
           ...
           IF AVAIL tit_acr THEN DO:   
              FIND FIRST repres_tit_acr 
                    ...
                    AND  repres_tit_acr.cdn_repres = 99999
                    NO-LOCK NO-ERROR.
                IF NOT AVAIL repres_tit_acr THEN DO:
                   ...
                   repres_tit_acr.cdn_repres                   = repres_tit_acr.cdn_repres
                   repres_tit_acr.cdn_cliente                  = tit_acr.cdn_cliente
                   repres_tit_acr.val_perc_comis_repres        = dPerc * 10
                   ...
                   repres_tit_acr.log_sdo_tit_acr              = tit_acr.LOG_sdo_tit_acr
                   repres_tit_acr.dat_ult_liquidac_tit_acr     = 12.31.9999.     
                   MESSAGE 'Comiss∆o criada para o titulo:' tit_acr.cod_tit_acr SKIP
                           'Parcela:' tit_acr.cod_parcela 
                       VIEW-AS ALERT-BOX INFO BUTTONS OK.
                END.
           END.
     END.
  END.
  ASSIGN btGerar:SENSITIVE = YES.  
END.
...
------------------------------------------------------------------------------*/
  DISPLAY fiEstab fiSerie fiNota 
      WITH FRAME f-cad IN WINDOW w-livre.
  ENABLE rt-button RECT-1 fiEstab fiSerie fiNota btGerar 
      WITH FRAME f-cad IN WINDOW w-livre.
