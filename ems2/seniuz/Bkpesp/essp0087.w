...
*******************************************************************************/
{include/i-prgvrs.i ESSP0087 2.04.00.000}
...
DEFINE VARIABLE fi-fin-it-codigo AS CHARACTER FORMAT "X(256)" INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.
...
DEFINE VARIABLE rs-tipo-conf AS INTEGER 
     VIEW-AS RADIO-SET VERTICAL
     RADIO-BUTTONS 
          "Apenas Eiquetas com ERRO", 1,
"Conferˆncia de DOCAS LIDAS", 2,
"Simples Conferˆncia", 3
...
DEFINE FRAME f-pg-par
     to-imp-param AT ROW 3.54 COL 27.29
     RECT-27 AT ROW 3 COL 5.86
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 77.14 BY 10.5
...
DEFINE FRAME f-pg-sel
     ...
     fi-nome-estabel AT ROW 1.75 COL 19.43 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     fi-dt-invent AT ROW 2.75 COL 15 COLON-ALIGNED
     fi-ini-it-codigo AT ROW 3.75 COL 15 COLON-ALIGNED
     fi-fin-it-codigo AT ROW 3.75 COL 42.57 COLON-ALIGNED NO-LABEL
     fi-localizacao-ini AT ROW 4.75 COL 15 COLON-ALIGNED WIDGET-ID 16
     fi-localizacao-fin AT ROW 4.75 COL 42.57 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     rs-tipo-conf AT ROW 6.75 COL 17 NO-LABEL WIDGET-ID 26
     IMAGE-1 AT ROW 3.79 COL 30
     IMAGE-2 AT ROW 3.75 COL 40.72
     IMAGE-5 AT ROW 4.75 COL 30 WIDGET-ID 18
     IMAGE-7 AT ROW 4.75 COL 41 WIDGET-ID 20
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 4 ROW 3.21
         SIZE 75.86 BY 10.25
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Conferˆncia do Invent rio da Expedi‡Æo"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Conferˆncia do Invent rio da Expedi‡Æo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Conferˆncia do Invent rio da Expedi‡Æo */
DO:
...
&Scoped-define SELF-NAME fi-localizacao-ini
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-localizacao-ini w-relat
ON LEAVE OF fi-localizacao-ini IN FRAME f-pg-sel /* Doca */
DO:
   IF TRIM(SELF:SCREEN-VALUE) <> "/" THEN
      ASSIGN fi-localizacao-fin:SCREEN-VALUE = SELF:SCREEN-VALUE.
END.
...
{utp/ut9000.i "ESSP0087" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-cod-estabel fi-nome-estabel fi-dt-invent fi-ini-it-codigo 
          fi-fin-it-codigo fi-localizacao-ini fi-localizacao-fin rs-tipo-conf 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-5 IMAGE-7 fi-cod-estabel fi-dt-invent 
         fi-ini-it-codigo fi-fin-it-codigo fi-localizacao-ini 
         fi-localizacao-fin rs-tipo-conf 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
DO ON ERROR UNDO, RETURN ERROR ON STOP UNDO, RETURN ERROR:
    ...
    IF NOT AVAIL inv-acab THEN DO.
       MESSAGE "NÆo foi encontrado Inventario na data Selecionada...." VIEW-AS ALERT-BOX.
    ...
    ASSIGN tt-param.usuario          = c-seg-usuario
           ...
           tt-param.ini-localiz      = INPUT FRAME f-pg-sel fi-localizacao-ini                
           tt-param.fin-localiz      = INPUT FRAME f-pg-sel fi-localizacao-fin             
           tt-param.tipo-conf        = INPUT FRAME f-pg-sel rs-tipo-conf
    ...
    {include/i-rprun.i esrp/essp0087rp.p}
