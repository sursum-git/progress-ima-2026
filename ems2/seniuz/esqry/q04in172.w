...
&Scoped-define QUERY-STRING-Query-Main FOR EACH item ~
 ...
 AND item.ge-codigo <= 58 NO-LOCK INDEXED-REPOSITION
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "fm-codigo,it-codigo,class-fiscal,cod-comprado,ct-codigo,cod-estabel,fm-cod-com,ge-codigo,cd-tag,nr-linha,cd-planejado,cod-refer,sc-codigo,un,nat-despesa,cod-servico,cod-tax"':U).
