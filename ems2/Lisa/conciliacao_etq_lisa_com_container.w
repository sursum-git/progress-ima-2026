...
DEFINE FRAME f-pg-par
     ...
     fiNrContainer AT ROW 3.21 COL 9.14 COLON-ALIGNED WIDGET-ID 18
     tgAtu AT ROW 4.33 COL 11.14 WIDGET-ID 14
     tgConciliacao AT ROW 5.17 COL 11.14 WIDGET-ID 16
     tgGerarLog AT ROW 9.83 COL 40.57 WIDGET-ID 2
     RECT-11 AT ROW 1.25 COL 2.72 WIDGET-ID 22
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN ed-ajuda:SCREEN-VALUE IN FRAME f-pg-par = 
        ...
        + CHR(13) + CHR(13) +
        '- A T E N Ä « O' + chr(13) + 
        '- FILTRO CONTAINER' + chr(13)  + 'O Filtro de Container n∆o filtra as etiquetas por container, mas apenas seleciona os itens e referencias de determinado container'
        .
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY ed-ajuda fiNrContainer tgAtu tgConciliacao tgGerarLog 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-11 fiNrContainer tgAtu tgConciliacao tgGerarLog 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    &endif
    /*Fim teste Modelo*/
    IF fiNrContainer:SCREEN-VALUE IN FRAME f-pg-par = '0'  THEN
    DO:
        MESSAGE 'ê obrigat¢rio informar o container'
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.nrContainer     = INPUT FRAME  f-pg-par fiNrContainer
    ...
    {include/i-rprun.i lisa/conciliacao_etq_lisa_com_container_rp.p}
