...
&Scoped-define QUERY-STRING-Query-Main FOR EACH inv-acab ~
      WHERE inv-acab.cod-estabel = c-cod-estabel ~
 AND inv-acab.data-invent = 12/19/2015 NO-LOCK ~
    BY inv-acab.cod-estabel ~
       BY inv-acab.num-etiqueta
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH inv-acab ~
      WHERE inv-acab.cod-estabel = c-cod-estabel ~
 AND inv-acab.data-invent = 12/19/2015 NO-LOCK ~
    BY inv-acab.cod-estabel ~
       BY inv-acab.num-etiqueta.
&Scoped-define TABLES-IN-QUERY-Query-Main inv-acab
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main inv-acab
...
<FOREIGN-KEYS>
cod-estabel||y|espec.inv-acab.cod-estabel
it-codigo||y|espec.inv-acab.it-codigo
Usuario||y|espec.inv-acab.Usuario
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "cod-estabel,it-codigo,Usuario"':U).
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Options          = "NO-LOCK"
     _OrdList          = "espec.inv-acab.cod-estabel|yes,espec.inv-acab.num-etiqueta|yes"
     _Where[1]         = "espec.inv-acab.cod-estabel = c-cod-estabel
 AND espec.inv-acab.data-invent = 12/19/2015"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod-estabel" "inv-acab" "cod-estabel"}
  {src/adm/template/sndkycas.i "it-codigo" "inv-acab" "it-codigo"}
  {src/adm/template/sndkycas.i "Usuario" "inv-acab" "Usuario"}
