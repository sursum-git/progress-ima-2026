...
&Scoped-Define ENABLED-OBJECTS rt-button RECT-1 RECT-3 fi_estab ~
fi_serie_ini fi_serie_fim fi_nf_ini fi_nf_fim fi_nat_operacao_ini ~
fi_nat_operacao_fim fi_cliente_ini fi_cliente_fim dt_emissao_ini ~
dt_emissao_fim tg_canceladas tg_dp_sim tg_dp_nao tg_entradas tg_saidas ~
bt_executar 
&Scoped-Define DISPLAYED-OBJECTS fi_estab fi_serie_ini fi_serie_fim ~
fi_nf_ini fi_nf_fim fi_nat_operacao_ini fi_nat_operacao_fim fi_cliente_ini ~
fi_cliente_fim dt_emissao_ini dt_emissao_fim tg_canceladas tg_dp_sim ~
tg_dp_nao tg_entradas tg_saidas 
...
DEFINE FRAME f-cad
     ...
     bt_executar AT ROW 15 COL 20 WIDGET-ID 36
...
DO:
  ...
  FOR EACH nota-fiscal NO-LOCK
      ...
      FOR EACH it-nota-fisc OF nota-fiscal NO-LOCK.
          ...
          /*verificar o motivo os valores estarem vindo zerados
          CREATE ttItens.
          ASSIGN ttItens.origem         = "FAT"
                 ttItens.sequencia      = it-nota-fisc.nr-seq-fat
                 ttItens.itCodigo       = it-nota-fisc.it-codigo
                 ttItens.vlPis          = it-nota-fisc.vl-pis
                 ttItens.vlCofins       = it-nota-fisc.vl-finsocial
                 ttItens.percPis        = dPercPis
                 ttItens.percCofins     = dPercCofins
                 ttItens.vlBasePis      = round(ttItens.vlPis / ttItens.percPis,2)
                 ttItens.vlBaseCofins   = round(ttItens.vlCofins / ttItens.percCofins,2)   
         ...
         IF AVAIL it-doc-fisc THEN DO:
            ...
            ASSIGN ttItens.origem       = "OF"
                   ...
                   ttItens.vlPis        = it-doc-fisc.val-pis
                   ttItens.vlCofins     = it-doc-fisc.val-cofins
                   ttItens.percPis      = it-doc-fisc.aliq-pis 
                   ttItens.percCofins   = it-doc-fisc.aliq-cofins
                   ttItens.vlBasePis    = it-doc-fisc.val-base-calc-pis
                   ttItens.vlBaseCofins = it-doc-fisc.val-base-calc-cofins
                   ttItens.rrowid       = ROWID(nota-fiscal).
...
------------------------------------------------------------------------------*/
  DISPLAY fi_estab fi_serie_ini fi_serie_fim fi_nf_ini fi_nf_fim 
          fi_nat_operacao_ini fi_nat_operacao_fim fi_cliente_ini fi_cliente_fim 
          dt_emissao_ini dt_emissao_fim tg_canceladas tg_dp_sim tg_dp_nao 
          tg_entradas tg_saidas 
      WITH FRAME f-cad IN WINDOW w-livre.
  ENABLE rt-button RECT-1 RECT-3 fi_estab fi_serie_ini fi_serie_fim fi_nf_ini 
         fi_nf_fim fi_nat_operacao_ini fi_nat_operacao_fim fi_cliente_ini 
         fi_cliente_fim dt_emissao_ini dt_emissao_fim tg_canceladas tg_dp_sim 
         tg_dp_nao tg_entradas tg_saidas bt_executar 
      WITH FRAME f-cad IN WINDOW w-livre.
