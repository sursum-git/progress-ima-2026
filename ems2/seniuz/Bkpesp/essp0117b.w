...
&Scoped-Define ENABLED-OBJECTS fi-placa fi-dt-entrada fi-hora-ent ~
fi-dt-saida fi-hora-sai fi-peso-bruto-nf fi-peso-liquido-nf ~
fi-peso-bruto-veiculo fi-peso-tara-veiculo fi-cod-emit fi-nro-docto ~
fi-nro-contrato fi-dt-emissao fi-dt-recebimento fi-procedencia fi-peso-nf ~
fi-padrao1 fi-qtd-fardos1 fi-padrao2 fi-qtd-fardos2 fi-padrao3 ~
fi-qtd-fardos3 fi-padrao4 fi-qtd-fardos4 fi-padrao5 fi-qtd-fardos5 bt-ok ~
bt-cancelar bt-ajuda RECT-1 RECT-13 RECT-14 
&Scoped-Define DISPLAYED-OBJECTS fi-placa fi-dt-entrada fi-hora-ent ~
fi-dt-saida fi-hora-sai fi-peso-bruto-nf fi-peso-liquido-nf ~
fi-peso-bruto-veiculo fi-peso-tara-veiculo fi-cod-emit fi-nome-emit ~
fi-nro-docto fi-nro-contrato fi-dt-emissao fi-dt-recebimento fi-procedencia ~
fi-peso-nf fi-padrao1 fi-qtd-fardos1 fi-padrao2 fi-qtd-fardos2 fi-padrao3 ~
...
DEFINE VARIABLE fi-hora-ent AS CHARACTER FORMAT "99:99":U 
     LABEL "Hora Entrada" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE fi-hora-sai AS CHARACTER FORMAT "99:99":U 
     LABEL "Hora Saida" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.
...
DEFINE VARIABLE fi-peso-bruto-nf AS DECIMAL FORMAT ">>>,>>9.99" INITIAL 0 
     LABEL "Peso Bruto da NF" 
     VIEW-AS FILL-IN 
     SIZE 12.57 BY .88 NO-UNDO.

DEFINE VARIABLE fi-peso-bruto-veiculo AS DECIMAL FORMAT ">>>,>>9.99" INITIAL 0 
     LABEL "Peso Bruto do Veiculo" 
     VIEW-AS FILL-IN 
     SIZE 12.57 BY .88 NO-UNDO.

DEFINE VARIABLE fi-peso-liquido-nf AS DECIMAL FORMAT ">>>,>>9.99" INITIAL 0 
...
DEFINE VARIABLE fi-peso-tara-veiculo AS DECIMAL FORMAT ">>>,>>9.99" INITIAL 0 
     LABEL "Peso Tara do Bruto" 
     VIEW-AS FILL-IN 
     SIZE 12.57 BY .88 NO-UNDO.
...
DEFINE FRAME F-Main
     fi-placa AT ROW 1.63 COL 17 COLON-ALIGNED
     fi-dt-entrada AT ROW 2.63 COL 17 COLON-ALIGNED
     fi-hora-ent AT ROW 2.63 COL 42.29 COLON-ALIGNED
     fi-dt-saida AT ROW 3.63 COL 17 COLON-ALIGNED
     fi-hora-sai AT ROW 3.63 COL 42.29 COLON-ALIGNED
     fi-peso-bruto-nf AT ROW 5.13 COL 17 COLON-ALIGNED
     fi-peso-liquido-nf AT ROW 6.13 COL 17 COLON-ALIGNED
     fi-peso-bruto-veiculo AT ROW 7.13 COL 17 COLON-ALIGNED
     fi-peso-tara-veiculo AT ROW 8.13 COL 17 COLON-ALIGNED
     fi-cod-emit AT ROW 10.08 COL 17 COLON-ALIGNED
     fi-nome-emit AT ROW 10.08 COL 23.72 COLON-ALIGNED NO-LABEL
     fi-nro-docto AT ROW 11.08 COL 17 COLON-ALIGNED
     fi-nro-contrato AT ROW 11.08 COL 50 COLON-ALIGNED
     fi-dt-emissao AT ROW 12.08 COL 17 COLON-ALIGNED
     fi-dt-recebimento AT ROW 12.08 COL 50 COLON-ALIGNED
     fi-procedencia AT ROW 13.08 COL 17 COLON-ALIGNED
     fi-peso-nf AT ROW 13.08 COL 50 COLON-ALIGNED
     fi-padrao1 AT ROW 14.83 COL 17 COLON-ALIGNED NO-LABEL
     fi-qtd-fardos1 AT ROW 14.83 COL 50 COLON-ALIGNED NO-LABEL
     fi-padrao2 AT ROW 15.83 COL 17 COLON-ALIGNED NO-LABEL
     fi-qtd-fardos2 AT ROW 15.83 COL 50 COLON-ALIGNED NO-LABEL
     fi-padrao3 AT ROW 16.83 COL 17 COLON-ALIGNED NO-LABEL
     fi-qtd-fardos3 AT ROW 16.83 COL 50 COLON-ALIGNED NO-LABEL
     fi-padrao4 AT ROW 17.83 COL 17 COLON-ALIGNED NO-LABEL
     fi-qtd-fardos4 AT ROW 17.83 COL 50 COLON-ALIGNED NO-LABEL
     fi-padrao5 AT ROW 18.83 COL 17 COLON-ALIGNED NO-LABEL
     fi-qtd-fardos5 AT ROW 18.83 COL 50 COLON-ALIGNED NO-LABEL
     bt-ok AT ROW 20.42 COL 3.29
     bt-cancelar AT ROW 20.42 COL 14.29
     bt-ajuda AT ROW 20.46 COL 60.14
     RECT-1 AT ROW 20.21 COL 2
     RECT-13 AT ROW 1.38 COL 2
     RECT-14 AT ROW 9.83 COL 2
     "Padr∆o" VIEW-AS TEXT
          SIZE 8 BY .75 AT ROW 14.08 COL 19
          FGCOLOR 9 FONT 8
     "Qt Fardos" VIEW-AS TEXT
          SIZE 11 BY .75 AT ROW 14.08 COL 52
          FGCOLOR 9 FONT 8
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-digita ASSIGN
         HIDDEN             = YES
         TITLE              = "Descarga de Algod∆o Paraopeba"
         HEIGHT             = 20.71
         WIDTH              = 70.86
         MAX-HEIGHT         = 28.54
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-digita /* Descarga de Algod∆o Paraopeba */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-digita w-digita
ON WINDOW-CLOSE OF w-digita /* Descarga de Algod∆o Paraopeba */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY fi-placa fi-dt-entrada fi-hora-ent fi-dt-saida fi-hora-sai 
          fi-peso-bruto-nf fi-peso-liquido-nf fi-peso-bruto-veiculo 
          fi-peso-tara-veiculo fi-cod-emit fi-nome-emit fi-nro-docto 
          fi-nro-contrato fi-dt-emissao fi-dt-recebimento fi-procedencia 
          fi-peso-nf fi-padrao1 fi-qtd-fardos1 fi-padrao2 fi-qtd-fardos2 
          fi-padrao3 fi-qtd-fardos3 fi-padrao4 fi-qtd-fardos4 fi-padrao5 
          fi-qtd-fardos5 
      WITH FRAME F-Main IN WINDOW w-digita.
  ENABLE fi-placa fi-dt-entrada fi-hora-ent fi-dt-saida fi-hora-sai 
         fi-peso-bruto-nf fi-peso-liquido-nf fi-peso-bruto-veiculo 
         fi-peso-tara-veiculo fi-cod-emit fi-nro-docto fi-nro-contrato 
         fi-dt-emissao fi-dt-recebimento fi-procedencia fi-peso-nf fi-padrao1 
         fi-qtd-fardos1 fi-padrao2 fi-qtd-fardos2 fi-padrao3 fi-qtd-fardos3 
         fi-padrao4 fi-qtd-fardos4 fi-padrao5 fi-qtd-fardos5 bt-ok bt-cancelar 
         bt-ajuda RECT-1 RECT-13 RECT-14 
      WITH FRAME F-Main IN WINDOW w-digita.
