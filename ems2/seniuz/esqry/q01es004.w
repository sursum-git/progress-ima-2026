...
&Scoped-define QUERY-STRING-Query-Main FOR EACH contr-sac NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH contr-sac NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main contr-sac
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main contr-sac
