...
*******************************************************************************/
{include/i-prgvrs.i ESSP0039 2.04.00.000}
...
DEFINE FRAME f-pg-cla
     rs-classif AT ROW 1.29 COL 3 HELP
...
DEFINE FRAME f-pg-sel
     ...
     fi-fin-fm-codigo AT ROW 1.25 COL 45.72 COLON-ALIGNED HELP
          "Codigo da familia no Magnus" NO-LABEL
     fi-ini-it-codigo AT ROW 2.25 COL 15 COLON-ALIGNED
     fi-fin-it-codigo AT ROW 2.25 COL 45.72 COLON-ALIGNED NO-LABEL
     fi-ini-ano-mes AT ROW 3.25 COL 15 COLON-ALIGNED HELP
          "Periodo: AAAA/MM (AAAA = Ano, MM = Mes)"
     fi-fin-ano-mes AT ROW 3.25 COL 45.72 COLON-ALIGNED HELP
          "Periodo: AAAA/MM (AAAA = Ano, MM = Mes)" NO-LABEL
     IMAGE-1 AT ROW 1.25 COL 29.43
     IMAGE-10 AT ROW 3.29 COL 44.86
     IMAGE-11 AT ROW 2.29 COL 44.86
     IMAGE-12 AT ROW 2.29 COL 29.43
     IMAGE-2 AT ROW 1.25 COL 44.86
     IMAGE-9 AT ROW 3.29 COL 29.43
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "ESSP0039" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-ini-fm-codigo fi-fin-fm-codigo fi-ini-it-codigo fi-fin-it-codigo 
          fi-ini-ano-mes fi-fin-ano-mes 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-ini-fm-codigo fi-fin-fm-codigo fi-ini-it-codigo fi-fin-it-codigo 
         fi-ini-ano-mes fi-fin-ano-mes IMAGE-1 IMAGE-10 IMAGE-11 IMAGE-12 
         IMAGE-2 IMAGE-9 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
if tt-param.destino = 1 
    ...
    {include/i-rprun.i esrp/essp0039rp.p}
