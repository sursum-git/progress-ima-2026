...
*******************************************************************************/
{include/i-prgvrs.i ESFT0004 2.04.00.000}
...
DEFINE FRAME f-pg-sel
     ...
     fi-fin-dt-emissao AT ROW 2.54 COL 38.72 COLON-ALIGNED HELP
          "Data prevista para entrega do Pedido" NO-LABEL
     fi-ini-cod-emitente AT ROW 3.54 COL 15.29 COLON-ALIGNED HELP
          "C¢digo do emitente"
     fi-fin-cod-emitente AT ROW 3.54 COL 38.72 COLON-ALIGNED HELP
          "C¢digo do emitente" NO-LABEL
     fi-ini-cod-rep AT ROW 4.54 COL 15.29 COLON-ALIGNED HELP
          "C¢digo do representante"
     fi-fin-cod-rep AT ROW 4.54 COL 38.72 COLON-ALIGNED HELP
          "C¢digo do representante" NO-LABEL
     fi-ini-ge-codigo AT ROW 5.5 COL 15.29 COLON-ALIGNED
     fi-fin-ge-codigo AT ROW 5.5 COL 38.72 COLON-ALIGNED NO-LABEL
     IMAGE-1 AT ROW 2.54 COL 27.86
     IMAGE-2 AT ROW 2.54 COL 37.14
     IMAGE-3 AT ROW 3.54 COL 27.86
     IMAGE-37 AT ROW 5.5 COL 27.86
     IMAGE-38 AT ROW 5.5 COL 37.14
     IMAGE-4 AT ROW 4.54 COL 27.86
     IMAGE-6 AT ROW 3.54 COL 37.14
     IMAGE-7 AT ROW 4.54 COL 37.14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.86 ROW 3.21
         SIZE 75.86 BY 10.25
         FONT 1.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Faturamento por Representante"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Faturamento por Representante */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Faturamento por Representante */
DO:
...
{utp/ut9000.i "ESFT0004" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE fi-cod-estabel fi-ini-dt-emissao fi-fin-dt-emissao fi-ini-cod-emitente 
         ...
         fi-fin-ge-codigo IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-37 IMAGE-38 IMAGE-4 
         IMAGE-6 IMAGE-7 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/esft0004rp.p}
