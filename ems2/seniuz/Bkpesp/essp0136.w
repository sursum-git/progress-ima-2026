...
*******************************************************************************/
{include/i-prgvrs.i ESSP0136 2.04.00.000}
...
&Scoped-Define ENABLED-OBJECTS bt-ok bt-cancela bt-imprime bt-ajuda ~
rt-button 
...
DEFINE VARIABLE h_q01es062 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v01es062 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 18.83 COL 2.29
     bt-cancela AT ROW 18.83 COL 13.29
     bt-imprime AT ROW 18.83 COL 24.29
     bt-ajuda AT ROW 18.83 COL 88
     rt-button AT ROW 18.63 COL 1.29
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Manutená∆o Par∆metros Controle Fardos"
         HEIGHT             = 19.08
         WIDTH              = 99.14
         MAX-HEIGHT         = 29
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-cadsim /* Manutená∆o Par∆metros Controle Fardos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manutená∆o Par∆metros Controle Fardos */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esvwr/v01es062.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_v01es062 ).
       /* Position in AB:  ( 1.00 , 1.00 ) */
       /* Size in UIB:  ( 17.50 , 98.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esqry/q01es062.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q01es062 ).
       RUN set-position IN h_q01es062 ( 18.75 , 56.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.21 , 7.72 ) */

       /* Links to  h_v01es062. */
       RUN add-link IN adm-broker-hdl ( h_q01es062 , 'Record':U , h_v01es062 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_v01es062 ).
...
------------------------------------------------------------------------------*/
  ENABLE bt-ok bt-cancela bt-imprime bt-ajuda rt-button 
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0136" "2.04.00.000"}
