...
*******************************************************************************/
{include/i-prgvrs.i D02ESSP0164 2.04.00.000}
...
&Scoped-Define ENABLED-OBJECTS fi-arq-saida bt-arq-sai bt-ok bt-cancela ~
bt-ajuda rt-buttom 
&Scoped-Define DISPLAYED-OBJECTS fi-arq-saida 
...
DEFINE FRAME D-Dialog
     fi-arq-saida AT ROW 1.29 COL 14.14 COLON-ALIGNED
     bt-arq-sai AT ROW 1.29 COL 61.29 HELP
          "Arquivo de pagamento de sa¡da (ajuntado)."
     bt-ok AT ROW 2.71 COL 1.86
     bt-cancela AT ROW 2.71 COL 12.86
     bt-ajuda AT ROW 2.71 COL 57.86
     rt-buttom AT ROW 2.46 COL 1
...
------------------------------------------------------------------------------*/
  DISPLAY fi-arq-saida 
      WITH FRAME D-Dialog.
  ENABLE fi-arq-saida bt-arq-sai bt-ok bt-cancela bt-ajuda rt-buttom 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "D02ESSP0164" "2.04.00.000"}
  ...
  CASE p-tipo:
      WHEN 1 THEN
          ASSIGN fi-arq-saida:SCREEN-VALUE IN FRAME {&FRAME-NAME} = SESSION:TEMP-DIRECTORY + "Pedidos Cancelados.xls".
      WHEN 2 THEN
          ASSIGN fi-arq-saida:SCREEN-VALUE IN FRAME {&FRAME-NAME} = SESSION:TEMP-DIRECTORY + "NF(s) Canceladas.xls".
      WHEN 3 THEN
          ASSIGN fi-arq-saida:SCREEN-VALUE IN FRAME {&FRAME-NAME} = SESSION:TEMP-DIRECTORY + "Devolu‡Æo de Mercadorias.xls".
      WHEN 4 THEN
          ASSIGN fi-arq-saida:SCREEN-VALUE IN FRAME {&FRAME-NAME} = SESSION:TEMP-DIRECTORY + "Resumo Por Itens da Devolu‡Æo.xls".
  END CASE.                                                                                  
