...
&Scoped-Define ENABLED-FIELDS ob-etiqueta.localizacao ~
ob-etiqueta.dt-emissao ob-etiqueta.num-etiqueta ob-etiqueta.nuance ~
ob-etiqueta.acondic ob-etiqueta.it-codigo ob-etiqueta.cod-refer ~
ob-etiqueta.quantidade ob-etiqueta.un ob-etiqueta.nr-ob ~
ob-etiqueta.nr-sequencia ob-etiqueta.cod-qualid 
&Scoped-define ENABLED-TABLES ob-etiqueta
&Scoped-define FIRST-ENABLED-TABLE ob-etiqueta
&Scoped-Define ENABLED-OBJECTS fi-desc-item FILL-IN-3 fi-desc-qualid ~
fi-tipo-ordem fi-situacao rt-mold 
&Scoped-Define DISPLAYED-FIELDS ob-etiqueta.localizacao ~
ob-etiqueta.dt-emissao ob-etiqueta.num-etiqueta ob-etiqueta.nuance ~
ob-etiqueta.acondic ob-etiqueta.it-codigo ob-etiqueta.cod-refer ~
ob-etiqueta.quantidade ob-etiqueta.un ob-etiqueta.nr-ob ~
ob-etiqueta.nr-sequencia ob-etiqueta.cod-qualid 
...
&Scoped-Define DISPLAYED-OBJECTS fi-desc-item FILL-IN-3 fi-desc-qualid ~
fi-tipo-ordem fi-situacao 
...
DEFINE VARIABLE FILL-IN-3 AS CHARACTER FORMAT "X(20)":U 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-main
     ob-etiqueta.localizacao AT ROW 1.25 COL 17 COLON-ALIGNED
          LABEL "Doca"
          VIEW-AS FILL-IN 
          SIZE 10.14 BY .88
     ob-etiqueta.dt-emissao AT ROW 1.25 COL 60 COLON-ALIGNED
          LABEL "Emiss∆o Etiqueta"
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     ob-etiqueta.num-etiqueta AT ROW 2.25 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.43 BY .88
     ob-etiqueta.nuance AT ROW 3.25 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5.14 BY .88
     ...
     ob-etiqueta.it-codigo AT ROW 5.25 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.14 BY .88
     fi-desc-item AT ROW 5.25 COL 34.14 COLON-ALIGNED NO-LABEL
     ob-etiqueta.cod-refer AT ROW 6.25 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .88
     FILL-IN-3 AT ROW 6.25 COL 29.14 COLON-ALIGNED NO-LABEL
     ob-etiqueta.quantidade AT ROW 7.25 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12.57 BY .88
     ob-etiqueta.un AT ROW 7.25 COL 29.57 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 3 BY .88
     ob-etiqueta.nr-ob AT ROW 8.25 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9.14 BY .88
     ob-etiqueta.nr-sequencia AT ROW 9.25 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.57 BY .88
