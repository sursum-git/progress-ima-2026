...
CREATE ttVendaTriangular.
ASSIGN ttVendaTriangular.valor = NO.
...
OUTPUT TO c:\temp\matriz_pos.txt.
PUT  "Cod.Parametro|Venda Triang.?|Suframa?|Fora do Estado?|Contr.ICMS|Cod.Finalidade|Desc.Finalidade|Cod.Tipo Ativ.|Desc.Tipo Atividade|Estab.|Nat.Operaá∆o|Denominaá∆o|Trib.ICMS|CFOP|Aliq.ICMS|% Red.ICMS|Aliq.ICMS Compl.|% Desc.ICMS|PIS|COFINS|BASE ICMS|TIPO TRIB|Red.ICMS|"  cListaEstados SKIP.
FOR EACH ttmatriz:
    ASSIGN cListaId = ''.
    ...
    FOR EACH 
        ...
        */
        FIND FIRST natur-oper
            WHERE natur-oper.nat-operacao = PARAM_nat_operacao.cod_nat_operacao
            NO-LOCK NO-ERROR.
        IF AVAIL natur-oper THEN DO:
           ASSIGN ttMatriz.cod_param_nat_operacao =   PARAM_nat_operacao.cod_param_nat_operacao
                  ttMatriz.cod_nat_operacao = PARAM_nat_operacao.cod_nat_operacao
