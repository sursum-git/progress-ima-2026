...
*******************************************************************************/
{include/i-prgvrs.i ESCR0018 2.04.00.000}
...
DEFINE VARIABLE fi-fin-dt-liq AS DATE FORMAT "99/99/9999" INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 TOOLTIP "Data de liquidaá∆o final." NO-UNDO.
...
DEFINE VARIABLE fi-ini-dt-liq AS DATE FORMAT "99/99/9999" INITIAL 01/01/001 
     LABEL "Dt Liquidaá∆o":R16 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 TOOLTIP "Data de liquidaá∆o inicial." NO-UNDO.
...
DEFINE FRAME f-pg-sel
     ...
     fi-ini-dt-liq AT ROW 6.79 COL 18.43 COLON-ALIGNED HELP
          "Data de liquidaá∆o do t°tulo (31/12/9999 para n∆o liquidados)"
     fi-fin-dt-liq AT ROW 6.79 COL 49.29 COLON-ALIGNED HELP
          "Data de liquidaá∆o do t°tulo (31/12/9999 para n∆o liquidados)" NO-LABEL
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "T°tulos Pagos por Portador/Data Liquidaá∆o"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* T°tulos Pagos por Portador/Data Liquidaá∆o */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* T°tulos Pagos por Portador/Data Liquidaá∆o */
DO:
...
{utp/ut9000.i "ESCR0018" "2.04.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN fi-ep-codigo:SCREEN-VALUE IN FRAME f-pg-sel  = "1" 
           fi-ini-dt-liq:SCREEN-VALUE IN FRAME f-pg-sel = string(TODAY)
           fi-fin-dt-liq:SCREEN-VALUE IN FRAME f-pg-sel = string(TODAY)
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-ep-codigo fi-razao-social fi-ini-cod-est fi-fin-cod-est 
          ...
          fi-ini-cod-emitente fi-fin-cod-emitente fi-ini-dt-liq fi-fin-dt-liq 
          fi-dt-corte 
  ...
  ENABLE fi-ep-codigo fi-ini-cod-est fi-fin-cod-est fi-ini-cod-port 
         ...
         fi-fin-cod-emitente fi-ini-dt-liq fi-fin-dt-liq fi-dt-corte IMAGE-1 
         IMAGE-2 IMAGE-57 IMAGE-58 IMAGE-59 IMAGE-60 IMAGE-61 IMAGE-62 IMAGE-63 
         IMAGE-64 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.ep-codigo        = INPUT FRAME f-pg-sel fi-ep-codigo
           ...
           tt-param.dt-liq-ini       = INPUT FRAME f-pg-sel fi-ini-dt-liq
           tt-param.dt-liq-fin       = INPUT FRAME f-pg-sel fi-fin-dt-liq
    ...
    {include/i-rprun.i esrp/escr0018rp.p} 
