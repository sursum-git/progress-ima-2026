...
//
    ...
    public class boad098c : Procedure
    {
	...
	static DataTableMetaData getCurrent_MetaData1;
        ...
        static boad098c()
        {
		getCurrent_MetaData1 = new DataTableMetaData(0, "RowObject", 200, false, 2, "1,cod-emitente:codigo.nome-abrev:nome", null, null, "StrongTypesNS.RowObjectDataTable");
	...
	public boad098c(ProObject appObj) : base(appObj)
	{
		...
		// Run procedure
		PersistProcObj = RunPersistentProcedure("boad098c.p", parms);
	...
	/// 
	/// </summary> 
	public string setConstraint1(int pCodEmitIni, int pCodEmitFim, string pNomeAbrevIni, string pNomeAbrevFim, int pNatureza)
	{
		...
		parms.setIntegerParameter(5, pNatureza, ParameterSet.INPUT);
