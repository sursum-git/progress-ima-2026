...
//
    ...
    public class boad098f : Procedure
    {
	...
	static DataTableMetaData validateUpdate_MetaData2;
		...
		getBatchRowids_MetaData1 = new DataTableMetaData(0, "RowObjectAux", 200, false, 0, null, null, null, "StrongTypesNS.RowObjectAuxDataTable");
	...
	public boad098f(ProObject appObj) : base(appObj)
	{
		...
		// Run procedure
		PersistProcObj = RunPersistentProcedure("boad098f.p", parms);
	...
	/// 
	/// </summary> 
	public string findRecordDynamic(string pExpression, out bool lFound, out Handle hRegister, out Handle hTableBuffer, out bool lUnique)
	{
		...
		// Set up input parameters
		parms.setStringParameter(1, pExpression, ParameterSet.INPUT);
		...
		parms.setHandleParameter(3, null, ParameterSet.OUTPUT);
		parms.setHandleParameter(4, null, ParameterSet.OUTPUT);
		parms.setBooleanParameter(5, false, ParameterSet.OUTPUT, UnknownType.None);
...
/// <summary>
	/// 
	/// </summary> 
	public string getBatchRecordsFromRow(int pNumeroLinha, int pOffset, out int pLinhasRetornadas, out Handle pBufferRows)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		// Set up input parameters
		parms.setIntegerParameter(1, pNumeroLinha, ParameterSet.INPUT);
		parms.setIntegerParameter(2, pOffset, ParameterSet.INPUT);
		...
		// Run procedure
		base.runProcedure("getBatchRecordsFromRow", parms);

		// Get output parameters
		outValue = parms.getOutputParameter(3);
		pLinhasRetornadas = (int)outValue;
		outValue = parms.getOutputParameter(4);
		pBufferRows = (Handle)outValue;
...
/// <summary>
	/// 
	/// </summary> 
	public string setRecordInHandle(Handle hRowObject)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		// Set up input parameters
		parms.setHandleParameter(1, hRowObject, ParameterSet.INPUT);
		...
		// Run procedure
		base.runProcedure("setRecordInHandle", parms);
...
/// <summary>
	/// 
	/// </summary> 
	public string getBatchRowids(out int pRowsReturned, out StrongTypesNS.RowObjectAuxDataTable RowObjectAux)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
...
/// <summary>
	/// 
	/// </summary> 
	public string getKey(out string pnomeAbrev)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
...
/// <summary>
	/// 
	/// </summary> 
	public string goToKey(string pnomeAbrev)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
...
/// <summary>
	/// 
	/// </summary> 
	public string goToCodEmitente(int pcodEmitente)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		// Run procedure
		base.runProcedure("goToCodEmitente", parms);
...
/// <summary>
	/// 
	/// </summary> 
	public string goToCodEmitenteOnlyFornec(int pcodEmitente)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		// Run procedure
		base.runProcedure("goToCodEmitenteOnlyFornec", parms);
...
/// <summary>
	/// 
	/// </summary> 
	public string linkToCdEmit(Handle pHandle)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		// Set up input parameters
		parms.setHandleParameter(1, pHandle, ParameterSet.INPUT);
		...
		// Run procedure
		base.runProcedure("linkToCdEmit", parms);
...
/// <summary>
	/// 
	/// </summary> 
	public string linkToNome(Handle pHandle)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		// Run procedure
		base.runProcedure("linkToNome", parms);
...
/// <summary>
	...
	public string openQueryCdEmit()
	{
		...
		// Run procedure
		base.runProcedure("openQueryCdEmit", parms);
...
/// <summary>
	...
	public string openQueryNome()
	{
		...
		// Run procedure
		base.runProcedure("openQueryNome", parms);
...
/// <summary>
	/// 
	/// </summary> 
	public string setConstraintCdEmit(int cCodIni, int cCodFim)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		// Set up input parameters
		parms.setIntegerParameter(1, cCodIni, ParameterSet.INPUT);
		parms.setIntegerParameter(2, cCodFim, ParameterSet.INPUT);
		...
		// Run procedure
		base.runProcedure("setConstraintCdEmit", parms);
...
/// <summary>
	/// 
	/// </summary> 
	public string setConstrintNome(string cNomeIni, string cNomeFim)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		// Set up input parameters
		parms.setStringParameter(1, cNomeIni, ParameterSet.INPUT);
		parms.setStringParameter(2, cNomeFim, ParameterSet.INPUT);
		...
		// Run procedure
		base.runProcedure("setConstrintNome", parms);
