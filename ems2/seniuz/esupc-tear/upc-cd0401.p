...
IF p-ind-event = "INITIALIZE" AND
   ...
   c-objeto = "'advwr\v04ad098.w'" THEN DO.
...
IF p-ind-event = "INITIALIZE" AND
   ...
   ON 'entry':U OF p-wgh-frame PERSISTENT RUN esupc/upc-cd0401-b.p.  
   ...
   DO WHILE VALID-HANDLE(h-objeto):
      IF h-objeto:TYPE <> "field-group" THEN DO:
         ...
         IF h-objeto:NAME = "cep" THEN DO.
            ...
            ON 'leave':U OF h-objeto PERSISTENT RUN esupc/upc-cd0401-a.p.  
         END.
