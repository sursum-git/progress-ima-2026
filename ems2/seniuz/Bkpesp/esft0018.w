...
DEFINE VARIABLE rs-imp-abe-tot AS INTEGER 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Aberta", 1,
"Total", 2
     SIZE 16 BY 1.25 TOOLTIP "Listar os pedidos pela quantidade Aberta ou Total" NO-UNDO.
...
DEFINE VARIABLE fi-ini-ge-codigo AS INTEGER FORMAT ">9" INITIAL 0 
     ...
     VIEW-AS FILL-IN 
     SIZE 3 BY .79 TOOLTIP "Grupo de estoque inicial" NO-UNDO.
...
DEFINE FRAME f-pg-par
     rs-imp-abe-tot AT ROW 2.67 COL 40.57 NO-LABEL
     to-imp-param AT ROW 5.79 COL 28
     RECT-27 AT ROW 5.25 COL 5.72
     RECT-28 AT ROW 2 COL 5.72
     "Listar pedidos pela quantidade:" VIEW-AS TEXT
          SIZE 21.86 BY .88 TOOLTIP "Listar os pedidos pela quantidade Aberta ou Total" AT ROW 2.79 COL 17.86
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 77.14 BY 10.5
...
DEFINE FRAME f-pg-sel
     ...
     fi-fin-ge-codigo AT ROW 2.54 COL 48.29 COLON-ALIGNED HELP
          "Grupo de estoque a que pertence o item" NO-LABEL
     fi-ini-nome-repres AT ROW 3.54 COL 15.29 COLON-ALIGNED
     fi-fin-nome-repres AT ROW 3.54 COL 48.29 COLON-ALIGNED HELP
          "Nome abreviado do representante principal" NO-LABEL
     IMAGE-1 AT ROW 1.54 COL 31.72
     IMAGE-13 AT ROW 3.54 COL 31.72
     IMAGE-14 AT ROW 3.54 COL 46.72
     IMAGE-2 AT ROW 1.54 COL 46.72
     IMAGE-5 AT ROW 2.54 COL 31.72
     IMAGE-8 AT ROW 2.54 COL 46.72
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 4 ROW 3.21
         SIZE 75.86 BY 10.25
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Faturamento por Representante com Prazo MÇdio"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Faturamento por Representante com Prazo MÇdio */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Faturamento por Representante com Prazo MÇdio */
DO:
...
{utp/ut9000.i "ESFT0018" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY rs-imp-abe-tot to-imp-param 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE rs-imp-abe-tot to-imp-param RECT-27 RECT-28 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-par}
  DISPLAY fi-ini-dt-entrega fi-fin-dt-entrega fi-ini-ge-codigo fi-fin-ge-codigo 
          fi-ini-nome-repres fi-fin-nome-repres 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-ini-dt-entrega fi-fin-dt-entrega fi-ini-ge-codigo fi-fin-ge-codigo 
         fi-ini-nome-repres fi-fin-nome-repres IMAGE-1 IMAGE-13 IMAGE-14 
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.imp-abe-tot     = INPUT FRAME f-pg-par rs-imp-abe-tot
    ...
    {include/i-rprun.i esrp/esft0018rp.p}
