...
*******************************************************************************/
{include/i-prgvrs.i ESSP0014 2.04.00.000}
...
DEFINE VARIABLE h_b02es009 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-consultarelacionamento /* Defeitos de Fabrica‡Æo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-consultarelacionamento w-consultarelacionamento
ON WINDOW-CLOSE OF w-consultarelacionamento /* Defeitos de Fabrica‡Æo */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v01es037 ).
       RUN set-position IN h_v01es037 ( 2.50 , 2.00 ) NO-ERROR.
       ...
       RUN set-size IN h_folder ( 12.17 , 90.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b02es009.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b02es009 ).
       RUN set-position IN h_b02es009 ( 6.75 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.83 , 88.00 ) */

       /* Links to SmartBrowser h_b02es009. */
       RUN add-link IN adm-broker-hdl ( h_q01es037 , 'Record':U , h_b02es009 ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0014" "2.04.00.000"}
