...
&Scoped-Define ENABLED-OBJECTS rt-buttom fi-arquivo bt-ok bt-cancela ~
bt-ajuda 
...
DEFINE FRAME D-Dialog
     fi-arquivo AT ROW 2 COL 11 COLON-ALIGNED WIDGET-ID 2
...
DO:
  INPUT FROM n:\coletor\receber\transf.txt NO-ECHO.
  REPEAT.
     SET c-linha.
     CREATE tt-aux.
     ASSIGN tt-aux.num-etiqueta = INT(SUBSTR(c-linha,7,9)).
...
------------------------------------------------------------------------------*/
  DISPLAY fi-arquivo 
      WITH FRAME D-Dialog.
  ENABLE rt-buttom fi-arquivo bt-ok bt-cancela bt-ajuda 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
