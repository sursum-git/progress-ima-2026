...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Exportaá∆o para o Serasa"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ASSIGN XXTABVALXX = FRAME f-imp:MOVE-AFTER-TAB-ITEM (cbx-tipo:HANDLE IN FRAME f-pg-sel)
       XXTABVALXX = FRAME f-exp:MOVE-BEFORE-TAB-ITEM (FRAME f-reexp:HANDLE)
       XXTABVALXX = FRAME f-imp:MOVE-BEFORE-TAB-ITEM (FRAME f-exp:HANDLE)
/* END-ASSIGN-TABS */.
...
ON END-ERROR OF w-relat /* Exportaá∆o para o Serasa */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Exportaá∆o para o Serasa */
DO:
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    {include/i-rprun.i esrp/esft0003rp.p}
