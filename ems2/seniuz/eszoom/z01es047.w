...
DEFINE VARIABLE h_b01es047 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 13.5 COL 1.72
     bt-ok AT ROW 15.21 COL 2.72
     bt-cancela AT ROW 15.21 COL 13.72
     bt-ajuda AT ROW 15.21 COL 76.29
     rt-button AT ROW 14.96 COL 1.72
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Ordens de Beneficiamento"
         HEIGHT             = 15.63
         WIDTH              = 87.86
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 90
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Ordens de Beneficiamento */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Ordens de Beneficiamento */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'OB' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 12.00 , 86.43 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b01es047.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01es047 ).
       RUN set-position IN h_b01es047 ( 2.67 , 2.43 ) NO-ERROR.
       /* Size in UIB:  ( 10.21 , 84.57 ) */

       /* Links to SmartBrowser h_b01es047. */
       RUN add-link IN adm-broker-hdl ( h_b01es047 , 'State':U , THIS-PROCEDURE ).
