...
oUri:addPathSegment('Rolo').
oUri:addPathSegment('query').
oUri:addQuery('pageSize','100000').
oUri:addQuery('codigoCliente','86159501').
oUri:addQuery('status','P').
...
oRequest = RequestBuilder:GET(oUri):addHeader('Authorization','Basic YXBpd21zOmFwaXdtcyMyNDVA'):addHeader('tenantid','03,08'):AcceptContentType('application/json;charset=uft-8'):ContentType('application/json;charset=utf-8'):Request.
