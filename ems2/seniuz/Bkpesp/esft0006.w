...
*******************************************************************************/
{include/i-prgvrs.i ESFT0006 2.04.00.000}
...
DEFINE FRAME f-pg-sel
     ...
     fi-ini-ge-codigo AT ROW 3.54 COL 15.29 COLON-ALIGNED HELP
          "Grupo de estoque a que pertence o item"
     fi-fin-ge-codigo AT ROW 3.54 COL 48.29 COLON-ALIGNED HELP
          "Grupo de estoque a que pertence o item" NO-LABEL
     IMAGE-1 AT ROW 2.54 COL 33.86
     IMAGE-2 AT ROW 2.54 COL 46.72
     IMAGE-5 AT ROW 3.54 COL 33.86
     IMAGE-8 AT ROW 3.54 COL 46.72
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 4 ROW 3.21
         SIZE 75.86 BY 10.25
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Distribuiá∆o do Faturamento"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Distribuiá∆o do Faturamento */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Distribuiá∆o do Faturamento */
DO:
...
{utp/ut9000.i "ESFT0006" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE fi-cod-estabel fi-ini-dt-emissao fi-fin-dt-emissao fi-ini-ge-codigo 
         fi-fin-ge-codigo IMAGE-1 IMAGE-2 IMAGE-5 IMAGE-8 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/esft0006rp.p}
