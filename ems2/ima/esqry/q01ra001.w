...
&Scoped-define INTERNAL-TABLES espec.ramo-ativ

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH espec.ramo-ativ NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH espec.ramo-ativ NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main espec.ramo-ativ
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main espec.ramo-ativ
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod-ramo-ativ" "espec.ramo-ativ" "cod-ramo-ativ"}
