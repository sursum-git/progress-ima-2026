...
PROCEDURE getArq:
    ...
    DEFINE VARIABLE cDirWindows  AS CHARACTER   NO-UNDO.
    DEFINE VARIABLE cDirLinux    AS CHARACTER   NO-UNDO.
    ...
    ASSIGN cDirWindows = DYNAMIC-FUNCTION('getBaseDirIntegrLisaWindows' IN hBoConsParam ) 
           cDirLinux   = DYNAMIC-FUNCTION('getBaseDirIntegrLisaLinux' IN hBoConsParam )
           
           cArq        = REPLACE(cArq,cDirLinux,cDirWindows).
