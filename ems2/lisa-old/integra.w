...
DEFINE VARIABLE h_integra-b5 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Parƒmetros|Notas ENVIO|Separa‡ao ISF|Notas RETORNO|Ajuste/Cortes|Conf. Estoque|Logs' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_integra-b2 ).
       RUN set-position IN h_integra-b2 ( 2.50 , 3.00 ) NO-ERROR.
    ...
    WHEN 5 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lisa/integra-b5.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_integra-b5 ).
       RUN set-position IN h_integra-b5 ( 2.50 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 23.00 , 142.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_integra-b5 ,
             h_folder , 'AFTER':U ).
    END. /* Page 5 */
    WHEN 6 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
