...
DEFINE INPUT-OUTPUT PARAMETER i-tp-acab           AS INT.
...
&Scoped-Define ENABLED-OBJECTS fi-cod-estabel fi-periodo-ini fi-periodo-fin ~
fi-num-progr-ini fi-num-progr-fin fi-it-codigo-ini fi-it-codigo-fin ~
fi-cod-refer-ini bt-dig-item fi-cod-refer-fin fi-cod-obsoleto-ini ~
fi-cod-obsoleto-fin rs-opc-acab rs-opc-artigo rs-situacao bt-ok bt-cancelar ~
bt-ajuda bt-dig-progr bt-ex-progr bt-ex-item bt-dig-ref bt-ex-ref ~
bt-dig-cob bt-ex-cob IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-90 IMAGE-91 ~
IMAGE-94 IMAGE-95 IMAGE-96 IMAGE-97 RECT-1 RECT-50 
&Scoped-Define DISPLAYED-OBJECTS fi-cod-estabel fi-nome-estabel ~
fi-periodo-ini fi-periodo-fin fi-num-progr-ini fi-num-progr-fin ~
fi-it-codigo-ini fi-it-codigo-fin fi-cod-refer-ini fi-cod-refer-fin ~
fi-cod-obsoleto-ini fi-cod-obsoleto-fin rs-opc-acab rs-opc-artigo ~
rs-situacao 
...
DEFINE BUTTON bt-dig-item 
     IMAGE-UP FILE "image/im-ran.bmp":U
     IMAGE-INSENSITIVE FILE "image/ii-ran.bmp":U NO-FOCUS
     LABEL "" 
...
"Estampado", 2,
"Ambos", 3
     SIZE 40 BY .79 TOOLTIP "Tipo de artigo." NO-UNDO.
...
DEFINE FRAME F-Main
     fi-cod-estabel AT ROW 2 COL 13.57 COLON-ALIGNED WIDGET-ID 6
     fi-nome-estabel AT ROW 2 COL 18.29 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     fi-periodo-ini AT ROW 3 COL 13.57 COLON-ALIGNED
     fi-periodo-fin AT ROW 3 COL 41.57 COLON-ALIGNED NO-LABEL
     fi-num-progr-ini AT ROW 4 COL 13.57 COLON-ALIGNED
     fi-num-progr-fin AT ROW 4 COL 41.57 COLON-ALIGNED NO-LABEL
     fi-it-codigo-ini AT ROW 5 COL 13.57 COLON-ALIGNED HELP
          "Codigo do Ötem no EMS"
     fi-it-codigo-fin AT ROW 5 COL 41.57 COLON-ALIGNED HELP
          "Codigo do Ötem no EMS" NO-LABEL
     fi-cod-refer-ini AT ROW 6 COL 13.57 COLON-ALIGNED HELP
          "Codigo do Ötem no EMS"
     bt-dig-item AT ROW 5 COL 60.57
     fi-cod-refer-fin AT ROW 6 COL 41.57 COLON-ALIGNED HELP
          "Codigo do Ötem no EMS" NO-LABEL
     fi-cod-obsoleto-ini AT ROW 7 COL 13.57 COLON-ALIGNED HELP
          "Codigo obsoleto"
     fi-cod-obsoleto-fin AT ROW 7 COL 41.57 COLON-ALIGNED HELP
          "Codigo obsoleto" NO-LABEL
     rs-opc-acab AT ROW 8.25 COL 15.14 NO-LABEL
     rs-opc-artigo AT ROW 9.17 COL 15.14 NO-LABEL
     rs-situacao AT ROW 10.17 COL 15.14 NO-LABEL
     bt-ok AT ROW 11.71 COL 3
     bt-cancelar AT ROW 11.71 COL 13.57
     bt-ajuda AT ROW 11.71 COL 65.29
     bt-dig-progr AT ROW 4 COL 60.57 NO-TAB-STOP 
     bt-ex-progr AT ROW 4 COL 65.57 NO-TAB-STOP 
     bt-ex-item AT ROW 5 COL 65.57 NO-TAB-STOP 
     bt-dig-ref AT ROW 6 COL 60.57 NO-TAB-STOP 
     bt-ex-ref AT ROW 6 COL 65.57 NO-TAB-STOP 
     bt-dig-cob AT ROW 7 COL 60.57 NO-TAB-STOP 
     bt-ex-cob AT ROW 7 COL 65.57 NO-TAB-STOP 
     " Sele‡Æo" VIEW-AS TEXT
          SIZE 7 BY .54 AT ROW 1 COL 3.14
     "Acabamento:" VIEW-AS TEXT
          SIZE 9.43 BY .54 AT ROW 8.29 COL 5.86
     "Tipo de Artigo:" VIEW-AS TEXT
          SIZE 9.86 BY .54 AT ROW 9.21 COL 5
     "Situa‡Æo:" VIEW-AS TEXT
          SIZE 7 BY .54 AT ROW 10.25 COL 8.29
     IMAGE-3 AT ROW 4 COL 31.14
     IMAGE-4 AT ROW 4 COL 40.14
     IMAGE-5 AT ROW 5 COL 31.14
     IMAGE-6 AT ROW 5 COL 40.14
     IMAGE-90 AT ROW 6 COL 31.14
     IMAGE-91 AT ROW 6 COL 40.14
     IMAGE-94 AT ROW 7 COL 31.14
     IMAGE-95 AT ROW 7 COL 40.14
     IMAGE-96 AT ROW 3 COL 31.14
     IMAGE-97 AT ROW 3 COL 40.14
     RECT-1 AT ROW 11.5 COL 2
...
DO:
    ...
    */
    ASSIGN c-cod-estabel      = INPUT FRAME {&FRAME-NAME} fi-cod-estabel   
           c-periodo-ini      = INPUT FRAME {&FRAME-NAME} fi-periodo-ini   
           ...
           i-tp-acab          = INPUT FRAME {&FRAME-NAME} rs-opc-acab        
...
------------------------------------------------------------------------------*/
  DISPLAY fi-cod-estabel fi-nome-estabel fi-periodo-ini fi-periodo-fin 
          ...
          fi-cod-refer-ini fi-cod-refer-fin fi-cod-obsoleto-ini 
          fi-cod-obsoleto-fin rs-opc-acab rs-opc-artigo rs-situacao 
      WITH FRAME F-Main IN WINDOW w-window.
  ENABLE fi-cod-estabel fi-periodo-ini fi-periodo-fin fi-num-progr-ini 
         fi-num-progr-fin fi-it-codigo-ini fi-it-codigo-fin fi-cod-refer-ini 
         bt-dig-item fi-cod-refer-fin fi-cod-obsoleto-ini fi-cod-obsoleto-fin 
         rs-opc-acab rs-opc-artigo rs-situacao bt-ok bt-cancelar bt-ajuda 
         bt-dig-progr bt-ex-progr bt-ex-item bt-dig-ref bt-ex-ref bt-dig-cob 
         bt-ex-cob IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-90 IMAGE-91 IMAGE-94 
         IMAGE-95 IMAGE-96 IMAGE-97 RECT-1 RECT-50 
      WITH FRAME F-Main IN WINDOW w-window.
