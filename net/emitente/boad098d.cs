...
//
    ...
    public class boad098d : Procedure
    {
	...
	static DataTableMetaData validateUpdate_MetaData2;
		...
		validateUpdate_MetaData1 = new DataTableMetaData(0, "RowObject", 200, false, 2, "1,cod-emitente:codigo.nome-abrev:nome", null, null, "StrongTypesNS.RowObjectDataTable");
	...
	public boad098d(ProObject appObj) : base(appObj)
	{
		...
		// Run procedure
		PersistProcObj = RunPersistentProcedure("boad098d.p", parms);
...
/// <summary>
	/// 
	/// </summary> 
	public string setConstraint2(int pCodEmitIni, int pCodEmitFim, string pNomeAbrevIni, string pNomeAbrevFim)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
...
/// <summary>
	/// 
	/// </summary> 
	public string setConstraint3(int pCodEmitIni, int pCodEmitFim, string pNomeAbrevIni, string pNomeAbrevFim, int pCodRep)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
...
/// <summary>
	/// 
	/// </summary> 
	public string setConstraint4(int pCodRep)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		// Set up input parameters
		parms.setIntegerParameter(1, pCodRep, ParameterSet.INPUT);
...
/// <summary>
	/// 
	/// </summary> 
	public string setConstraint5(int pCodEmitente)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
