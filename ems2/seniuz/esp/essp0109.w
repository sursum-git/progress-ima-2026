...
DEFINE VARIABLE fi-fin-it-codigo AS CHARACTER FORMAT "x(16)" INITIAL "599999" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-ini-it-codigo AS CHARACTER FORMAT "x(16)" INITIAL "500001" 
     LABEL "Item" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     fi-ini-it-codigo AT ROW 1.25 COL 19.57 COLON-ALIGNED
     fi-fin-it-codigo AT ROW 1.25 COL 50 COLON-ALIGNED NO-LABEL
     fi-ini-cod-refer AT ROW 2.25 COL 19.57 COLON-ALIGNED
     fi-fin-cod-refer AT ROW 2.25 COL 50.14 COLON-ALIGNED NO-LABEL
     fi-ini-dt-emissao AT ROW 3.25 COL 19.57 COLON-ALIGNED HELP
          "Data do movimento"
     fi-fin-dt-emissao AT ROW 3.25 COL 50 COLON-ALIGNED HELP
...
DEFINE FRAME f-pg-par
     tg-imp-param AT ROW 8.04 COL 25.43
     rs-tipo-relatorio AT ROW 2.25 COL 34.72 NO-LABEL
     RECT-11 AT ROW 1.5 COL 27.14
     RECT-34 AT ROW 7.54 COL 4
     "  Tipo do Relat¢rio" VIEW-AS TEXT
          SIZE 13.14 BY .5 AT ROW 1.25 COL 33
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 77.14 BY 10.5
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Relat¢rio de Estatistica do Rolo por Corte/Qualidade"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Relat¢rio de Estatistica do Rolo por Corte/Qualidade */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Relat¢rio de Estatistica do Rolo por Corte/Qualidade */
DO:
...
{utp/ut9000.i "ESSP0109" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY tg-imp-param rs-tipo-relatorio 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE tg-imp-param rs-tipo-relatorio RECT-11 RECT-34 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ...
  ENABLE fi-ini-it-codigo fi-fin-it-codigo fi-ini-cod-refer fi-fin-cod-refer 
         fi-ini-dt-emissao fi-fin-dt-emissao IMAGE-1 IMAGE-2 IMAGE-27 IMAGE-28 
         IMAGE-31 IMAGE-32 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario           = c-seg-usuario
           ...
           tt-param.fi-ini-dt-emissao = INPUT FRAME f-pg-sel fi-ini-dt-emissao
           tt-param.fi-fin-dt-emissao = INPUT FRAME f-pg-sel fi-fin-dt-emissao
    ...
    {include/i-rprun.i esrp/essp0109rp.p}
