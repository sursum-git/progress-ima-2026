     ...
     IF br-usr-connect:FETCH-SELECTED-ROW(i-ct) THEN DO.
        CASE tt-usr-connect.marca.
             WHEN 'i' OR WHEN 'r' THEN DO.   /* Idle ou Run */
                 ...
                 /*
                 RUN pi-disconnect-db (INPUT tt-usr-connect.marca,
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH tt-usr WHERE
        ...
        RUN szdbu/sum-mark.p tt-usr.banco p-marca STRING(tt-usr.usr).
    END.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN c-comando = "PSKILL \\" + p-maquina + " " + STRING(p-pid).
