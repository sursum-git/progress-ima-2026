...
*******************************************************************************/
{include/i-prgvrs.i documentos_func 2.04.00.001}
...
DEFINE VARIABLE fi-data-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/08 
     LABEL "Data" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE fi-est-fim AS INTEGER FORMAT ">>9":U INITIAL 999 
     VIEW-AS FILL-IN 
     SIZE 4 BY .79 NO-UNDO.

DEFINE VARIABLE fi-est-ini AS INTEGER FORMAT ">>9":U INITIAL 0 
     LABEL "Estab" 
     VIEW-AS FILL-IN 
     SIZE 4 BY .79 NO-UNDO.

DEFINE IMAGE IMAGE-4
     FILENAME "image/gr-ant.bmp":U
     SIZE 3 BY .75.

DEFINE IMAGE IMAGE-5
     FILENAME "image/gr-prx.bmp":U
     SIZE 3 BY .75.
...
DEFINE FRAME f-pg-sel
     fi-est-ini AT ROW 2.5 COL 30.14 COLON-ALIGNED
     fi-est-fim AT ROW 2.5 COL 41.14 COLON-ALIGNED NO-LABEL
     fi-data-fim AT ROW 4 COL 32.14 COLON-ALIGNED
     rs-ordenar AT ROW 7.21 COL 29 NO-LABEL
     IMAGE-4 AT ROW 2.58 COL 37.14
     IMAGE-5 AT ROW 2.58 COL 39.14
     RECT-14 AT ROW 1.83 COL 2
     RECT-15 AT ROW 6.67 COL 27
     " Ordenar por:" VIEW-AS TEXT
          SIZE 16 BY .54 AT ROW 6.42 COL 27.57
          FONT 0
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.83
...
{utp/ut9000.i "documentos_func" "2.04.00.001"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ON 'return':U OF rs-ordenar       IN FRAME f-pg-sel, 
                     fi-data-fim      IN FRAME f-pg-sel,
                     fi-est-ini       IN FRAME f-pg-sel,
                     fi-est-fim       IN FRAME f-pg-sel
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-est-ini fi-est-fim fi-data-fim rs-ordenar 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-est-ini fi-est-fim fi-data-fim rs-ordenar IMAGE-4 IMAGE-5 RECT-14 
         RECT-15 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
 ...
 /*   for each tt-digita no-lock:
   ...
   */ 
    ...
    /*:T Coloque aqui a/l¢gica de gravaá∆o dos demais campos que devem ser passados
       como parÉmetros para o programa RP.P, atravÇs da temp-table tt-param */
        ...
        ASSIGN tt-param.rs-ordenar      = INPUT FRAME f-pg-sel  rs-ordenar  
               tt-param.fi-data-fim     = INPUT FRAME f-pg-sel  fi-data-fim
               tt-param.fi-est-ini      = INPUT FRAME f-pg-sel  fi-est-ini
               tt-param.fi-est-fim      = INPUT FRAME f-pg-sel  fi-est-fim
               .
    ...
    {include/i-rprun.i esrp/documentos_funcrp.p}
