...
DEFINE INPUT-OUTPUT PARAMETER i-em-espera         AS INT.
...
IMAGE-102 IMAGE-103 IMAGE-104 IMAGE-105 RECT-54 RECT-55 RECT-56 ~
fi-cod-estabel fi-dt-implant-ini fi-dt-implant-fin fi-nr-pedcli-ini ~
fi-nr-pedcli-fin bt-dig-ped bt-ex-ped fi-it-codigo-ini fi-it-codigo-fin ~
bt-dig-item bt-ex-item fi-cod-refer-ini fi-cod-refer-fin bt-dig-ref ~
bt-ex-ref fi-nome-abrev-ini fi-nome-abrev-fin bt-dig-cli bt-ex-cli ~
fi-uf-ini fi-uf-fin bt-dig-cond bt-ex-cond fi-nome-tra-ini fi-nome-tra-fin ~
bt-dig-tra bt-ex-tra fi-cidade-ini fi-cidade-fin bt-dig-red bt-ex-red ~
fi-nr-container-ini fi-nr-container-fin bt-dig-container bt-ex-container ~
cb-tp-pedido cb-ext-tp-pedido tg-corte rs-situacao rs-preco rs-aprovar ~
...
fi-cidade-fin fi-nr-container-ini fi-nr-container-fin cb-tp-pedido ~
cb-ext-tp-pedido tg-corte rs-situacao rs-preco rs-aprovar rs-em-espera ~
tg-sit-todas rs-credito tg-sit-atp tg-sit-sus tg-sit-abe tg-sit-can ~
tg-sit-att tg-sit-pen 

/* Custom List Definitions                                              */
/* List-1,List-2,List-3,List-4,List-5,List-6                            */
&Scoped-define List-5 fi-cod-estabel cb-tp-pedido 
...
DEFINE FRAME F-Main
     ...
     fi-nome-estabel AT ROW 1.75 COL 18.29 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     ...
     cb-tp-pedido AT ROW 12.79 COL 14 COLON-ALIGNED WIDGET-ID 42
     cb-ext-tp-pedido AT ROW 12.79 COL 40 COLON-ALIGNED NO-LABEL WIDGET-ID 68
     tg-corte AT ROW 13 COL 51.29 WIDGET-ID 112
     rs-situacao AT ROW 14.42 COL 6 NO-LABEL WIDGET-ID 36
     rs-preco AT ROW 14.46 COL 22.57 NO-LABEL WIDGET-ID 30
     rs-aprovar AT ROW 14.5 COL 41.57 NO-LABEL WIDGET-ID 24
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 106.57 BY 22.29
         FONT 1.

/* DEFINE FRAME statement is approaching 4K Bytes.  Breaking it up   */
DEFINE FRAME F-Main
     rs-em-espera AT ROW 14.5 COL 59.57 NO-LABEL WIDGET-ID 70
     tg-sit-todas AT ROW 18.42 COL 5.14
     rs-credito AT ROW 18.42 COL 56 NO-LABEL
     tg-sit-atp AT ROW 19.38 COL 21.57
     tg-sit-sus AT ROW 19.38 COL 42.29
     tg-sit-abe AT ROW 19.46 COL 5.14
     tg-sit-can AT ROW 20.17 COL 5.14
     tg-sit-att AT ROW 20.17 COL 21.57
     tg-sit-pen AT ROW 20.17 COL 42.29
     bt-ok AT ROW 21.96 COL 3
     bt-cancelar AT ROW 21.96 COL 14
     bt-ajuda AT ROW 21.96 COL 66.43
     " Situa‡Æo" VIEW-AS TEXT
          SIZE 7 BY .54 AT ROW 13.79 COL 5 WIDGET-ID 40
     " Situa‡Æo dos Pedidos" VIEW-AS TEXT
          SIZE 19 BY .75 AT ROW 17.63 COL 4.86
          FGCOLOR 9 FONT 6
     " Sele‡Æo" VIEW-AS TEXT
          SIZE 8.43 BY .54 AT ROW 1 COL 3.57
          FGCOLOR 9 FONT 6
     " Cr‚dito" VIEW-AS TEXT
          SIZE 7 BY .75 AT ROW 17.63 COL 55.43
          FGCOLOR 9 FONT 6
     " Espera" VIEW-AS TEXT
          SIZE 5.29 BY .54 AT ROW 13.83 COL 58.43 WIDGET-ID 74
     " Aprovar" VIEW-AS TEXT
          SIZE 6 BY .54 AT ROW 13.83 COL 40.57 WIDGET-ID 28
     " Pre‡o" VIEW-AS TEXT
          SIZE 5 BY .54 AT ROW 13.83 COL 22.43 WIDGET-ID 34
     ...
     RECT-1 AT ROW 21.75 COL 2
     RECT-50 AT ROW 1.25 COL 2
     RECT-51 AT ROW 17.96 COL 54
     RECT-52 AT ROW 17.96 COL 4
     ...
     RECT-53 AT ROW 14.08 COL 4 WIDGET-ID 76
     ...
     RECT-54 AT ROW 14.08 COL 21.57 WIDGET-ID 102
     RECT-55 AT ROW 14.13 COL 39.43 WIDGET-ID 104
     RECT-56 AT ROW 14.13 COL 57.29 WIDGET-ID 106
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 106.57 BY 22.29
...
DO:
    ASSIGN c-cod-estabel      = INPUT FRAME {&FRAME-NAME} fi-cod-estabel
           ...
           i-em-espera        = INPUT FRAME {&FRAME-NAME} rs-em-espera
...
&Scoped-define SELF-NAME fi-dt-implant-ini
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-dt-implant-ini w-window
ON LEAVE OF fi-dt-implant-ini IN FRAME F-Main /* Data Implant. */
DO:
  IF SELF:SCREEN-VALUE <> '01/01/0001' THEN
     ASSIGN fi-dt-implant-fin:SCREEN-VALUE = SELF:SCREEN-VALUE.
...
------------------------------------------------------------------------------*/
  DISPLAY fi-cod-estabel fi-nome-estabel fi-dt-implant-ini fi-dt-implant-fin 
          fi-nr-pedcli-ini fi-nr-pedcli-fin fi-it-codigo-ini fi-it-codigo-fin 
          fi-cod-refer-ini fi-cod-refer-fin fi-nome-abrev-ini fi-nome-abrev-fin 
          fi-no-ab-reppri-ini fi-no-ab-reppri-fin fi-uf-ini fi-uf-fin 
          fi-nome-tra-ini fi-nome-tra-fin fi-cidade-ini fi-cidade-fin 
          fi-nr-container-ini fi-nr-container-fin cb-tp-pedido cb-ext-tp-pedido 
  ...
  ENABLE IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-88 IMAGE-89 IMAGE-90 IMAGE-91 
         ...
         IMAGE-104 IMAGE-105 RECT-54 RECT-55 RECT-56 fi-cod-estabel 
         fi-dt-implant-ini fi-dt-implant-fin fi-nr-pedcli-ini fi-nr-pedcli-fin 
         ...
         bt-ex-container cb-tp-pedido cb-ext-tp-pedido tg-corte rs-situacao 
         rs-preco rs-aprovar rs-em-espera tg-sit-todas rs-credito tg-sit-atp 
         tg-sit-sus tg-sit-abe tg-sit-can tg-sit-att tg-sit-pen bt-ok 
...
/*{utp/ut9000.i "XX9999" "9.99.99.999"} */
  ...
  APPLY 'entry' TO fi-dt-implant-ini IN FRAME {&FRAME-NAME}.
