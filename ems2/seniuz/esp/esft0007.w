...
*******************************************************************************/
{include/i-prgvrs.i ESFT0007 2.04.00.000}
...
DEFINE VARIABLE fi-serie AS CHARACTER FORMAT "x(5)" INITIAL "U" 
     LABEL "S‚rie":R7 
     VIEW-AS FILL-IN 
     SIZE 8.86 BY .79 TOOLTIP "S‚rie da Nota Fiscal." NO-UNDO.
...
DEFINE FRAME f-pg-sel
     ...
     fi-serie AT ROW 2.54 COL 15.29 COLON-ALIGNED HELP
          "S‚rie da nota fiscal"
     fi-ini-dt-emissao AT ROW 3.54 COL 15.29 COLON-ALIGNED HELP
          "Data prevista para entrega do Pedido"
     fi-fin-dt-emissao AT ROW 3.54 COL 34.86 COLON-ALIGNED HELP
          "Data prevista para entrega do Pedido" NO-LABEL
     IMAGE-1 AT ROW 3.54 COL 27.57
     IMAGE-2 AT ROW 3.54 COL 33.57
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 4 ROW 3.21
         SIZE 75.86 BY 10.25
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Faturamento por Natureza de Opera‡Æo/Vencimento"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Faturamento por Natureza de Opera‡Æo/Vencimento */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Faturamento por Natureza de Opera‡Æo/Vencimento */
DO:
...
{utp/ut9000.i "ESFT0007" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-cod-estabel fi-nome-estabel fi-serie fi-ini-dt-emissao 
          fi-fin-dt-emissao 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-cod-estabel fi-serie fi-ini-dt-emissao fi-fin-dt-emissao IMAGE-1 
         IMAGE-2 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/esft0007rp.p}
