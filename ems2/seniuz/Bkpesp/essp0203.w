  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v01in172 ).
       RUN set-position IN h_v01in172 ( 2.88 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = inzoom/z01in172.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01in172 ).
       RUN set-position IN h_q01in172 ( 1.25 , 60.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP203" "2.04.0.000"}
