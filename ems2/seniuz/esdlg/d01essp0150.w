...
*******************************************************************************/
{include/i-prgvrs.i D01ESSP0150 2.04.00.000}
...
DEF INPUT PARAMETER p-tp-calculo AS INTEGER.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "D01ESSP0150" "2.04.00.000"}
  ...
  ASSIGN fi-arq-saida:SCREEN-VALUE IN FRAME {&FRAME-NAME} = SESSION:TEMP-DIRECTORY + 
         IF p-tp-calculo = 1 THEN "Total.xls"
         ELSE
         IF p-tp-calculo = 2 THEN "Disponivel.xls"
                             ELSE "Negativo.xls".
