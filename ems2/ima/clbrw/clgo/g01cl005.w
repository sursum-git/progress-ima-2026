...
*******************************************************************************/
{include/i-prgvrs.i G01CL005 1.00.00.000}
...
&Scoped-Define ENABLED-FIELDS movind.it-doc-fisico.nro-docto ~
movind.it-doc-fisico.serie-docto movind.it-doc-fisico.cod-emitente ~
movind.it-doc-fisico.sequencia 
&Scoped-define ENABLED-TABLES movind.it-doc-fisico
&Scoped-define FIRST-ENABLED-TABLE movind.it-doc-fisico
&Scoped-define DISPLAYED-TABLES movind.it-doc-fisico
&Scoped-define FIRST-DISPLAYED-TABLE movind.it-doc-fisico
&Scoped-Define ENABLED-OBJECTS bt-ok bt-cancela bt-ajuda rt-button 
&Scoped-Define DISPLAYED-FIELDS movind.it-doc-fisico.nro-docto ~
movind.it-doc-fisico.serie-docto movind.it-doc-fisico.cod-emitente ~
movind.it-doc-fisico.sequencia 
...
DEFINE FRAME d-vapara
     movind.it-doc-fisico.nro-docto AT ROW 1.17 COL 23 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.14 BY .88
     movind.it-doc-fisico.serie-docto AT ROW 2.17 COL 23 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9.14 BY .88
     movind.it-doc-fisico.cod-emitente AT ROW 3.17 COL 23 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.43 BY .88
     movind.it-doc-fisico.sequencia AT ROW 4.17 COL 23 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.57 BY .88
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "V  Para Recebimento Fisico"
...
ON GO OF FRAME d-vapara /* V  Para Recebimento Fisico */
DO:
  FIND FIRST it-doc-fisico no-lock 
      WHERE it-doc-fisico.nro-docto    = INPUT FRAME {&FRAME-NAME} it-doc-fisico.nro-docto
        AND it-doc-fisico.serie-docto  = INPUT FRAME {&FRAME-NAME} it-doc-fisico.serie-docto
        AND it-doc-fisico.cod-emitente = INPUT FRAME {&FRAME-NAME} it-doc-fisico.cod-emitente
        AND it-doc-fisico.sequencia    = INPUT FRAME {&FRAME-NAME} it-doc-fisico.sequencia 
      USE-INDEX documento NO-ERROR.
  IF  NOT AVAIL it-doc-fisico THEN DO:
      {utp/ut-table.i movind it-doc-fisico 1}
      RUN utp/ut-msgs.p (INPUT "show",
                         INPUT 2,
                         INPUT RETURN-VALUE).
      RETURN NO-APPLY.
  END.
  ASSIGN p-row-tabela = rowid(it-doc-fisico).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Recebimento Fisico */
DO:  
...
------------------------------------------------------------------------------*/
  IF AVAILABLE movind.it-doc-fisico THEN 
    DISPLAY movind.it-doc-fisico.nro-docto movind.it-doc-fisico.serie-docto 
          movind.it-doc-fisico.cod-emitente movind.it-doc-fisico.sequencia 
      WITH FRAME d-vapara.
  ENABLE movind.it-doc-fisico.nro-docto movind.it-doc-fisico.serie-docto 
         movind.it-doc-fisico.cod-emitente movind.it-doc-fisico.sequencia bt-ok 
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "G01CL005" "1.00.00.000"}
