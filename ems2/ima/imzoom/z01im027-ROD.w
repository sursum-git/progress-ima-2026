...
*******************************************************************************/
{include/i-prgvrs.i Z01IM027 2.04.00.001}
...
DEFINE OUTPUT PARAMETER r-row-emit AS ROWID NO-UNDO.
...
DEFINE VARIABLE h_b01im027 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-ok AT ROW 20 COL 2
     bt-cancela AT ROW 20 COL 13
     bt-ajuda AT ROW 20 COL 100
     rt-button AT ROW 19.75 COL 1
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 110.57 BY 20.46
...
ON END-ERROR OF w-pesquisa /* Busca de Pedidos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Busca de Pedidos */
DO:
...
DO:
  RUN pi-retorna-valor IN h_b01im027 (OUTPUT r-row-emit).
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_folder ( 18.58 , 109.43 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'imbrw/b01im027-rod.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01im027 ).
       RUN set-position IN h_b01im027 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 16.58 , 107.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "Z01IM027" "2.04.00.001"}
