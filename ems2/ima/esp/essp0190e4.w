...
*******************************************************************************/
{include/i-prgvrs.i ESSP0190E4 2.04.00.000}
...
&GLOBAL-DEFINE SORTBY-PHRASE BY IF sort-col = 1 ~
                                 THEN tt-work.regiao + tt-work.und ~
                                ELSE IF sort-col = 2 ~
                                     THEN tt-work.und + tt-work.regiao ~
                                    ELSE IF sort-col = 3 ~
...
&GLOBAL-DEFINE SORTBY-IMP-EXCEL BY IF sort-col = 1 ~
                                    THEN b-tt-work.regiao + b-tt-work.und ~
                                   ELSE IF sort-col = 2 ~
                                        THEN b-tt-work.und + b-tt-work.regiao ~
                                       ELSE IF sort-col = 3 ~
...
&Scoped-define FIELDS-IN-QUERY-br-work tt-work.regiao tt-work.und tt-work.qtd tt-work.vlr tt-work.desc-pratic tt-work.preco-medio tt-work.qtd-devol tt-work.vlr-devol   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-work tt-work.regiao   tt-work.und   tt-work.qtd   tt-work.vlr   tt-work.desc-pratic   tt-work.preco-medio   tt-work.qtd-devol   tt-work.vlr-devol   
...
fi-tot-qtd-und fi-tot-vlr-und fi-tot-desc-und fi-ger-vlr-dev fi-tot-geral 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-work D-Dialog _FREEFORM
  QUERY br-work NO-LOCK DISPLAY
      tt-work.regiao          COLUMN-LABEL "Regi∆o"               FORMAT "x(20)"              WIDTH 43.3 
      ...
      tt-work.desc-pratic     COLUMN-LABEL "Valor"                FORMAT ">>>,>>>,>>>,>>9.99" WIDTH 11.0
...
DEFINE FRAME D-Dialog
     ...
     fi-media-m AT ROW 13.08 COL 71.72 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-dev-m AT ROW 13.08 COL 82.29 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-dev-m AT ROW 13.08 COL 94 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-m AT ROW 13.13 COL 35.14 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-m AT ROW 13.13 COL 47.29 COLON-ALIGNED NO-LABEL
     fi-tot-desc-m AT ROW 13.13 COL 59.72 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     fi-media-kg AT ROW 14.08 COL 71.72 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-dev-kg AT ROW 14.08 COL 82.29 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-dev-kg AT ROW 14.08 COL 94 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-kg AT ROW 14.13 COL 35.14 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-kg AT ROW 14.13 COL 47.29 COLON-ALIGNED NO-LABEL
     fi-tot-desc-kg AT ROW 14.17 COL 59.86 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     fi-media-und AT ROW 15.08 COL 71.72 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-dev-und AT ROW 15.08 COL 82.29 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-dev-und AT ROW 15.08 COL 94 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-und AT ROW 15.13 COL 35.14 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-und AT ROW 15.13 COL 47.29 COLON-ALIGNED NO-LABEL
     fi-tot-desc-und AT ROW 15.13 COL 59.86 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     fi-ger-vlr-dev AT ROW 16.08 COL 94 COLON-ALIGNED NO-LABEL
     fi-tot-geral AT ROW 16.13 COL 47.29 COLON-ALIGNED NO-LABEL
     ...
     "UND" VIEW-AS TEXT
          SIZE 3.29 BY .54 AT ROW 15.21 COL 33.43
          FGCOLOR 12 
     "TOTAL GERAL:" VIEW-AS TEXT
          SIZE 11.29 BY .71 AT ROW 16.38 COL 37.86
          FGCOLOR 4 
     "TOTAIS:" VIEW-AS TEXT
          SIZE 6.72 BY .88 AT ROW 13.21 COL 27.29
          FONT 0
     "KG" VIEW-AS TEXT
          SIZE 2 BY .54 AT ROW 14.33 COL 34.57
          FGCOLOR 12 
     "M" VIEW-AS TEXT
          SIZE 1.57 BY .54 AT ROW 13.38 COL 35.29
          FGCOLOR 12 
     RECT-1 AT ROW 1.17 COL 111.29
     rt-buttom AT ROW 17.17 COL 1.57
     SPACE(7.71) SKIP(0.15)
...
/* ***************************  Main Block  *************************** */
 ASSIGN FRAME d-dialog:TITLE = "Totais Das Regi‰es  -  ESSP0190E4".

 tt-work.regiao:READ-ONLY IN BROWSE br-work       = YES.
...
------------------------------------------------------------------------------*/
  DISPLAY fi-media-m fi-tot-qtd-dev-m fi-tot-vlr-dev-m fi-tot-qtd-m fi-tot-vlr-m 
          fi-tot-desc-m fi-media-kg fi-tot-qtd-dev-kg fi-tot-vlr-dev-kg 
          fi-tot-qtd-kg fi-tot-vlr-kg fi-tot-desc-kg fi-media-und 
          fi-tot-qtd-dev-und fi-tot-vlr-dev-und fi-tot-qtd-und fi-tot-vlr-und 
          fi-tot-desc-und fi-ger-vlr-dev fi-tot-geral 
      WITH FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
    ...
    PUT "REGIÂES                                          UND    QUANTIDADE         VALOR  DESC PRATIC   PRECO MEDIO  QTD DEVOLUÄ«O  VLR DEVOLUÄ«O" AT 1.
    PUT "-----------------------------------------------  ---  ------------  ------------  ------------  -----------  -------------  -------------" AT 1.
...
/*          PUT CONTROL "~033&l1O~033(s16H". /* ORIENTAÄ«O PAISAGEM & COMPACTA */  */
  ...
  DO i-ct = 1 TO i-num-copias.
     ...
     PUT fi-tot-qtd-m    FORMAT "->,>>>,>>9.99"  AT  54
         ...
         fi-tot-desc-m   FORMAT "->,>>>,>>9.99"  AT  85.
...
------------------------------------------------------------------------------*/
 ...
 chWorkSheet = chExcelapp:Sheets:ITEM(1).
 chWorkSheet:NAME = "Faturamento Por Regi‰es".
 ...
 ChWorksheet:range("A1:H1"):Merge.
 Chworksheet:Range("A1:H1"):HorizontalAlignment =  3.
 /* Colorir Titulo da Planilha */
 chWorkSheet:Range("A1:H1"):FONT:ColorIndex     = 18. /* Avermelhado */
 chWorkSheet:Range("A1:H1"):Interior:ColorIndex = 2. /* Branco */
 ...
 /* Titulo das Colunas */
 ASSIGN chworksheet:range("A3"):VALUE = "REGIÂES"
        chworksheet:range("B3"):VALUE = "UND"  
        chworksheet:range("C3"):VALUE = "QUANTIDADE"
        chworksheet:range("D3"):VALUE = "VALOR"     
        chworksheet:range("E3"):VALUE = "DESC PRATIC" 
        chworksheet:range("F3"):VALUE = "PREÄO MêDIO" 
        chworksheet:range("G3"):VALUE = "QTD DEVOLUÄ«O"     
        chworksheet:range("H3"):VALUE = "VLR DEVOLUÄ«O". 
 ...
 ASSIGN chworksheet:range("C:H"):NumberFormat        = "###.###.##0,00"
        Chworksheet:range("C:H"):HorizontalAlignment = 4. /* Alinhamento a Direita */

 /* Configura Cabeáalho das Colunas */
 chWorkSheet:Range("A3:G3"):SELECT().
...
FOR EACH b-tt-work NO-LOCK {&SORTBY-IMP-EXCEL}.
    ASSIGN chworksheet:range("A" + STRING(i-lin)):VALUE = b-tt-work.regiao
           ...
           chworksheet:range("E" + STRING(i-lin)):VALUE = b-tt-work.desc-pratic
           chworksheet:range("F" + STRING(i-lin)):VALUE = b-tt-work.preco-medio
           chworksheet:range("G" + STRING(i-lin)):VALUE = b-tt-work.qtd-devol
...
IF i-lin <> 4 THEN DO:
   ...
   ASSIGN chworksheet:range("C" + STRING(i-lin)):VALUE = fi-tot-qtd-m     
          ...
          chworksheet:range("E" + STRING(i-lin)):VALUE = fi-tot-desc-m 
          chworksheet:range("F" + STRING(i-lin)):VALUE = (fi-tot-vlr-m / fi-tot-qtd-m)
          chworksheet:range("G" + STRING(i-lin)):VALUE = fi-tot-qtd-dev-m
          chworksheet:range("H" + STRING(i-lin)):VALUE = fi-tot-vlr-dev-m.
   ...
   ASSIGN chworksheet:range("C" + STRING(i-lin)):VALUE = fi-tot-qtd-kg     
          ...
          chworksheet:range("G" + STRING(i-lin)):VALUE = fi-tot-desc-kg
          chworksheet:range("H" + STRING(i-lin)):VALUE = (fi-tot-vlr-kg / fi-tot-qtd-kg)
   ...
   ASSIGN chworksheet:range("C" + STRING(i-lin)):VALUE = fi-tot-qtd-und     
          ...
          chworksheet:range("G" + STRING(i-lin)):VALUE = fi-tot-desc-und     
          chworksheet:range("H" + STRING(i-lin)):VALUE = (fi-tot-vlr-und / fi-tot-qtd-und)
          chworksheet:range("I" + STRING(i-lin)):VALUE = fi-tot-qtd-dev-und
          chworksheet:range("J" + STRING(i-lin)):VALUE = fi-tot-vlr-dev-und.
    /* Colorir a Linha / Negrito */
   ASSIGN chWorkSheet:Range("A" + STRING(i-lin) + ":G" + STRING(i-lin)):Interior:ColorIndex = 14
          chWorkSheet:Range("A" + STRING(i-lin) + ":G" + STRING(i-lin)):FONT:ColorIndex     =  2
          chWorkSheet:Range("A" + STRING(i-lin) + ":G" + STRING(i-lin)):FONT:Bold           = TRUE.
   ...
   ASSIGN chworksheet:range("D" + STRING(i-lin)):VALUE = fi-tot-vlr-m + fi-tot-vlr-kg + fi-tot-vlr-und
          chworksheet:range("G" + STRING(i-lin)):VALUE = fi-tot-vlr-dev-m + fi-tot-vlr-dev-kg + fi-tot-vlr-dev-und.
    /* Colorir a Linha / Negrito */
   ASSIGN chWorkSheet:Range("A" + STRING(i-lin) + ":G" + STRING(i-lin)):Interior:ColorIndex = 18
          chWorkSheet:Range("A" + STRING(i-lin) + ":G" + STRING(i-lin)):FONT:ColorIndex     =  2
          chWorkSheet:Range("A" + STRING(i-lin) + ":G" + STRING(i-lin)):FONT:Bold           = TRUE.
END.
...
ASSIGN FRAME {&FRAME-NAME}:VISIBLE = NO.
 ...
 FOR EACH tt-trab WHERE
     ...
     CREATE tt-work.
     ASSIGN tt-work.regiao      = tt-trab.regiao
            tt-work.Und         = tt-trab.und
            tt-work.qtd         = tt-trab.qtd
            tt-work.vlr         = tt-trab.vlr - tt-work.desc-pratic
