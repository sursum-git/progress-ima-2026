...
*******************************************************************************/
{include/i-prgvrs.i esp700 9.99.99.999}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i esp700rp mpd}
&ENDIF
...
DEFINE FRAME f-pg-sel
     "Este Programa Apaga as Tabelas Wp do Portal de Vendas" VIEW-AS TEXT
          SIZE 61 BY .67 AT ROW 5 COL 7 WIDGET-ID 2
          FGCOLOR 12 
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
ON END-ERROR OF w-relat /* Limpar tabelas Wp */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Limpar tabelas Wp */
DO:
...
{utp/ut9000.i "esp700" "9.99.99.999"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/esp700rp.p}
