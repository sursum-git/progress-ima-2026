...
{include/i-prgvrs.i get-devolucao-venda 1.00.00.000}

{utp/ut-api-action.i pidefault  GET ~* }
...
PROCEDURE piDefault:
    ...
    ELSE DO:
        ...
        oHeaders:ADD("Content-Type", "application/custom.content.type+json"). // se retirar d† erro 500
        //oHeaders:ADD("Access-Control-Allow-Origin", "http://localhost:80").
        oHeaders:ADD("Access-Control-Allow-Origin", "http://localhost:63342").
        oHeaders:ADD("Access-Control-Allow-Methods", "GET,POST,PUT,PATCH,DELETE,OPTIONS").
        oHeaders:ADD("Access-Control-Allow-Headers", "Content-Type, Authorization").
        oHeaders:ADD("Access-Control-Allow-Credentials", "true").    
