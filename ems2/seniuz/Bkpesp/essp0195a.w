...
tg-lote-todos rs-opc-artigo bt-ok bt-cancelar bt-ajuda IMAGE-2 IMAGE-51 ~
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-window ASSIGN
         HIDDEN             = YES
         TITLE              = "Parƒmetros e Sele‡Æo da Localiza‡Æo Etiquetas - ESSP0195A"
         HEIGHT             = 11.75
         WIDTH              = 75
         MAX-HEIGHT         = 21.13
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-window /* Parƒmetros e Sele‡Æo da Localiza‡Æo Etiquetas - ESSP0195A */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-window w-window
ON WINDOW-CLOSE OF w-window /* Parƒmetros e Sele‡Æo da Localiza‡Æo Etiquetas - ESSP0195A */
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE rs-local fi-it-codigo-ini fi-it-codigo-fin bt-dig-item bt-ex-item 
         ...
         tg-lote-todos rs-opc-artigo bt-ok bt-cancelar bt-ajuda IMAGE-2 
         IMAGE-51 IMAGE-52 IMAGE-73 IMAGE-75 IMAGE-77 IMAGE-78 IMAGE-82 
         IMAGE-83 IMAGE-87 RECT-1 RECT-49 
      WITH FRAME F-Main IN WINDOW w-window.
