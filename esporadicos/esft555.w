...
*******************************************************************************/
{include/i-prgvrs.i ESFT555 9.99.99.999}
...
&Scoped-Define ENABLED-OBJECTS rt-button btExec fiNF 
&Scoped-Define DISPLAYED-OBJECTS fiNF 
...
DEFINE VARIABLE fiNF AS CHARACTER FORMAT "X(15)":U 
     LABEL "NF" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-cad
     btExec AT ROW 3.75 COL 44.72 WIDGET-ID 4
     fiNF AT ROW 3.79 COL 19.29 COLON-ALIGNED WIDGET-ID 2
...
ON END-ERROR OF w-livre /* Acerto NF */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-livre w-livre
ON WINDOW-CLOSE OF w-livre /* Acerto NF */
DO:
...
DO:
  FIND nota-fiscal WHERE
        ...
        nota-fiscal.nr-nota-fis = fiNF:SCREEN-VALUE
        NO-LOCK NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESFT555" "9.99.99.999"}
