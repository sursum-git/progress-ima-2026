...
OUTPUT TO c:\temp\movto_cta_corren.txt.
    ...
    /*MESSAGE dat_transacao_ini SKIP
            dat_transacao_fim SKIP
            ctaCorrenIni      SKIP
            ctaCorrenFim      SKIP
            iSeqIni           SKIP
            iSeqfim
    ...
    IF AVAIL movto_cta_corren THEN DO:
       IF cNivel = 'fluxo' THEN DO:
           ...
           FIND tip_fluxo_financ
               ...
               NO-LOCK NO-ERROR.
           RUN criarTTFluxo(
               movto_cta_corren.cod_modul_dtsul,            //1
                estabelecimento.cod_empresa,                //2
                cta_corren.cod_estab,                       //3
                movto_cta_corren.cod_tip_trans_cx ,         //4
                tip_trans_cx.des_tip_trans_cx,              //5
                movto_cta_corren.dat_movto_cta_corren,      //6
                cod_docto_movto_cta_bco,                    //7
                '',                                         //8
                '',                                         //9
                '',                                         //10
                movto_cta_corren.val_movto_cta_corren * iSinal, //11           
                tip_trans_cx.cod_tip_fluxo_financ_saida ,       //12
                tip_fluxo_financ.des_tip_fluxo_financ ,         //13
                '',                                           //14
                            //tit_acr.des_observacao,         
                movto_cta_corren.dat_transacao ,              //15
                movto_cta_corren.num_seq_movto_cta_corren,    //16     
                movto_cta_corren.cod_cta_corren,              //17
                movto_cta_corren.num_id_movto_cta_corren,     //18
                movto_cta_corren.dat_transacao                //19
                   ).
       END.                                             
...
IF cNivel = 'fluxo' THEN DO:
   ...
   FOR EACH rat_financ_cmg OF movto_cta_corren :
       ...
       RUN criarTTFluxo(cOrigem,  //1           
           ...
           '',             //9
           '',             //10
           rat_financ_cmg.val_movto_cta_corren * iSinal,            //11
           rat_financ_cmg.cod_tip_fluxo_financ ,                    //12
           tip_fluxo_financ.des_tip_fluxo_financ ,                  //13
           tit_acr.des_observacao,                                  //14
           movto_cta_corren.dat_transacao ,                         //15
           movto_cta_corren.num_seq_movto_cta_corren,               //16
           movto_cta_corren.cod_cta_corren,                         //17
           movto_cta_corren.num_id_movto_cta_corren,                //18
...
DEFINE BUFFER bfMovtoTitAcr FOR movto_tit_acr.
...
FOR EACH movto_tit_acr OF movto_cta_corren NO-LOCK:
    ...
    IF cNivel = 'fluxo' THEN DO:
       ...
       ASSIGN lRateio = NO.
       //lanáamentos de estorno n∆o tem apropriaá∆o e rateio e precisam ser criados a partir dos dados do movto do acr
       IF movto_tit_acr.ind_trans_acr = 'Estorno de Liquidacao' THEN DO:      
          FIND  bfMovtoTitAcr NO-LOCK
                WHERE bfMovtoTitAcr.num_id_movto_tit_acr = movto_tit_acr.num_id_movto_tit_acr_pai
                NO-ERROR.
          IF AVAIL bfMovtoTitAcr THEN DO:                 
             FOR EACH val_movto_tit_acr OF bfMovtoTitAcr NO-LOCK.                  
                 ASSIGN lRateio = YES.
                 FIND FIRST tip_fluxo_financ OF val_movto_tit_acr NO-LOCK NO-ERROR.                  
                 RUN criarTTFluxo(cOrigem,                                    //1
                                tit_acr.cod_empresa,                        //2
                                tit_acr.cod_estab,                          //3
                                IF AVAIL tit_acr THEN string(tit_acr.cdn_cliente) ELSE  '0'  , //4
                                IF AVAIL emitente THEN emitente.nome-emit ELSE '', //5
                                movto_cta_corren.dat_movto_cta_corren,             //6
                                tit_acr.cod_tit_acr,                               //7
                                tit_acr.cod_ser ,                                  //8
                                tit_acr.cod_parcela,                               //9
                                tit_acr.cod_espec_docto,                           //10
                               /* (val_movto_tit_acr.val_liquidac_tit_acr + val_movto_tit_acr.val_juros 
                                ...
                                (val_movto_tit_acr.val_liquidac_tit_acr + val_movto_tit_acr.val_juros + val_movto_tit_acr.val_multa_tit_acr - val_movto_tit_acr.val_abat_tit_acr) 
                                / bfMovtoTitAcr.val_movto_tit_acr * iSinal * movto_tit_acr.val_movto_tit_acr , //11
                                val_movto_tit_acr.cod_tip_fluxo_financ ,   //12   
                                tip_fluxo_financ.des_tip_fluxo_financ ,   //13   
                               '', // IF AVAIL histor_movto_tit_acr THEN histor_movto_tit_acr.des_text_histor ELSE '',         //14
                                movto_cta_corren.dat_transacao ,             //15
                                movto_cta_corren.num_seq_movto_cta_corren,   //16      
                                movto_cta_corren.cod_cta_corren,             //17
                                movto_cta_corren.num_id_movto_cta_corren,    //18
          ...
          FOR EACH rat_movto_tit_acr OF movto_tit_acr NO-LOCK.              
              ...
              RUN criarTTFluxo(cOrigem,                                    //1
                              ...
                              /* (val_movto_tit_acr.val_liquidac_tit_acr + val_movto_tit_acr.val_juros 
                                + val_movto_tit_acr.val_multa_tit_acr - val_movto_tit_acr.val_abat_tit_acr 
                                - val_movto_tit_acr.val_desconto ) * iSinal, */
                               rat_movto_tit_acr.val_aprop_ctbl * iSinal , //11
                               rat_movto_tit_acr.cod_tip_fluxo_financ ,   //12   
                               tip_fluxo_financ.des_tip_fluxo_financ ,   //13   
                              '', // IF AVAIL histor_movto_tit_acr THEN histor_movto_tit_acr.des_text_histor ELSE '',         //14
                               movto_cta_corren.dat_transacao ,             //15
                               movto_cta_corren.num_seq_movto_cta_corren,   //16      
    ...
    IF NOT AVAIL tit_Ap  THEN DO:
        ...
        FOR EACH ems5.antecip_pef_pend OF movto_tit_ap  NO-LOCK:
            ...
            FOR EACH ems5.aprop_ctbl_pend_ap OF antecip_pef_pend NO-LOCK:
                ...
                RUN criarTTFluxo(cOrigem,                                                                         //1 
                                estabelecimento.cod_empresa ,  //IF AVAIL tit_ap THEN tit_ap.cod_empresa ELSE '', //2
                                estabelecimento.cod_estab ,   //movto_cta_corren.cod_estab,                      // 3
                                string(ems5.antecip_pef_pend.cdn_fornecedor),                                    // 4
                                IF AVAIL fornecedor THEN fornecedor.nom_pessoa  ELSE '',                         // 5
                                movto_cta_corren.dat_movto_cta_corren,                                           // 6
                                IF AVAIL tit_ap THEN tit_ap.cod_tit_ap ELSE '',                                  // 7
                                IF AVAIL tit_ap THEN tit_ap.cod_ser ELSE '',                                     // 8
                                IF AVAIL tit_ap THEN tit_ap.cod_parcela ELSE '',                                 // 9
                                IF AVAIL tit_ap THEN tit_ap.cod_espec_docto ELSE '',                             // 10
                                aprop_ctbl_pend_ap.val_aprop_ctbl * iSinal ,                                     // 11
                                aprop_ctbl_pend_ap.cod_tip_fluxo_financ ,                                        // 12
                                tip_fluxo_financ.des_tip_fluxo_financ ,                                          // 13
                                '',                                                                              // 14
                                movto_cta_corren.dat_transacao ,                                                 // 15
                                movto_cta_corren.num_seq_movto_cta_corren,                                       // 16
                                movto_cta_corren.cod_cta_corren,                                                 // 17
                                movto_cta_corren.num_id_movto_cta_corren,                                        // 18
                                antecip_pef_pend.dat_emis_docto ).                                               // 19 
      ...
      IF cNivel = 'fluxo' THEN DO:
         ...
         IF espec_docto.ind_tip_espec_docto = 'antecipaá∆o' THEN DO:
            ...
            FOR EACH rat_movto_tit_ap OF movto_tit_ap NO-LOCK:
               ...
               RUN criarTTFluxo(cOrigem,            //1
                       tit_ap.cod_empresa,          //2
                       tit_ap.cod_estab,            //3
                       string(tit_ap.cdn_fornec),   //4
                       IF AVAIL fornecedor THEN fornecedor.nom_pessoa ELSE '',  //5
                       movto_cta_corren.dat_movto_cta_corren,                   //6
                       tit_ap.cod_tit_ap,                                       //7
                       tit_ap.cod_ser,                                          //8
                       tit_ap.cod_parcela,                                      //9
                       tit_ap.cod_espec_docto,                                  //10
                       rat_movto_tit_ap.val_aprop_ctbl * iSinal / dConv,        //11
                       //movto_cta_corren.val_movto_cta_corren * iSinal, //val_tit_ap.val_origin_tit_ap * iSinal,             
                       rat_movto_tit_ap.cod_tip_fluxo_financ ,                                                                //12
                       tip_fluxo_financ.des_tip_fluxo_financ ,                                                                //13
                       '',                                                                                                    //14
                       movto_cta_corren.dat_transacao ,                                                                       //15
                       movto_cta_corren.num_seq_movto_cta_corren,                                                             //16
         ...
         ELSE DO:
             ...
             FOR EACH rat_movto_tit_ap OF movto_tit_ap NO-LOCK:
                ...
                RUN criarTTFluxo(cOrigem,              //1
                                tit_ap.cod_empresa,    //2
                                tit_ap.cod_estab,      //3
                                IF AVAIL tit_ap THEN string(tit_ap.cdn_fornec) ELSE  '0'  , //4
                                IF AVAIL fornecedor THEN fornecedor.nom_pessoa ELSE '',     //5
                                movto_cta_corren.dat_movto_cta_corren,                      //6
                                tit_ap.cod_tit_ap,                                          //7
                                tit_ap.cod_ser,                                             //8
             ...
             IF lRateio = NO THEN DO:
                ...
                FOR EACH val_movto_ap OF movto_tit_ap NO-LOCK:
                    ...
                    RUN criarTTFluxo(cOrigem,           //1        
                                    ...
                                    tit_ap.cod_parcela,                                         //9
                                    tit_ap.cod_espec_docto,                                     //10
                                    (val_movto_ap.val_pagto_tit_ap  + val_movto_ap.val_multa_tit_ap + val_movto_ap.val_juros - val_movto_ap.val_desconto - val_movto_ap.val_abat_tit_ap) * iSinal,            //11
                                    val_movto_ap.cod_tip_fluxo_financ ,      //12
                                    tip_fluxo_financ.des_tip_fluxo_financ ,      //13
                                    '',         //14
                                    movto_cta_corren.dat_transacao ,            //15
                                    movto_cta_corren.num_seq_movto_cta_corren,  //16       
                ...
                IF lValAp = NO  THEN DO:
                    FOR EACH val_tit_ap OF tit_ap NO-LOCK . 
                        ...
                        ELSE
                           ASSIGN dValorAprop = IF val_tit_ap.val_pagto_tit_ap > movto_tit_ap.val_movto_ap 
                                                THEN movto_tit_ap.val_movto_ap    * iSinal 
                        ...
                        RUN criarTTFluxo(cOrigem,                                   //1
                                    ...
                                    tit_ap.cod_espec_docto,                                   //10
                                    dValorAprop ,                                             //11
                                    val_tit_ap.cod_tip_fluxo_financ ,                         //12
                                    IF AVAIL tip_fluxo_financ THEN tip_fluxo_financ.des_tip_fluxo_financ ELSE '' ,      //13
                                    '',                                                                                 //14
                                    movto_cta_corren.dat_transacao ,                                                    //15
                                    movto_cta_corren.num_seq_movto_cta_corren,                                          //16
                                    movto_cta_corren.cod_cta_corren,                                                    //17
