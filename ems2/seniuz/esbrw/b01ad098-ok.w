...
*******************************************************************************/
{include/i-prgvrs.i B01AD098 2.04.00.000}
...
&Scoped-define FIELDS-IN-QUERY-br-table emitente.cod-emitente ~
emitente.nome-abrev emitente.cgc emitente.nome-emit 
...
&Scoped-define QUERY-STRING-br-table FOR EACH emitente WHERE ~{&KEY-PHRASE} ~
 ...
 AND emitente.cod-emitente >= fi-ini-cod-emitente ~
 AND emitente.cod-emitente <= fi-fin-cod-emitente  NO-LOCK ~
...
&Scoped-Define ENABLED-OBJECTS IMAGE-1 IMAGE-2 fi-ini-cod-emitente ~
fi-fin-cod-emitente bt-confirma br-table 
...
<FOREIGN-KEYS>
cod-cond-pag|y|y|ems2cad.emitente.cod-cond-pag
cod-gr-forn|y|y|ems2cad.emitente.cod-gr-forn
nat-operacao|y|y|ems2cad.emitente.nat-operacao
cod-rep|y|y|ems2cad.emitente.cod-rep
cod-tax|y|y|ems2cad.emitente.cod-tax
cod-transp|y|y|ems2cad.emitente.cod-transp
cod-banco||y|ems2cad.emitente.cod-banco
cod-canal-venda||y|ems2cad.emitente.cod-canal-venda
nome-abrev||y|ems2cad.emitente.nome-abrev
categoria||y|ems2cad.emitente.categoria
cod-emitente||y|ems2cad.emitente.cod-emitente
cod-gr-cli||y|ems2cad.emitente.cod-gr-cli
cod-isencao||y|ems2cad.emitente.cod-isencao
cod-mensagem||y|ems2cad.emitente.cod-mensagem
nr-tab-progr||y|ems2cad.emitente.nr-tab-progr
nr-tabpre||y|ems2cad.emitente.nr-tabpre
cod-tip-ent||y|ems2cad.emitente.cod-tip-ent
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
DEFINE VARIABLE fi-fin-cod-emitente AS INTEGER FORMAT ">>>>>>>>9" INITIAL 999999999 
     VIEW-AS FILL-IN 
     SIZE 10.14 BY .88 TOOLTIP "C¢digo do emitente final."
     FONT 1 NO-UNDO.

DEFINE VARIABLE fi-ini-cod-emitente AS INTEGER FORMAT ">>>>>>>>9" INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 10.14 BY .88 TOOLTIP "C¢digo do emitente inicial."
     FONT 1 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      ...
      emitente.nome-abrev FORMAT "X(12)":U WIDTH 17.57
      emitente.cgc FORMAT "x(19)":U
      emitente.nome-emit FORMAT "x(80)":U WIDTH 39.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 84 BY 10.58
         FONT 1.
...
DEFINE FRAME F-Main
     fi-ini-cod-emitente AT ROW 1.17 COL 6.14 COLON-ALIGNED NO-LABEL
     fi-fin-cod-emitente AT ROW 1.17 COL 42.43 COLON-ALIGNED NO-LABEL
     bt-confirma AT ROW 1.17 COL 79.72
     br-table AT ROW 2.17 COL 1
     IMAGE-1 AT ROW 1.17 COL 18.72
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "ems2cad.emitente"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "ems2cad.emitente.identific <> 2
 AND emitente.cod-rep >= i-cod-rep-ini
 AND emitente.cod-rep <= i-cod-rep-fin
 AND emitente.cod-emitente >= fi-ini-cod-emitente
 AND emitente.cod-emitente <= fi-fin-cod-emitente "
     _FldNameList[1]   = ems2cad.emitente.cod-emitente
     _FldNameList[2]   > ems2cad.emitente.nome-abrev
"emitente.nome-abrev" ? ? "character" ? ? ? ? ? ? no ? no no "17.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = ems2cad.emitente.cgc
     _FldNameList[4]   > ems2cad.emitente.nome-emit
