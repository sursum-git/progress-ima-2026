...
ASSIGN c-programa     = "esimft05abrp":U
       c-versao       = "2.06":U
       c-revisao      = ".00.001":U
...
IF SEARCH('excel/movtoestoq.xlsx') <> ? THEN
    OS-COMMAND VALUE('start excel /t ' + SEARCH('excel/movtoestoq.xlsx') ).
ELSE
    MESSAGE "Modelo Excel de Movimento de Estoque n∆o encontrado"
