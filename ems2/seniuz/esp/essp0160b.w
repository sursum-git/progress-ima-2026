...
&Scoped-define FIELDS-IN-QUERY-br-pedidos tt-itens-ped.it-codigo tt-itens-ped.cod-refer tt-itens-ped.lote tt-itens-ped.corte-comerc tt-itens-ped.nome-abrev tt-itens-ped.nr-pedcli tt-itens-ped.nr-sequencia tt-itens-ped.dt-entrega tt-itens-ped.qt-crivada de-tot-saldo   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-pedidos   
&Scoped-define SELF-NAME br-pedidos
&Scoped-define OPEN-QUERY-br-pedidos RUN pi-totais. OPEN QUERY {&SELF-NAME} FOR EACH tt-itens-ped WHERE                                  tt-itens-ped.visualiza                                  NO-LOCK BY tt-itens-ped.dt-entrega.
...
BUTTON-1 bt-etiquetas bt-ok bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS fi-tot-crivada 
...
tt-itens-ped.corte-comerc     WIDTH 4   COLUMN-LABEL "Corte"
tt-itens-ped.nome-abrev       WIDTH 15
tt-itens-ped.nr-pedcli        WIDTH 8
tt-itens-ped.nr-sequencia     WIDTH 3
tt-itens-ped.dt-entrega       WIDTH 10
tt-itens-ped.qt-crivada       WIDTH 12  COLUMN-LABEL "Qt Crivada" FORMAT ">,>>>,>>9.99"
de-tot-saldo                  WIDTH 10  COLUMN-LABEL "Qt Estoque"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME D-Dialog
     ...
     fi-tot-crivada AT ROW 13.5 COL 64 COLON-ALIGNED NO-LABEL
     bt-ok AT ROW 15.25 COL 3
     bt-cancela AT ROW 15.25 COL 13.43
     bt-ajuda AT ROW 15.25 COL 81.29
     rt-buttom AT ROW 15 COL 2
     SPACE(0.71) SKIP(0.24)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 1
         TITLE "Pedidos Crivados por Cr‚dito - ESSP0160B"
...
/* SETTINGS FOR FILL-IN fi-tot-crivada IN FRAME D-Dialog
   NO-ENABLE                                                            */
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Pedidos Crivados por Cr‚dito - ESSP0160B */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY fi-tot-crivada 
      WITH FRAME D-Dialog.
  ENABLE rt-buttom br-pedidos bt-detalhe bt-imprime BUTTON-1 bt-etiquetas bt-ok 
         bt-cancela bt-ajuda 
      WITH FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
 ...
 CASE i-saida:
     ...
     WHEN 3 THEN DO.
         ASSIGN c-saida = SESSION:TEMP-DIRECTORY + "essp0160b.tmp".
         OUTPUT TO VALUE(c-saida).
     END.
 END CASE.
 ...
 DO i-ct = 1 TO i-num-copias.
    ...
    FOR EACH tt-itens-ped NO-LOCK,
        EACH ped-venda WHERE
             ped-venda.nr-pedcli = tt-itens-ped.nr-pedcli AND
             ped-venda.nome-abrev = tt-itens-ped.nome-abrev AND
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH tt-itens-ped WHERE
      ...
      ASSIGN fi-tot-crivada = fi-tot-crivada + tt-itens-ped.qt-pedida.
  END.
  DISP fi-tot-crivada
