...
IF p-wgh-frame:NAME = "fpage0" AND
   ...
   DO WHILE VALID-HANDLE(h-objeto):
      IF h-objeto:NAME  = "btOK" THEN /* Chamada para Imprimir ROMANEIO */
         ON 'mouse-select-click':U OF h-objeto PERSISTENT RUN esupc/upc-ft0518a2.p (INPUT p-wgh-frame). 
      ...
      IF h-objeto:NAME = "fPage2" THEN DO:
         ...
         DO WHILE VALID-HANDLE(h-campo):
            ...
            IF h-campo:NAME = "c-cod-estabel" THEN DO.
               ON 'ENTRY':U OF h-campo PERSISTENT RUN esupc/upc-ft0518a1.p.  
               ON 'LEAVE':U OF h-campo PERSISTENT RUN esupc/upc-ft0518a1.p.  
            END.
