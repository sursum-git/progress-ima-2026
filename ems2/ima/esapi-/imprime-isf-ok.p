...
FOR EACH ped-item OF ped-venda NO-LOCK.
    ...
    MESSAGE 'antes pi-imp-item' SKIP
            i-lin
        VIEW-AS ALERT-BOX INFO BUTTONS OK.
...
PROCEDURE pi-cabec-form.
    ...
    RUN pdf_text_xy  IN h_PDFinc ("Spdf","INSTRUÄ«O PARA SEPARAÄ«O E FATURAMENTO",190,770).
    ...
    RUN pdf_text_xy  IN h_PDFinc ("Spdf","CIDADE....: " + ped-venda.cidade,350,670).       
...
PROCEDURE pi-imp-item.
     MESSAGE 'dentro pi-imp-item' SKIP
             i-lin-item < 30
         VIEW-AS ALERT-BOX INFO BUTTONS OK.
     ...
     RUN pdf_text_xy  IN h_PDFinc ("Spdf",ped-item.cod-refer,307,i-lin).
     ...
     RUN pi-desenha-linha (15,(i-lin - i-salto),580,(i-lin - i-salto),1). /* Traáo Horizontal Apos Impress∆o do ITEM */
     ...
     RUN pi-desenha-linha ( 60,i-lin-item, 60,i-lin,1). 
     RUN pi-desenha-linha (300,i-lin-item,300,i-lin,1). 
     RUN pi-desenha-linha (330,i-lin-item,330,i-lin,1). 
     RUN pi-desenha-linha (395,i-lin-item,395,i-lin,1). 
     RUN pi-desenha-linha (420,i-lin-item,420,i-lin,1). 
     RUN pi-desenha-linha (480,i-lin-item,480,i-lin,1). 
