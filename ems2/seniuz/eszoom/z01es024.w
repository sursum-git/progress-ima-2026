...
DEFINE VARIABLE h_b01es024 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Produtos do Beneficiamento"
         HEIGHT             = 14.54
         WIDTH              = 90
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 90
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Produtos do Beneficiamento */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Produtos do Beneficiamento */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b01es024.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01es024 ).
       RUN set-position IN h_b01es024 ( 2.25 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.50 , 86.00 ) */

       /* Links to SmartBrowser h_b01es024. */
       RUN add-link IN adm-broker-hdl ( h_b01es024 , 'State':U , THIS-PROCEDURE ).
