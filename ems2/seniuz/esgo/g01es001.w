...
&Scoped-Define ENABLED-FIELDS amostra-fam.fm-codigo amostra-fam.ano-mes ~
...
&Scoped-Define DISPLAYED-FIELDS amostra-fam.fm-codigo amostra-fam.ano-mes ~
amostra-fam.num-amostra 
...
DEFINE FRAME d-vapara
     amostra-fam.fm-codigo AT ROW 1.17 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10.14 BY .88
     fi-desc-familia AT ROW 1.17 COL 22.29 COLON-ALIGNED NO-LABEL
     amostra-fam.ano-mes AT ROW 2.17 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9.14 BY .88
     amostra-fam.num-amostra AT ROW 3.17 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 3.43 BY .88
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "V  Para Amostras por Fam¡lia"
...
ON GO OF FRAME d-vapara /* V  Para Amostras por Fam¡lia */
DO:
  find amostra-fam no-lock 
      where amostra-fam.fm-codigo   = input frame {&frame-name} amostra-fam.fm-codigo
        ...
        AND amostra-fam.num-amostra = INPUT FRAME {&FRAME-NAME} amostra-fam.num-amostra
      no-error.
  if  not avail amostra-fam then do:
      {utp/ut-table.i espec amostra-fam 1}
      run utp/ut-msgs.p (input "show",
                         input 2,
                         input RETURN-VALUE).
      return no-apply.
  end.
  assign p-row-tabela = rowid(amostra-fam).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Amostras por Fam¡lia */
DO:  
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL amostra-fam.fm-codigo d-vapara
ON LEAVE OF amostra-fam.fm-codigo IN FRAME d-vapara /* Familia */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY fi-desc-familia 
      WITH FRAME d-vapara.
  IF AVAILABLE amostra-fam THEN 
    DISPLAY amostra-fam.fm-codigo amostra-fam.ano-mes amostra-fam.num-amostra 
      WITH FRAME d-vapara.
  ENABLE amostra-fam.fm-codigo amostra-fam.ano-mes amostra-fam.num-amostra 
         bt-ok bt-cancela bt-ajuda rt-button 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
