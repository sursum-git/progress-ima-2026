...
DEF TEMP-TABLE tt-etq-reservadas NO-UNDO LIKE ob-etiqueta LABEL "TT ETQ Reservadas" 
    FIELD nr-pedcli              LIKE ped-item.nr-pedcli
    FIELD nr-seq-ped-item        LIKE ped-item.nr-sequencia
    FIELD tp-acao                AS CHAR.

DEF TEMP-TABLE tt-etq-estoque NO-UNDO LIKE ob-etiqueta LABEL "TT ETQ Estoque" 
...
DEF TEMP-TABLE tt-etq-lidas LABEL "TT ETQ Lidas" 
    FIELD i-lin        AS INT
...
&Scoped-define FIELDS-IN-QUERY-br-etq-estoque tt-etq-estoque.localizacao tt-etq-estoque.num-etiqueta tt-etq-estoque.cod-estab tt-etq-estoque.cod-depos tt-etq-estoque.quantidade   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-etq-estoque w-livre _FREEFORM
  QUERY br-etq-estoque NO-LOCK DISPLAY
      ...
      tt-etq-estoque.cod-estab                         COLUMN-LABEL "Est" WIDTH 3
      tt-etq-estoque.cod-depos                         COLUMN-LABEL "Dep" WIDTH 4                         
...
DO:
   ...
   FOR EACH tt-etq-lidas.
       ...
       IF AVAIL ob-etiqueta THEN DO.
          ...
          IF NOT AVAIL tt-etq-reservadas THEN DO.
             CREATE tt-etq-reservadas.
             ASSIGN tt-etq-reservadas.cod-estabel = ob-etiqueta.cod-estabel
    ...
    */
    ...
    FOR EACH tt-itens-ped NO-LOCK BY tt-itens-ped.nr-sequencia.
        ...
        DO TRANSACTION.
           ...
           END.
           ELSE
              ASSIGN c-desc-reserva = c-desc-reserva + " RESERVA ELIMINADA (ESSP0154)".
