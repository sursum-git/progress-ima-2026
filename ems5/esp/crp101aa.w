...
/*------------------------------------------------------------------------
File.............: crp101aa.w
Description......: Pagamentos Quitados
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 31/07/03 - 09:20 - CDIAS
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "CRP101AA".
...
DEFINE FRAME f-pg-sel
   i-cod-fornec-ini label "Fornecedor"
     at row 1 col 18 colon-aligned
     view-as fill-in 
     size 10 by .88
     font 1

   i-cod-fornec-fim no-label
     at row 1 col 39 colon-aligned
     view-as fill-in 
     size 10 by .88
     font 1

   da-dt-prev-pag-ini label "Dt Prev Pagto"
     at row 2 col 18 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   da-dt-prev-pag-fim no-label
     at row 2 col 39 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   i-portador-ini label "Portador"
     at row 3 col 18 colon-aligned
     view-as fill-in 
     size 6 by .88
     font 1

   i-portador-fim no-label
     at row 3 col 39 colon-aligned
     view-as fill-in 
     size 6 by .88
     font 1

   c-cod-esp-ini label "Esp‚cie"
   ...
   i-modalidade-ini label "Modalidade"
     at row 5 col 18 colon-aligned
     view-as fill-in 
     size 2 by .88
     font 1

   i-modalidade-fim no-label
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Pagamentos Quitados - crp101aa"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "crp101aa".
...
PROCEDURE enable_UI :
   ...
   DISPLAY  
   i-cod-fornec-ini i-cod-fornec-fim
   da-dt-prev-pag-ini da-dt-prev-pag-fim
   i-portador-ini i-portador-fim
   c-cod-esp-ini c-cod-esp-fim
   i-modalidade-ini i-modalidade-fim
...
PROCEDURE pi-executar :
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "crp101aa" + ".tmp".

    assign tt-param.i-cod-fornec-ini = input frame f-pg-sel i-cod-fornec-ini
           tt-param.i-cod-fornec-fim = input frame f-pg-sel i-cod-fornec-fim
           tt-param.i-cod-fornec-fim = input frame f-pg-sel i-cod-fornec-fim
           tt-param.da-dt-prev-pag-ini = input frame f-pg-sel da-dt-prev-pag-ini
           tt-param.da-dt-prev-pag-fim = input frame f-pg-sel da-dt-prev-pag-fim
           ...
           tt-param.i-modalidade-ini = input frame f-pg-sel i-modalidade-ini
           tt-param.i-modalidade-fim = input frame f-pg-sel i-modalidade-fim.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "crp/crp10127.p".
