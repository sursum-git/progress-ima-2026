/* Programa: cep_emitente_ped.p
**           Verifica validade do Cep do emitente, a partir dos pedidos em aberto.
*/
...
OUTPUT STREAM sai_erro TO c:\temp\cep_invalido.csv CONVERT SOURCE "ibm850".
OUTPUT STREAM sai_ok   TO c:\temp\cep_valido.csv CONVERT SOURCE "ibm850".
