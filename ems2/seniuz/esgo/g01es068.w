...
*******************************************************************************/
{include/i-prgvrs.i G01ES068 2.04.00.000}
...
&Scoped-Define ENABLED-FIELDS acab-tecido.codigo 
...
&Scoped-Define DISPLAYED-FIELDS acab-tecido.codigo 
...
DEFINE FRAME d-vapara
     acab-tecido.codigo AT ROW 1.5 COL 10 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4 BY .88 TOOLTIP "C¢digo do Acabamento de Tecido."
     bt-ok AT ROW 3.13 COL 2.14
     bt-cancela AT ROW 3.13 COL 13
     bt-ajuda AT ROW 3.13 COL 58
     rt-button AT ROW 2.88 COL 1
     SPACE(0.13) SKIP(0.15)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 1
         TITLE "V  Para Acabamentos de Tecidos"
...
ON GO OF FRAME d-vapara /* V  Para Acabamentos de Tecidos */
DO:
  find acab-tecido no-lock 
      where acab-tecido.codigo = input frame {&frame-name} acab-tecido.codigo no-error.
  if  not avail acab-tecido then do:
      {utp/ut-table.i espec acab-tecido 1}
      run utp/ut-msgs.p (input "show":U,
                         input 2,
                         input RETURN-VALUE).
      return no-apply.
  end.
  assign p-row-tabela = rowid(acab-tecido).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Acabamentos de Tecidos */
DO:  
...
------------------------------------------------------------------------------*/
  IF AVAILABLE acab-tecido THEN 
    DISPLAY acab-tecido.codigo 
      WITH FRAME d-vapara.
  ENABLE acab-tecido.codigo bt-ok bt-cancela bt-ajuda rt-button 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "G01ES068" "2.04.00.000"}
