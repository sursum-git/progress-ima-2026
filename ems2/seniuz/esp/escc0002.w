...
*******************************************************************************/
{include/i-prgvrs.i ESCC0002 2.04.00.000}
...
DEFINE VARIABLE tg-situacao1 AS LOGICAL INITIAL yes 
     LABEL "Ativo" 
     VIEW-AS TOGGLE-BOX
     SIZE 11.57 BY .88 NO-UNDO.

DEFINE VARIABLE tg-situacao2 AS LOGICAL INITIAL no 
     LABEL "Obsoleto Ordens Autom ticas" 
     VIEW-AS TOGGLE-BOX
     SIZE 23 BY .88 NO-UNDO.

DEFINE VARIABLE tg-situacao3 AS LOGICAL INITIAL no 
     LABEL "Obbsoleto Todas as Ordens" 
     VIEW-AS TOGGLE-BOX
     SIZE 22 BY .88 NO-UNDO.

DEFINE VARIABLE tg-situacao4 AS LOGICAL INITIAL no 
...
DEFINE FRAME f-pg-par
     tg-situacao1 AT ROW 2.88 COL 27
     tg-situacao2 AT ROW 3.88 COL 27
     tg-situacao3 AT ROW 4.88 COL 27
     tg-situacao4 AT ROW 5.88 COL 27
     tg-imp-param AT ROW 8.92 COL 25.43
     RECT-34 AT ROW 8.5 COL 4
     RECT-35 AT ROW 2.08 COL 4
     "Situa‡äes de Obsoleto" VIEW-AS TEXT
          SIZE 16 BY .88 AT ROW 1.67 COL 31
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 77.14 BY 10.5
...
DEFINE FRAME f-pg-sel
     fi-ini-it-codigo AT ROW 1.25 COL 16.86 COLON-ALIGNED
     fi-fin-it-codigo AT ROW 1.25 COL 44.29 COLON-ALIGNED NO-LABEL
     IMAGE-29 AT ROW 1.25 COL 33.43
     IMAGE-30 AT ROW 1.25 COL 43.14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Ötens com éltima Compra e Varia‡Æo de Pre‡o"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Ötens com éltima Compra e Varia‡Æo de Pre‡o */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Ötens com éltima Compra e Varia‡Æo de Pre‡o */
DO:
...
{utp/ut9000.i "ESCC0002" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY tg-situacao1 tg-situacao2 tg-situacao3 tg-situacao4 tg-imp-param 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE tg-situacao1 tg-situacao2 tg-situacao3 tg-situacao4 tg-imp-param 
         RECT-34 RECT-35 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-par}
  DISPLAY fi-ini-it-codigo fi-fin-it-codigo 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-ini-it-codigo fi-fin-it-codigo IMAGE-29 IMAGE-30 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.situacao1        = INPUT FRAME f-pg-par tg-situacao1
           tt-param.situacao2        = INPUT FRAME f-pg-par tg-situacao2
           tt-param.situacao3        = INPUT FRAME f-pg-par tg-situacao3
           tt-param.situacao4        = INPUT FRAME f-pg-par tg-situacao4
    ...
    {include/i-rprun.i esrp/escc0002rp.p}
