    ...
    */
    ...
    IF lCodigoProdUnificado THEN DO:
        FOR EACH ttPeditemFat:
            IF NUM-ENTRIES(ttPedITemFat.itCodigo,"-") > 1 THEN
            DO:
                ASSIGN ttPedItemFat.codRefer = ENTRY(2,ttPedITemFat.itCodigo,"-")
                       ttPedItemFat.itCodigo = ENTRY(1,ttPedITemFat.itCodigo,"-")
                       .                
            END.
