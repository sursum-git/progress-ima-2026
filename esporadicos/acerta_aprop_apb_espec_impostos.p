...
ASSIGN d = 0
       c = 0.
OUTPUT TO c:\temp\corrigeimpostos.txt.
FOR EACH movto_tit_ap NO-LOCK
   ...
   /* DISP cod_tit_ap cod_espec_docto  dat_transacao ind_trans_ap_abrev ind_motiv_acerto_val.*/
    ...
    FOR EACH aprop_ctbl_ap OF movto_tit_ap
       WHERE cod_cta_ctbl = '19000016'  EXCLUSIVE-LOCK.
       ASSIGN c = c + 1.
       ASSIGN cod_cta_ctbl = '19000005'.
       DISP tit_ap.cod_tit_ap tit_ap.cod_espec_docto tit_ap.dat_transacao .
