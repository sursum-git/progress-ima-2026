...
*******************************************************************************/
{include/i-prgvrs.i ESSP0033 2.04.00.000}
...
ON END-ERROR OF w-consim /* M quinas do Beneficiamento */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-consim w-consim
ON WINDOW-CLOSE OF w-consim /* M quinas do Beneficiamento */
DO:
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es018.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01es018 ).
       RUN set-position IN h_q01es018 ( 1.50 , 66.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0033" "2.04.00.000"}
