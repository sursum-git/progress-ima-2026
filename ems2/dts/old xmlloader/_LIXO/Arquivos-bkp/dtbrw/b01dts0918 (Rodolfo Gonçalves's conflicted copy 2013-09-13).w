...
{include/i-buffer.i}
{utp/ut-glob.i}
{include/i-prgvrs.i B01DTS0918 2.06.00.001}
...
rs-sit-import dt-pesq-ini dt-pesq-fim fi-arquivo-ini fi-arquivo-fim ~
bt-pesquisa br-log btDetalhe 
&Scoped-Define DISPLAYED-OBJECTS rs-sit-import dt-pesq-ini dt-pesq-fim ~
fi-arquivo-ini fi-arquivo-fim 
...
DEFINE FRAME F-Main
     ...
     dt-pesq-ini AT ROW 2.04 COL 22.57 COLON-ALIGNED WIDGET-ID 12
     dt-pesq-fim AT ROW 2.04 COL 42.43 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     fi-arquivo-ini AT ROW 3.04 COL 7 COLON-ALIGNED WIDGET-ID 26
     fi-arquivo-fim AT ROW 3.04 COL 42.43 COLON-ALIGNED NO-LABEL WIDGET-ID 32
     ...
     IMAGE-1 AT ROW 2.04 COL 35.72 WIDGET-ID 8
     IMAGE-2 AT ROW 2.04 COL 41.43 WIDGET-ID 10
     IMAGE-3 AT ROW 3.04 COL 35.72 WIDGET-ID 28
     RECT-17 AT ROW 1.42 COL 74.57 WIDGET-ID 18
     IMAGE-4 AT ROW 3.04 COL 41.43 WIDGET-ID 30
