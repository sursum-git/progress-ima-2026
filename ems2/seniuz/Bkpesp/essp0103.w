...
DEFINE VARIABLE h_q01es050 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v01es050 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 16.88 COL 2.43
     bt-cancela AT ROW 16.88 COL 13.43
     bt-imprime AT ROW 16.88 COL 24.43
     bt-ajuda AT ROW 16.88 COL 78.86
     rt-button AT ROW 16.63 COL 1.43
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡Æo Parƒmetros Revisäes"
         HEIGHT             = 17.13
         WIDTH              = 89.57
         MAX-HEIGHT         = 22
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-cadsim /* Manuten‡Æo Parƒmetros Revisäes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo Parƒmetros Revisäes */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esvwr/v01es050.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v01es050 ).
       RUN set-position IN h_v01es050 ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 15.25 , 88.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esqry/q01es050.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q01es050 ).
       RUN set-position IN h_q01es050 ( 16.75 , 53.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 6.00 ) */

       /* Links to SmartViewer h_v01es050. */
       RUN add-link IN adm-broker-hdl ( h_q01es050 , 'Record':U , h_v01es050 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TABLEIO':U , h_v01es050 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v01es050 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0103" "2.00.04.000"}
