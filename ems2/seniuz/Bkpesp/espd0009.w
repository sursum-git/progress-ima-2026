...
*******************************************************************************/
{include/i-prgvrs.i ESPD0009 2.04.00.000}
...
DEFINE FRAME f-pg-sel
     ...
     fi-ini-dt-entrega AT ROW 2.5 COL 19 COLON-ALIGNED
     fi-fin-dt-entrega AT ROW 2.5 COL 48 COLON-ALIGNED NO-LABEL
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Estat¡stica de Pedidos de Vendas Cancelados"
         COLUMN             = 13.14
         ROW                = 6.83
         HEIGHT             = 15.04
         WIDTH              = 80.72
...
ON END-ERROR OF w-relat /* Estat¡stica de Pedidos de Vendas Cancelados */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Estat¡stica de Pedidos de Vendas Cancelados */
DO:
...
{utp/ut9000.i "ESPD0009" "2.04.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN fi-cod-estabel:SCREEN-VALUE IN FRAME f-pg-sel = "2"
           fi-ini-dt-entrega:SCREEN-VALUE IN FRAME f-pg-sel = STRING(DATE(MONTH(TODAY),1,YEAR(TODAY)),"99/99/9999")
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-cod-estabel fi-nome-estabel fi-ini-dt-entrega fi-fin-dt-entrega 
          fi-ini-ge-codigo fi-fin-ge-codigo 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-cod-estabel fi-ini-dt-entrega fi-fin-dt-entrega fi-ini-ge-codigo 
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/espd0009rp.p} 
