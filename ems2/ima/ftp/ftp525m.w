...
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 21/05/03 - 15:17 - CDIAS
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/
DEFINE BUFFER empresa FOR mgcad.empresa.
define variable c-prog-gerado as character no-undo initial "FTP525M".
...
DEFINE FRAME f-pg-sel
   ...
   da-dt-emis-nota-fim no-label
     at row 1 col 35 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   IMAGE-1 AT ROW 01.00 COL 28
   IMAGE-2 AT ROW 01.00 COL 33
   WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY
   SIDE-LABELS NO-UNDERLINE THREE-D
   AT COL 3 ROW 2.85
   SIZE 76.86 BY 10.62.
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Fechamento de Caixa - ftp525m"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "ftp525m".
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "ftp525m" + ".tmp".
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "ftp/ftp52513.p".
