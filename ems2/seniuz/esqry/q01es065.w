...
*******************************************************************************/
{include/i-prgvrs.i Q01ES065 2.04.00.000}
...
&Scoped-define INTERNAL-TABLES espec.corte-comerc

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH espec.corte-comerc NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH espec.corte-comerc NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main espec.corte-comerc
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main espec.corte-comerc
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "codigo" "espec.corte-comerc" "codigo"}
