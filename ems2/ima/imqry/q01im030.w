...
*******************************************************************************/
{include/i-prgvrs.i Q01IM030 1.00.00.000}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH emitente NO-LOCK ~
    BY emitente.cod-emitente INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH emitente NO-LOCK ~
    BY emitente.cod-emitente INDEXED-REPOSITION.
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgadm.emitente"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _TblOptList       = "USED"
     _OrdList          = "mgadm.emitente.cod-emitente|yes"
...
------------------------------------------------------------------------------*/
  ...
  /*
  DEF VAR i-emitente AS INTEGER.
  i-emitente = i-cod-emitente.
  */
