...
*******************************************************************************/
{include/i-prgvrs.i Q01IN354 2.04.00.000}
...
DEFINE NEW GLOBAL SHARED VAR fi-ini-it-codigo AS CHAR FORMAT "x(16)".
DEFINE NEW GLOBAL SHARED VAR fi-fin-it-codigo AS CHAR FORMAT "x(16)".
...
&Scoped-define INTERNAL-TABLES ref-item

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH ref-item ~
      WHERE ref-item.it-codigo >= fi-ini-it-codigo ~
 AND ref-item.it-codigo <= fi-fin-it-codigo NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH ref-item ~
      WHERE ref-item.it-codigo >= fi-ini-it-codigo ~
 AND ref-item.it-codigo <= fi-fin-it-codigo NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main ref-item
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main ref-item
...
<FOREIGN-KEYS>
it-codigo||y|mgcad.ref-item.it-codigo
cod-refer||y|mgcad.ref-item.cod-refer
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgcad.ref-item"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _Where[1]         = "ref-item.it-codigo >= fi-ini-it-codigo
 AND ref-item.it-codigo <= fi-fin-it-codigo"
