...
DEFINE FRAME d-vapara
     bc-etiqueta.progressivo AT ROW 1.5 COL 26 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 15 BY .88
...
------------------------------------------------------------------------------*/
  IF AVAILABLE bc-etiqueta THEN 
    DISPLAY bc-etiqueta.progressivo 
      WITH FRAME d-vapara.
  ENABLE rt-button bc-etiqueta.progressivo bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
