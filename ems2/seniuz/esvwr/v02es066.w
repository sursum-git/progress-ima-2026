...
mp-mistura.qtd-fardos mp-mistura.tp-mistura 
...
mp-mistura.qtd-bancadas mp-mistura.qtd-fardos mp-mistura.tp-mistura 
...
&Scoped-define ADM-CREATE-FIELDS mp-mistura.nr-mistura 
...
DEFINE FRAME f-main
     mp-mistura.nr-mistura AT ROW 1.17 COL 10 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 13.72 BY .88
     mp-mistura.dt-mistura AT ROW 2.54 COL 10 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12.57 BY .88
     mp-mistura.qtd-bancadas AT ROW 3.54 COL 10 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.57 BY .88
     mp-mistura.qtd-fardos AT ROW 4.54 COL 10 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.57 BY .88
     mp-mistura.tp-mistura AT ROW 5.54 COL 10 COLON-ALIGNED
          VIEW-AS COMBO-BOX 
          LIST-ITEMS "100% Algod∆o","Algod∆o e Retorno (A/R)","Linho","Viscose" 
          DROP-DOWN-LIST
          SIZE 29 BY 1
