...
DEF TEMP-TABLE tt-ped-item LIKE ped-item 
    FIELD r-rowid AS ROWID.
DEF TEMP-TABLE wt-ped-item LIKE ped-item 
    FIELD r-rowid AS ROWID.

DEF TEMP-TABLE tt-ped-repre LIKE ped-repre
    FIELD r-rowid AS ROWID.
DEF TEMP-TABLE wt-ped-repre LIKE ped-repre
    FIELD r-rowid AS ROWID.


DEF TEMP-TABLE tt-cond-ped LIKE cond-ped
    FIELD r-rowid AS ROWID.
DEF TEMP-TABLE wt-cond-ped LIKE cond-ped
    FIELD r-rowid AS ROWID.
...
&Scoped-Define ENABLED-FIELDS pp-container.cod-estabel ~
pp-container.dt-prev-chegada 
&Scoped-define ENABLED-TABLES pp-container
&Scoped-define FIRST-ENABLED-TABLE pp-container
&Scoped-Define ENABLED-OBJECTS im-fecha rt-key 
&Scoped-Define DISPLAYED-FIELDS pp-container.cod-estabel ~
pp-container.nr-container pp-container.dt-prev-chegada 
&Scoped-define DISPLAYED-TABLES pp-container
&Scoped-define FIRST-DISPLAYED-TABLE pp-container
&Scoped-Define DISPLAYED-OBJECTS fi-nome-estab 
...
DEFINE IMAGE im-fecha
     ...
     SIZE 8 BY 2.25 TOOLTIP "Indica se Container j  foi Fechado".
...
DEFINE FRAME f-main
     pp-container.cod-estabel AT ROW 1.25 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5 BY .88
     fi-nome-estab AT ROW 1.25 COL 26.43 COLON-ALIGNED NO-LABEL
     pp-container.nr-container AT ROW 2.25 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9.14 BY .88
     pp-container.dt-prev-chegada AT ROW 2.25 COL 64 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     im-fecha AT ROW 1.25 COL 85.29
...
------------------------------------------------------------------------------*/
    ...
    IF AVAIL pp-container THEN DO.
       ...
       im-fecha:LOAD-IMAGE("image/im-uchk1.bmp") IN FRAME {&FRAME-NAME}.
       IF pp-container.situacao = 3 THEN
          im-fecha:LOAD-IMAGE("image/im-chk1.bmp") IN FRAME {&FRAME-NAME}.
