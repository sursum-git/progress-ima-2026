...
&Scoped-Define ENABLED-OBJECTS fi-nr-ob bt-ok bt-cancela bt-ajuda RECT-1 ~
rt-button 
&Scoped-Define DISPLAYED-OBJECTS fi-nr-ob 
...
DEFINE FRAME d-vapara
     fi-nr-ob AT ROW 1.75 COL 25 COLON-ALIGNED
     bt-ok AT ROW 3.71 COL 2.14
     bt-cancela AT ROW 3.71 COL 13
     bt-ajuda AT ROW 3.71 COL 58
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         FONT 1
         TITLE "V  Para Ordem de Beneficiamento"
...
ON GO OF FRAME d-vapara /* V  Para Ordem de Beneficiamento */
DO:
  FIND FIRST ordem-benefic WHERE
             ordem-benefic.nr-ob = INPUT FRAME {&FRAME-NAME} fi-nr-ob 
             NO-LOCK NO-ERROR.
  IF NOT AVAIL ordem-benefic then do:
     {utp/ut-table.i espec ordem-benefic 1}
     RUN utp/ut-msgs.p (INPUT "show":U,
                        INPUT 2,
                        INPUT RETURN-VALUE).
     RETURN NO-APPLY.
  END.
  ASSIGN p-row-tabela = ROWID(ordem-benefic).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Ordem de Beneficiamento */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY fi-nr-ob 
      WITH FRAME d-vapara.
  ENABLE fi-nr-ob bt-ok bt-cancela bt-ajuda RECT-1 rt-button 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  /*{utp/ut9000.i "G01ES047" "9.99.99.999"}*/
