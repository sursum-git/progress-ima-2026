...
DEFINE VARIABLE h_b01es016 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-ok AT ROW 13.38 COL 2.72
     bt-cancela AT ROW 13.38 COL 13.72
     bt-ajuda AT ROW 13.38 COL 72.29
     rt-button AT ROW 13.13 COL 1.72
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Reservas para Clientes"
         HEIGHT             = 13.54
         WIDTH              = 84.14
         MAX-HEIGHT         = 22.08
         MAX-WIDTH          = 90
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Reservas para Clientes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Reservas para Clientes */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Reservas' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 11.83 , 82.43 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b01es016.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01es016 ).
       RUN set-position IN h_b01es016 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_b01es016. */
       RUN add-link IN adm-broker-hdl ( h_b01es016 , 'State':U , THIS-PROCEDURE ).
