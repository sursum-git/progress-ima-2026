...
&Scoped-define QUERY-STRING-Query-Main FOR EACH set-mec NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH set-mec NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main set-mec
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main set-mec
