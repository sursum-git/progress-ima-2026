...
------------------------------------------------------------------------------*/
    FOR EACH ped-venda WHERE
        ...
        ASSIGN de-qt-pedida = 0             de-qt-reservada = 0
               de-vl-tot-ped = 0            de-vl-aberto = 0 
               de-vl-desconto = 0.
    
        ASSIGN c-situacao = '1,2'.   // Somente Aberto e Atendido Parcial
        FOR EACH ped-item OF ped-venda WHERE
           ...
           FIRST ped-item-ext WHERE
            ...
            ASSIGN de-vl-tot-ped = de-vl-tot-ped + (ped-item.qt-pedida * ped-item.vl-preori).
        ...
        IF NOT AVAIL tt-ped-venda THEN DO:
           ASSIGN de-vl-aberto = de-vl-tot-ped - de-vl-desconto.
           ...
           ASSIGN tt-ped-venda.visualiza    = YES
                  ...
                  tt-ped-venda.vl-tot-ped   = de-vl-tot-ped
