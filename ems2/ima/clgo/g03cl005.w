...
*******************************************************************************/
{include/i-prgvrs.i G03CL005 1.00.00.000}
...
DEFINE FRAME d-vapara
     mgcld.bc-etiqueta.progressivo AT ROW 1.25 COL 11
          LABEL "Nr Etiqueta":R21
          VIEW-AS FILL-IN 
          SIZE 15 BY .88
     bt-ok AT ROW 2.75 COL 2.14
     bt-cancela AT ROW 2.75 COL 13
     bt-ajuda AT ROW 2.75 COL 58
     rt-button AT ROW 2.5 COL 1
...
DO:
  find bc-etiqueta no-lock 
      where bc-etiqueta.progressivo = input frame {&frame-name} bc-etiqueta.progressivo no-error.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "G03CL005" "1.00.00.000"}
