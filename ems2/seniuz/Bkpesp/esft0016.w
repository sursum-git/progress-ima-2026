...
*******************************************************************************/
{include/i-prgvrs.i ESFT0016 2.04.00.000}
...
DEFINE VARIABLE fi-fin-dt-emissao AS DATE FORMAT "99/99/9999" INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 TOOLTIP "Data de emiss∆o final da Nota Fiscal." NO-UNDO.
...
DEFINE VARIABLE fi-ini-dt-emissao AS DATE FORMAT "99/99/9999" INITIAL 01/01/001 
     ...
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 TOOLTIP "Data de emiss∆o inicial da Nota Fiscal." NO-UNDO.
...
DEFINE FRAME f-pg-par
     to-imp-param AT ROW 2.54 COL 27.72
     RECT-27 AT ROW 2 COL 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 77.14 BY 10.5
...
DEFINE FRAME f-pg-sel
     ...
     fi-fin-dt-emissao AT ROW 2.54 COL 42.29 COLON-ALIGNED HELP
     ...
     fi-fin-it-codigo AT ROW 3.54 COL 42.29 COLON-ALIGNED HELP
     ...
     fi-fin-ge-codigo AT ROW 4.54 COL 42.29 COLON-ALIGNED HELP
          "Grupo de estoque a que pertence o item" NO-LABEL
     IMAGE-1 AT ROW 2.54 COL 34.57
     IMAGE-10 AT ROW 3.54 COL 41
     IMAGE-11 AT ROW 4.54 COL 41
     IMAGE-12 AT ROW 4.54 COL 34.57
     IMAGE-2 AT ROW 2.54 COL 41
     IMAGE-9 AT ROW 3.54 COL 34.57
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 4 ROW 3.21
         SIZE 75.86 BY 10.25
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Faturamento por Item/Vencimento"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Faturamento por Item/Vencimento */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Faturamento por Item/Vencimento */
DO:
...
{utp/ut9000.i "ESFT0016" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE fi-cod-estabel fi-ini-dt-emissao fi-fin-dt-emissao fi-ini-it-codigo 
         fi-fin-it-codigo fi-ini-ge-codigo fi-fin-ge-codigo IMAGE-1 IMAGE-10 
         IMAGE-11 IMAGE-12 IMAGE-2 IMAGE-9 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/esft0016rp.p}
