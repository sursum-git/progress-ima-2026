...
&Scoped-define QUERY-STRING-Query-Main FOR EACH pp-container ~
      WHERE pp-container.situacao = i-sit-container NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH pp-container ~
      WHERE pp-container.situacao = i-sit-container NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main pp-container
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main pp-container
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "espec.pp-container.situacao = i-sit-container"
