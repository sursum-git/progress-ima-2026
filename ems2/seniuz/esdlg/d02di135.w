...
*******************************************************************************/
{include/i-prgvrs.i D02DI135 2.04.00.000}
...
&Scoped-Define ENABLED-OBJECTS fi-ini-cod-estabel1 fi-fin-cod-estabel1 ~
fi-ini-serie1 fi-fin-serie1 fi-ini-nr-nota-fis1 fi-fin-nr-nota-fis1 ~
fi-ini-dt-emis-nota1 fi-fin-dt-emis-nota1 bt-ok bt-cancela bt-ajuda IMAGE-1 ~
IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 RECT-1 rt-buttom 
&Scoped-Define DISPLAYED-OBJECTS fi-ini-cod-estabel1 fi-fin-cod-estabel1 ~
fi-ini-serie1 fi-fin-serie1 fi-ini-nr-nota-fis1 fi-fin-nr-nota-fis1 ~
...
DEFINE FRAME D-Dialog
     fi-ini-cod-estabel1 AT ROW 1.42 COL 15.29 COLON-ALIGNED HELP
          "C¢digo do estabelecimento"
     fi-fin-cod-estabel1 AT ROW 1.42 COL 42.29 COLON-ALIGNED HELP
          "C¢digo do estabelecimento" NO-LABEL
     fi-ini-serie1 AT ROW 2.42 COL 15.29 COLON-ALIGNED HELP
          "SÇrie da nota fiscal"
     fi-fin-serie1 AT ROW 2.42 COL 42.29 COLON-ALIGNED HELP
          "SÇrie da nota fiscal" NO-LABEL
     fi-ini-nr-nota-fis1 AT ROW 3.42 COL 15.29 COLON-ALIGNED HELP
          "N£mero da nota fiscal"
     fi-fin-nr-nota-fis1 AT ROW 3.42 COL 42.29 COLON-ALIGNED HELP
          "N£mero da nota fiscal" NO-LABEL
     fi-ini-dt-emis-nota1 AT ROW 4.42 COL 15.29 COLON-ALIGNED HELP
          "Data de emiss∆o da nota fiscal"
     fi-fin-dt-emis-nota1 AT ROW 4.42 COL 42.29 COLON-ALIGNED HELP
          "Data de emiss∆o da nota fiscal" NO-LABEL
     bt-ok AT ROW 6.17 COL 3
     bt-cancela AT ROW 6.17 COL 14
     bt-ajuda AT ROW 6.17 COL 59
     IMAGE-1 AT ROW 1.46 COL 28.86
     IMAGE-2 AT ROW 1.46 COL 40.86
     IMAGE-3 AT ROW 2.46 COL 28.86
     IMAGE-4 AT ROW 2.46 COL 40.86
     IMAGE-5 AT ROW 3.46 COL 28.86
     IMAGE-6 AT ROW 3.46 COL 40.86
     IMAGE-7 AT ROW 4.46 COL 28.86
     IMAGE-8 AT ROW 4.46 COL 40.86
     RECT-1 AT ROW 1.25 COL 2
     rt-buttom AT ROW 5.92 COL 2
     SPACE(0.85) SKIP(0.07)
...
------------------------------------------------------------------------------*/
  DISPLAY fi-ini-cod-estabel1 fi-fin-cod-estabel1 fi-ini-serie1 fi-fin-serie1 
          fi-ini-nr-nota-fis1 fi-fin-nr-nota-fis1 fi-ini-dt-emis-nota1 
          fi-fin-dt-emis-nota1 
      WITH FRAME D-Dialog.
  ENABLE fi-ini-cod-estabel1 fi-fin-cod-estabel1 fi-ini-serie1 fi-fin-serie1 
         fi-ini-nr-nota-fis1 fi-fin-nr-nota-fis1 fi-ini-dt-emis-nota1 
         fi-fin-dt-emis-nota1 bt-ok bt-cancela bt-ajuda IMAGE-1 IMAGE-2 IMAGE-3 
         IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 RECT-1 rt-buttom 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "D02DI135" "2.04.00.000"}
  ...
  ASSIGN fi-ini-cod-estabel1:SCREEN-VALUE IN FRAME {&FRAME-NAME} = fi-ini-cod-estabel
