...
*******************************************************************************/
{include/i-prgvrs.i V01es020 2.04.00.000}
...
DO:
  ...
  RUN pi-select-page IN h-essp0199 (INPUT 2).

  RUN pi-processa IN h-b03es0020 (INPUT fi-dt-limite, 
...
&Scoped-define SELF-NAME rt-key
...
------------------------------------------------------------------------------*/
  ASSIGN fi-dt-limite:SCREEN-VALUE IN FRAME {&FRAME-NAME}        = STRING(MONTH(TODAY),'99') +
         ...
         fi-it-codigo-fin:SCREEN-VALUE IN FRAME {&FRAME-NAME}    = '699999'
