...
FOR EACH tt50:
    FIND FIRST tt51 WHERE tt51.conta = tt50.conta
        NO-LOCK NO-ERROR.
    IF NOT AVAIL tt51 THEN DO:
       FOR EACH ttMatriz
           WHERE ttMatriz.conta = tt50.conta NO-LOCK.
           CREATE tt51.
           ASSIGN tt51.conta = tt50.Conta
                  tt51.contaRef  = ttMatriz.contaref
                  tt51.cc = ''
                  tt51.linha = '|J051||' + ttmatriz.contaRef + "|".
       END.
    END.
END.
...
FOR EACH tt50:
    EXPORT tt50.linha.
    FOR EACH tt51
        WHERE tt51.conta = tt50.conta BREAK BY tt51.cc.
        IF LAST-OF(tt51.cc) THEN
           EXPORT tt51.linha.
    END.
END.
