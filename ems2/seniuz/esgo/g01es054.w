...
*******************************************************************************/
{include/i-prgvrs.i G01ES054 2.04.00.000}
...
&Scoped-Define ENABLED-FIELDS mp-coloracao.codigo 
&Scoped-define ENABLED-TABLES mp-coloracao
&Scoped-define FIRST-ENABLED-TABLE mp-coloracao
&Scoped-Define ENABLED-OBJECTS bt-ok bt-cancela bt-ajuda rt-button 
&Scoped-Define DISPLAYED-FIELDS mp-coloracao.codigo 
&Scoped-define DISPLAYED-TABLES mp-coloracao
&Scoped-define FIRST-DISPLAYED-TABLE mp-coloracao
...
DEFINE FRAME d-vapara
     mp-coloracao.codigo AT ROW 1.58 COL 25 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 8.86 BY .79 TOOLTIP "C¢digo da coloraá∆o."
     bt-ok AT ROW 3.08 COL 2.14
     bt-cancela AT ROW 3.08 COL 13
     bt-ajuda AT ROW 3.08 COL 58
     rt-button AT ROW 2.83 COL 1
     SPACE(0.13) SKIP(0.07)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 1
         TITLE "V† Para Coloraá∆o de Algod∆o"
...
ON GO OF FRAME d-vapara /* V† Para Coloraá∆o de Algod∆o */
DO:
  find mp-coloracao no-lock 
      where mp-coloracao.codigo = input frame {&frame-name} mp-coloracao.codigo no-error.
  if  not avail mp-coloracao then do:
      {utp/ut-table.i espec mp-coloracao 1}
      run utp/ut-msgs.p (input "show":U,
                         input 2,
                         input RETURN-VALUE).
      return no-apply.
  end.
  assign p-row-tabela = rowid(mp-coloracao).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V† Para Coloraá∆o de Algod∆o */
DO:  
...
------------------------------------------------------------------------------*/
  IF AVAILABLE mp-coloracao THEN 
    DISPLAY mp-coloracao.codigo 
      WITH FRAME d-vapara.
  ENABLE mp-coloracao.codigo bt-ok bt-cancela bt-ajuda rt-button 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "G01ES054" "2.04.00.000"}
