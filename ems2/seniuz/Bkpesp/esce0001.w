...
*******************************************************************************/
{include/i-prgvrs.i ESCE0001 2.04.00.000} 
...
DEFINE VARIABLE fi-fin-cod-obsoleto AS INTEGER FORMAT ">9" INITIAL 4 
     VIEW-AS FILL-IN 
     SIZE 3 BY .88 TOOLTIP "1=Ativo, 2=Ordens Autom ticas, 3=Todas Ordens, 4=Tot.Obsoleto" NO-UNDO.
...
DEFINE FRAME f-pg-sel
     ...
     fi-ini-ge-codigo AT ROW 2.54 COL 15.29 COLON-ALIGNED HELP
          "Grupo de estoque a que pertence o item"
     fi-fin-ge-codigo AT ROW 2.54 COL 44.29 COLON-ALIGNED HELP
          "Grupo de estoque a que pertence o item" NO-LABEL
     fi-ini-it-codigo AT ROW 3.54 COL 15.29 COLON-ALIGNED
     fi-fin-it-codigo AT ROW 3.54 COL 44.29 COLON-ALIGNED NO-LABEL
     fi-ini-cod-obsoleto AT ROW 4.54 COL 15.29 COLON-ALIGNED
     fi-fin-cod-obsoleto AT ROW 4.54 COL 44.29 COLON-ALIGNED NO-LABEL
     fi-periodo-ini AT ROW 5.54 COL 15.29 COLON-ALIGNED
     fi-periodo-fim AT ROW 5.54 COL 44.29 COLON-ALIGNED NO-LABEL
     IMAGE-1 AT ROW 3.54 COL 32
     IMAGE-11 AT ROW 5.54 COL 32
     IMAGE-12 AT ROW 4.54 COL 42.72
     IMAGE-15 AT ROW 4.54 COL 32
     IMAGE-16 AT ROW 3.54 COL 42.72
     IMAGE-2 AT ROW 5.54 COL 42.72
     IMAGE-67 AT ROW 2.54 COL 32
     IMAGE-68 AT ROW 2.54 COL 42.72
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
DEFINE FRAME f-pg-par
     tg-all-depos AT ROW 1.75 COL 19
     fi-cod-depos1 AT ROW 2.54 COL 17 COLON-ALIGNED NO-LABEL
     fi-cod-depos2 AT ROW 2.54 COL 21.72 COLON-ALIGNED NO-LABEL
     fi-cod-depos3 AT ROW 2.54 COL 26.43 COLON-ALIGNED NO-LABEL
     fi-cod-depos4 AT ROW 2.54 COL 31.14 COLON-ALIGNED NO-LABEL
     fi-cod-depos5 AT ROW 2.54 COL 35.86 COLON-ALIGNED NO-LABEL
     fi-cod-depos6 AT ROW 2.54 COL 40.57 COLON-ALIGNED NO-LABEL
     fi-cod-depos7 AT ROW 2.54 COL 45.29 COLON-ALIGNED NO-LABEL
     fi-cod-depos8 AT ROW 2.54 COL 50 COLON-ALIGNED NO-LABEL
     fi-cod-depos9 AT ROW 2.54 COL 54.72 COLON-ALIGNED NO-LABEL
     fi-cod-depos10 AT ROW 2.54 COL 59.29 COLON-ALIGNED NO-LABEL
     fi-desc-depos AT ROW 3.54 COL 17 COLON-ALIGNED
     cb-esp-docto1 AT ROW 5.75 COL 1.86 COLON-ALIGNED NO-LABEL
     cb-esp-docto2 AT ROW 5.75 COL 9 COLON-ALIGNED NO-LABEL
     cb-esp-docto3 AT ROW 5.75 COL 16.14 COLON-ALIGNED NO-LABEL
     cb-esp-docto4 AT ROW 5.75 COL 23.29 COLON-ALIGNED NO-LABEL
     cb-esp-docto5 AT ROW 5.75 COL 30.43 COLON-ALIGNED NO-LABEL
     cb-esp-docto6 AT ROW 5.75 COL 37.57 COLON-ALIGNED NO-LABEL
     cb-esp-docto7 AT ROW 5.75 COL 44.72 COLON-ALIGNED NO-LABEL
     cb-esp-docto8 AT ROW 5.75 COL 51.86 COLON-ALIGNED NO-LABEL
     cb-esp-docto9 AT ROW 5.75 COL 59 COLON-ALIGNED NO-LABEL
     cb-esp-docto10 AT ROW 5.75 COL 66.14 COLON-ALIGNED NO-LABEL
     tg-gerar-excel AT ROW 8.13 COL 6.14
     fi-arq-excel AT ROW 8.13 COL 31 COLON-ALIGNED
     to-imp-param AT ROW 10.21 COL 26.57
     "Planilha para Excel" VIEW-AS TEXT
          SIZE 13.57 BY .54 AT ROW 7.29 COL 29.14
     "Esp‚cies de Documentos" VIEW-AS TEXT
          SIZE 18 BY .54 AT ROW 5 COL 29.14
     "Dep¢sitos" VIEW-AS TEXT
          SIZE 7.57 BY .63 AT ROW 1.21 COL 9.43
     RECT-14 AT ROW 1.54 COL 2.43
     RECT-25 AT ROW 10.04 COL 2.43
     RECT-29 AT ROW 7.58 COL 2.43
     RECT-40 AT ROW 5.29 COL 2.43
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 75 BY 10.54
...
/* SETTINGS FOR FILL-IN fi-nome-estabel IN FRAME f-pg-sel
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN fi-periodo-fim IN FRAME f-pg-sel
   NO-ENABLE                                                            */
...
ON END-ERROR OF w-relat /* Consumo de Itens */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Consumo de Itens */
DO:
...
DO:
  ASSIGN fi-periodo-fim:SCREEN-VALUE = IF SUBSTR(SELF:SCREEN-VALUE,6,2) = "01"
...
{utp/ut9000.i "ESCE0001" "2.04.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN cb-esp-docto1:LIST-ITEMS IN FRAME f-pg-par = c-especies
           ...
           cb-esp-docto1:SCREEN-VALUE IN FRAME f-pg-par = "REQ"
           cb-esp-docto2:SCREEN-VALUE IN FRAME f-pg-par = "RRQ"
           cb-esp-docto3:SCREEN-VALUE IN FRAME f-pg-par = "DEV".


    ASSIGN fi-periodo-ini:SCREEN-VALUE IN FRAME f-pg-sel = STRING(YEAR(TODAY) - 1) + STRING(MONTH(TODAY),"99").
    ASSIGN fi-periodo-fim:SCREEN-VALUE IN FRAME f-pg-sel = IF STRING(MONTH(TODAY)) = "01"
                                                           THEN STRING(YEAR(TODAY)) + "12" 
                                                           ELSE STRING(YEAR(TODAY) ) +  STRING(INT(MONTH(TODAY) - 1),"99").
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-cod-estabel fi-nome-estabel fi-ini-ge-codigo fi-fin-ge-codigo 
          fi-ini-it-codigo fi-fin-it-codigo fi-ini-cod-obsoleto 
          fi-fin-cod-obsoleto fi-periodo-ini fi-periodo-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-11 IMAGE-12 IMAGE-15 IMAGE-16 IMAGE-2 IMAGE-67 IMAGE-68 
         fi-cod-estabel fi-ini-ge-codigo fi-fin-ge-codigo fi-ini-it-codigo 
         fi-fin-it-codigo fi-ini-cod-obsoleto fi-fin-cod-obsoleto 
         fi-periodo-ini 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY tg-all-depos fi-cod-depos1 fi-cod-depos2 fi-cod-depos3 fi-cod-depos4 
          ...
          cb-esp-docto9 cb-esp-docto10 tg-gerar-excel fi-arq-excel to-imp-param 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-14 RECT-25 RECT-29 RECT-40 tg-all-depos cb-esp-docto1 
         cb-esp-docto2 cb-esp-docto3 cb-esp-docto4 cb-esp-docto5 cb-esp-docto6 
         cb-esp-docto7 cb-esp-docto8 cb-esp-docto9 cb-esp-docto10 
         tg-gerar-excel to-imp-param 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
*/    
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.fi-periodo-ini   = INPUT FRAME f-pg-sel fi-periodo-ini     
           tt-param.fi-periodo-fim   = INPUT FRAME f-pg-sel fi-periodo-fim
    ...
    ASSIGN i-data[1] = tt-param.fi-periodo-ini.
    DO i-cont = 2 TO 12:
    ...
    {include/i-rprun.i esrp/esce0001rp.p}
