OUTPUT TO c:\temp\movto_tit_Acr_juros.txt.
FOR EACH movto_tit_acr NO-LOCK
    WHERE dat_transacao >= 02/26/2015 AND val_juros <> 0
    AND   dat_transacao <= 02/27/2015.
    FIND FIRST tit_acr OF movto_tit_acr NO-LOCK NO-ERROR.
    DISP movto_tit_acr.cod_empresa movto_tit_acr.cod_estab movto_tit_acr.cod_espec_docto cod_tit_acr cod_parcela movto_tit_acr.cdn_cliente movto_tit_acr.dat_vencto_tit_acr
