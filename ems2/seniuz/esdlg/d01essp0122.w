...
*******************************************************************************/
{include/i-prgvrs.i D01ESSP0122 2.04.00.000}
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "D01ESSP0122" "2.04.00.000"}
  ...
  ASSIGN fi-arq-saida:SCREEN-VALUE IN FRAME {&FRAME-NAME} = SESSION:TEMP-DIRECTORY + "Posi‡Æo Estoque de Fardos.xls".
