...
*******************************************************************************/
{include/i-prgvrs.i ESSP0010 2.04.00.000}
...
ON END-ERROR OF w-consim /* Testes de Amostras */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-consim w-consim
ON WINDOW-CLOSE OF w-consim /* Testes de Amostras */
DO:
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es029.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01es029 ).
       RUN set-position IN h_q01es029 ( 1.75 , 67.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0010" "2.04.00.000"}
