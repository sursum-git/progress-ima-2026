...
&Scoped-Define ENABLED-OBJECTS rt-button bt-pri 
...
DEFINE FRAME f-cad
     bt-pri AT ROW 1.38 COL 60.86 WIDGET-ID 2
     rt-button AT ROW 1.21 COL 1.57
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 90 BY 14.79 WIDGET-ID 100.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-pri w-cadsim
ON CHOOSE OF bt-pri IN FRAME f-cad
DO:
   RUN pi-imprime IN h_v01es049.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v01es049 ).
       RUN set-position IN h_v01es049 ( 2.75 , 1.86 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es049.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q04es049 ).
       RUN set-position IN h_q04es049 ( 1.21 , 66.86 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_v01es049 ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0135" "2.04.00.001"}
  ...
  {esinc/valida-acesso.i}
  
  MESSAGE 'Esse programa foi descontinuado. Favor utilizar a versÆo Web atrav‚s do portal de acesso'
      VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
  OS-COMMAND SILENT VALUE('start https://imaonline.imatextil.com.br/portal_acesso_2/app_ldap_Login').
  //OS-COMMAND
  RUN local-exit.
