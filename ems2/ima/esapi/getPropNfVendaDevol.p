/*************************************************
programa: esapi/getPropNfVendaDevol.p
...
DEFINE INPUT-OUTPUT PARAMETER dPropDevol   AS DECIMAL     NO-UNDO.
...
IF AVAIL devol-cli THEN DO:
    ...
    IF AVAIL it-nota-fisc THEN DO:
       ASSIGN dPropDevol = devol-cli.qt-devolvida / it-nota-fisc.qt-faturada[1] .
    END.                                         
END.
ELSE DO:
    FIND item-doc-est 
    ...
    IF AVAIL item-doc-est THEN DO:
       ...
       FIND it-nota-fisc 
        ...
        NO-LOCK NO-ERROR. 
        IF AVAIL it-nota-fisc THEN DO:
           ASSIGN dPropDevol = item-doc-est.quantidade / it-nota-fisc.qt-faturada[1] .
        END.
    END.
    ELSE DO:
        RETURN 'nok'.
