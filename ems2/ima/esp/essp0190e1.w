...
*******************************************************************************/
{include/i-prgvrs.i ESSP0190E1 2.04.00.000}
...
&GLOBAL-DEFINE SORTBY-PHRASE BY IF sort-col = 1 ~
                                ...
                                ELSE IF sort-col = 2 ~
                                    ...
                                    ELSE IF sort-col = 3 ~
                                         THEN tt-work.und + STRING(tt-work.cod-rep, ">>>>>9") ~
                                        ELSE IF sort-col = 4 ~
...
&GLOBAL-DEFINE SORTBY-IMP-EXCEL BY IF sort-col = 1 ~
                                   ...
                                   ELSE IF sort-col = 2 ~
                                       ...
                                       ELSE IF sort-col = 3 ~
                                            THEN b-tt-work.und + STRING(b-tt-work.cod-rep, ">>>>>9") ~
                                           ELSE IF sort-col = 4 ~
...
&Scoped-define FIELDS-IN-QUERY-br-work tt-work.cod-rep tt-work.no-ab-reppri tt-work.und tt-work.qtd tt-work.vlr tt-work.desc-pratic tt-work.preco-medio tt-work.qtd-devol tt-work.vlr-devol   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-work tt-work.cod-rep   tt-work.no-ab-reppri   tt-work.und   tt-work.qtd   tt-work.vlr   tt-work.desc-pratic   tt-work.preco-medio   tt-work.qtd-devol   tt-work.vlr-devol   
...
bt-imprime bt-total-rep bt-exit bt-ok bt-cancela bt-ajuda 
...
fi-tot-qtd-dev-und fi-tot-vlr-dev-und fi-tot-geral fi-ger-vlr-dev 
...
DEFINE BUTTON bt-total-rep 
     IMAGE-UP FILE "image/imt-total.bmp":U
     LABEL "Button 1" 
     SIZE 15 BY 1.13 TOOLTIP "Totaliza os Valores do Representante".
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 120.43 BY 11.92
         FONT 1
...
DEFINE FRAME D-Dialog
     ...
     bt-vapara AT ROW 1.38 COL 123.14
     bt-excel AT ROW 2.92 COL 123.14
     bt-imprime AT ROW 4.5 COL 123.14
     fi-tot-qtd-m AT ROW 13.08 COL 45.72 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-m AT ROW 13.08 COL 57.86 COLON-ALIGNED NO-LABEL
     fi-tot-desc-m AT ROW 13.08 COL 70.14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     fi-media-m AT ROW 13.08 COL 81.72 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-dev-m AT ROW 13.08 COL 93.57 COLON-ALIGNED NO-LABEL
     fi-tot-vlr-dev-m AT ROW 13.08 COL 105.72 COLON-ALIGNED NO-LABEL
     bt-total-rep AT ROW 13.25 COL 4 WIDGET-ID 8
     fi-tot-qtd-kg AT ROW 14.08 COL 45.72 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-kg AT ROW 14.08 COL 57.86 COLON-ALIGNED NO-LABEL
     fi-tot-desc-kg AT ROW 14.08 COL 70.14 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     fi-media-kg AT ROW 14.08 COL 81.72 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-dev-kg AT ROW 14.08 COL 93.57 COLON-ALIGNED NO-LABEL
     fi-tot-vlr-dev-kg AT ROW 14.08 COL 105.72 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-und AT ROW 15.08 COL 45.72 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-und AT ROW 15.08 COL 57.86 COLON-ALIGNED NO-LABEL
     fi-tot-desc-und AT ROW 15.08 COL 70.14 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     fi-media-und AT ROW 15.08 COL 81.72 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-dev-und AT ROW 15.08 COL 93.57 COLON-ALIGNED NO-LABEL
     fi-tot-vlr-dev-und AT ROW 15.08 COL 105.72 COLON-ALIGNED NO-LABEL
     fi-tot-geral AT ROW 16.29 COL 57.86 COLON-ALIGNED NO-LABEL
     fi-ger-vlr-dev AT ROW 16.29 COL 105.72 COLON-ALIGNED NO-LABEL
     bt-exit AT ROW 16.83 COL 123.14
     bt-ok AT ROW 17.58 COL 2.57
     bt-cancela AT ROW 17.58 COL 13.57
     bt-ajuda AT ROW 17.58 COL 110.57
     "TOTAL GERAL:" VIEW-AS TEXT
          SIZE 11.29 BY .71 AT ROW 16.38 COL 48.14
          FGCOLOR 4 
     "TOTAIS:" VIEW-AS TEXT
          SIZE 6.72 BY .88 AT ROW 13.17 COL 37.86
          FONT 0
     "M" VIEW-AS TEXT
          SIZE 1.57 BY .54 AT ROW 13.33 COL 45.86
          FGCOLOR 12 
     "KG" VIEW-AS TEXT
          SIZE 2 BY .54 AT ROW 14.29 COL 45.14
          FGCOLOR 12 
     "UND" VIEW-AS TEXT
          SIZE 3.29 BY .54 AT ROW 15.17 COL 44
          FGCOLOR 12 
     RECT-1 AT ROW 1.08 COL 122.57
     rt-buttom AT ROW 17.33 COL 1.57
     SPACE(7.70) SKIP(0.03)
...
&Scoped-define SELF-NAME bt-total-rep
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-total-rep D-Dialog
ON CHOOSE OF bt-total-rep IN FRAME D-Dialog /* Button 1 */
DO:
    RUN esp/essp0190E1a.w (INPUT TABLE tt-work,
                           INPUT c-titulo).
END.
...
/* ***************************  Main Block  *************************** */
 ASSIGN FRAME d-dialog:TITLE = "Totais Dos Representantes  -  ESSP0190E1".
...
------------------------------------------------------------------------------*/
  DISPLAY fi-tot-qtd-m fi-tot-vlr-m fi-tot-desc-m fi-media-m fi-tot-qtd-dev-m 
          ...
          fi-tot-vlr-dev-und fi-tot-geral fi-ger-vlr-dev 
      WITH FRAME D-Dialog.
  ENABLE br-work RECT-1 rt-buttom bt-vapara bt-excel bt-imprime bt-total-rep 
...
------------------------------------------------------------------------------*/
    ...
    PUT "CODIGO  NOME DO REPRESENTANTE                    UND    QUANTIDADE          VALOR    DESC PRATIC   PRECO MEDIO  QTD DEVOLUÄ«O  VLR DEVOLUÄ«O" AT 1.
    PUT "------  ---------------------------------------  ---  ------------   ------------   ------------   -----------  -------------  -------------" AT 1.
...
/*          PUT CONTROL "~033&l1O~033(s16H". /* ORIENTAÄ«O PAISAGEM & COMPACTA */  */
  ...
  DO i-ct = 1 TO i-num-copias.
     ...
     ASSIGN fi-tot-qtd-dev-m  = 0 fi-tot-qtd-m      = 0 fi-tot-vlr-m       = 0 fi-tot-qtd-kg      = 0 
            fi-tot-vlr-dev-m  = 0 fi-tot-vlr-kg     = 0 fi-tot-qtd-und     = 0 fi-tot-vlr-und     = 0
     ...
     PUT fi-tot-qtd-m    FORMAT "->,>>>,>>9.99"  AT  54
         ...
         fi-tot-vlr-m    FORMAT "->,>>>,>>9.99"  AT  84.
     IF (fi-tot-qtd-m + fi-tot-vlr-m) > 0  THEN
     PUT (fi-tot-vlr-m / 
     ...
     PUT fi-tot-qtd-kg    FORMAT "->,>>>,>>9.99"  AT  54
         ...
         fi-tot-vlr-kg    FORMAT "->,>>>,>>9.99"  AT  84.
     IF (fi-tot-qtd-kg + fi-tot-vlr-kg) > 0 THEN
     PUT (fi-tot-vlr-kg / 
     ...
     PUT fi-tot-qtd-und    FORMAT "->,>>>,>>9.99"  AT  54
         ...
         fi-tot-vlr-und    FORMAT "->,>>>,>>9.99"  AT  84.
     IF (fi-tot-qtd-und + fi-tot-vlr-und) > 0 THEN
     PUT (fi-tot-vlr-und / 
...
ASSIGN fi-tot-qtd-dev-m   = 0 fi-tot-qtd-m     = 0 fi-tot-vlr-m      = 0 fi-tot-qtd-kg      = 0 
       fi-tot-qtd-dev-kg  = 0 fi-tot-vlr-kg    = 0 fi-tot-qtd-und    = 0 fi-tot-vlr-und     = 0
       fi-tot-qtd-dev-und = 0 fi-tot-vlr-dev-m = 0 fi-tot-vlr-dev-kg = 0 fi-tot-vlr-dev-und = 0
       fi-tot-desc-m      = 0 fi-tot-desc-kg   = 0 fi-tot-desc-und   = 0.
...
ASSIGN FRAME {&FRAME-NAME}:VISIBLE = NO.
 ...
 FOR EACH tt-trab WHERE
     tt-trab.no-ab-reppri <> "" AND
     tt-trab.uf         = "ZZ" NO-LOCK.
     FIND repres WHERE
          repres.nome-abrev = tt-trab.no-ab-reppri NO-LOCK NO-ERROR.
     CREATE tt-work.
     ASSIGN tt-work.cod-rep      = repres.cod-rep
