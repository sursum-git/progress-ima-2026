...
*******************************************************************************/
{include/i-prgvrs.i ESSP0023 2.04.00.000}
...
ON END-ERROR OF w-consim /* Testes de Pick-Up */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-consim w-consim
ON WINDOW-CLOSE OF w-consim /* Testes de Pick-Up */
DO:
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es034.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01es034 ).
       RUN set-position IN h_q01es034 ( 1.25 , 51.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0023" "2.04.00.000"}
