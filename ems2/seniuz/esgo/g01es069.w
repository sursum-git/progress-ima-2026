...
*******************************************************************************/
{include/i-prgvrs.i G01ES069 2.04.00.000}
...
&Scoped-Define ENABLED-FIELDS qualid-tecido.codigo 
...
DEFINE FRAME d-vapara
     qualid-tecido.codigo AT ROW 1.54 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4 BY .88 TOOLTIP "C¢digo do Tipo de Qualidade de Tecido."
          FONT 1
     bt-ok AT ROW 3.33 COL 2.14
     bt-cancela AT ROW 3.33 COL 13
     bt-ajuda AT ROW 3.33 COL 58
     rt-button AT ROW 3.08 COL 1
     SPACE(0.13) SKIP(0.16)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 1
         TITLE "V  Para Tipo de Qualidade de Tecido"
...
ON GO OF FRAME d-vapara /* V  Para Tipo de Qualidade de Tecido */
DO:
  find qualid-tecido no-lock 
      where qualid-tecido.codigo = input frame {&frame-name} qualid-tecido.codigo no-error.
  if  not avail qualid-tecido then do:
      {utp/ut-table.i espec qualid-tecido 1}
      run utp/ut-msgs.p (input "show":U,
                         input 2,
                         input RETURN-VALUE).
      return no-apply.
  end.
  assign p-row-tabela = rowid(qualid-tecido).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Tipo de Qualidade de Tecido */
DO:  
...
------------------------------------------------------------------------------*/
  IF AVAILABLE qualid-tecido THEN 
    DISPLAY qualid-tecido.codigo 
      WITH FRAME d-vapara.
  ENABLE qualid-tecido.codigo bt-ok bt-cancela bt-ajuda rt-button 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "G01ES069" "2.04.00.000"}
