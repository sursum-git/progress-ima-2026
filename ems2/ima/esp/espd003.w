...
*******************************************************************************/
{include/i-prgvrs.i espd003 9.99.99.999}
...
DEFINE VARIABLE fiPedWebFim AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 9999999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fiPedWebIni AS INTEGER FORMAT ">>>,>>>,>>9":U INITIAL 0 
     LABEL "Pedido Web" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     fiPedWebIni AT ROW 1.25 COL 15 COLON-ALIGNED
     fiPedWebFim AT ROW 1.25 COL 48.14 COLON-ALIGNED NO-LABEL
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Atualizaá∆o Situaá∆o Pedidos Web"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 41.33
         MAX-WIDTH          = 274.29
...
ON END-ERROR OF w-relat /* Atualizaá∆o Situaá∆o Pedidos Web */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Atualizaá∆o Situaá∆o Pedidos Web */
DO:
...
{utp/ut9000.i "espd003" "9.99.99.999"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN rs-destino:SCREEN-VALUE IN FRAME f-pg-imp = '2' 
           c-arquivo:SCREEN-VALUE IN FRAME f-pg-imp = "espd003-" + STRING(TIME) + '-'
           + c-seg-usuario + ".txt" .
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fiPedWebIni fiPedWebFim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 fiPedWebIni fiPedWebFim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    create tt-param.
    assign 
           tt-param.pedWebIdIni     = INPUT FRAME f-pg-sel fiPedwebIni
           tt-param.pedWebIdFim     = INPUT FRAME f-pg-sel fiPedwebFim
    ...
    {include/i-rprun.i esrp/espd003rp.p}
