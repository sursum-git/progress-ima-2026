...
DEFINE VARIABLE h_b01es039 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b02es039 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     ...
     bt-cancela AT ROW 15.17 COL 14
     bt-ajuda AT ROW 15.17 COL 79
     rt-button AT ROW 14.92 COL 2
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Tipos de Embalagens"
         HEIGHT             = 15.42
         WIDTH              = 90
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 90
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Tipos de Embalagens */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Tipos de Embalagens */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Tipo|Descri‡Æo' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b01es039.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01es039 ).
       RUN set-position IN h_b01es039 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.17 , 87.57 ) */

       /* Links to SmartBrowser h_b01es039. */
       RUN add-link IN adm-broker-hdl ( h_b01es039 , 'State':U , THIS-PROCEDURE ).

    END. /* Page 1 */

    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b02es039.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b02es039 ).
       RUN set-position IN h_b02es039 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.17 , 87.57 ) */

       /* Links to SmartBrowser h_b02es039. */
       RUN add-link IN adm-broker-hdl ( h_b02es039 , 'State':U , THIS-PROCEDURE ).
