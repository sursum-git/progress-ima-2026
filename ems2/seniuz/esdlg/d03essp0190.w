...
DEFINE OUTPUT PARAMETER p-arq-saida AS CHAR FORMAT "x(65)".
...
DEFINE VARIABLE fi-arq-saida AS CHARACTER FORMAT "X(65)":U 
     LABEL "Arquivo Sa¡da" 
     VIEW-AS FILL-IN 
     SIZE 53.86 BY .88 TOOLTIP "Caminho/nome do arquivo de sa¡da."
     FONT 1 NO-UNDO.
...
DO:
  IF NOT fi-arq-saida:SCREEN-VALUE IN FRAME {&FRAME-NAME} MATCHES "*.xls*" THEN DO:
     ...
     ASSIGN fi-arq-saida:SCREEN-VALUE IN FRAME {&FRAME-NAME} = SESSION:TEMP-DIRECTORY + p-titulo + ".xls".
     RETURN NO-APPLY.
  END.
END.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "D03ESSP0190" "2.04.00.000"}
