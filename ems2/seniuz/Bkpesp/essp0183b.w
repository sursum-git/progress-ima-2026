...
DO:
   ...
   FOR EACH tt-ped-venda WHERE
       ...
       IF c-destinatario = "" THEN DO:
          ...
          RETURN NO-APPLY.
       END.
       ASSIGN c-destinatario = c-destinatario + "," + "faturamento.med@imatextil.com.br".
       ...
       ASSIGN de-vl-aberto = tt-ped-venda.vl-aberto        /*    daf   */
              de-vl-desconto = tt-ped-venda.vl-desconto.   /*    daf   */

       IF ped-venda-ext.cod-estabel = "5" THEN
          RUN pi-email-med.
       ELSE
          RUN pi-email-ima.
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN c-mensagem = "PEDIDO ∑ VISTA Nß " + tt-ped-venda.nr-pedcli + CHR(13) +
       ...
       ASSIGN c-mensagem = c-mensagem + CHR(13) +
                           ...
                           "     BANCO BRADESCO: AG.6348-7 C/C:31332-7."    + CHR(13) +
       ...
       IF tt-ped-venda.vl-desconto > 0  THEN
          ASSIGN c-mensagem = c-mensagem + CHR(13) + CHR(13) +
                              ...
                              "     BANCO BRADESCO: AG.6348-7 C/C:47154-2."    + CHR(13) +
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pi-email-med w-digita 
PROCEDURE pi-email-med :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
ASSIGN c-mensagem = "PEDIDO ∑ VISTA Nß " + tt-ped-venda.nr-pedcli + CHR(13) +
       ...
       ASSIGN c-mensagem = c-mensagem + CHR(13) +
                           ...
                           "     BANCO BRADESCO: AG.6348-7 C/C:31333-5."    + CHR(13) +
                           "     BANCO ITAÈ: AG.1403 C/C:26917-6."    + CHR(13).
       ...
       IF tt-ped-venda.vl-desconto > 0  THEN
          ASSIGN c-mensagem = c-mensagem + CHR(13) + CHR(13) +
                              ...
                              "     BANCO BRADESCO: AG.6348-7 C/C:926-1."    + CHR(13) +
                              "     BANCO ITAÈ: AG.3054 C/C:09274-1."    + CHR(13).
