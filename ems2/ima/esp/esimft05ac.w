...
*******************************************************************************/
{include/i-prgvrs.i esimft05ac 2.06.00.001}
...
DEFINE FRAME f-pg-sel
     ...
     fi-ge-codigo-ini AT ROW 6.08 COL 19 COLON-ALIGNED WIDGET-ID 14
     fi-ge-codigo-fim AT ROW 6.08 COL 44 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     fi-dt-trans-ini AT ROW 7.08 COL 19 COLON-ALIGNED WIDGET-ID 4
     fi-dt-trans-fim AT ROW 7.08 COL 44 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     tgSoFaturaveis AT ROW 9.75 COL 21 WIDGET-ID 46
     IMAGE-1 AT ROW 5 COL 37
     IMAGE-2 AT ROW 5 COL 42.29
     IMAGE-9 AT ROW 7.04 COL 37 WIDGET-ID 6
     IMAGE-10 AT ROW 7.04 COL 42.29 WIDGET-ID 8
     IMAGE-11 AT ROW 6.04 COL 37 WIDGET-ID 18
     IMAGE-12 AT ROW 6.04 COL 42.29 WIDGET-ID 16
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Saldos de Produtos por Periodo"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Saldos de Produtos por Periodo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Saldos de Produtos por Periodo */
DO:
...
{utp/ut9000.i "esimft05ac" "2.06.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-cod-estab-ini fi-cod-estab-fim fi-it-codigo-ini fi-it-codigo-fim 
          fi-ge-codigo-ini fi-ge-codigo-fim fi-dt-trans-ini fi-dt-trans-fim 
          tgSoFaturaveis 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-9 IMAGE-10 IMAGE-11 IMAGE-12 IMAGE-15 IMAGE-16 
         fi-cod-estab-ini fi-cod-estab-fim fi-it-codigo-ini fi-it-codigo-fim 
         fi-ge-codigo-ini fi-ge-codigo-fim fi-dt-trans-ini fi-dt-trans-fim 
         tgSoFaturaveis 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/esimft05acrp.p}
