...
&Scoped-Define ENABLED-OBJECTS i_num-reserva bt-ok bt-cancela bt-ajuda ~
rt-button 
&Scoped-Define DISPLAYED-OBJECTS i_num-reserva 
...
DEFINE VARIABLE i_num-reserva AS INTEGER FORMAT ">>>>>>>>9":U 
     LABEL "N£mero da Reserva" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     i_num-reserva AT ROW 1.79 COL 25.72 COLON-ALIGNED
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         FONT 1
         TITLE "V  Para Reservas para Clientes"
...
ON GO OF FRAME d-vapara /* V  Para Reservas para Clientes */
DO:
FIND ped-reserva NO-LOCK
    WHERE ped-reserva.num-reserva EQ INPUT FRAME {&FRAME-NAME} i_num-reserva NO-ERROR.

IF NOT AVAILABLE ped-reserva THEN DO:
    {utp/ut-table.i espec ped-reserva 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(ped-reserva).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Reservas para Clientes */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY i_num-reserva 
      WITH FRAME d-vapara.
  ENABLE i_num-reserva bt-ok bt-cancela bt-ajuda rt-button 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "G01ES016" "2.04.00.000"}
