...
*******************************************************************************/
{include/i-prgvrs.i ESSP0047 2.04.00.000}
...
ON END-ERROR OF w-relat /* Testes de Hidrofilidade */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Testes de Hidrofilidade */
DO:
...
{utp/ut9000.i "ESSP0047" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE fi-ini-fm-codigo fi-fin-fm-codigo fi-ini-data-teste fi-fin-data-teste 
         IMAGE-1 IMAGE-10 IMAGE-2 IMAGE-9 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
if tt-param.destino = 1 
    ...
    {include/i-rprun.i esrp/essp0047rp.p}
