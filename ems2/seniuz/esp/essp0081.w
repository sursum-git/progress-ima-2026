...
*******************************************************************************/
{include/i-prgvrs.i ESSP0081 2.04.00.000}
...
DEFINE VARIABLE fi-fin-cod-maq AS CHARACTER FORMAT "x(6)" INITIAL "ZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88 TOOLTIP "M quina final" NO-UNDO.

DEFINE VARIABLE fi-fin-cod-setor AS CHARACTER FORMAT "x(3)" INITIAL "ZZZ" 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88 TOOLTIP "C¢digo do setor final" NO-UNDO.
...
DEFINE VARIABLE fi-fin-func-abe AS INTEGER FORMAT "999999" INITIAL 999999 
     VIEW-AS FILL-IN 
     SIZE 8 BY .88 TOOLTIP "Funcion rio final" NO-UNDO.
...
DEFINE VARIABLE fi-ini-cod-area AS CHARACTER FORMAT "x(3)" 
     LABEL "Area" 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88 TOOLTIP "µrea inicial" NO-UNDO.

DEFINE VARIABLE fi-ini-cod-maq AS CHARACTER FORMAT "x(6)" 
     LABEL "M quina" 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88 TOOLTIP "M quina inicial" NO-UNDO.

DEFINE VARIABLE fi-ini-cod-setor AS CHARACTER FORMAT "x(3)" 
     LABEL "Setor" 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88 TOOLTIP "C¢digo do setor inicial" NO-UNDO.
...
DEFINE VARIABLE fi-ini-func-abe AS INTEGER FORMAT "999999" INITIAL 0 
     ...
     VIEW-AS FILL-IN 
     SIZE 8 BY .88 TOOLTIP "Funcion rio inicial" NO-UNDO.
...
DEFINE FRAME f-pg-par
     ...
     fi-tp-man1 AT ROW 4.5 COL 20 COLON-ALIGNED
     fi-tp-man2 AT ROW 4.5 COL 26 COLON-ALIGNED NO-LABEL
     fi-tp-man3 AT ROW 4.5 COL 32 COLON-ALIGNED NO-LABEL
     fi-tp-man4 AT ROW 4.5 COL 38 COLON-ALIGNED NO-LABEL
     fi-tp-man5 AT ROW 4.5 COL 44 COLON-ALIGNED NO-LABEL
     fi-tp-man6 AT ROW 4.5 COL 50 COLON-ALIGNED NO-LABEL
     rs-situacao AT ROW 6.71 COL 29.57 NO-LABEL
     tg-all-types AT ROW 4.5 COL 58.43
     tg-imp-param AT ROW 9.58 COL 25.43
     RECT-34 AT ROW 9.17 COL 4
     RECT-35 AT ROW 4.04 COL 4
     RECT-36 AT ROW 6.58 COL 4
     RECT-37 AT ROW 1.5 COL 4
     "Tipos de OS:" VIEW-AS TEXT
          SIZE 9.86 BY .54 AT ROW 7.17 COL 19.14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 77.14 BY 10.5
...
DEFINE FRAME f-pg-sel
     ...
     IMAGE-29 AT ROW 2.25 COL 31.72
     IMAGE-30 AT ROW 2.25 COL 50.86
     IMAGE-31 AT ROW 1.25 COL 31.72
     IMAGE-32 AT ROW 1.25 COL 50.86
     IMAGE-33 AT ROW 3.25 COL 31.72
     IMAGE-34 AT ROW 3.25 COL 50.86
     IMAGE-35 AT ROW 4.25 COL 31.72
     IMAGE-36 AT ROW 4.25 COL 50.86
     IMAGE-37 AT ROW 5.25 COL 31.72
     IMAGE-38 AT ROW 5.25 COL 50.86
     IMAGE-39 AT ROW 6.25 COL 31.72
     IMAGE-40 AT ROW 6.25 COL 50.86
     IMAGE-41 AT ROW 8.25 COL 31.72
     IMAGE-42 AT ROW 8.25 COL 50.86
     IMAGE-43 AT ROW 9.25 COL 31.72
     IMAGE-44 AT ROW 9.25 COL 50.86
     IMAGE-53 AT ROW 7.25 COL 31.72
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Incidˆncia de Manuten‡Æo por Tipo Manuten‡Æo"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Incidˆncia de Manuten‡Æo por Tipo Manuten‡Æo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Incidˆncia de Manuten‡Æo por Tipo Manuten‡Æo */
DO:
...
{utp/ut9000.i "ESSP0081" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-masc-ssist fi-tp-man1 fi-tp-man2 fi-tp-man3 fi-tp-man4 fi-tp-man5 
          fi-tp-man6 rs-situacao tg-all-types tg-imp-param 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE fi-masc-ssist rs-situacao tg-all-types tg-imp-param RECT-34 RECT-35 
         RECT-36 RECT-37 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/essp0081rp.p}
