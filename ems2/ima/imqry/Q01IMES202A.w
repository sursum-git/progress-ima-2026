...
&Scoped-define INTERNAL-TABLES IM-USER-TIPO-PED

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH IM-USER-TIPO-PED NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH IM-USER-TIPO-PED NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main IM-USER-TIPO-PED
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main IM-USER-TIPO-PED
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems2ima.IM-USER-TIPO-PED"
