...
*******************************************************************************/
{include/i-prgvrs.i V04AD098 2.04.00.000}
...
&Scoped-Define ENABLED-FIELDS emitente.cod-emitente 
...
&Scoped-Define DISPLAYED-OBJECTS cb-tipo-cliente 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,ADM-MODIFY-FIELDS,List-4,List-5,List-6 */
&Scoped-define ADM-MODIFY-FIELDS emitente.nome-emit 
&Scoped-define List-4 cb-tipo-cliente 
...
DEFINE VARIABLE cb-tipo-cliente AS CHARACTER FORMAT "X(10)":U 
     LABEL "Tipo Cliente" 
     VIEW-AS COMBO-BOX INNER-LINES 5
     DROP-DOWN-LIST
     SIZE 16 BY 1 TOOLTIP "Tipo de Cliente: Normal, Especial." NO-UNDO.
...
DEFINE FRAME f-main
     emitente.cod-emitente AT ROW 1.17 COL 9 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.43 BY .88
     emitente.nome-emit AT ROW 2.17 COL 9 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 41.14 BY .88
     cb-tipo-cliente AT ROW 3.79 COL 9 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN emitente-ext.tipo-cliente = LOOKUP(INPUT FRAME {&FRAME-NAME} cb-tipo-cliente,c-tipos).
...
------------------------------------------------------------------------------*/
    ...
    IF AVAIL emitente THEN DO:
       FIND emitente-ext WHERE emitente-ext.cod-emitente = emitente.cod-emitente NO-ERROR.
       IF AVAIL emitente-ext THEN
          ASSIGN cb-tipo-cliente:SCREEN-VALUE IN FRAME {&FRAME-NAME} = 
                                      ENTRY(emitente-ext.tipo-cliente,c-tipos).
    END.
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN emitente.cod-emitente:SENSITIVE IN FRAME {&FRAME-NAME} = NO.
