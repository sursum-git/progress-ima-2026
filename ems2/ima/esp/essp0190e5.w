...
*******************************************************************************/
{include/i-prgvrs.i ESSP0190E5 2.04.00.000}
...
&GLOBAL-DEFINE SORTBY-PHRASE BY IF sort-col = 1 ~
                                 THEN tt-work.nat-operacao ~
                                ELSE IF sort-col = 2 ~
                                     THEN STRING(tt-work.aliq-icms, "999.99") ~
                                    ELSE IF sort-col = 3 ~
                                         THEN tt-work.und + tt-work.nat-operacao ~
                                        ELSE IF sort-col = 4 ~
                                            ...
                                            ELSE IF sort-col = 5 ~
                                                ...
                                                ELSE IF sort-col = 6 ~
                                                     ...
                                                     ELSE IF sort-col = 7 ~
                                                          ...
                                                          ELSE IF sort-col = 8 ~
                                                               THEN STRING(tt-work.vl-icms, "999,999,999.99") ~
                                                               ELSE IF sort-col = 9 ~
...
&GLOBAL-DEFINE SORTBY-IMP-EXCEL BY IF sort-col = 1 ~
                                    THEN b-tt-work.nat-operacao ~
                                   ELSE IF sort-col = 2 ~
                                        THEN STRING(b-tt-work.aliq-icms, "999.99") ~
                                       ELSE IF sort-col = 3 ~
                                             THEN b-tt-work.und + b-tt-work.nat-operacao ~
                                            ELSE IF sort-col = 4 ~
                                                ...
                                                ELSE IF sort-col = 5 ~
                                                     ...
                                                     ELSE IF sort-col = 6 ~
                                                          ...
                                                          ELSE IF sort-col = 7 ~
                                                               ...
                                                               ELSE IF sort-col = 8 ~
                                                                    THEN STRING(b-tt-work.vl-icms, "999,999,999.99") ~
                                                                    ELSE IF sort-col = 9 ~
...
&Scoped-define FIELDS-IN-QUERY-br-work tt-work.nat-operacao tt-work.aliq-icms tt-work.und tt-work.qtd tt-work.vlr tt-work.desc-pratic tt-work.preco-medio tt-work.vl-icms tt-work.qtd-devol tt-work.vlr-devol   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-work tt-work.nat-operacao   tt-work.aliq-icms   tt-work.und   tt-work.qtd   tt-work.vlr   tt-work.vlr   tt-work.preco-medio   tt-work.desc-pratic   tt-work.vl-icms   tt-work.qtd-devol ~
tt-work.vlr-devol   
...
&Scoped-Define DISPLAYED-OBJECTS fi-media-m fi-tot-icms-m fi-tot-qtd-dev-m ~
fi-tot-vlr-dev-m fi-tot-qtd-m fi-tot-vlr-m fi-tot-desc-m fi-media-kg ~
fi-tot-icms-kg fi-tot-qtd-dev-kg fi-tot-vlr-dev-kg fi-tot-qtd-kg ~
fi-tot-vlr-kg fi-tot-desc-kg fi-media-und fi-tot-icms-und ~
fi-tot-qtd-dev-und fi-tot-vlr-dev-und fi-tot-qtd-und fi-tot-vlr-und ~
fi-tot-desc-und fi-tot-geral-icms fi-ger-vlr-dev fi-tot-geral 
...
DEFINE VARIABLE fi-tot-geral-icms AS DECIMAL FORMAT " ZZZ,ZZZ,ZZ9.99":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88
     FGCOLOR 4  NO-UNDO.

DEFINE VARIABLE fi-tot-icms-kg AS DECIMAL FORMAT " ZZZ,ZZZ,ZZ9.99":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88
     FGCOLOR 1  NO-UNDO.

DEFINE VARIABLE fi-tot-icms-m AS DECIMAL FORMAT " ZZZ,ZZZ,ZZ9.99":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88
     FGCOLOR 1  NO-UNDO.

DEFINE VARIABLE fi-tot-icms-und AS DECIMAL FORMAT " ZZZ,ZZZ,ZZ9.99":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88
     FGCOLOR 1  NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-work D-Dialog _FREEFORM
  QUERY br-work NO-LOCK DISPLAY
      tt-work.nat-operacao    COLUMN-LABEL "Natureza"             FORMAT "x(13)"              WIDTH 18.4
      tt-work.aliq-icms       COLUMN-LABEL "Aliquota"             FORMAT ">>9.99"             WIDTH 07.0 
      tt-work.und             COLUMN-LABEL "Und"                  FORMAT "x(03)"              WIDTH 03.0
      tt-work.qtd             COLUMN-LABEL "Quantidade"           FORMAT ">>>,>>>,>>9.99"     WIDTH 12.0
      tt-work.vlr             COLUMN-LABEL "Valor"                FORMAT ">>>,>>>,>>>,>>9.99" WIDTH 13.0
      tt-work.desc-pratic     COLUMN-LABEL "Desc. Pratic"         FORMAT ">>>,>>>,>>>,>>9.99" WIDTH 10.5
      tt-work.preco-medio     COLUMN-LABEL "Preco Medio"          FORMAT ">>>,>>9.99"         WIDTH 12.0 
      tt-work.vl-icms         COLUMN-LABEL "Valor ICMS"           FORMAT ">>>,>>>,>>>,>>9.99" WIDTH 12.5
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 108.86 BY 11.92
         FONT 1
...
DEFINE FRAME D-Dialog
     br-work AT ROW 1.04 COL 1.43
     bt-vapara AT ROW 1.38 COL 111.29
     bt-excel AT ROW 2.92 COL 111.29
     bt-imprime AT ROW 4.5 COL 111.29
     fi-media-m AT ROW 13.08 COL 57.14 COLON-ALIGNED NO-LABEL
     fi-tot-icms-m AT ROW 13.08 COL 69.43 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-dev-m AT ROW 13.08 COL 82 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-dev-m AT ROW 13.08 COL 93.57 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-m AT ROW 13.13 COL 18.86 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-m AT ROW 13.13 COL 32.29 COLON-ALIGNED NO-LABEL
     fi-tot-desc-m AT ROW 13.13 COL 44.86 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     fi-media-kg AT ROW 14.08 COL 57.14 COLON-ALIGNED NO-LABEL
     fi-tot-icms-kg AT ROW 14.08 COL 69.43 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-dev-kg AT ROW 14.08 COL 82 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-dev-kg AT ROW 14.08 COL 93.57 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-kg AT ROW 14.13 COL 18.86 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-kg AT ROW 14.13 COL 32.29 COLON-ALIGNED NO-LABEL
     fi-tot-desc-kg AT ROW 14.17 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     fi-media-und AT ROW 15.08 COL 57.14 COLON-ALIGNED NO-LABEL
     fi-tot-icms-und AT ROW 15.08 COL 69.43 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-dev-und AT ROW 15.08 COL 82 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-dev-und AT ROW 15.08 COL 93.57 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-und AT ROW 15.13 COL 18.86 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-und AT ROW 15.13 COL 32.29 COLON-ALIGNED NO-LABEL
     fi-tot-desc-und AT ROW 15.13 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     fi-tot-geral-icms AT ROW 16.08 COL 69.43 COLON-ALIGNED NO-LABEL
     fi-ger-vlr-dev AT ROW 16.08 COL 93.57 COLON-ALIGNED NO-LABEL
     fi-tot-geral AT ROW 16.13 COL 32.29 COLON-ALIGNED NO-LABEL
     bt-exit AT ROW 16.83 COL 111.29
     bt-ok AT ROW 17.42 COL 2.57
     bt-cancela AT ROW 17.42 COL 13.57
     bt-ajuda AT ROW 17.42 COL 98.72
     "UND" VIEW-AS TEXT
          SIZE 3.29 BY .54 AT ROW 15.21 COL 17.14
          FGCOLOR 12 
     "TOTAIS:" VIEW-AS TEXT
          SIZE 6.72 BY .88 AT ROW 13.21 COL 11
          FONT 0
     "TOTAL GERAL:" VIEW-AS TEXT
          SIZE 11.29 BY .71 AT ROW 16.21 COL 22.57
          FGCOLOR 4 
     "M" VIEW-AS TEXT
          SIZE 1.57 BY .54 AT ROW 13.38 COL 19
          FGCOLOR 12 
     "KG" VIEW-AS TEXT
          SIZE 2 BY .54 AT ROW 14.33 COL 18.29
          FGCOLOR 12 
     RECT-1 AT ROW 1.17 COL 110.72
     rt-buttom AT ROW 17.17 COL 1.57
     SPACE(7.99) SKIP(0.03)
...
/* SETTINGS FOR FILL-IN fi-tot-geral IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN fi-tot-geral-icms IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN fi-tot-icms-kg IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN fi-tot-icms-m IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN fi-tot-icms-und IN FRAME D-Dialog
   NO-ENABLE                                                            */
...
/* ***************************  Main Block  *************************** */
 ASSIGN FRAME d-dialog:TITLE = "Totais Das Naturezas das Operaá‰es  -  ESSP0190E5".

 tt-work.nat-operacao:READ-ONLY IN BROWSE br-work = YES.
 tt-work.aliq-icms:READ-ONLY IN BROWSE br-work    = YES.
 tt-work.vl-icms:READ-ONLY IN BROWSE br-work      = YES.
 ...
 tt-work.desc-pratic:READ-ONLY IN BROWSE br-work  = YES.
...
------------------------------------------------------------------------------*/
  DISPLAY fi-media-m fi-tot-icms-m fi-tot-qtd-dev-m fi-tot-vlr-dev-m 
          fi-tot-qtd-m fi-tot-vlr-m fi-tot-desc-m fi-media-kg fi-tot-icms-kg 
          fi-tot-qtd-dev-kg fi-tot-vlr-dev-kg fi-tot-qtd-kg fi-tot-vlr-kg 
          fi-tot-desc-kg fi-media-und fi-tot-icms-und fi-tot-qtd-dev-und 
          fi-tot-vlr-dev-und fi-tot-qtd-und fi-tot-vlr-und fi-tot-desc-und 
          fi-tot-geral-icms fi-ger-vlr-dev fi-tot-geral 
      WITH FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
    ...
    PUT "NATUREZA DA OPERAÄ«O  ALIQUOTA  UND    QUANTIDADE         VALOR   DESC PRATIC  PREÄO MEDIO    VALOR ICMS  QTD DEVOLUÄ«O VLR DEVOLUÄ«O" AT 1.
    PUT "--------------------  --------  ---  ------------  ------------  ------------  -----------  ------------  ------------- -------------" AT 1.
...
/*          PUT CONTROL "~033&l1O~033(s16H". /* ORIENTAÄ«O PAISAGEM & COMPACTA */  */
  ...
  DO i-ct = 1 TO i-num-copias.
     ...
     ASSIGN fi-tot-qtd-m    = 0 fi-tot-vlr-m   = 0 fi-tot-icms-m  = 0 fi-tot-qtd-kg  = 0 
            fi-tot-vlr-kg   = 0 fi-tot-icms-kg = 0 fi-tot-qtd-und = 0 fi-tot-vlr-und = 0
            fi-tot-icms-und = 0
     ...
     FOR EACH b-tt-work NO-LOCK {&SORTBY-IMP-EXCEL}.
         IF i-lin > 62 THEN DO:
            ...
            ASSIGN i-lin = 7.
         END.
         PUT b-tt-work.nat-operacao FORMAT "x(15)"          AT   1
             b-tt-work.aliq-icm     FORMAT ">>9.99"         AT  25 
             TRIM(b-tt-work.un)     FORMAT "x(3)"           AT  33
             b-tt-work.qtd          FORMAT "->,>>>,>>9.99"  AT  37
             b-tt-work.vlr          FORMAT "->,>>>,>>9.99"  AT  51
             b-tt-work.desc-pratic  FORMAT "->,>>>,>>9.99"  AT  66.
         IF b-tt-work.qtd <> 0 THEN
            PUT  (b-tt-work.vlr /
                  b-tt-work.qtd)    FORMAT "->>>,>>9.99"    AT  80.
         PUT b-tt-work.vl-icms      FORMAT "->,>>>,>>9.99"  AT  92
             b-tt-work.qtd-devol    FORMAT "->,>>>,>>9.99"  AT 107
             b-tt-work.vlr-devol    FORMAT "->,>>>,>>9.99"  AT 121.
         ...
         CASE b-tt-work.un:
             WHEN 'M'   THEN
                 ASSIGN fi-tot-qtd-m  = fi-tot-qtd-m  + b-tt-work.qtd
                        ...
                        fi-tot-icms-m = fi-tot-icms-m + b-tt-work.vl-icms.
             WHEN 'KG'  THEN
                 ASSIGN fi-tot-qtd-kg  = fi-tot-qtd-kg  + b-tt-work.qtd
                        ...
                        fi-tot-icms-kg = fi-tot-icms-kg + b-tt-work.vl-icms.
             WHEN 'UN' THEN
                 ASSIGN fi-tot-qtd-und  = fi-tot-qtd-und  + b-tt-work.qtd
                        ...
                        fi-tot-icms-und = fi-tot-icms-und + b-tt-work.vl-icms.
         END CASE.
     END.
     IF i-lin > 62 THEN DO:
        RUN pi-imp-cabec.
     ...
     END.
     PUT "---  ------------  ------------  -----------  ------------  ------------  ------------- -------------" AT 33.
     PUT "TOTAL GERAL:   M" AT 18.
     PUT fi-tot-qtd-m    FORMAT "->,>>>,>>9.99"  AT  37
         fi-tot-vlr-m    FORMAT "->,>>>,>>9.99"  AT  51
         fi-tot-desc-m   FORMAT "->,>>>,>>9.99"  AT  66.
     IF fi-tot-vlr-m > 0  THEN
     PUT (fi-tot-vlr-m / 
          fi-tot-qtd-m)  FORMAT "->>>,>>9.99"     AT  80.
     PUT fi-tot-icms-m   FORMAT "->,>>>,>>9.99"   AT  92
         fi-tot-qtd-dev-m FORMAT "->,>>>,>>9.99"  AT 107
         fi-tot-vlr-dev-m FORMAT "->,>>>,>>9.99"  AT 121.

     PUT "KG" AT 33.
     PUT fi-tot-qtd-kg    FORMAT "->,>>>,>>9.99"  AT  37
         fi-tot-vlr-kg    FORMAT "->,>>>,>>9.99"  AT  51
         fi-tot-desc-kg   FORMAT "->,>>>,>>9.99"  AT  66.
     IF fi-tot-vlr-kg > 0 THEN
     PUT (fi-tot-vlr-kg / 
          fi-tot-qtd-kg)   FORMAT "->>>,>>9.99"    AT  80.
     PUT fi-tot-icms-kg    FORMAT "->,>>>,>>9.99"  AT  92
         fi-tot-qtd-dev-kg FORMAT "->,>>>,>>9.99"  AT 107
         fi-tot-vlr-dev-kg FORMAT "->,>>>,>>9.99"  AT 121.

     PUT "UN" AT 33.
     PUT fi-tot-qtd-und    FORMAT "->,>>>,>>9.99"  AT  37
         fi-tot-vlr-und    FORMAT "->,>>>,>>9.99"  AT  51
         fi-tot-desc-und   FORMAT "->,>>>,>>9.99"  AT  66.
     IF fi-tot-vlr-und > 0 THEN
     PUT (fi-tot-vlr-und / 
          fi-tot-qtd-und)   FORMAT "->>>,>>9.99"    AT  80.
     PUT fi-tot-icms-und    FORMAT "->,>>>,>>9.99"  AT  92
         fi-tot-qtd-dev-und FORMAT "->,>>>,>>9.99"  AT 107
         fi-tot-vlr-dev-und FORMAT "->,>>>,>>9.99"  AT 121.
     ...
     PUT (fi-tot-icms-m +
          ...
          fi-tot-icms-und)    FORMAT "->,>>>,>>9.99"  AT  80
         (fi-tot-vlr-dev-m  + 
          fi-tot-vlr-dev-kg +                                  
          fi-tot-vlr-dev-und) FORMAT "->,>>>,>>9.99"  AT 107.
...
------------------------------------------------------------------------------*/
 ...
 chWorkSheet = chExcelapp:Sheets:ITEM(1).
 chWorkSheet:NAME = "Faturamento Por Natureza".
 ...
 /* Titulo das Colunas */
 ASSIGN chworksheet:range("A3"):VALUE = "NATUREZA DA OPERAÄ«O"
        chworksheet:range("B3"):VALUE = "ALIQUOTA"    
        chworksheet:range("C3"):VALUE = "UND"  
        chworksheet:range("D3"):VALUE = "QUANTIDADE"
        chworksheet:range("E3"):VALUE = "VALOR"     
        chworksheet:range("F3"):VALUE = "DESC PRATIC" 
        chworksheet:range("G3"):VALUE = "PREÄO MêDIO" 
        chworksheet:range("H3"):VALUE = "VALOR ICMS"
        chworksheet:range("I3"):VALUE = "QTD DEVOLUÄ«O" 
        chworksheet:range("J3"):VALUE = "VLR DEVOLUÄ«O". 
 ...
 ASSIGN chworksheet:range("B:B"):NumberFormat        = "###.###.##0,00"
        chworksheet:range("D:J"):NumberFormat        = "###.###.##0,00"
        chworksheet:range("B:B"):HorizontalAlignment = 4
...
ASSIGN fi-tot-qtd-dev-m   = 0 fi-tot-qtd-m    = 0 fi-tot-vlr-m     = 0 fi-tot-icms-m     = 0 fi-tot-qtd-kg      = 0 
       fi-tot-qtd-dev-kg  = 0 fi-tot-vlr-kg   = 0 fi-tot-icms-kg   = 0 fi-tot-qtd-und    = 0 fi-tot-vlr-und     = 0
       fi-tot-qtd-dev-und = 0 fi-tot-icms-und = 0 fi-tot-vlr-dev-m = 0 fi-tot-vlr-dev-kg = 0 fi-tot-vlr-dev-und = 0
       fi-tot-desc-m      = 0 fi-tot-desc-kg   = 0 fi-tot-desc-und   = 0. 

FOR EACH b-tt-work NO-LOCK {&SORTBY-IMP-EXCEL}.
    ASSIGN chworksheet:range("A" + STRING(i-lin)):VALUE = b-tt-work.nat-operacao
           chworksheet:range("B" + STRING(i-lin)):VALUE = b-tt-work.aliq-icms
           chworksheet:range("C" + STRING(i-lin)):VALUE = b-tt-work.un
           ...
           chworksheet:range("H" + STRING(i-lin)):VALUE = b-tt-work.vl-icms
           chworksheet:range("I" + STRING(i-lin)):VALUE = b-tt-work.qtd-devol
           chworksheet:range("J" + STRING(i-lin)):VALUE = b-tt-work.vlr-devol.
    ...
    CASE b-tt-work.un:
        WHEN 'M'   THEN
            ASSIGN fi-tot-qtd-m     = fi-tot-qtd-m     + b-tt-work.qtd
                   ...
                   fi-tot-qtd-dev-m = fi-tot-qtd-dev-m + b-tt-work.qtd-devol
                   fi-tot-vlr-dev-m = fi-tot-vlr-dev-m + b-tt-work.vlr-devol.
        WHEN 'KG'  THEN
            ASSIGN fi-tot-qtd-kg     = fi-tot-qtd-kg     + b-tt-work.qtd
                   fi-tot-vlr-kg     = fi-tot-vlr-kg     + b-tt-work.vlr
                   fi-tot-desc-kg    = fi-tot-desc-kg    + b-tt-work.desc-pratic
                   fi-tot-icms-kg    = fi-tot-icms-kg    + b-tt-work.vl-icms
                   fi-tot-qtd-dev-kg = fi-tot-qtd-dev-kg + b-tt-work.qtd-devol
        ...
        WHEN 'UN' THEN
            ASSIGN fi-tot-qtd-und     = fi-tot-qtd-und     + b-tt-work.qtd
                   ...
                   fi-tot-qtd-dev-und = fi-tot-qtd-dev-und + b-tt-work.qtd-devol
                   fi-tot-vlr-dev-und = fi-tot-vlr-dev-und + b-tt-work.vlr-devol.
    END CASE.
...
IF i-lin <> 4 THEN DO:
   ...
   ASSIGN chworksheet:range("D" + STRING(i-lin)):VALUE = fi-tot-qtd-m     
          chworksheet:range("E" + STRING(i-lin)):VALUE = fi-tot-vlr-m     
          chworksheet:range("F" + STRING(i-lin)):VALUE = fi-tot-desc-m 
          chworksheet:range("G" + STRING(i-lin)):VALUE = (fi-tot-vlr-m / fi-tot-qtd-m) 
          chworksheet:range("H" + STRING(i-lin)):VALUE = fi-tot-icms-m  
          chworksheet:range("I" + STRING(i-lin)):VALUE = fi-tot-qtd-dev-m 
          chworksheet:range("J" + STRING(i-lin)):VALUE = fi-tot-vlr-dev-m. 
   ...
   ASSIGN chworksheet:range("D" + STRING(i-lin)):VALUE = fi-tot-qtd-kg     
          chworksheet:range("E" + STRING(i-lin)):VALUE = fi-tot-vlr-kg     
          chworksheet:range("F" + STRING(i-lin)):VALUE = fi-tot-desc-kg 
          chworksheet:range("G" + STRING(i-lin)):VALUE = (fi-tot-vlr-kg / fi-tot-qtd-kg)
          chworksheet:range("H" + STRING(i-lin)):VALUE = fi-tot-icms-kg     
          chworksheet:range("I" + STRING(i-lin)):VALUE = fi-tot-qtd-dev-kg 
          chworksheet:range("J" + STRING(i-lin)):VALUE = fi-tot-vlr-dev-kg. 
    /* Colorir a Linha / Negrito */
   ASSIGN chWorkSheet:Range("A" + STRING(i-lin) + ":J" + STRING(i-lin)):Interior:ColorIndex = 14
          chWorkSheet:Range("A" + STRING(i-lin) + ":J" + STRING(i-lin)):FONT:ColorIndex     =  2
          chWorkSheet:Range("A" + STRING(i-lin) + ":J" + STRING(i-lin)):FONT:Bold           = TRUE.
   ...
   ASSIGN chworksheet:range("D" + STRING(i-lin)):VALUE = fi-tot-qtd-und     
          chworksheet:range("E" + STRING(i-lin)):VALUE = fi-tot-vlr-und     
          chworksheet:range("F" + STRING(i-lin)):VALUE = fi-tot-desc-und     
          chworksheet:range("G" + STRING(i-lin)):VALUE = (fi-tot-vlr-und / fi-tot-qtd-und)
          chworksheet:range("H" + STRING(i-lin)):VALUE = fi-tot-icms-und
          chworksheet:range("I" + STRING(i-lin)):VALUE = fi-tot-qtd-dev-und 
          chworksheet:range("J" + STRING(i-lin)):VALUE = fi-tot-vlr-dev-und. 
    /* Colorir a Linha / Negrito */
   ASSIGN chWorkSheet:Range("A" + STRING(i-lin) + ":J" + STRING(i-lin)):Interior:ColorIndex = 14
          chWorkSheet:Range("A" + STRING(i-lin) + ":J" + STRING(i-lin)):FONT:ColorIndex     =  2
          chWorkSheet:Range("A" + STRING(i-lin) + ":J" + STRING(i-lin)):FONT:Bold           = TRUE.
   ASSIGN i-lin = i-lin + 2.
   ASSIGN chworksheet:range("B" + STRING(i-lin)):VALUE = "VALOR TOTAL DO FATURAMENTO"
          chworksheet:range("E" + STRING(i-lin)):VALUE = fi-tot-vlr-m  + fi-tot-vlr-kg  + fi-tot-vlr-und
          chworksheet:range("G" + STRING(i-lin)):VALUE = fi-tot-icms-m + fi-tot-icms-kg + fi-tot-icms-und
          chworksheet:range("I" + STRING(i-lin)):VALUE = fi-tot-vlr-dev-m + fi-tot-vlr-dev-kg + fi-tot-vlr-dev-und.
    /* Colorir a Linha / Negrito */
   ASSIGN chWorkSheet:Range("A" + STRING(i-lin) + ":I" + STRING(i-lin)):Interior:ColorIndex = 18
...
ASSIGN FRAME {&FRAME-NAME}:VISIBLE = NO.
 ...
 FOR EACH tt-trab WHERE
     tt-trab.nat-operacao <> "" AND
     tt-trab.uf            = "ZZ" NO-LOCK.

     FIND natur-oper WHERE
          natur-oper.nat-operacao = tt-trab.nat-operacao NO-LOCK NO-ERROR. 
     IF NOT AVAIL natur-oper THEN NEXT.

     CREATE tt-work.
     ASSIGN tt-work.nat-operacao = natur-oper.nat-operacao
            tt-work.denominacao  = natur-oper.denominacao
            tt-work.aliq-icms    = natur-oper.aliquota-icm
            tt-work.Und          = tt-trab.und
            tt-work.qtd          = tt-trab.qtd
            tt-work.vlr          = tt-trab.vlr
            tt-work.preco-medio  = tt-trab.preco-medio
            tt-work.vl-icms      = tt-trab.vl-icms
...
------------------------------------------------------------------------------*/
     ...
     CASE tt-work.und:
         WHEN "M" THEN
             ASSIGN fi-tot-qtd-m     = fi-tot-qtd-m  + tt-work.qtd  
                    ...
                    fi-tot-icms-m    = fi-tot-icms-m + tt-work.vl-icms
         ...
         WHEN "KG" THEN
             ASSIGN fi-tot-qtd-kg     = fi-tot-qtd-kg     + tt-work.qtd  
                    ...
                    fi-tot-icms-kg    = fi-tot-icms-kg    + tt-work.vl-icms
         ...
         WHEN "UN" THEN
             ASSIGN fi-tot-qtd-und     = fi-tot-qtd-und     + tt-work.qtd  
                    ...
                    fi-tot-icms-und    = fi-tot-icms-und    + tt-work.vl-icms
 ...
 ASSIGN fi-media-m        = fi-tot-vlr-m / fi-tot-qtd-m
        ...
        fi-tot-geral-icms = fi-tot-icms-m + fi-tot-icms-kg + fi-tot-icms-und
