...
&Scoped-define INTERNAL-TABLES espec.ordem-benefic

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH espec.ordem-benefic NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH espec.ordem-benefic NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main espec.ordem-benefic
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main espec.ordem-benefic
...
cod-refer||y|espec.ordem-benefic.cod-refer
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "it-codigo" "espec.ordem-benefic" "it-codigo"}
  {src/adm/template/sndkycas.i "cod-refer" "espec.ordem-benefic" "cod-refer"}
