...
*******************************************************************************/
{include/i-prgvrs.i Q02im026 2.04.00.0001}
...
CREATE WIDGET-POOL.
DEF BUFFER tb-preco FOR mgadm.tb-preco.
/* ***************************  Definitions  ************************** */
...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH tb-preco NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main tb-preco
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main tb-preco
...
PROCEDURE send-key :
/*------------------------------------------------------------------------------
  Purpose:     Sends a requested KEY value back to the caolono
               SmartObject.
