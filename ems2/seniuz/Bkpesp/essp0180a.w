...
RECT-50 fi-dt-limite-fin fi-nr-pedcli-ini fi-nr-pedcli-fin bt-dig-ped ~
...
&Scoped-Define DISPLAYED-OBJECTS fi-dt-limite-fin fi-nr-pedcli-ini ~
...
DEFINE FRAME F-Main
     fi-dt-limite-fin AT ROW 1.75 COL 14 COLON-ALIGNED
...
DO:
    ASSIGN INPUT FRAME {&FRAME-NAME} fi-dt-limite-fin.
    ...
    ASSIGN c-dt-limite-fin    = INPUT FRAME {&FRAME-NAME} fi-dt-limite-fin   
...
------------------------------------------------------------------------------*/
  DISPLAY fi-dt-limite-fin fi-nr-pedcli-ini fi-nr-pedcli-fin fi-it-codigo-ini 
  ...
  ENABLE IMAGE-100 IMAGE-101 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-90 IMAGE-91 
         IMAGE-94 IMAGE-95 IMAGE-96 IMAGE-97 RECT-1 RECT-50 fi-dt-limite-fin 
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN fi-dt-limite-fin    = c-dt-limite-fin
