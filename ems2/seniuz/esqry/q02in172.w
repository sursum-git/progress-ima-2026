...
*******************************************************************************/
{include/i-prgvrs.i Q02IN172 2.04.00.000}
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "fm-codigo,it-codigo,class-fiscal,cod-comprado,ct-codigo,cod-estabel,fm-cod-com,ge-codigo,nr-linha,cd-planejado,cod-refer,sc-codigo,un,cd-tag,nat-despesa,cod-servico,cod-tax"':U).
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "mgcad.item.ge-codigo >= 50
 AND mgcad.item.ge-codigo <= 59"
