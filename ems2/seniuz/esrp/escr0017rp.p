...
** Objetivo: Listar titulos pagos por Representante/Cliente/Data de Vencimento
** Autor...: Gilvando de Souza Araujo - Outubro/2006
** Obs.....: Especifico da TEAR TÒXTIL INDéSTRIA E COMRCIO LTDA.
*/

/* include de controle de versÆo */
{include/i-prgvrs.i ESCR0017RP 2.04.00.000}
...
def var de-tot-rep1 as dec format ">>>>>>,>>9.99".
def var de-tot-rep2 as dec format ">>>>>>,>>9.99".
def var de-tot-rep3 as dec format ">>>>>>,>>9.99".
...
def var de-vlr-bru-rep as dec.
def var de-vlr-liq-rep as dec.
...
for each titulo where titulo.ep-codigo    =  tt-param.ep-codigo
    ...
    if de-saldo = 0 then do:
       ...
       if titulo.dt-ult-pag = titulo.dt-vencimen then
          assign de-vl-bxa1  = de-vl-bxa
                 ...
                 de-tot-rep1 = de-tot-rep1 + de-vl-bxa
       ...
       if titulo.dt-ult-pag > titulo.dt-vencimen then
          assign de-vl-bxa2  = de-vl-bxa
                 ...
                 de-tot-rep2 = de-tot-rep2 + de-vl-bxa
          ...
          assign de-vl-bxa3  = de-vl-bxa
                 ...
                 de-tot-rep3 = de-tot-rep3 + de-vl-bxa
       ...
       and i-atraso < 100 then
           assign de-vlr-bru-dia = de-vlr-bru-dia +
                                   (de-vl-bxa * i-atraso)
                  de-vlr-bru-rep = de-vlr-bru-rep +
                                   (de-vl-bxa * i-atraso)
                  de-vlr-bru-ger = de-vlr-bru-ger +
                                   (de-vl-bxa * i-atraso)
                  de-vlr-liq-dia = de-vlr-liq-dia + de-vl-bxa
                  de-vlr-liq-rep = de-vlr-liq-rep + de-vl-bxa
    ...
    and (de-tot-rep1 <> 0 or
         de-tot-rep2 <> 0 or
         de-tot-rep3 <> 0) then do:
        
        if de-vlr-liq-rep <> 0 then
           assign de-pmr = de-vlr-bru-rep / de-vlr-liq-rep.
        else
           assign de-pmr = 0.
         
       put "Total do Repres:"    at   1
           de-tot-rep1           at  72
           de-tot-rep2           at  87
           de-tot-rep3           at 100
           de-pmr                at 121 skip(1).
       assign de-tot-rep1    = 0
              de-tot-rep2    = 0
              de-tot-rep3    = 0
              de-vlr-bru-rep = 0
              de-vlr-liq-rep = 0.
