...
*******************************************************************************/
{include/i-prgvrs.i ESSP0090 2.04.00.000}
...
DEFINE VARIABLE h_b02es020 AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v03es021 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-concom ASSIGN
         HIDDEN             = YES
         TITLE              = "Consulta Movimentos Produtos Acabados"
         HEIGHT             = 17.38
         WIDTH              = 90
         MAX-HEIGHT         = 17.58
         MAX-WIDTH          = 90
...
ON END-ERROR OF w-concom /* Consulta Movimentos Produtos Acabados */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-concom w-concom
ON WINDOW-CLOSE OF w-concom /* Consulta Movimentos Produtos Acabados */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esvwr/v03es021.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v03es021 ).
       RUN set-position IN h_v03es021 ( 2.75 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Defeitos|Nuances' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 10.00 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 8.38 , 88.43 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es021.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01es021 ).
       RUN set-position IN h_q01es021 ( 1.50 , 53.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_v03es021. */
       RUN add-link IN adm-broker-hdl ( h_q01es021 , 'Record':U , h_v03es021 ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b02es020.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b02es020 ).
       RUN set-position IN h_b02es020 ( 11.25 , 2.57 ) NO-ERROR.
       /* Size in UIB:  ( 6.92 , 86.72 ) */

       /* Links to SmartBrowser h_b02es020. */
       RUN add-link IN adm-broker-hdl ( h_q01es021 , 'Record':U , h_b02es020 ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v02es021 ).
       RUN set-position IN h_v02es021 ( 11.25 , 2.43 ) NO-ERROR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE local-create-objects w-concom 
...
------------------------------------------------------------------------------*/
  ...
  RUN pi-obtem-handle IN h_v03es021 (INPUT THIS-PROCEDURE:HANDLE,
                                     INPUT h_b02es020).

  RUN pi-obtem-handle IN h_b02es020 (INPUT THIS-PROCEDURE:HANDLE,
                                     INPUT h_v03es021).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0090" "2.04.00.000"}
