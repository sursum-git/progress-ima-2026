...
*******************************************************************************/
{include/i-prgvrs.i Q02DI159 2.04.00.000}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH ped-venda ~
 ...
 OR ped-venda.cod-sit-ped = 5 NO-LOCK INDEXED-REPOSITION
...
cod-emitente||y|mgmov.ped-venda.cod-emitente
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "nr-pedido,cod-emitente"':U).
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgmov.ped-venda"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _Where[1]         = "mgmov.ped-venda.cod-sit-ped < 3
 OR mgmov.ped-venda.cod-sit-ped = 5"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod-emitente" "ped-venda" "cod-emitente"}
