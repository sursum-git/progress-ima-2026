...
*******************************************************************************/
{include/i-prgvrs.i V02IN172 2.04.00.000}
...
&Scoped-Define ENABLED-FIELDS item.it-codigo item.un 
&Scoped-define ENABLED-TABLES item
&Scoped-define FIRST-ENABLED-TABLE item
&Scoped-Define ENABLED-OBJECTS rt-key 
&Scoped-Define DISPLAYED-FIELDS item.it-codigo item.un item.desc-item 
...
DEFINE FRAME f-main
     item.it-codigo AT ROW 1.13 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.14 BY .88
          FONT 1
     item.un AT ROW 1.13 COL 42.57 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5.14 BY .88
          FONT 1
     item.desc-item AT ROW 2.13 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 61.14 BY .88
          FONT 1
