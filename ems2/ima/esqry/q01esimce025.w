...
&Scoped-define QUERY-STRING-Query-Main FOR EACH item ~
      WHERE item.ge-codigo >= var-glb-ge-ini ~
 AND item.ge-codigo <= var-glb-ge-fim NO-LOCK INDEXED-REPOSITION
...
<FOREIGN-KEYS>
fm-codigo||y|item.fm-codigo
it-codigo||y|item.it-codigo
class-fiscal||y|item.class-fiscal
cod-comprado||y|item.cod-comprado
cod-estabel||y|item.cod-estabel
fm-cod-com||y|item.fm-cod-com
ge-codigo||y|item.ge-codigo
cd-tag||y|item.cd-tag
ct-codigo||y|item.ct-codigo
nr-linha||y|item.nr-linha
cd-planejado||y|item.cd-planejado
cod-refer||y|item.cod-refer
sc-codigo||y|item.sc-codigo
un||y|item.un
nat-despesa||y|item.nat-despesa
cod-servico||y|item.cod-servico
cod-tax||y|item.cod-tax
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "fm-codigo,it-codigo,class-fiscal,cod-comprado,cod-estabel,fm-cod-com,ge-codigo,cd-tag,ct-codigo,nr-linha,cd-planejado,cod-refer,sc-codigo,un,nat-despesa,cod-servico,cod-tax"':U).
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems2med.item"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _Where[1]         = "ems2med.item.ge-codigo >= var-glb-ge-ini
 AND ems2med.item.ge-codigo <= var-glb-ge-fim"
...
------------------------------------------------------------------------------*/
  ...
  FIND item WHERE ROWID(item) = gr-item NO-LOCK NO-ERROR.
