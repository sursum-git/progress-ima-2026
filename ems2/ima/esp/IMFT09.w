...
define variable c-prog-gerado as character no-undo initial "IMFT09".
...
def var c-titulo           as char init "Pre‡os dos produtos faturados" no-undo.        
def var v-cod-prog-gerado  as char init "imft09" no-undo.           
...
assign v-cod-prog-gerado = "imft09".
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK 
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
        ...
        assign c-lista = "Por Item" + "," + 
                         "Por Item" + "," + 
                         "".

        assign c-prog = "IMFT09A.w" + "," + 
                        "IMFT09B.w" + "," + 
                        "imft09a.w".


run grapi/gr2012.p (input {&window-name}:handle,
                    input v-cod-prog-gerado,
