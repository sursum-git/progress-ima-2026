...
*******************************************************************************/
{include/i-prgvrs.i ESSP0171 2.04.00.000}
...
DEFINE VARIABLE fi-dt-fin AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     LABEL "" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.

DEFINE VARIABLE fi-dt-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/001 
     LABEL "Data do Periodo Atual" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     fi-dt-ini AT ROW 2.25 COL 21 COLON-ALIGNED
     fi-dt-fin AT ROW 2.25 COL 49.86 COLON-ALIGNED
     IMAGE-1 AT ROW 2.25 COL 34.29
     IMAGE-2 AT ROW 2.25 COL 48.72
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 4 ROW 3.21
         SIZE 75.86 BY 10.25
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Gerador do Saldo de Estoque"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
/* SETTINGS FOR FRAME f-pg-sel
   Custom                                                               */
/* SETTINGS FOR FILL-IN fi-dt-fin IN FRAME f-pg-sel
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN fi-dt-ini IN FRAME f-pg-sel
   NO-ENABLE                                                            */
...
ON END-ERROR OF w-relat /* Gerador do Saldo de Estoque */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Gerador do Saldo de Estoque */
DO:
...
{utp/ut9000.i "ESSP0171" "2.04.00.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    IF INPUT FRAME f-pg-sel fi-dt-ini < 03/07/2008 THEN DO:
       MESSAGE "Data Invalida; . . . Anterior a data de implanta‡Æo 06/03/2008"
    ...
    */
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.dt-fin          = INPUT FRAME f-pg-sel fi-dt-fin
    ...
    {include/i-rprun.i esrp/essp0171rp.p} 
