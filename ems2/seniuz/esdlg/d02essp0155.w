...
*******************************************************************************/
{include/i-prgvrs.i D02ESSP0155 2.04.00.000}
...
DEF OUTPUT PARAMETER p-arq-saida AS CHAR FORMAT "x(54)".
...
DEFINE VARIABLE fi-arq-saida AS CHARACTER FORMAT "X(54)":U 
     LABEL "Arquivo Sa¡da" 
     VIEW-AS FILL-IN 
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "D02ESSP0155" "2.04.00.000"}
  ...
  ASSIGN fi-arq-saida:SCREEN-VALUE IN FRAME {&FRAME-NAME} = SESSION:TEMP-DIRECTORY +
         "Pedidos no Periodo " + STRING(p-dt-ini, '99-99-9999') + " a " + 
                                 STRING(p-dt-fin, '99-99-9999') + ".xls".
END PROCEDURE.
