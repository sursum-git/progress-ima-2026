...
DEFINE VARIABLE h_b01cm008 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 12.58 COL 1.57
     bt-ok AT ROW 14.29 COL 2.86
     bt-cancela AT ROW 14.29 COL 13.86
     bt-ajuda AT ROW 14.29 COL 72.57
     rt-button AT ROW 14.04 COL 1.86
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_folder ( 11.33 , 81.43 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b01cm008.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01cm008 ).
       RUN set-position IN h_b01cm008 ( 2.25 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_b01cm008. */
       RUN add-link IN adm-broker-hdl ( h_b01cm008 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b01cm008 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
