...
IF AVAIL ob-etiqueta THEN DO:
   ...
   IF ob-etiqueta.quantidade >= pQtAtuEtqOri THEN DO ON ERROR UNDO: 
      ...
      END.      
      ELSE DO:
        RUN setMsg IN hBoMsg('105','A quantidade da etiqueta no banco de dados Ç menor ou igual  e por isso ser† N«O feito o ajuste','log').
