...
*******************************************************************************/
{include/i-prgvrs.i ESCR0015 2.04.00.000}
...
define temp-table tt-param   no-undo
       ...
       FIELD salta-pagina    AS LOGICAL FORMAT "Sim/N∆o"
...
DEFINE VARIABLE tg-salta-pagina AS LOGICAL INITIAL no 
     LABEL "Saltar de p†gina a cada Representante" 
     VIEW-AS TOGGLE-BOX
     SIZE 30.43 BY .88 TOOLTIP "Imprimir ParÉmetros/Seleá∆o ao final do relat¢rio."
     FONT 1 NO-UNDO.
...
DEFINE FRAME f-pg-par
     tg-salta-pagina AT ROW 2.46 COL 6.57
...
DEFINE FRAME f-pg-sel
     ...
     fi-ini-dt-deposito AT ROW 4.83 COL 18.43 COLON-ALIGNED HELP
          "Data efetiva do dep¢sito do cheque"
     fi-fin-dt-deposito AT ROW 4.83 COL 49.29 COLON-ALIGNED HELP
          "Data efetiva do dep¢sito do cheque" NO-LABEL
     IMAGE-1 AT ROW 4.83 COL 30.86
     IMAGE-2 AT ROW 4.83 COL 47.86
     IMAGE-61 AT ROW 3.83 COL 30.86
     IMAGE-62 AT ROW 3.83 COL 47.86
     IMAGE-67 AT ROW 2.83 COL 30.86
     IMAGE-68 AT ROW 2.83 COL 47.86
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 2.72 ROW 2.83
         SIZE 77.43 BY 10.83
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Comiss‰es sobre Cheques contra Duplicatas"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Comiss‰es sobre Cheques contra Duplicatas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Comiss‰es sobre Cheques contra Duplicatas */
DO:
...
{utp/ut9000.i "ESCR0015" "2.04.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN fi-ep-codigo:SCREEN-VALUE IN FRAME f-pg-sel       = "1" 
           ...
           fi-fin-cod-estabel:SCREEN-VALUE IN FRAME f-pg-sel = "3"
           fi-ini-dt-deposito:SCREEN-VALUE IN FRAME f-pg-sel = STRING(DATE(MONTH(TODAY),1,YEAR(TODAY)))
           fi-fin-dt-deposito:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY).
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY tg-salta-pagina tg-impr-param 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE tg-salta-pagina tg-impr-param RECT-15 RECT-34 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-par}
  DISPLAY fi-ep-codigo fi-razao-social fi-ini-cod-estabel fi-fin-cod-estabel 
          fi-ini-cod-rep fi-fin-cod-rep fi-ini-dt-deposito fi-fin-dt-deposito 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-ep-codigo fi-ini-cod-estabel fi-fin-cod-estabel fi-ini-cod-rep 
         fi-fin-cod-rep fi-ini-dt-deposito fi-fin-dt-deposito IMAGE-1 IMAGE-2 
         IMAGE-61 IMAGE-62 IMAGE-67 IMAGE-68 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/escr0015rp.p} 
