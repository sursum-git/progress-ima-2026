...
*******************************************************************************/
{include/i-prgvrs.i B03IN172 2.04.00.000}
...
&Scoped-define QUERY-STRING-br-table FOR EACH item WHERE ~{&KEY-PHRASE} ~
      AND item.desc-item CONTAINS fi-desc-item ~
...
&Scoped-Define ENABLED-OBJECTS fi-desc-item bt-confirma br-table 
...
DEFINE FRAME F-Main
     fi-desc-item AT ROW 1 COL 8.43 COLON-ALIGNED NO-LABEL
     bt-confirma AT ROW 1 COL 82.72
     br-table AT ROW 2.17 COL 1
     "Contenha:" VIEW-AS TEXT
          SIZE 7.72 BY .67 AT ROW 1.08 COL 2.29
          FONT 1
     "na Descri‡Æo do Item" VIEW-AS TEXT
          SIZE 14.72 BY .67 AT ROW 1.08 COL 44.29
          FONT 1
...
/* Query rebuild information for BROWSE br-table
     ...
     _Where[1]         = "mgcad.item.desc-item CONTAINS fi-desc-item
...
DO:
  assign input frame {&frame-name} fi-desc-item.
