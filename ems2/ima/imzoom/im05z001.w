...
*******************************************************************************/
{include/i-prgvrs.i IM05Z001 2.04.00.001}
...
DEFINE VARIABLE h_im05b001 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 15.42 COL 2
     bt-ok AT ROW 17.13 COL 3
     bt-cancela AT ROW 17.13 COL 14
     bt-ajuda AT ROW 17.13 COL 79
     rt-button AT ROW 16.88 COL 2
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Parƒmetros de ConexÆo"
         HEIGHT             = 17.5
         WIDTH              = 90
         MAX-HEIGHT         = 21.92
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Parƒmetros de ConexÆo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Parƒmetros de ConexÆo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_folder ( 14.08 , 88.43 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'imbrw/im05b001.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_im05b001 ).
       RUN set-position IN h_im05b001 ( 2.50 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.25 , 84.57 ) */

       /* Links to SmartBrowser h_im05b001. */
       RUN add-link IN adm-broker-hdl ( h_im05b001 , 'State':U , THIS-PROCEDURE ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "IM05Z001" "2.04.00.001"}
