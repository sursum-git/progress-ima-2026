...
**
** Este fonte e de propriedade exclusiva da DATASUL, sua roducao
** parcial ou total por qualquer meio, so podera ser feita mediante
** autorizacao expressa.
*******************************************************************************/
{include/i-prgvrs.i ESCR0003 9.99.99.999}
...
/*:T Processadores do Template de Relat¢rio                            */
/*:T Obs: Retirar o valor do processador para as p†ginas que n∆o existirem  */
...
DEFINE FRAME f-pg-par
     tg-impr-param AT ROW 2.04 COL 25.43
     RECT-35 AT ROW 1.63 COL 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
DEFINE FRAME f-pg-sel
     ...
     fi-ini-cod-esp AT ROW 3.83 COL 18.43 COLON-ALIGNED HELP
          "C¢digo da espÇcie do documento"
     fi-fin-cod-esp AT ROW 3.83 COL 49.29 COLON-ALIGNED HELP
          "C¢digo da espÇcie do documento" NO-LABEL
     fi-ini-cod-rep AT ROW 4.83 COL 18.43 COLON-ALIGNED HELP
          "C¢digo do representante principal"
     fi-fin-cod-rep AT ROW 4.83 COL 49.29 COLON-ALIGNED HELP
          "C¢digo do representante principal" NO-LABEL
     fi-ini-dt-emissao AT ROW 5.83 COL 18.43 COLON-ALIGNED
     fi-fin-dt-emissao AT ROW 5.83 COL 49.29 COLON-ALIGNED NO-LABEL
     IMAGE-57 AT ROW 5.83 COL 31.57
     IMAGE-58 AT ROW 5.83 COL 47.14
     IMAGE-59 AT ROW 3.83 COL 31.57
     IMAGE-60 AT ROW 3.83 COL 47.14
     IMAGE-61 AT ROW 4.83 COL 31.57
     IMAGE-62 AT ROW 4.83 COL 47.14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 2.72 ROW 2.83
         SIZE 77.43 BY 10.83
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Notas de DÇbito por Representante"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Notas de DÇbito por Representante */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Notas de DÇbito por Representante */
DO:
...
{utp/ut9000.i "ESCR0003" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-17 RECT-7 RECT-9 rs-destino rs-tipo-rel bt-config-impr bt-arquivo 
         c-arquivo rs-execucao 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-imp}
  DISPLAY tg-impr-param 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-35 tg-impr-param 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-par}
  DISPLAY fi-ep-codigo fi-razao-social fi-cod-estabel fi-nome-estabel 
          fi-ini-cod-esp fi-fin-cod-esp fi-ini-cod-rep fi-fin-cod-rep 
          fi-ini-dt-emissao fi-fin-dt-emissao 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-57 IMAGE-58 IMAGE-59 IMAGE-60 IMAGE-61 IMAGE-62 fi-ep-codigo 
         fi-cod-estabel fi-ini-cod-esp fi-fin-cod-esp fi-ini-cod-rep 
         fi-fin-cod-rep fi-ini-dt-emissao fi-fin-dt-emissao 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/escr0003rp.p} 
