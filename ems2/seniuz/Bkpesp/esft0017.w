...
DEFINE VARIABLE cb-mercado AS CHARACTER FORMAT "X(256)":U INITIAL "Todos" 
     ...
     LIST-ITEMS "Interno","Externo","Zona Franca","Todos" 
     DROP-DOWN-LIST
...
DEFINE VARIABLE rs-cod-descr AS INTEGER INITIAL 1 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "C¢digo", 1,
"Descri‡Æo", 2
...
DEFINE VARIABLE tg-abe-item AS LOGICAL INITIAL yes 
     LABEL "Abertos" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .58 NO-UNDO.

DEFINE VARIABLE tg-abe-ped AS LOGICAL INITIAL yes 
     LABEL "Abertos" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .58 NO-UNDO.

DEFINE VARIABLE tg-atp-item AS LOGICAL INITIAL yes 
     LABEL "Atendidos Parcial" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .58 NO-UNDO.

DEFINE VARIABLE tg-atp-ped AS LOGICAL INITIAL yes 
     LABEL "Atendidos Parcial" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .58 NO-UNDO.

DEFINE VARIABLE tg-att-item AS LOGICAL INITIAL no 
     LABEL "Atendidos Total" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .58 NO-UNDO.

DEFINE VARIABLE tg-att-ped AS LOGICAL INITIAL no 
     LABEL "Atendidos Total" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .58 NO-UNDO.

DEFINE VARIABLE tg-can-item AS LOGICAL INITIAL no 
     LABEL "Cancelados" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .58 NO-UNDO.

DEFINE VARIABLE tg-can-ped AS LOGICAL INITIAL no 
     LABEL "Cancelados" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .58 NO-UNDO.
...
DEFINE VARIABLE tg-out-item AS LOGICAL INITIAL no 
     LABEL "Outros" 
     VIEW-AS TOGGLE-BOX
     SIZE 11.57 BY .83 NO-UNDO.

DEFINE VARIABLE tg-out-ped AS LOGICAL INITIAL no 
     LABEL "Outros" 
     VIEW-AS TOGGLE-BOX
     SIZE 11.57 BY .83 NO-UNDO.

DEFINE VARIABLE tg-pen-item AS LOGICAL INITIAL no 
     LABEL "Pendentes" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .58 NO-UNDO.

DEFINE VARIABLE tg-pen-ped AS LOGICAL INITIAL no 
     LABEL "Pendentes" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .58 NO-UNDO.
...
DEFINE VARIABLE tg-sus-item AS LOGICAL INITIAL yes 
     LABEL "Suspensos" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .58 NO-UNDO.

DEFINE VARIABLE tg-sus-ped AS LOGICAL INITIAL yes 
     LABEL "Suspensos" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .58 NO-UNDO.
...
DEFINE VARIABLE fi-fim-no-ab-reppri AS CHARACTER FORMAT "X(12)" INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .88 TOOLTIP "C¢digo ou Nome-abreviado do Representante final." NO-UNDO.

DEFINE VARIABLE fi-fim-nome-abrev AS CHARACTER FORMAT "X(12)" INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .88 TOOLTIP "C¢digo ou Nome-abreviado do Cliente final." NO-UNDO.

DEFINE VARIABLE fi-fim-nome-transp AS CHARACTER FORMAT "x(12)" INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 TOOLTIP "Transportador final" NO-UNDO.

DEFINE VARIABLE fi-fim-perc-comis AS DECIMAL FORMAT ">>9.999" INITIAL 999.999 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-ini-no-ab-reppri AS CHARACTER FORMAT "X(12)":U 
     LABEL "Representante" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .88 TOOLTIP "C¢digo ou Nome-abreviado do Representante inicial." NO-UNDO.

DEFINE VARIABLE fi-ini-nome-abrev AS CHARACTER FORMAT "X(12)" 
     LABEL "Cliente":R17 
     VIEW-AS FILL-IN 
     SIZE 13 BY .88 TOOLTIP "C¢digo ou Nome-abreviado do Cliente inicial." NO-UNDO.

DEFINE VARIABLE fi-ini-nome-transp AS CHARACTER FORMAT "x(12)" 
     LABEL "Transportador":R16 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 TOOLTIP "Transportador inicial" NO-UNDO.

DEFINE VARIABLE fi-ini-perc-comis AS DECIMAL FORMAT ">>9.999" INITIAL 0 
     LABEL "% ComissÆo":R8 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.
...
DEFINE FRAME f-relat
     bt-executar AT ROW 14.33 COL 3 HELP
          "Dispara a execu‡Æo do relat¢rio"
     bt-cancelar AT ROW 14.33 COL 14 HELP
          "Fechar"
     bt-ajuda AT ROW 14.33 COL 70 HELP
          "Ajuda"
...
DEFINE FRAME f-pg-sel
     fi-ini-no-ab-reppri AT ROW 1.63 COL 19 COLON-ALIGNED
     fi-fim-no-ab-reppri AT ROW 1.63 COL 48 COLON-ALIGNED HELP
          "Nome abreviado do representante principal" NO-LABEL
     fi-ini-nome-abrev AT ROW 2.63 COL 19 COLON-ALIGNED HELP
          "Nome abreviado do cliente/fornecedor"
     fi-fim-nome-abrev AT ROW 2.63 COL 48 COLON-ALIGNED HELP
          "Nome abreviado do cliente/fornecedor" NO-LABEL
     fi-ini-ge-codigo AT ROW 3.63 COL 19 COLON-ALIGNED
     fi-fim-ge-codigo AT ROW 3.63 COL 48 COLON-ALIGNED NO-LABEL
     fi-ini-it-codigo AT ROW 4.54 COL 19 COLON-ALIGNED
     fi-fim-it-codigo AT ROW 4.63 COL 48 COLON-ALIGNED NO-LABEL
     fi-ini-cod-refer AT ROW 5.63 COL 19 COLON-ALIGNED HELP
          "C¢digo de referˆncia do item"
     fi-fim-cod-refer AT ROW 5.63 COL 48 COLON-ALIGNED HELP
          "C¢digo de referˆncia do item" NO-LABEL
     fi-ini-dt-entrega AT ROW 6.63 COL 19 COLON-ALIGNED
     fi-fim-dt-entrega AT ROW 6.63 COL 48 COLON-ALIGNED NO-LABEL
     fi-ini-dt-implant AT ROW 7.63 COL 19 COLON-ALIGNED
     fi-fim-dt-implant AT ROW 7.63 COL 48 COLON-ALIGNED NO-LABEL
     fi-ini-dt-cancel AT ROW 8.63 COL 19 COLON-ALIGNED
     fi-fim-dt-cancel AT ROW 8.63 COL 48 COLON-ALIGNED NO-LABEL
     fi-ini-perc-comis AT ROW 9.63 COL 19 COLON-ALIGNED
     fi-fim-perc-comis AT ROW 9.63 COL 48 COLON-ALIGNED NO-LABEL
     fi-ini-nome-transp AT ROW 10.63 COL 19 COLON-ALIGNED HELP
          "Nome do transportador"
     fi-fim-nome-transp AT ROW 10.63 COL 48 COLON-ALIGNED HELP
          "Nome do transportador" NO-LABEL
     IMAGE-10 AT ROW 1.63 COL 46.57
     IMAGE-19 AT ROW 3.63 COL 39
     IMAGE-20 AT ROW 3.63 COL 46.57
     IMAGE-21 AT ROW 4.63 COL 39
     IMAGE-22 AT ROW 4.63 COL 46.57
     IMAGE-23 AT ROW 8.63 COL 39
     IMAGE-24 AT ROW 8.63 COL 46.57
     IMAGE-25 AT ROW 9.63 COL 39
     IMAGE-26 AT ROW 9.63 COL 46.57
     IMAGE-27 AT ROW 5.63 COL 39
     IMAGE-28 AT ROW 5.63 COL 46.57
     IMAGE-29 AT ROW 10.63 COL 39
     IMAGE-3 AT ROW 7.58 COL 39
     IMAGE-30 AT ROW 10.63 COL 46.57
     IMAGE-4 AT ROW 7.63 COL 46.57
     IMAGE-5 AT ROW 6.63 COL 39
     IMAGE-6 AT ROW 6.63 COL 46.57
     IMAGE-7 AT ROW 2.63 COL 39
     IMAGE-8 AT ROW 2.63 COL 46.57
     IMAGE-9 AT ROW 1.63 COL 39
...
DEFINE FRAME f-pg-par
     tg-crd-nava AT ROW 2.21 COL 38.43
     tg-abe-ped AT ROW 2.25 COL 3.14
     tg-abe-item AT ROW 2.25 COL 20.57
     rs-cond-pagto AT ROW 2.33 COL 60.86 NO-LABEL
     tg-crd-aval AT ROW 3.04 COL 38.43
     tg-atp-ped AT ROW 3.17 COL 3.14
     tg-atp-item AT ROW 3.17 COL 20.57
     tg-crd-aprv AT ROW 3.92 COL 38.43
     tg-att-ped AT ROW 4.13 COL 3.14
     tg-att-item AT ROW 4.13 COL 20.57
     tg-crd-repr AT ROW 4.79 COL 38.43
     tg-pen-ped AT ROW 5.08 COL 3.14
     tg-pen-item AT ROW 5.08 COL 20.57
     tg-sus-ped AT ROW 6.04 COL 3.14
     tg-sus-item AT ROW 6.04 COL 20.57
     cb-mercado AT ROW 6.38 COL 46.86 COLON-ALIGNED
     tg-can-ped AT ROW 7 COL 3.14
     tg-can-item AT ROW 7 COL 20.57
     rs-qtd-ped AT ROW 7.63 COL 58.43 NO-LABEL
     tg-out-ped AT ROW 7.83 COL 3.14
     tg-out-item AT ROW 7.83 COL 20.57
     rs-tp-relat AT ROW 9.08 COL 41.43 NO-LABEL
     tg-tp-pedido AT ROW 9.21 COL 3.86
     rs-cod-descr AT ROW 9.83 COL 53.86 NO-LABEL
     ...
     tg-pula-pag AT ROW 10.54 COL 28.29
     tg-impr-param AT ROW 10.67 COL 57
     RECT-17 AT ROW 1.17 COL 1
     RECT-18 AT ROW 1.75 COL 2
     RECT-19 AT ROW 1.75 COL 36.86
     RECT-20 AT ROW 1.79 COL 54.86
     RECT-21 AT ROW 5.96 COL 36.86
     RECT-22 AT ROW 9 COL 2
     RECT-23 AT ROW 1.75 COL 19.43
     RECT-32 AT ROW 9 COL 25.43
     "  Situa‡Æo de Pedidos" VIEW-AS TEXT
          SIZE 15.29 BY .75 AT ROW 1.42 COL 2.72
     " Condi‡Æo de Cr‚dito" VIEW-AS TEXT
          SIZE 14.86 BY .75 AT ROW 1.46 COL 38.29
     "Listar pela Quantidade:" VIEW-AS TEXT
          SIZE 15.86 BY .88 AT ROW 7.54 COL 42
     " Condi‡Æo de Pagamento" VIEW-AS TEXT
          SIZE 17.43 BY .75 AT ROW 1.5 COL 56.57
     "Tiipo de Relat¢rio:" VIEW-AS TEXT
          SIZE 13 BY .88 AT ROW 9.04 COL 28
     "Pedidos do Tipo:" VIEW-AS TEXT
          SIZE 12 BY .75 AT ROW 10.38 COL 6.86
     "Imprimir C¢digo ou Descri‡Æo do Item:" VIEW-AS TEXT
          SIZE 26 BY .88 AT ROW 9.79 COL 28
     "  Situa‡Æo de Itens" VIEW-AS TEXT
          SIZE 13.86 BY .75 AT ROW 1.42 COL 21
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.71
         SIZE 77.14 BY 10.92
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Pedidos Venda por Representante/Cliente"
         COLUMN             = 14.57
         ROW                = 8.79
         HEIGHT             = 15
         WIDTH              = 80.72
...
ON END-ERROR OF w-relat /* Pedidos Venda por Representante/Cliente */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Pedidos Venda por Representante/Cliente */
DO:
...
&Scoped-define SELF-NAME fi-fim-nome-transp
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-fim-nome-transp w-relat
ON MOUSE-SELECT-DBLCLICK OF fi-fim-nome-transp IN FRAME f-pg-sel
DO:
  {include/zoomvar.i &prog-zoom = adzoom/z01ad268.w
                     &campo     = fi-fim-nome-transp
                     &campozoom = nome-abrev
                     &FRAME     = f-pg-sel}
END.
...
&Scoped-define SELF-NAME tg-can-ped
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tg-can-ped w-relat
ON VALUE-CHANGED OF tg-can-ped IN FRAME f-pg-par /* Cancelados */
DO:
  IF INPUT FRAME {&FRAME-NAME} tg-can-ped = "YES" THEN
     ASSIGN tg-abe-ped:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "YES"
            tg-atp-ped:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "YES"
            tg-att-ped:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "YES"
            tg-pen-ped:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "YES"
            tg-sus-ped:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "YES" 
            tg-out-ped:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "YES"
            tg-abe-item:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "NO"
            tg-atp-item:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "NO"
            tg-att-item:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "NO"
            tg-pen-item:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "NO"
            tg-sus-item:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "NO"
            tg-can-item:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "YES"
            tg-out-item:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "NO".
  ELSE
     ASSIGN tg-abe-ped:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "YES"
            tg-atp-ped:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "YES"
            tg-att-ped:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "NO"
            tg-pen-ped:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "NO"
            tg-sus-ped:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "YES"
            tg-out-ped:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "NO"
            tg-abe-item:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "YES"
            tg-atp-item:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "YES"
            tg-att-item:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "NO" 
            tg-pen-item:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "NO" 
            tg-sus-item:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "YES"
            tg-can-item:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "NO" 
            tg-out-item:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "NO". 
END.
...
{utp/ut9000.i "ESFT0017" "2.04.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    fi-fim-nome-transp:LOAD-MOUSE-POINTER("image/lupa.cur") IN FRAME f-pg-sel.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY tg-crd-nava tg-abe-ped tg-abe-item rs-cond-pagto tg-crd-aval 
          tg-atp-ped tg-atp-item tg-crd-aprv tg-att-ped tg-att-item tg-crd-repr 
          tg-pen-ped tg-pen-item tg-sus-ped tg-sus-item cb-mercado tg-can-ped 
          tg-can-item rs-qtd-ped tg-out-ped tg-out-item rs-tp-relat tg-tp-pedido 
          rs-cod-descr fi-tp-pedido tg-pula-pag tg-impr-param 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE tg-crd-nava tg-abe-ped tg-abe-item rs-cond-pagto tg-crd-aval 
         tg-atp-ped tg-atp-item tg-crd-aprv tg-att-ped tg-att-item tg-crd-repr 
         tg-pen-ped tg-pen-item tg-sus-ped tg-sus-item cb-mercado tg-can-ped 
         tg-can-item rs-qtd-ped tg-out-ped tg-out-item rs-tp-relat tg-tp-pedido 
         rs-cod-descr tg-pula-pag tg-impr-param RECT-17 RECT-18 RECT-19 RECT-20 
  ...
  DISPLAY fi-ini-no-ab-reppri fi-fim-no-ab-reppri fi-ini-nome-abrev 
          ...
          fi-ini-nome-transp fi-fim-nome-transp 
  ...
  ENABLE fi-ini-no-ab-reppri fi-fim-no-ab-reppri fi-ini-nome-abrev 
         ...
         fi-ini-nome-transp fi-fim-nome-transp IMAGE-10 IMAGE-19 IMAGE-20 
         IMAGE-21 IMAGE-22 IMAGE-23 IMAGE-24 IMAGE-25 IMAGE-26 IMAGE-27 
         IMAGE-28 IMAGE-29 IMAGE-3 IMAGE-30 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 
         IMAGE-8 IMAGE-9 RECT-24 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    /*:T Coloque aqui a l¢gica de grava‡Æo dos demais campos que devem ser passados
     ...
     ASSIGN tt-param.c-repres-ini  = input frame f-pg-sel fi-ini-no-ab-reppri
            ...
            tt-param.c-transp-ini  = input frame f-pg-sel fi-ini-nome-transp
            tt-param.c-transp-fim  = input frame f-pg-sel fi-fim-nome-transp
            ...
            tt-param.l-ped-abe     = INPUT FRAME f-pg-par tg-abe-ped
            tt-param.l-ped-atp     = INPUT FRAME f-pg-par tg-atp-ped
            tt-param.l-ped-att     = INPUT FRAME f-pg-par tg-att-ped
            tt-param.l-ped-pen     = INPUT FRAME f-pg-par tg-pen-ped
            tt-param.l-ped-sus     = INPUT FRAME f-pg-par tg-sus-ped
            tt-param.l-ped-can     = INPUT FRAME f-pg-par tg-can-ped
            tt-param.l-ped-out     = INPUT FRAME f-pg-par tg-out-ped
            tt-param.l-item-abe    = INPUT FRAME f-pg-par tg-abe-item
            tt-param.l-item-atp    = INPUT FRAME f-pg-par tg-atp-item
            tt-param.l-item-att    = INPUT FRAME f-pg-par tg-att-item
            tt-param.l-item-pen    = INPUT FRAME f-pg-par tg-pen-item
            tt-param.l-item-sus    = INPUT FRAME f-pg-par tg-sus-item
            tt-param.l-item-can    = INPUT FRAME f-pg-par tg-can-item
            tt-param.l-ped-out     = INPUT FRAME f-pg-par tg-out-item
            ...
            tt-param.c-cod-descr   = IF INPUT FRAME f-pg-par rs-cod-descr = 1
                                        THEN "C"
                                        ELSE "D"
    ...
    {include/i-rprun.i esrp/esft0017rp.p} 
