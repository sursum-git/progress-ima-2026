FOR EACH movto_cta_corren
    WHERE movto_cta_corren.cod_cta_corren = '5178-0'
    AND   movto_cta_corren.dat_movto_cta_corren = 05.18.2017 
    AND   movto_cta_corren.num_seq_movto_cta_corren = 50:
    ASSIGN cod_tip_trans_cx = '008'.
    FOR EACH aprop_ctbl_cmg OF movto_cta_corren EXCLUSIVE-LOCK.
        UPDATE aprop_ctbl_cmg WITH 1 COL WIDTH 550.
