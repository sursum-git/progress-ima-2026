...
&Scoped-define FIELDS-IN-QUERY-br-usr-connect tt-usr-connect.cod-usuario tt-usr-connect.maquina tt-usr-connect.pid tt-usr-connect.login   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-usr-connect C-Win _FREEFORM
  QUERY br-usr-connect NO-LOCK DISPLAY
      ...
      tt-usr-connect.pid            FORMAT ">>>>9"  COLUMN-LABEL "PID"      WIDTH 5
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH tt-usr BREAK BY tt-usr.pid.
