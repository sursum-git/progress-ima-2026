...
*******************************************************************************/
{include/i-prgvrs.i ESFT9991 9.99.99.999}
...
&Scoped-Define ENABLED-OBJECTS rt-button fi_nf_ini bt_executar fi_estab ~
fi_serie_ini 
&Scoped-Define DISPLAYED-OBJECTS fi_nf_ini fi_estab fi_serie_ini 
...
DEFINE FRAME f-cad
     fi_nf_ini AT ROW 3.88 COL 44.43 COLON-ALIGNED WIDGET-ID 10
     bt_executar AT ROW 3.88 COL 62 WIDGET-ID 36
     fi_estab AT ROW 3.92 COL 18.14 COLON-ALIGNED WIDGET-ID 2
     fi_serie_ini AT ROW 3.92 COL 31.14 COLON-ALIGNED WIDGET-ID 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-livre ASSIGN
         HIDDEN             = YES
         TITLE              = "Acertar PIS/COFINS Notas de Importaá∆o"
         HEIGHT             = 5.04
         WIDTH              = 89.72
         MAX-HEIGHT         = 27.5
         MAX-WIDTH          = 195.14
...
ON END-ERROR OF w-livre /* Acertar PIS/COFINS Notas de Importaá∆o */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-livre w-livre
ON WINDOW-CLOSE OF w-livre /* Acertar PIS/COFINS Notas de Importaá∆o */
DO:
  ...
  FOR EACH nota-fiscal NO-LOCK
      ...
      FOR EACH it-nota-fisc OF nota-fiscal NO-LOCK.
          ...
          FIND FIRST item-doc-est OF docum-est 
               ...
               AND   item-doc-est.sequencia = it-nota-fisc.nr-seq-fat
               NO-LOCK NO-ERROR.
          IF AVAIL ext-it-nota-fisc AND AVAIL item-doc-est THEN DO:
             //ASSIGN dAliqCOFINS = dec(substr(item-doc-est.char-2,609,4)).
             ASSIGN  ext-it-nota-fisc.val-livre-3 = item-doc-est.valor-pis
                     ext-it-nota-fisc.val-livre-6 = item-doc-est.val-cofins    // / item-doc-est.val-aliq-cofins * (dAliqCofins)
                     ext-it-nota-fisc.val-livre-2 = item-doc-est.base-pis
                     ext-it-nota-fisc.val-livre-5 = item-doc-est.val-base-calc-cofins.
          END.
          ELSE DO:
              MESSAGE 'Registro do RE ou da extens∆o do item no faturamento n∆o encontrado'
                  VIEW-AS ALERT-BOX INFO BUTTONS OK.
              RETURN NO-APPLY.
          END.
      END.
  END.
  IF lAchou = NO THEN DO:
      MESSAGE 'A nota fiscal informada n∆o existe ou est† cancelada ou n∆o Ç de importaá∆o'
          VIEW-AS ALERT-BOX INFO BUTTONS OK.
  END.
  ELSE DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             fi_nf_ini:HANDLE IN FRAME f-cad , 'BEFORE':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  DISPLAY fi_nf_ini fi_estab fi_serie_ini 
      WITH FRAME f-cad IN WINDOW w-livre.
  ENABLE rt-button fi_nf_ini bt_executar fi_estab fi_serie_ini 
      WITH FRAME f-cad IN WINDOW w-livre.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESFT9991" "9.99.99.999"}
