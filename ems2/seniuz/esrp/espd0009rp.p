/* Programa: ESPD0009RP.P
** Autor...: Gilvando Souza Araujo
** Data....: 26/01/2004
** Observ..: Chamado pelo programa ESPD0009.W
*/

/* include de controle de versÆo */
{include/i-prgvrs.i ESPD0009RP 2.04.00.000}
...
form
    ...
    de-naprov-res  at 67
    header
    "CONDICOES PARA FATURAMENTO   PEDIDOS         VALOR      QUANTIDADE      RESERVA"
...
{utp/ut-liter.i Estat¡stica_de_Pedidos_de_Vendas_Cancelados * r}
...
for each ped-venda where ped-venda.dt-entrega  >= tt-param.dt-entrega-ini
   ...
   if ped-venda.cod-sit-aval = 2 /* Credito Aprovado */
