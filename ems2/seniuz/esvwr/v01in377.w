...
&Scoped-Define ENABLED-OBJECTS rt-key rt-mold bt-desenho 
...
fi-cod-fundo fi-cor fi-colecao cb-estilo-desenho 
...
DEFINE VARIABLE cb-estilo-desenho AS CHARACTER FORMAT "X(15)":U 
     LABEL "Estilo Desenho" 
     VIEW-AS COMBO-BOX INNER-LINES 10
     LIST-ITEMS "Liso","Abstrato","Animal","Barrado","Bola","Camisaria","Camuflado","Cashimier","Copa","Coqueiro","Coracao","Esportivo","Floral","Folhagem","Fruta","Geometrico","Indiano","Infantil","Junino","Laco","Listra","Manchado","Patchwork","Ped Pule","Spatulatto","Surfwear","Tye-die","Xadrez" 
     DROP-DOWN-LIST
...
DEFINE FRAME f-main
     ...
     referencia.descricao AT ROW 2.58 COL 13 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 33.14 BY .88
     bt-desenho AT ROW 2.75 COL 82 WIDGET-ID 8
     ...
     tg-var9 AT ROW 3.58 COL 72
          ...
          "Colecao do item"
     cb-estilo-desenho AT ROW 8.58 COL 13 COLON-ALIGNED WIDGET-ID 6
...
/* SETTINGS FOR COMBO-BOX cb-estilo-desenho IN FRAME f-main
   NO-ENABLE 1                                                          */
...
ON CHOOSE OF bt-desenho IN FRAME f-main /* Des */
DO:
...
------------------------------------------------------------------------------*/
    ...
    IF NOT AVAIL referencia-ext THEN DO:
       ...
       ASSIGN referencia-ext.cod-refer      = referencia.cod-refer
              ...
              referencia-ext.estilo-desenho = INPUT FRAME {&FRAME-NAME} cb-estilo-desenho.
    END.
    ELSE DO:
    ...
    IF AVAIL referencia THEN DO:
       ...
       IF AVAIL referencia-ext THEN DO.
          ASSIGN fi-cod-obsoleto:SCREEN-VALUE IN FRAME {&FRAME-NAME}   = referencia-ext.cod-obsoleto
                 ...
                 cb-estilo-desenho:SCREEN-VALUE IN FRAME {&FRAME-NAME} = referencia-ext.estilo-desenho.
       END.
...
------------------------------------------------------------------------------*/
    ...
    IF adm-new-record = NO THEN
       ASSIGN referencia.descricao:SENSITIVE IN FRAME {&FRAME-NAME} = NO
              ...
              cb-estilo-desenho:SENSITIVE IN FRAME {&FRAME-NAME}    = YES.
