...
*******************************************************************************/
{include/i-prgvrs.i ESFT0005 2.04.00.000}
...
DEFINE VARIABLE rs-imp-oque AS INTEGER 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Todos", 1,
"Somente Representantes sem e-mail", 2
...
DEFINE FRAME f-pg-par
     to-imp-param AT ROW 1.92 COL 48.29
     ...
     rs-imp-oque AT ROW 1.88 COL 8 NO-LABEL
...
DEFINE FRAME f-pg-sel
     fi-ini-cod-estabel AT ROW 1.54 COL 15.29 COLON-ALIGNED
     fi-fin-cod-estabel AT ROW 1.54 COL 42.14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     fi-ini-dt-emissao AT ROW 2.54 COL 15.29 COLON-ALIGNED HELP
          "Data prevista para entrega do Pedido"
     fi-fin-dt-emissao AT ROW 2.54 COL 42.14 COLON-ALIGNED HELP
          "Data prevista para entrega do Pedido" NO-LABEL
     fi-ini-cod-emitente AT ROW 3.54 COL 15.29 COLON-ALIGNED HELP
          "C¢digo do emitente"
     fi-fin-cod-emitente AT ROW 3.54 COL 42.14 COLON-ALIGNED HELP
          "C¢digo do emitente" NO-LABEL
     fi-ini-cod-rep AT ROW 4.54 COL 15.29 COLON-ALIGNED HELP
          "C¢digo do representante"
     fi-fin-cod-rep AT ROW 4.54 COL 42.14 COLON-ALIGNED HELP
          "C¢digo do representante" NO-LABEL
     IMAGE-1 AT ROW 2.54 COL 27.72
     IMAGE-2 AT ROW 2.54 COL 40.57
     IMAGE-3 AT ROW 3.54 COL 27.72
     IMAGE-4 AT ROW 4.54 COL 27.72
     IMAGE-6 AT ROW 3.54 COL 40.57
     IMAGE-7 AT ROW 4.54 COL 40.57
     IMAGE-8 AT ROW 1.54 COL 27.72 WIDGET-ID 4
     IMAGE-9 AT ROW 1.54 COL 40.57 WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 4 ROW 3.21
         SIZE 75.86 BY 10.25
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Notas Fiscais Emitidas por Representante"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Notas Fiscais Emitidas por Representante */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Notas Fiscais Emitidas por Representante */
DO:
...
DO:
  IF INPUT FRAME {&frame-name} to-enviar-e-mail = YES THEN DO:
     ...
     ASSIGN fi-assunto-e-mail:SCREEN-VALUE IN FRAME f-pg-par = "Pedidos Faturados - #PER-INI a #PER-FIN".

     ASSIGN fi-texto-e-mail:SCREEN-VALUE IN FRAME f-pg-par = 
            "Segue anexo Relaá∆o de Pedidos faturados no per°odo de #PER-INI a #PER-FIN." +
...
{utp/ut9000.i "ESFT0005" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY to-imp-param to-enviar-e-mail fi-texto-e-mail rs-imp-oque 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE to-imp-param to-enviar-e-mail rs-imp-oque RECT-13 RECT-27 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-par}
  DISPLAY fi-ini-cod-estabel fi-fin-cod-estabel fi-ini-dt-emissao 
          fi-fin-dt-emissao fi-ini-cod-emitente fi-fin-cod-emitente 
          fi-ini-cod-rep fi-fin-cod-rep 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-6 IMAGE-7 IMAGE-8 IMAGE-9 
         fi-ini-cod-estabel fi-fin-cod-estabel fi-ini-dt-emissao 
         fi-fin-dt-emissao fi-ini-cod-emitente fi-fin-cod-emitente 
         fi-ini-cod-rep fi-fin-cod-rep 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.ini-cod-estabel  = INPUT FRAME f-pg-sel fi-ini-cod-estabel
           tt-param.fin-cod-estabel  = INPUT FRAME f-pg-sel fi-fin-cod-estabel
           ...
           tt-param.imp-oque         = INPUT FRAME f-pg-par rs-imp-oque
           tt-param.desc-imp-oque    = entry((tt-param.imp-oque - 1) * 2 + 1, 
                                              rs-imp-oque:radio-buttons in frame f-pg-par)
