...
FOR EACH ITEM WHERE 
    ...
    FOR EACH saldo-estoq USE-INDEX item WHERE
        ...
        /*IF saldo-estoq.cod-refer <> '218' THEN NEXT.*/
    ...
    FOR EACH ob-etiqueta WHERE
             ...
             ob-etiqueta.it-codigo = ITEM.it-codigo NO-LOCK.

        /*IF ob-etiqueta.cod-refer <> '218' THEN NEXT.*/
...
FOR EACH tt-itens WHERE
    ...
    DISP tt-itens.it-codigo
         ...
         tt-itens.lote
         tt-itens.qtidade-atu - tt-itens.qtidade-etq
         tt-itens.qtidade-atu COLUMN-LABEL "Qtde Atu" 
         tt-itens.qtidade-etq COLUMN-LABEL "Qtde Etq"
...
------------------------------------------------------------------------------*/
    ...
    IF AVAIL tt-erro THEN DO.
       FOR EACH tt-erro.
           MESSAGE "Erro ao acertar o item " SKIP
                   tt-erro.mensagem
