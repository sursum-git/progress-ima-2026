...
*******************************************************************************/
{include/i-prgvrs.i ESFT0027 2.04.00.000}
...
DEFINE FRAME f-pg-par
     rs-emit-dup AT ROW 2.54 COL 6.57 NO-LABEL
     rs-nota-can AT ROW 2.58 COL 43.72 NO-LABEL
     cb-mercado AT ROW 5.75 COL 32.29 COLON-ALIGNED
     tg-impr-param AT ROW 9.17 COL 33
     RECT-17 AT ROW 1.25 COL 1
     RECT-20 AT ROW 2.08 COL 4.14
     RECT-21 AT ROW 4.75 COL 4
     RECT-23 AT ROW 2.13 COL 40
     RECT-32 AT ROW 8.46 COL 4
     " Emite Duplicata" VIEW-AS TEXT
          SIZE 12.29 BY .75 AT ROW 1.79 COL 5.14
     " Notas Canceladas" VIEW-AS TEXT
          SIZE 14 BY .75 AT ROW 1.83 COL 42.29
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.71
         SIZE 77.14 BY 10.92
...
DEFINE FRAME f-pg-sel
     ...
     fi-fim-cod-estabel AT ROW 1.88 COL 48 COLON-ALIGNED NO-LABEL
     fi-ini-no-ab-reppri AT ROW 2.88 COL 19 COLON-ALIGNED
     fi-fim-no-ab-reppri AT ROW 2.88 COL 48 COLON-ALIGNED HELP
          "Nome abreviado do representante principal" NO-LABEL
     fi-ini-nome-abrev AT ROW 3.88 COL 19 COLON-ALIGNED HELP
          "Nome abreviado do cliente/fornecedor"
     fi-fim-nome-abrev AT ROW 3.88 COL 48 COLON-ALIGNED HELP
          "Nome abreviado do cliente/fornecedor" NO-LABEL
     fi-ini-ge-codigo AT ROW 4.88 COL 19 COLON-ALIGNED
     fi-fim-ge-codigo AT ROW 4.88 COL 48 COLON-ALIGNED NO-LABEL
     fi-ini-it-codigo AT ROW 5.79 COL 19 COLON-ALIGNED
     fi-fim-it-codigo AT ROW 5.79 COL 48 COLON-ALIGNED NO-LABEL
     cb-ini-esp-docto AT ROW 6.88 COL 19 COLON-ALIGNED
     cb-fim-esp-docto AT ROW 6.88 COL 48 COLON-ALIGNED NO-LABEL
     fi-ini-dt-emissao AT ROW 7.88 COL 19 COLON-ALIGNED
     fi-fim-dt-emissao AT ROW 7.88 COL 48 COLON-ALIGNED NO-LABEL
     fi-ini-cond-pagto AT ROW 8.88 COL 19 COLON-ALIGNED
     fi-fim-cond-pagto AT ROW 8.88 COL 48 COLON-ALIGNED NO-LABEL
     fi-ini-natur-oper AT ROW 9.88 COL 19 COLON-ALIGNED HELP
          "Natureza de opera‡Æo"
     fi-fim-natur-oper AT ROW 9.88 COL 48 COLON-ALIGNED NO-LABEL
     IMAGE-10 AT ROW 2.88 COL 46.57
     IMAGE-19 AT ROW 4.88 COL 39
     IMAGE-20 AT ROW 4.88 COL 46.57
     IMAGE-21 AT ROW 5.88 COL 39
     IMAGE-22 AT ROW 5.88 COL 46.57
     IMAGE-23 AT ROW 8.88 COL 39
     IMAGE-24 AT ROW 8.88 COL 46.57
     IMAGE-25 AT ROW 9.96 COL 39
     IMAGE-26 AT ROW 9.96 COL 46.57
     IMAGE-29 AT ROW 1.92 COL 38.86
     IMAGE-3 AT ROW 7.88 COL 39
     IMAGE-30 AT ROW 1.92 COL 46.57
     IMAGE-4 AT ROW 7.88 COL 46.57
     IMAGE-5 AT ROW 6.88 COL 39
     IMAGE-6 AT ROW 6.88 COL 46.57
     IMAGE-7 AT ROW 3.88 COL 39
     IMAGE-8 AT ROW 3.88 COL 46.57
     IMAGE-9 AT ROW 2.88 COL 39
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Faturamento por Representante/Estado"
         COLUMN             = 14
         ROW                = 6.88
         HEIGHT             = 15.04
         WIDTH              = 80.72
...
ON END-ERROR OF w-relat /* Faturamento por Representante/Estado */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Faturamento por Representante/Estado */
DO:
...
{utp/ut9000.i "ESFT0027" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY rs-emit-dup rs-nota-can cb-mercado tg-impr-param 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE rs-emit-dup rs-nota-can cb-mercado tg-impr-param RECT-17 RECT-20 
         RECT-21 RECT-23 RECT-32 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ...
  DISPLAY fi-ini-cod-estabel fi-fim-cod-estabel fi-ini-no-ab-reppri 
          ...
          cb-ini-esp-docto cb-fim-esp-docto fi-ini-dt-emissao fi-fim-dt-emissao 
          fi-ini-cond-pagto fi-fim-cond-pagto fi-ini-natur-oper 
          fi-fim-natur-oper 
  ...
  ENABLE fi-ini-cod-estabel fi-fim-cod-estabel fi-ini-no-ab-reppri 
         ...
         fi-fim-natur-oper IMAGE-10 IMAGE-19 IMAGE-20 IMAGE-21 IMAGE-22 
         IMAGE-23 IMAGE-24 IMAGE-25 IMAGE-26 IMAGE-29 IMAGE-3 IMAGE-30 IMAGE-4 
         IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 IMAGE-9 RECT-24 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/esft0027rp.p} 
