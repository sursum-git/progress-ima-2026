...
*******************************************************************************/
{include/i-prgvrs.i ESFT0002 2.04.00.000}
...
DEFINE VARIABLE to-emite-dup AS LOGICAL INITIAL yes 
     LABEL "Apenas Notas que geraram duplicata" 
     VIEW-AS TOGGLE-BOX
     SIZE 29.29 BY .83 TOOLTIP "Considerar apenas notas que emitem duplicata."
     FONT 1 NO-UNDO.
...
DEFINE FRAME f-pg-par
     to-imp-param AT ROW 4.88 COL 47.86
     to-emite-dup AT ROW 4.88 COL 9.29
     RECT-27 AT ROW 4.25 COL 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 77.14 BY 10.5
...
DEFINE FRAME f-pg-sel
     ...
     fi-fin-it-codigo AT ROW 3.54 COL 48.29 COLON-ALIGNED NO-LABEL
     ...
     IMAGE-4 AT ROW 3.54 COL 33.86
     IMAGE-5 AT ROW 4.54 COL 33.86
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Resumo do Faturamento por Natureza de Operaá∆o"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Resumo do Faturamento por Natureza de Operaá∆o */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Resumo do Faturamento por Natureza de Operaá∆o */
DO:
...
{utp/ut9000.i "ESFT0002" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY to-imp-param to-emite-dup 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE to-imp-param to-emite-dup RECT-27 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.emite-dup       = INPUT FRAME f-pg-par to-emite-dup
    ...
    {include/i-rprun.i esrp/esft0002rp.p}
