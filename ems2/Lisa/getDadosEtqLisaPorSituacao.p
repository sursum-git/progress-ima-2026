...
DEFINE INPUT  PARAMETER pSoEstoque      AS LOGICAL     NO-UNDO.
...
DEFINE TEMP-TABLE ttReg NO-UNDO
    ...
    IF pSoEstoque THEN
    DO:
        RUN lisa/consultarEtiquetasEstoque.p(pItCodigo,pCodRefer,pLogAtuEnd,pDtAtuEndIni,pDtAtuEndFim,OUTPUT TABLE ttJson,OUTPUT cErros,NO).    
    END.
    ELSE DO:
