...
DEFINE TEMP-TABLE tt-preco-item NO-UNDO LIKE preco-item
    INDEX ch-itemtab IS PRIMARY it-codigo
                                cod-refer
                                nr-tabpre
                                dt-inival
                                quant-min.
...
*******************************************************************************/
{include/i-prgvrs.i Q03im026 2.04.00.001}
...
&Scoped-define INTERNAL-TABLES tt-preco-item

/* Definitions for QUERY Query-Main                                     */
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH tt-preco-item NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main tt-preco-item
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main tt-preco-item
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "Temp-Tables.tt-preco-item"
