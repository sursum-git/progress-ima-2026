...
*******************************************************************************/
{include/i-prgvrs.i ESFT0015 2.04.00.000}
...
DEFINE VARIABLE fi-fin-cod-rep AS INTEGER FORMAT ">>>>9" INITIAL 99999 
     VIEW-AS FILL-IN 
     SIZE 6 BY .88 TOOLTIP "C¢digo do representante final" NO-UNDO.
...
DEFINE VARIABLE fi-ini-cod-rep AS INTEGER FORMAT ">>>>9" INITIAL 0 
     ...
     VIEW-AS FILL-IN 
     SIZE 6 BY .88 TOOLTIP "C¢digo do representante inicial" NO-UNDO.
...
DEFINE FRAME f-pg-par
     tg-impr-param AT ROW 2.88 COL 30.57
     RECT-17 AT ROW 1.25 COL 1
     RECT-32 AT ROW 2.17 COL 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.71
         SIZE 77.14 BY 10.92
...
DEFINE FRAME f-pg-sel
     fi-ini-cod-estabel AT ROW 1.92 COL 22.86 COLON-ALIGNED
     fi-fin-cod-estabel AT ROW 1.92 COL 44.57 COLON-ALIGNED NO-LABEL
     fi-ini-cod-rep AT ROW 2.92 COL 22.86 COLON-ALIGNED HELP
          "C¢digo do representante"
     fi-fin-cod-rep AT ROW 2.92 COL 44.57 COLON-ALIGNED HELP
          "C¢digo do representante" NO-LABEL
     fi-ini-dt-emissao AT ROW 3.92 COL 22.86 COLON-ALIGNED
     fi-fin-dt-emissao AT ROW 3.92 COL 44.57 COLON-ALIGNED NO-LABEL
     IMAGE-10 AT ROW 2.92 COL 43.14
     IMAGE-29 AT ROW 1.92 COL 35.43
     IMAGE-30 AT ROW 1.92 COL 43.14
     IMAGE-7 AT ROW 3.92 COL 35.57
     IMAGE-8 AT ROW 3.92 COL 43.14
     IMAGE-9 AT ROW 2.92 COL 35.57
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Comiss∆o sobre Vendas das Lojas"
         COLUMN             = 13
         ROW                = 8.58
         HEIGHT             = 15.04
         WIDTH              = 80.72
...
ON END-ERROR OF w-relat /* Comiss∆o sobre Vendas das Lojas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Comiss∆o sobre Vendas das Lojas */
DO:
...
{utp/ut9000.i "ESFT0015" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-ini-cod-estabel fi-fin-cod-estabel fi-ini-cod-rep fi-fin-cod-rep 
          fi-ini-dt-emissao fi-fin-dt-emissao 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-ini-cod-estabel fi-fin-cod-estabel fi-ini-cod-rep fi-fin-cod-rep 
         fi-ini-dt-emissao fi-fin-dt-emissao IMAGE-10 IMAGE-29 IMAGE-30 IMAGE-7 
...
do on error undo, return error on stop  undo, return error:
   ...
   ASSIGN tt-param.estab-ini   = input frame f-pg-sel fi-ini-cod-estabel
          ...
          tt-param.repres-fin  = input frame f-pg-sel fi-fin-cod-rep
    ...
    {include/i-rprun.i esrp/esft0015rp.p} 
