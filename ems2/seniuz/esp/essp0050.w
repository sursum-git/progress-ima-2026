...
*******************************************************************************/
{include/i-prgvrs.i ESSP0050 2.04.00.000}
...
ON END-ERROR OF w-consim /* Testes de NIP */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-consim w-consim
ON WINDOW-CLOSE OF w-consim /* Testes de NIP */
DO:
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es033.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01es033 ).
       RUN set-position IN h_q01es033 ( 1.50 , 62.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0050" "2.04.00.000"}
