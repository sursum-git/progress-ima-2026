...
------------------------------------------------------------------------------*/
  ...
  ENABLE IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 RECT-18 RECT-19 fi-it-codigo 
         fi-ini-cod-refer fi-fim-cod-refer fi-ini-seq fi-fim-seq fi-partida 
         fi-metro fi-embalagem fi-qualidade fi-nuance TOGGLE-1 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-sel}
  DISPLAY rs-destino-ok c-arquivo rs-execucao 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
  ENABLE RECT-7 RECT-9 rs-destino-ok cb-impressoras bt-config-impr bt-arquivo 
