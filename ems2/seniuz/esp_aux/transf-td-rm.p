...
DEF INPUT PARAMETER p-row-movto AS ROWID.

FIND movto-estoq WHERE 
     ROWID(movto-estoq) = p-row-movto NO-ERROR.

IF AVAIL movto-estoq THEN DO:
   ASSIGN c-it-codigo = movto-estoq.it-codigo    
          c-cod-refer = movto-estoq.cod-refer    
          c-lote = movto-estoq.lote              
          de-quantidade = movto-estoq.quantidade
          da-dt-trans = movto-estoq.dt-trans. 
