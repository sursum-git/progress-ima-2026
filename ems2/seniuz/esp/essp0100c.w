...
&Scoped-define FIELDS-IN-QUERY-br-pedidos tt-pedidos.nr-pedcli tt-pedidos.nome-abrev tt-pedidos.dt-entrega tt-pedidos.qt-pedida tt-pedidos.it-codigo tt-pedidos.cod-refer   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-pedidos   
&Scoped-define SELF-NAME br-pedidos
&Scoped-define OPEN-QUERY-br-pedidos RUN pi-totais. OPEN QUERY {&SELF-NAME} FOR EACH tt-pedidos WHERE                                  tt-pedidos.visualiza = YES NO-LOCK, ~
...
tt-pedidos.it-codigo        COLUMN-LABEL "Item" 
tt-pedidos.cod-refer        COLUMN-LABEL "Referˆncia"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME D-Dialog
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         FONT 1
         TITLE "Pedidos Selecionados - ESSP0100C"
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Pedidos Selecionados - ESSP0100C */
DO:  
...
DO:
   ...
   ASSIGN tt-param.usuario          = c-seg-usuario
          ...
          tt-param.estabel-ini      = tt-pedidos.cod-estabel
          tt-param.estabel-fin      = tt-pedidos.cod-estabel 
