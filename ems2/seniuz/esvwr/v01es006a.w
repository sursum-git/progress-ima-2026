...
mov-est-acbm.it-codigo mov-est-acbm.tipo-tear mov-est-acbm.qtd-tot-perf ~
mov-est-acbm.qtd-tot-def mov-est-acbm.qtd-tot-sob 
...
DEFINE FRAME f-main
     ...
     mov-est-acbm.it-codigo AT ROW 3.17 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.14 BY .88
     fi-desc-item AT ROW 3.17 COL 36 COLON-ALIGNED NO-LABEL
     mov-est-acbm.tipo-tear AT ROW 4.75 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .88
     mov-est-acbm.qtd-tot-perf AT ROW 4.75 COL 49 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12.57 BY .88
     mov-est-acbm.qtd-tot-def AT ROW 5.75 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12.57 BY .88
     mov-est-acbm.qtd-tot-sob AT ROW 5.75 COL 49 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12.57 BY .88
