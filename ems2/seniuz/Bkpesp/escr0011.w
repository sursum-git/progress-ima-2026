...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Cartas de Notifica‡Æo de T¡tulos em Aberto"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Cartas de Notifica‡Æo de T¡tulos em Aberto */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Cartas de Notifica‡Æo de T¡tulos em Aberto */
DO:
...
{utp/ut9000.i "ESCR0011" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE fi-ep-codigo fi-cod-mensagem btn-anterior btn-proximo tg-email 
         ed-texto RECT-15 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ...
  ENABLE fi-ep-codigo fi-ini-cod-estabel fi-fim-cod-estabel fi-ini-cod-esp 
         fi-fim-cod-esp fi-ini-serie fi-fim-serie fi-ini-cod-rep fi-fim-cod-rep 
         fi-ini-cod-port fi-fim-cod-port fi-ini-cod-emitente 
         fi-fim-cod-emitente fi-ini-dt-emissao fi-fim-dt-emissao 
         fi-ini-dt-vencimen fi-fim-dt-vencimen IMAGE-1 IMAGE-10 IMAGE-2 
         IMAGE-27 IMAGE-28 IMAGE-29 IMAGE-30 IMAGE-31 IMAGE-32 IMAGE-33 
         IMAGE-34 IMAGE-35 IMAGE-36 IMAGE-7 IMAGE-8 IMAGE-9 RECT-16 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/escr0011rp.p} 
