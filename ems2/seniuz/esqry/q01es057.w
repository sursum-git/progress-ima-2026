...
*******************************************************************************/
{include/i-prgvrs.i Q01ES057 9.99.99.999}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH mp-entr-cam ~
      WHERE (espec.mp-entr-cam.dt-saida = ? ~
 AND i-tipo-saida = 1) or ~
(espec.mp-entr-cam.dt-saida <> ? ~
 AND i-tipo-saida = 2) or ~
i-tipo-saida = 3  NO-LOCK ~
    BY mp-entr-cam.dt-entrada ~
       BY mp-entr-cam.hr-entrada ~
        BY mp-entr-cam.placa INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH mp-entr-cam ~
      WHERE (espec.mp-entr-cam.dt-saida = ? ~
 AND i-tipo-saida = 1) or ~
(espec.mp-entr-cam.dt-saida <> ? ~
 AND i-tipo-saida = 2) or ~
i-tipo-saida = 3  NO-LOCK ~
    BY mp-entr-cam.dt-entrada ~
       BY mp-entr-cam.hr-entrada ~
        BY mp-entr-cam.placa INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main mp-entr-cam
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main mp-entr-cam
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "(espec.mp-entr-cam.dt-saida = ?
 AND i-tipo-saida = 1) or
(espec.mp-entr-cam.dt-saida <> ?
 AND i-tipo-saida = 2) or
i-tipo-saida = 3 "
