...
DEFINE VARIABLE rs-tipo-relatorio AS INTEGER INITIAL 2 
     ...
     RADIO-BUTTONS 
          "Sint‚tico", 1,
"Anal¡tico", 2
     SIZE 32 BY 1.17 TOOLTIP "Sele‡Æo do Tipo do Relatorio" NO-UNDO.
...
DEFINE VARIABLE fi-data-fin AS DATE FORMAT "99/99/9999" INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 TOOLTIP "Per¡odo para Etiquetas Faturadas" NO-UNDO.
...
DEFINE VARIABLE fi-it-codigo-fin AS CHARACTER FORMAT "X(16)" INITIAL "ZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 16.43 BY .88 TOOLTIP "C¢digo do Item final." NO-UNDO.
...
"Estampado", 2,
"Ambos", 3
     SIZE 41.14 BY .88 TOOLTIP "Tipo de artigo." NO-UNDO.
...
DEFINE FRAME f-pg-par
     ...
     to-item-dif AT ROW 8.13 COL 24
     to-imp-param AT ROW 10.04 COL 24
     ...
     tg-sem-est AT ROW 9.08 COL 24 WIDGET-ID 8
     " Situa‡Æo das Etiquetas" VIEW-AS TEXT
          SIZE 16.57 BY .54 AT ROW 1.21 COL 6.57
          FONT 1
     " Tipo do Relat¢rio" VIEW-AS TEXT
          SIZE 12.57 BY .54 AT ROW 5.29 COL 6.57
     " Op‡Æo de ImpressÆo" VIEW-AS TEXT
          SIZE 15.86 BY .54 AT ROW 7.5 COL 6.57
     RECT-11 AT ROW 5.54 COL 6.14
     RECT-2 AT ROW 1.46 COL 6
     RECT-28 AT ROW 7.75 COL 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 77.14 BY 10.5
...
DEFINE FRAME f-pg-sel
     fi-nome-estabel AT ROW 1.54 COL 19.72 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     ...
     fi-it-codigo-fin AT ROW 2.5 COL 38.57 COLON-ALIGNED NO-LABEL
     fi-cod-refer-ini AT ROW 3.54 COL 14.72 COLON-ALIGNED HELP
          "Codigo de Referˆncia Inicial"
     fi-cod-refer-fin AT ROW 3.5 COL 38.57 COLON-ALIGNED HELP
          "Codigo de Referˆncia Final" NO-LABEL
     fi-lote-ini AT ROW 4.54 COL 14.72 COLON-ALIGNED HELP
          "N§ do Lote Inicial"
     fi-lote-fin AT ROW 4.5 COL 38.57 COLON-ALIGNED NO-LABEL
     fi-corte-comerc-ini AT ROW 5.54 COL 14.72 COLON-ALIGNED
     fi-corte-comerc-fin AT ROW 5.5 COL 38.57 COLON-ALIGNED HELP
          "Corte Comercial" NO-LABEL
     fi-cod-depos-ini AT ROW 6.54 COL 14.72 COLON-ALIGNED
     fi-cod-depos-fin AT ROW 6.5 COL 38.57 COLON-ALIGNED NO-LABEL
     fi-data-ini AT ROW 7.54 COL 14.72 COLON-ALIGNED HELP
          "Codigo obsoleto"
     fi-data-fin AT ROW 7.5 COL 38.57 COLON-ALIGNED HELP
          "Codigo obsoleto" NO-LABEL
     rs-opc-acab AT ROW 8.88 COL 16.43 NO-LABEL WIDGET-ID 8
     rs-tipo-artigo AT ROW 10 COL 16.43 NO-LABEL WIDGET-ID 18
     "Acabamento:" VIEW-AS TEXT
          SIZE 9.43 BY .54 AT ROW 9.04 COL 7 WIDGET-ID 6
     "Tipo de Artigo:" VIEW-AS TEXT
          SIZE 10 BY .88 AT ROW 9.92 COL 6.29 WIDGET-ID 22
     IMAGE-1 AT ROW 2.54 COL 33.14
     IMAGE-2 AT ROW 2.5 COL 37
     IMAGE-28 AT ROW 3.54 COL 33.14
     IMAGE-29 AT ROW 3.5 COL 37
     IMAGE-30 AT ROW 4.54 COL 33.14
     IMAGE-31 AT ROW 4.5 COL 37
     IMAGE-32 AT ROW 5.5 COL 37
     IMAGE-33 AT ROW 5.54 COL 33.14
     IMAGE-88 AT ROW 6.54 COL 33.14
     IMAGE-89 AT ROW 6.5 COL 37
     IMAGE-90 AT ROW 7.54 COL 33.14
     IMAGE-91 AT ROW 7.5 COL 37
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 4 ROW 3.21
         SIZE 75.86 BY 10.25
...
/* SETTINGS FOR FRAME f-pg-sel
   Custom                                                               */
/* SETTINGS FOR FILL-IN fi-data-fin IN FRAME f-pg-sel
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN fi-data-ini IN FRAME f-pg-sel
   NO-ENABLE                                                            */
...
DO:
    ...
    ASSIGN fi-cod-depos-ini:SCREEN-VALUE = c-cod-depos
           fi-cod-depos-fin:SCREEN-VALUE = c-cod-depos.
...
&Scoped-define SELF-NAME to-fat1
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL to-fat1 w-relat
ON VALUE-CHANGED OF to-fat1 IN FRAME f-pg-par /* Faturada */
DO:
   ASSIGN fi-data-ini:SENSITIVE IN FRAME f-pg-sel = SELF:INPUT-VALUE
          fi-data-fin:SENSITIVE IN FRAME f-pg-sel = SELF:INPUT-VALUE.

   IF SELF:INPUT-VALUE = NO THEN
      ASSIGN fi-data-ini:SCREEN-VALUE = '01/01/0001'
             fi-data-fin:SCREEN-VALUE = '31/12/9999'.
END.
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    /* MESSAGE 'Esse programa foi descontiuado. Favor utilizar a versÆo Web atrav‚s do portal de acesso'
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-nome-estabel fi-cod-estabel fi-it-codigo-ini fi-it-codigo-fin 
          ...
          fi-cod-depos-fin fi-data-ini fi-data-fin rs-opc-acab rs-tipo-artigo 
  ...
  ENABLE fi-cod-estabel fi-it-codigo-ini fi-it-codigo-fin fi-cod-refer-ini 
         ...
         fi-corte-comerc-fin fi-cod-depos-ini fi-cod-depos-fin rs-opc-acab 
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.data-fin         = INPUT FRAME f-pg-sel fi-data-fin
