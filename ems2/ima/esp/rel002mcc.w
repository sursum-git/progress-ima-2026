...
*******************************************************************************/
{include/i-prgvrs.i rel001mcc 2.04.00.001}
...
DEFINE VARIABLE fi-cod-estabel AS CHARACTER FORMAT "X(7)":U 
     LABEL "Estabelecimento" 
     VIEW-AS FILL-IN 
     SIZE 12.43 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE fi-cod-estabel-fim AS CHARACTER FORMAT "X(7)":U INITIAL "ZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 12.29 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     fi-cod-estabel AT ROW 3.5 COL 23 COLON-ALIGNED
     fi-cod-estabel-fim AT ROW 3.5 COL 43.72 COLON-ALIGNED NO-LABEL
     fi-it-codigo AT ROW 4.54 COL 23 COLON-ALIGNED
     fi-it-codigo-fim AT ROW 4.54 COL 43.72 COLON-ALIGNED NO-LABEL
     rs-ordenar AT ROW 7.58 COL 31 NO-LABEL
     IMAGE-1 AT ROW 4.54 COL 37.29
     IMAGE-10 AT ROW 3.5 COL 42.86
     IMAGE-2 AT ROW 4.54 COL 42.86
     IMAGE-9 AT ROW 3.5 COL 37.29
     RECT-10 AT ROW 7 COL 29
     "Ordenar" VIEW-AS TEXT
          SIZE 6 BY .67 AT ROW 6.75 COL 30
          FONT 1
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Saldo de Estoque - Compras"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Saldo de Estoque - Compras */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Saldo de Estoque - Compras */
DO:
...
{utp/ut9000.i "rel001mcc" "2.04.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-cod-estabel fi-cod-estabel-fim fi-it-codigo fi-it-codigo-fim 
          rs-ordenar 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-cod-estabel fi-cod-estabel-fim fi-it-codigo fi-it-codigo-fim 
         rs-ordenar IMAGE-1 IMAGE-10 IMAGE-2 IMAGE-9 RECT-10 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-sel}
  DISPLAY rs-destino c-arquivo l-habilitaRtf c-modelo-rtf rs-execucao text-rtf 
          text-modelo-rtf 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
  ENABLE rs-destino bt-config-impr bt-arquivo c-arquivo l-habilitaRtf 
...
do on error undo, return error on stop  undo, return error:
   ...
   /* for each tt-digita no-lock:
    ...
    create tt-param.
    ASSIGN tt-param.rs-ordenar         = INPUT FRAME f-pg-sel rs-ordenar
           tt-param.cod-estabel-ini    = INPUT FRAME f-pg-sel fi-cod-estabel         
    ...
    {include/i-rprun.i esrp/rel002mccrp.p}
