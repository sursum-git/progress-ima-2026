...
*******************************************************************************/
{include/i-prgvrs.i Z01CL005 1.00.00.000}
...
DEFINE VARIABLE h_b04im001 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Etiquetas (Corte)"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 27.96
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Etiquetas (Corte) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Etiquetas (Corte) */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'clbrw/b04cl005.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b04im001 ).
       RUN set-position IN h_b04im001 ( 3.25 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 84.57 ) */

       /* Links to SmartBrowser h_b04im001. */
       RUN add-link IN adm-broker-hdl ( h_b04im001 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b04im001 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "Z01CL005" "1.00.00.000"}
