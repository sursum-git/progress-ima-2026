...
*******************************************************************************/
{include/i-prgvrs.i ESSP0054 2.04.00.000}
...
ON END-ERROR OF w-consim /* Testes de Resistˆncia */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-consim w-consim
ON WINDOW-CLOSE OF w-consim /* Testes de Resistˆncia */
DO:
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es036.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01es036 ).
       RUN set-position IN h_q01es036 ( 1.50 , 63.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0054" "2.04.00.000"}
