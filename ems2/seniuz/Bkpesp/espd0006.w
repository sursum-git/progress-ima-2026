...
*******************************************************************************/
{include/i-prgvrs.i ESPD0006 2.04.00.000}
...
DEFINE FRAME f-pg-sel
     fi-cod-estabel AT ROW 1.5 COL 19 COLON-ALIGNED
     fi-nome-estabel AT ROW 1.5 COL 24.14 COLON-ALIGNED NO-LABEL
     fi-ini-dt-implant AT ROW 2.5 COL 19 COLON-ALIGNED
     fi-fin-dt-implant AT ROW 2.5 COL 48 COLON-ALIGNED NO-LABEL
     fi-ini-ge-codigo AT ROW 3.5 COL 19 COLON-ALIGNED HELP
          "Grupo de estoque a que pertence o item"
     fi-fin-ge-codigo AT ROW 3.5 COL 48 COLON-ALIGNED HELP
          "Grupo de estoque a que pertence o item" NO-LABEL
     IMAGE-35 AT ROW 3.5 COL 32.57
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Estat¡stica de Pedidos de Vendas"
         COLUMN             = 13.14
         ROW                = 6.83
         HEIGHT             = 15.04
         WIDTH              = 80.72
...
ON END-ERROR OF w-relat /* Estat¡stica de Pedidos de Vendas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Estat¡stica de Pedidos de Vendas */
DO:
...
{utp/ut9000.i "ESPD0006" "2.04.00.000"} 
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN fi-cod-estabel:SCREEN-VALUE IN FRAME f-pg-sel = "2"
           ...
           fi-fin-dt-implant:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY,"99/99/9999")
           fi-ini-ge-codigo:SCREEN-VALUE IN FRAME f-pg-sel = "11"
           fi-fin-ge-codigo:SCREEN-VALUE IN FRAME f-pg-sel = "11".
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-cod-estabel fi-nome-estabel fi-ini-dt-implant fi-fin-dt-implant 
          fi-ini-ge-codigo fi-fin-ge-codigo 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-cod-estabel fi-ini-dt-implant fi-fin-dt-implant fi-ini-ge-codigo 
         fi-fin-ge-codigo IMAGE-35 IMAGE-5 IMAGE-6 IMAGE-8 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/espd0006rp.p} 
