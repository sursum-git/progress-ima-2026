...
DO:
    ...
    */ 
    ...
    IF LENGTH(fi-num-etiqueta:SCREEN-VALUE) = 13 THEN DO. /* Ç ean13 */
    ...
    ELSE DO.
       ...
       END.
       /*                 
       IF ped-item-rom.marca <> '' AND l-valida = NO AND c-seg-usuario <> 'super' THEN DO. /* Etiqueta Impressa */
          RUN pi-valida.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  ELSE
     ASSIGN c-form-epl = "M:\ems206\especificos\etiqueta\form-nf-med.epl".
