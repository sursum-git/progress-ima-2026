...
DEFINE VARIABLE h_b01es034 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b02es034 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     ...
     bt-cancela AT ROW 15.08 COL 14
     bt-ajuda AT ROW 15.08 COL 75.86
     rt-button AT ROW 14.88 COL 2
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Tabela Pick-Up"
         HEIGHT             = 15.29
         WIDTH              = 86
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 90
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Tabela Pick-Up */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Tabela Pick-Up */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Maquinas|Data' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b01es034.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01es034 ).
       RUN set-position IN h_b01es034 ( 2.08 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.25 , 84.57 ) */

       /* Links to SmartBrowser h_b01es034. */
       RUN add-link IN adm-broker-hdl ( h_b01es034 , 'State':U , THIS-PROCEDURE ).

    END. /* Page 1 */

    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b02es034.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b02es034 ).
       RUN set-position IN h_b02es034 ( 2.08 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.54 , 84.57 ) */
