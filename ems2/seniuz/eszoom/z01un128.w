...
*******************************************************************************/
{include/i-prgvrs.i Z01UN128 2.04.00.000}
...
DEFINE VARIABLE h_b01un128 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b02un128 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b03un128 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Programas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Programas */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'C¢digo|Descri‡Æo|Contenha' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b01un128.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01un128 ).
       RUN set-position IN h_b01un128 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.25 , 87.14 ) */

       /* Links to SmartBrowser h_b01un128. */
       RUN add-link IN adm-broker-hdl ( h_b01un128 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b01un128 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b02un128.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b02un128 ).
       RUN set-position IN h_b02un128 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.25 , 87.00 ) */

       /* Links to SmartBrowser h_b02un128. */
       RUN add-link IN adm-broker-hdl ( h_b02un128 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b02un128 ,
             h_folder , 'AFTER':U ).
    END. /* Page 2 */
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b03un128.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b03un128 ).
       RUN set-position IN h_b03un128 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.25 , 87.14 ) */

       /* Links to SmartBrowser h_b03un128. */
       RUN add-link IN adm-broker-hdl ( h_b03un128 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b03un128 ,
             h_folder , 'AFTER':U ).
    END. /* Page 3 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "Z01UN128" "2.04.00.000"}
