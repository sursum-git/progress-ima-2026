...
*******************************************************************************/
{include/i-prgvrs.i ESSP0065 2.04.00.000}
...
DEFINE VARIABLE fi-fin-larg-ent AS DECIMAL FORMAT "9.99" INITIAL 9.99 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE fi-fin-larg-sai AS DECIMAL FORMAT "9.99" INITIAL 9.99 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.
...
DEFINE VARIABLE fi-ini-enc-tra AS DECIMAL FORMAT "->9.99" INITIAL 0 
     LABEL "Encolhimento Trama" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE fi-ini-enc-urd AS DECIMAL FORMAT "->9.99" INITIAL 0 
...
DEFINE VARIABLE fi-ini-larg-ent AS DECIMAL FORMAT "9.99" INITIAL 0 
     LABEL "Largura Entrada" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE fi-ini-larg-sai AS DECIMAL FORMAT "9.99" INITIAL 0 
     LABEL "Largura Saida" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-par
     rs-tipo-relatorio AT ROW 2.54 COL 6.72 NO-LABEL
     to-imp-param AT ROW 3.25 COL 38
     RECT-27 AT ROW 1.75 COL 3
     RECT-34 AT ROW 2.5 COL 26
     "Tipo do Relat¢rio" VIEW-AS TEXT
          SIZE 12.14 BY .79 AT ROW 1.42 COL 7
          FONT 1
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
DEFINE FRAME f-pg-sel
     ...
     fi-ini-data-teste AT ROW 2.25 COL 19 COLON-ALIGNED HELP
          "Data do teste (dd/mm/aaaa)"
     fi-fin-data-teste AT ROW 2.25 COL 52 COLON-ALIGNED HELP
          "Data do teste (dd/mm/aaaa)" NO-LABEL
     fi-ini-cod-maq AT ROW 3.25 COL 19 COLON-ALIGNED HELP
          "Codigo da maquina"
     fi-fin-cod-maq AT ROW 3.25 COL 52 COLON-ALIGNED HELP
          "Codigo da maquina" NO-LABEL
     fi-ini-num-ob AT ROW 4.25 COL 19 COLON-ALIGNED
     fi-fin-num-ob AT ROW 4.25 COL 52 COLON-ALIGNED NO-LABEL
     fi-ini-enc-tra AT ROW 5.25 COL 19.14 COLON-ALIGNED HELP
          "Encolhimento da Trama em percentual"
     fi-fin-enc-tra AT ROW 5.25 COL 52 COLON-ALIGNED HELP
          "Encolhimento da Trama em percentual" NO-LABEL
     fi-ini-enc-urd AT ROW 6.25 COL 19.14 COLON-ALIGNED HELP
          "Encolhimento do Urdume em percentual"
     fi-fin-enc-urd AT ROW 6.25 COL 52 COLON-ALIGNED HELP
          "Encolhimento do Urdume em percentual" NO-LABEL
     fi-ini-larg-ent AT ROW 7.25 COL 19 COLON-ALIGNED HELP
          "Largura na entrada"
     fi-fin-larg-ent AT ROW 7.25 COL 52 COLON-ALIGNED HELP
          "Largura na entrada" NO-LABEL
     fi-ini-larg-sai AT ROW 8.25 COL 19 COLON-ALIGNED HELP
          "Largura na saida"
     fi-fin-larg-sai AT ROW 8.25 COL 52 COLON-ALIGNED HELP
          "Largura na saida" NO-LABEL
     IMAGE-1 AT ROW 1.25 COL 35.57
     IMAGE-2 AT ROW 1.25 COL 50.86
     IMAGE-27 AT ROW 2.25 COL 35.57
     IMAGE-28 AT ROW 2.25 COL 50.86
     IMAGE-31 AT ROW 3.25 COL 35.72
     IMAGE-32 AT ROW 3.25 COL 50.86
     IMAGE-33 AT ROW 4.25 COL 35.72
     IMAGE-34 AT ROW 5.25 COL 35.72
     IMAGE-35 AT ROW 6.25 COL 35.72
     IMAGE-36 AT ROW 4.25 COL 50.86
     IMAGE-37 AT ROW 5.25 COL 50.86
     IMAGE-38 AT ROW 6.25 COL 50.86
     IMAGE-40 AT ROW 8.25 COL 35.72
     IMAGE-41 AT ROW 7.25 COL 35.72
...
ON END-ERROR OF w-relat /* Testes de Amostra */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Testes de Amostra */
DO:
...
{utp/ut9000.i "ESSP0065" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-ini-fm-codigo fi-fin-fm-codigo fi-ini-data-teste fi-fin-data-teste 
          ...
          fi-ini-enc-tra fi-fin-enc-tra fi-ini-enc-urd fi-fin-enc-urd 
          fi-ini-larg-ent fi-fin-larg-ent fi-ini-larg-sai fi-fin-larg-sai 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-ini-fm-codigo fi-fin-fm-codigo fi-ini-data-teste fi-fin-data-teste 
         fi-ini-cod-maq fi-fin-cod-maq fi-ini-num-ob fi-fin-num-ob 
         fi-ini-enc-tra fi-fin-enc-tra fi-ini-enc-urd fi-fin-enc-urd 
         fi-ini-larg-ent fi-fin-larg-ent fi-ini-larg-sai fi-fin-larg-sai 
         IMAGE-1 IMAGE-2 IMAGE-27 IMAGE-28 IMAGE-31 IMAGE-32 IMAGE-33 IMAGE-34 
         IMAGE-35 IMAGE-36 IMAGE-37 IMAGE-38 IMAGE-40 IMAGE-41 IMAGE-42 
         IMAGE-43 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY rs-tipo-relatorio to-imp-param 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE rs-tipo-relatorio to-imp-param RECT-27 RECT-34 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.fi-ini-larg-ent     = INPUT FRAME f-pg-sel fi-ini-larg-ent   
           tt-param.fi-fin-larg-ent     = INPUT FRAME f-pg-sel fi-fin-larg-ent    
           tt-param.fi-ini-larg-sai     = INPUT FRAME f-pg-sel fi-ini-larg-sai     
           tt-param.fi-fin-larg-sai     = INPUT FRAME f-pg-sel fi-fin-larg-sai    
    ...
    {include/i-rprun.i esrp/essp0065rp.p}
