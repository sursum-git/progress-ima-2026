...
*******************************************************************************/
{include/i-prgvrs.i ESPD0017 2.04.00.000}
...
DEFINE VARIABLE fi-fin-dt-implant AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 TOOLTIP "Data de implanta‡Æo final" NO-UNDO.
...
DEFINE FRAME f-pg-sel
     fi-ini-no-ab-reppri AT ROW 1.88 COL 19 COLON-ALIGNED
     fi-fin-no-ab-reppri AT ROW 1.88 COL 48 COLON-ALIGNED HELP
          "Nome abreviado do representante principal" NO-LABEL
     fi-ini-nome-abrev AT ROW 2.88 COL 19 COLON-ALIGNED HELP
          "Nome abreviado do cliente/fornecedor"
     fi-fin-nome-abrev AT ROW 2.88 COL 48 COLON-ALIGNED HELP
          "Nome abreviado do cliente/fornecedor" NO-LABEL
     fi-ini-dt-entrega AT ROW 3.88 COL 19 COLON-ALIGNED
     fi-fin-dt-entrega AT ROW 3.88 COL 48 COLON-ALIGNED NO-LABEL
     fi-ini-dt-implant AT ROW 4.88 COL 19 COLON-ALIGNED
     fi-fin-dt-implant AT ROW 4.88 COL 48 COLON-ALIGNED NO-LABEL
     IMAGE-10 AT ROW 1.88 COL 46.57
     IMAGE-19 AT ROW 4.88 COL 34.29
     IMAGE-20 AT ROW 4.88 COL 46.57
     IMAGE-5 AT ROW 3.88 COL 34.29
     IMAGE-6 AT ROW 3.88 COL 46.57
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Pedidos de Vendas … Vista p/Solicita‡Æo de Dep¢sito"
         COLUMN             = 13.14
         ROW                = 6.83
         HEIGHT             = 15.04
         WIDTH              = 80.72
...
ON END-ERROR OF w-relat /* Pedidos de Vendas … Vista p/Solicita‡Æo de Dep¢sito */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Pedidos de Vendas … Vista p/Solicita‡Æo de Dep¢sito */
DO:
...
{utp/ut9000.i "ESPD0017" "2.04.00.000"} 
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-ini-no-ab-reppri fi-fin-no-ab-reppri fi-ini-nome-abrev 
          fi-fin-nome-abrev fi-ini-dt-entrega fi-fin-dt-entrega 
          fi-ini-dt-implant fi-fin-dt-implant 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-ini-no-ab-reppri fi-fin-no-ab-reppri fi-ini-nome-abrev 
         fi-fin-nome-abrev fi-ini-dt-entrega fi-fin-dt-entrega 
         fi-ini-dt-implant fi-fin-dt-implant IMAGE-10 IMAGE-19 IMAGE-20 IMAGE-5 
...
do on error undo, return error on stop  undo, return error:
    ...
    /*:T Coloque aqui a l¢gica de grava‡Æo dos demais campos que devem ser passados
     ...
     ASSIGN tt-param.repres-ini     = input frame f-pg-sel fi-ini-no-ab-reppri
    ...
    {include/i-rprun.i esrp/espd0017rp.p} 
