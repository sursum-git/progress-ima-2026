...
*******************************************************************************/
{include/i-prgvrs.i ESSP0046 2.04.00.000}
...
ON END-ERROR OF w-consim /* Testes de Hidrofilidade */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-consim w-consim
ON WINDOW-CLOSE OF w-consim /* Testes de Hidrofilidade */
DO:
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es032.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01es032 ).
       RUN set-position IN h_q01es032 ( 1.50 , 62.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0046" "2.04.00.000"}
