...
*******************************************************************************/
{include/i-prgvrs.i ESSP0174E 2.04.00.000}
...
DEFINE INPUT PARAMETER TABLE FOR tt-can.  
...
&Scoped-define INTERNAL-TABLES tt-can

/* Definitions for BROWSE br-pedidos                                    */
&Scoped-define FIELDS-IN-QUERY-br-pedidos tt-can.tipo tt-can.nr-pedcli tt-can.nr-pedrep tt-can.nome-abrev tt-can.no-ab-reppri tt-can.dt-cancela tt-can.dt-Implant tt-can.sit tt-can.qtde tt-can.valor tt-can.motivo   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-pedidos   
&Scoped-define SELF-NAME br-pedidos
&Scoped-define OPEN-QUERY-br-pedidos RUN pi-total. OPEN QUERY {&SELF-NAME} FOR EACH tt-can  NO-LOCK                               BY tt-can.dt-cancela                               BY tt-can.nr-pedcli.
&Scoped-define TABLES-IN-QUERY-br-pedidos tt-can
&Scoped-define FIRST-TABLE-IN-QUERY-br-pedidos tt-can
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-pedidos D-Dialog _FREEFORM
  QUERY br-pedidos NO-LOCK DISPLAY
      tt-can.tipo         COLUMN-LABEL "Tipo"      
tt-can.nr-pedcli    COLUMN-LABEL "Ped Cli"
tt-can.nr-pedrep    COLUMN-LABEL "Ped Rep"
tt-can.nome-abrev   COLUMN-LABEL "Cliente"
tt-can.no-ab-reppri COLUMN-LABEL "Representante"
tt-can.dt-cancela   COLUMN-LABEL "Dt.Cancela" COLUMN-BGCOLOR 8
tt-can.dt-Implant   COLUMN-LABEL "Dt.Implant"
tt-can.sit          COLUMN-LABEL "Sit" FORMAT "x(4)"
tt-can.qtde         COLUMN-LABEL "Metros Cancelados"
tt-can.valor        COLUMN-LABEL "Valor Cancelado"
tt-can.motivo       COLUMN-LABEL "Motivo do Cancelamento" FORMAT "x(70)"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME D-Dialog
     ...
     fi-tot-qtd-nor AT ROW 13.08 COL 65.14 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-nor AT ROW 13.13 COL 77.57 COLON-ALIGNED NO-LABEL
     bt-detalhe AT ROW 13.21 COL 2.57
     bt-imprime AT ROW 13.21 COL 16.14
     bt-vapara AT ROW 13.21 COL 29.57
     fi-tot-qtd-ljs AT ROW 14.08 COL 65.14 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-ljs AT ROW 14.08 COL 77.57 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-ind AT ROW 15.08 COL 65.14 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-ind AT ROW 15.08 COL 77.57 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-out AT ROW 16.08 COL 65.14 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-out AT ROW 16.08 COL 77.57 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-geral AT ROW 17.08 COL 65.14 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-geral AT ROW 17.08 COL 77.57 COLON-ALIGNED NO-LABEL
     bt-ok AT ROW 18.38 COL 2.72
     bt-cancela AT ROW 18.38 COL 13.72
     bt-ajuda AT ROW 18.38 COL 82.29
     rt-buttom AT ROW 18.13 COL 1.72
     "Normal:" VIEW-AS TEXT
          SIZE 6 BY .88 AT ROW 13 COL 61
     "Lojas:" VIEW-AS TEXT
          SIZE 4.57 BY .88 AT ROW 14 COL 62.14
     "Industrializaá∆o:" VIEW-AS TEXT
          SIZE 11 BY .88 AT ROW 15 COL 55.43
     "Total Geral:" VIEW-AS TEXT
          SIZE 8 BY .88 AT ROW 17 COL 58.43
     "Outros:" VIEW-AS TEXT
          SIZE 5.57 BY .88 AT ROW 16 COL 61.57
     SPACE(28.14) SKIP(2.82)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 1
         TITLE "Detalha Pedidos do Periodo - ESSP0174E"
...
/* Query rebuild information for BROWSE br-pedidos
     _START_FREEFORM
RUN pi-total.
OPEN QUERY {&SELF-NAME} FOR EACH tt-can  NO-LOCK
                              BY tt-can.dt-cancela
                              BY tt-can.nr-pedcli.
     _END_FREEFORM
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Detalha Pedidos do Periodo - ESSP0174E */
DO:  
...
DO:
  IF AVAIL tt-can THEN DO:
     FIND ped-venda WHERE
          ped-venda.nr-pedcli  = tt-can.nr-pedcli AND
          ped-venda.nome-abrev = tt-can.nome-abrev NO-LOCK NO-ERROR.
...
DO:
    ...
    IF c-nr-pedcli <> ? THEN DO:
       FIND tt-can WHERE
            tt-can.nr-pedcli = c-nr-pedcli NO-LOCK NO-ERROR. 
       ...
       h-query:REPOSITION-TO-ROWID(ROWID(tt-can)) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  /* {utp/ut9000.i "ESSP0174E" "2.04.00.000"} */ 
  ...
  IF p-tp-relat = 1 THEN
     ASSIGN  br-pedidos:TITLE IN FRAME {&FRAME-NAME} = "DETALHAMENTO DE PEDIDOS CANCELADOS DO PERIODO: " + 
                                                       SUBSTR(p-periodo,1,2) + "/" + SUBSTR(p-periodo,3,4).
  ELSE
      ASSIGN  br-pedidos:TITLE IN FRAME {&FRAME-NAME} = "DETALHAMENTO DE PEDIDOS CANCELADOS DO EXERCICIO: " + 
...
------------------------------------------------------------------------------*/
 ...
 tt-can.tipo:FGCOLOR IN BROWSE         {&browse-name} = p-cor.
 tt-can.nr-pedcli:FGCOLOR IN BROWSE    {&browse-name} = p-cor.
 tt-can.nr-pedrep:FGCOLOR IN BROWSE    {&browse-name} = p-cor.
 tt-can.nome-abrev:FGCOLOR IN BROWSE   {&browse-name} = p-cor.
 tt-can.no-ab-reppri:FGCOLOR IN BROWSE {&browse-name} = p-cor.
 tt-can.dt-cancela:FGCOLOR IN BROWSE   {&browse-name} = p-cor.
 tt-can.dt-implant:FGCOLOR IN BROWSE   {&browse-name} = p-cor.
 tt-can.sit:FGCOLOR IN BROWSE          {&browse-name} = p-cor.
 tt-can.motivo:FGCOLOR IN BROWSE       {&browse-name} = p-cor.
 tt-can.qtd:FGCOLOR IN BROWSE          {&browse-name} = p-cor.
 tt-can.valor:FGCOLOR IN BROWSE        {&browse-name} = p-cor. 
...
------------------------------------------------------------------------------*/
    ...
    IF p-tp-relat = 1 THEN DO:
      PUT "RELATORIO DE DETALHAMENTO DE PEDIDOS CANCELADOS DO PERIODO " AT 31.
      PUT SUBSTR(p-periodo,1,2) + "/" + substr(p-periodo,3,4) AT 90 SKIP(1).
    END.
    ELSE DO:
        PUT "RELATORIO DE DETALHAMENTO DE PEDIDOS CANCELADOS DO EXERCICIO " AT 31.
        PUT SUBSTR(p-periodo,3,4) AT 92 SKIP(1).
    END.
 
    PUT "Tipo   Ped Cli Ped. Repres. Cliente      Representante Sit Dt.Cancela Dt.Implant   Qtde Cancelada Valor Cancelado Motivo do Cancelamento" AT 1.
    PUT "------ ------- ------------ ------------ ------------- --- ---------- ---------- ---------------- --------------- -----------------------" AT 1.
...
------------------------------------------------------------------------------*/
 ...
 CASE i-saida:
     ...
     WHEN 3 THEN DO.
         ASSIGN c-saida = SESSION:TEMP-DIRECTORY + "essp0174e.tmp".
         OUTPUT TO VALUE(c-saida).
     END.
 END CASE.
 ...
 DO i-ct = 1 TO i-num-copias.
    ...
    FOR EACH tt-can WHERE NO-LOCK
        ...
        IF i-lin > 62 THEN DO:
           ...
           ASSIGN i-lin = 7.
        END.
        PUT tt-can.tipo       FORMAT "x(6)"           AT   1
            tt-can.nr-pedcli  FORMAT "x(6)"           AT   8
            tt-can.nr-pedrep                          AT  16
            tt-can.nome-abrev                         AT  29
            tt-can.no-ab-reppri                       AT  42
            tt-can.sit        FORMAT "x(3)"           AT  56
            tt-can.dt-cancela                         AT  60
            tt-can.dt-implant                         AT  71
            tt-can.qtde       FORMAT ">>>,>>>,>>9.99" AT  84
            tt-can.valor      FORMAT ">>>,>>>,>>9.99" AT 100
            tt-can.motivo     FORMAT "x(23)"          AT 115.
        ASSIGN i-lin = i-lin + 1.
        ACCUMULATE tt-can.qtde (TOTAL).
        ACCUMULATE tt-can.valor (TOTAL).
        CASE tt-can.tipo:
            WHEN "Normal" THEN
                ASSIGN de-nor-qtd = de-nor-qtd +  tt-can.qtde
                       de-nor-vlr = de-nor-vlr +  tt-can.valor.
            WHEN "Loja" THEN
                ASSIGN de-ljs-qtd = de-ljs-qtd + tt-can.qtde
                       de-ljs-vlr = de-ljs-vlr + tt-can.valor.
            WHEN "Indl" THEN
                ASSIGN de-ind-qtd = de-ind-qtd + tt-can.qtde
                       de-ind-vlr = de-ind-vlr + tt-can.valor.
            WHEN "Outros" THEN
                ASSIGN de-out-qtd = de-out-qtd + tt-can.qtde
                       de-out-vlr = de-out-vlr + tt-can.valor.
        END CASE.
   END.
   IF (ACCUM TOTAL tt-can.qtde)  <> 0 OR
      (ACCUM TOTAL tt-can.valor) <> 0 THEN DO:
      IF i-lin > 60 THEN DO:
         RUN pi-imp-cabec.
         ASSIGN i-lin = 7.
      END.
      PUT "-------------- --------------" AT 84 SKIP.
      PUT "Normal..............:"              AT  60.
      PUT de-nor-qtd   FORMAT ">>>,>>>,>>9.99" AT  84.
      PUT de-nor-vlr   FORMAT ">>>,>>>,>>9.99" AT 100.
      PUT "Loja................:"              AT  60.
      PUT de-ljs-qtd   FORMAT ">>>,>>>,>>9.99" AT  84.
      PUT de-ljs-vlr   FORMAT ">>>,>>>,>>9.99" AT 100.
      PUT "Industrializaá∆o....:"              AT  60.
      PUT de-ind-qtd   FORMAT ">>>,>>>,>>9.99" AT  84.
      PUT de-ind-vlr   FORMAT ">>>,>>>,>>9.99" AT 100.
      PUT "Outros..............:"              AT  60.
      PUT de-out-qtd   FORMAT ">>>,>>>,>>9.99" AT  84.
      PUT de-out-vlr   FORMAT ">>>,>>>,>>9.99" AT 100.
      PUT "Total Geral.........:"              AT  60.
      PUT ACCUM TOTAL tt-can.qtde  FORMAT ">>>,>>>,>>9.99" AT  84.
      PUT ACCUM TOTAL tt-can.valor FORMAT ">>>,>>>,>>9.99" AT 100.
   END.
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH tt-can NO-LOCK.
        CASE tt-can.tipo:
            WHEN "Normal" THEN
                ASSIGN fi-tot-qtd-nor = fi-tot-qtd-nor + tt-can.qtde
                       fi-tot-vlr-nor = fi-tot-vlr-nor + tt-can.valor.
            WHEN "Loja" THEN
                ASSIGN fi-tot-qtd-ljs = fi-tot-qtd-ljs + tt-can.qtde  
                       fi-tot-vlr-ljs = fi-tot-vlr-ljs + tt-can.valor.
            WHEN "Indl" THEN
                ASSIGN fi-tot-qtd-ind = fi-tot-qtd-ind + tt-can.qtde  
                       fi-tot-vlr-ind = fi-tot-vlr-ind + tt-can.valor.
            WHEN "Outros" THEN
                ASSIGN fi-tot-qtd-out = fi-tot-qtd-out + tt-can.qtde  
                       fi-tot-vlr-out = fi-tot-vlr-out + tt-can.valor.
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tt-can"}
