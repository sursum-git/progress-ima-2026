...
DEFINE VARIABLE fi-nr-pedcli-fim AS CHARACTER FORMAT "X(256)":U INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     fi-nr-pedcli-ini AT ROW 2.75 COL 15 COLON-ALIGNED WIDGET-ID 6
     fi-nr-pedcli-fim AT ROW 2.75 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     fi-emb-ini AT ROW 3.75 COL 15 COLON-ALIGNED
     fi-emb-fim AT ROW 3.75 COL 49 COLON-ALIGNED NO-LABEL
     IMAGE-1 AT ROW 3.75 COL 32.72
     IMAGE-2 AT ROW 3.75 COL 46.72
     IMAGE-3 AT ROW 2.75 COL 32.86 WIDGET-ID 2
     IMAGE-4 AT ROW 2.75 COL 46.86 WIDGET-ID 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
DO:
   IF SELF:SCREEN-VALUE <> "" THEN
      ASSIGN fi-nr-pedcli-fim:SCREEN-VALUE = SELF:SCREEN-VALUE.
END.
...
{utp/ut9000.i "pesoembarque" "2.04.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-nr-pedcli-ini fi-nr-pedcli-fim fi-emb-ini fi-emb-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 fi-nr-pedcli-ini fi-nr-pedcli-fim 
         fi-emb-ini fi-emb-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
   ...
   */ 
    ...
    /*:T Coloque aqui a/l¢gica de gravaá∆o dos demais campos que devem ser passados
       como parÉmetros para o programa RP.P, atravÇs da temp-table tt-param */
        ...
        ASSIGN tt-param.nr-pedcli-ini    = INPUT FRAME f-pg-sel  fi-nr-pedcli-ini
               tt-param.nr-pedcli-fim    = INPUT FRAME f-pg-sel  fi-nr-pedcli-fim
               tt-param.fi-emb-ini       = INPUT FRAME f-pg-sel  fi-emb-ini
    ...
    {include/i-rprun.i esrp/pesoembarquerp.p}
