/**************************************************************
Programa: Desembolsorp999.p
Objetivo: Buscar as contas contabeis para analise de gastos a 
partir dos movimentos de caixa e banco.
Dependendo da origem do titulo ‚ necess rio buscar as contas da
nota fiscal de entrada.
Autor:Tadeu Silva Parreiras
Data:20/09/2017
Listagem dos lan‡amentos de caixa e bancos realizados analiticos.
Quando do contas a pagar, busca os titulos a pagar relacionados, proporcionalizando o valor aos titulos
Quando do contas a receber, busca os titulos a receber relacionados proporcionalizando valor aos titulos
***************************************************************/
...
FOR EACH ems5.movto_cta_corren 
    ...
    FIND FIRST ems5.cta_corren OF movto_cta_corren
        NO-LOCK NO-ERROR.
