...
DEFINE TEMP-TABLE ttResult NO-UNDO
    ...
    INDEX primario IS PRIMARY nrContainer itCodigo
    .
/*
...
FOR EACH fats_04 NO-LOCK,
    EACH pp-it-container NO-LOCK
    WHERE pp-it-container.nr-container   = fats_04.num_origem
    AND   pp-it-container.it-codigo      = fats_04.it_codigo
    AND   pp-it-container.cod-refer      = fats_04.cod_refer,
    ...
    FIND ttResult 
        ...
        AND   ttResult.itCodigo    = fats_04.it_codigo
        NO-ERROR.
    IF NOT AVAIL ttResult THEN DO:
       ...
       ASSIGN ttResult.codEstabel               = pp-container.cod-estabel
              ...
              ttResult.produto                  = fats_04.it_codigo + "-" + item.desc-item
              ttResult.itCodigo                 = fats_04.it_codigo
              .
        FOR LAST versoes_item_custo_container NO-LOCK
            ...
            WHERE ITEM_custos.it_codigo = fats_04.it_codigo .
...
FOR EACH ttResult.
    ...
    ASSIGN ttResult.percVendido         = ttResult.qtFaturada / ttResult.qtComprada
           ...
           ttResult.vlLucroProduto      = (ttResult.qtFaturada  - ttResult.qtDevolvida) * (ttResult.vlUnitVenda - ttResult.vlCustoUnitAposImportacao)
