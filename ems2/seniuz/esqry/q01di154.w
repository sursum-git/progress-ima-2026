...
DEFINE NEW GLOBAL SHARED VAR fi-ini-nome-abrev LIKE ped-item.nome-abrev.
DEFINE NEW GLOBAL SHARED VAR fi-fin-nome-abrev LIKE ped-item.nome-abrev.
DEFINE NEW GLOBAL SHARED VAR fi-ini-nr-pedcli  LIKE ped-item.nr-pedcli.
DEFINE NEW GLOBAL SHARED VAR fi-fin-nr-pedcli  LIKE ped-item.nr-pedcli.
DEFINE NEW GLOBAL SHARED VAR fi-ini-it-codigo  LIKE ped-item.it-codigo.
DEFINE NEW GLOBAL SHARED VAR fi-fin-it-codigo  LIKE ped-item.it-codigo.
...
&Scoped-define INTERNAL-TABLES ped-item

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH ped-item ~
      WHERE ped-item.nome-abrev >= fi-ini-nome-abrev ~
 AND ped-item.nome-abrev <= fi-fin-nome-abrev ~
 AND ped-item.nr-pedcli >= fi-ini-nr-pedcli ~
 AND ped-item.nr-pedcli <= fi-fin-nr-pedcli ~
 AND ped-item.it-codigo >= fi-ini-it-codigo ~
 AND ped-item.it-codigo <= fi-fin-it-codigo ~
 AND ped-item.dt-entrega >= fi-ini-dt-entrega ~
 AND ped-item.dt-entrega <= fi-fin-dt-entrega ~
 AND (ped-item.cod-sit-item = 1 and to-abe or  ~
      ped-item.cod-sit-item = 2 and to-atp or ~
      ped-item.cod-sit-item = 3 and to-att or ~
      ped-item.cod-sit-item = 4 and to-pen or ~
      ped-item.cod-sit-item = 5 and to-sus or ~
      ped-item.cod-sit-item = 6 and to-can or ~
      ped-item.cod-sit-item = 7 and to-bal) NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH ped-item ~
 ...
 AND (ped-item.cod-sit-item = 1 and to-abe or  ~
      ...
      ped-item.cod-sit-item = 6 and to-can or ~
      ped-item.cod-sit-item = 7 and to-bal) NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main ped-item
...
<FOREIGN-KEYS>
nr-ord-produ||y|ems2ima.ped-item.nr-ord-produ
nr-programa||y|ems2ima.ped-item.nr-programa
it-codigo||y|ems2ima.ped-item.it-codigo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems2ima.ped-item"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _Where[1]         = "ems2ima.ped-item.nome-abrev >= fi-ini-nome-abrev
 AND ems2ima.ped-item.nome-abrev <= fi-fin-nome-abrev
 AND ems2ima.ped-item.nr-pedcli >= fi-ini-nr-pedcli
 AND ems2ima.ped-item.nr-pedcli <= fi-fin-nr-pedcli
 AND ems2ima.ped-item.it-codigo >= fi-ini-it-codigo
 AND ems2ima.ped-item.it-codigo <= fi-fin-it-codigo
 AND ems2ima.ped-item.dt-entrega >= fi-ini-dt-entrega
 AND ems2ima.ped-item.dt-entrega <= fi-fin-dt-entrega
 AND (ems2ima.ped-item.cod-sit-item = 1 and to-abe or 
      ems2ima.ped-item.cod-sit-item = 2 and to-atp or
      ems2ima.ped-item.cod-sit-item = 3 and to-att or
      ems2ima.ped-item.cod-sit-item = 4 and to-pen or
      ems2ima.ped-item.cod-sit-item = 5 and to-sus or
      ems2ima.ped-item.cod-sit-item = 6 and to-can or
      ems2ima.ped-item.cod-sit-item = 7 and to-bal)"
...
ASSIGN fi-ini-nome-abrev = ""
       ...
       fi-fin-nr-pedcli  = "ZZZZZZZZ"
       fi-ini-it-codigo  = "5"
       fi-fin-it-codigo  = "5ZZZZZZZZZZZZZZZ"
