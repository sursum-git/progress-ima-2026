...
*******************************************************************************/
{include/i-prgvrs.i Q01UN128 2.04.00.000}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH prog_dtsul NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH prog_dtsul NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main prog_dtsul
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main prog_dtsul
...
<FOREIGN-KEYS>
num_manual_documen||y|mgcad.produt_dtsul.num_manual_documen
cod_produt_dtsul||y|mgcad.produt_dtsul.cod_produt_dtsul
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "num_manual_documen,cod_produt_dtsul"':U).
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "num_manual_documen" "produt_dtsul" "num_manual_documen"}
  {src/adm/template/sndkycas.i "cod_produt_dtsul" "produt_dtsul" "cod_produt_dtsul"}
