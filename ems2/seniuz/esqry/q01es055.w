...
&Scoped-define QUERY-STRING-Query-Main FOR EACH mp-tipo NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH mp-tipo NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main mp-tipo
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main mp-tipo
