...
*******************************************************************************/
{include/i-prgvrs.i lisa01a 9.99.99.999}
...
DEFINE VARIABLE EDITOR-1 AS CHARACTER 
     VIEW-AS EDITOR
     SIZE 69 BY 4.75 TOOLTIP "Este Programa far† a importaá∆o de todos os arquivos json referente a RETORNOS"
...
DEFINE FRAME f-pg-sel
     EDITOR-1 AT ROW 4.21 COL 5 NO-LABEL WIDGET-ID 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
ON END-ERROR OF w-relat /* Importaá∆o de Retornos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Importaá∆o de Retornos */
DO:
...
{utp/ut9000.i "lisa01a" "9.99.99.999"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i lisa/lisa01arp.p}
...
/*:T------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
DEFINE VARIABLE hConsParam AS HANDLE      NO-UNDO.
RUN esbo/boConsParam.p PERSIST SET hConsParam.
RUN getDirCompletoRetornoLisa IN hConsParam(OUTPUT cDir).
IF VALID-HANDLE(hConsParam) THEN
    DELETE PROCEDURE hConsParam.

ASSIGN editor-1:SCREEN-VALUE IN FRAME f-pg-sel = 'Este Programa far† a importaá∆o de todos os arquivos json referente a RETORNOS LISA enviados por API e salvos na pasta:' + cDir
      + chr(13) + " Para alterar a pasta a ser buscada os XMls Ç necess†rio criar ou modificar os parametros dir_json_lisa e dir_retorno_lisa".
