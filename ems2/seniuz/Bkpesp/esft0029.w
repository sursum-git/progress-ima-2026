...
*******************************************************************************/
{include/i-prgvrs.i ESFT0029 2.04.00.000}
...
DEFINE FRAME f-pg-sel
     ...
     fi-ini-dt-precoant AT ROW 3.54 COL 15.29 COLON-ALIGNED
     fi-fin-dt-precoant AT ROW 3.54 COL 48.29 COLON-ALIGNED NO-LABEL
     fi-ini-it-codigo AT ROW 4.54 COL 15.29 COLON-ALIGNED
     fi-fin-it-codigo AT ROW 4.54 COL 48.29 COLON-ALIGNED NO-LABEL
     ...
     IMAGE-5 AT ROW 5.54 COL 33.86
     IMAGE-6 AT ROW 3.54 COL 46.72
     IMAGE-7 AT ROW 4.54 COL 46.72
     IMAGE-8 AT ROW 5.54 COL 46.72
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 4 ROW 3.21
         SIZE 75.86 BY 10.25
...
DEFINE FRAME f-pg-par
     ...
     to-imp-param AT ROW 8.25 COL 28
     tg-tp-pedido AT ROW 2.21 COL 25.29
          ...
          "Dispon°vel para classificaá∆o/indicaá∆o pr¢pria do usu†rio" NO-LABEL
     rs-qualidade AT ROW 5.88 COL 26.86 NO-LABEL
     RECT-27 AT ROW 7.71 COL 6.29
     RECT-28 AT ROW 1.5 COL 6.29
     RECT-29 AT ROW 5.46 COL 6.29
     "Pedidos do Tipo:" VIEW-AS TEXT
          SIZE 12 BY .75 AT ROW 3.21 COL 13.29
     "Qualidade:" VIEW-AS TEXT
          SIZE 7.86 BY .75 AT ROW 6 COL 16.86
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 77.14 BY 10.5
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Relat¢rio de Resumo do Faturamento Por Aliquota ICMS"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Relat¢rio de Resumo do Faturamento Por Aliquota ICMS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Relat¢rio de Resumo do Faturamento Por Aliquota ICMS */
DO:
...
{utp/ut9000.i "ESFT0029" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY tg-tp-normal to-imp-param tg-tp-pedido fi-tp-pedido-1 fi-tp-pedido-2 
          fi-tp-pedido-3 fi-tp-pedido-4 fi-tp-pedido-5 rs-qualidade 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE to-imp-param tg-tp-pedido rs-qualidade RECT-27 RECT-28 RECT-29 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-par}
  DISPLAY fi-cod-estabel fi-nome-estabel fi-ini-dt-emissao fi-fin-dt-emissao 
          fi-ini-dt-precoant fi-fin-dt-precoant fi-ini-it-codigo 
          fi-fin-it-codigo fi-ini-ge-codigo fi-fin-ge-codigo 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-cod-estabel fi-ini-dt-emissao fi-fin-dt-emissao fi-ini-dt-precoant 
         fi-fin-dt-precoant fi-ini-it-codigo fi-fin-it-codigo fi-ini-ge-codigo 
         fi-fin-ge-codigo IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 
         IMAGE-7 IMAGE-8 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/esft0029rp.p}
