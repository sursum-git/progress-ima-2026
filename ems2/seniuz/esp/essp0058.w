...
*******************************************************************************/
{include/i-prgvrs.i ESSP0058 2.04.00.000}
...
DEFINE FRAME f-pg-sel
     ...
     IMAGE-11 AT ROW 2.33 COL 31.86
     IMAGE-12 AT ROW 2.21 COL 47.43
...
ON END-ERROR OF w-relat /* Testes da Carga de Goma */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Testes da Carga de Goma */
DO:
...
{utp/ut9000.i "ESSP0058" "2.04.00.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/essp0058rp.p}
