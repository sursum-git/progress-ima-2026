...
&Scoped-define INTERNAL-TABLES user-coml

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH user-coml NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH user-coml NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main user-coml
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main user-coml
...
<FOREIGN-KEYS>
usuario||y|mgdis.user-coml.usuario
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "usuario" "user-coml" "usuario"}
