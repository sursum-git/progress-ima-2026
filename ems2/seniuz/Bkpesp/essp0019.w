...
ON END-ERROR OF w-cadsim /* Composi‡äes de Itens */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Composi‡äes de Itens */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v01es003 ).
       RUN set-position IN h_v01es003 ( 3.00 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es003.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01es003 ).
       RUN set-position IN h_q01es003 ( 1.50 , 68.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_v01es003 ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0019" "2.04.00.000"}
