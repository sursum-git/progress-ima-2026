...
//
    ...
    public class boad098q02 : Procedure
    {
	...
	static DataTableMetaData validateUpdate_MetaData2;
		...
		getBatchRecords_MetaData1 = new DataTableMetaData(0, "RowObjectAux", 201, false, 0, null, null, null, "StrongTypesNS.RowObject3DataTable");
		...
		getBatchRecords_MetaData1.setFieldDesc(201, "rownum", 0, Parameter.PRO_INTEGER, 0, 200, 0, "", "", 0, null, "");

		getBatchRecordsPrev_MetaData1 = new DataTableMetaData(0, "RowObjectAux", 201, false, 0, null, null, null, "StrongTypesNS.RowObject3DataTable");
		...
		getBatchRecordsPrev_MetaData1.setFieldDesc(201, "rownum", 0, Parameter.PRO_INTEGER, 0, 200, 0, "", "", 0, null, "");

		getRecord_MetaData1 = new DataTableMetaData(0, "RowObject", 201, false, 0, null, null, null, "StrongTypesNS.RowObject3DataTable");
		...
		getRecord_MetaData1.setFieldDesc(201, "rownum", 0, Parameter.PRO_INTEGER, 0, 200, 0, "", "", 0, null, "");

		setRecord_MetaData1 = new DataTableMetaData(0, "RowObject", 201, false, 0, null, null, null, "StrongTypesNS.RowObject3DataTable");
		...
		setRecord_MetaData1.setFieldDesc(201, "rownum", 0, Parameter.PRO_INTEGER, 0, 200, 0, "", "", 0, null, "");

		findRowidShow_MetaData1 = new DataTableMetaData(0, "RowObject", 201, false, 0, null, null, null, "StrongTypesNS.RowObject3DataTable");
		...
		findRowidShow_MetaData1.setFieldDesc(201, "rownum", 0, Parameter.PRO_INTEGER, 0, 200, 0, "", "", 0, null, "");
		...
		serverSendRows_MetaData1 = new DataTableMetaData(0, "RowObjectAux", 201, false, 2, "1,cod-emitente:codigo.nome-abrev:nome", null, null, "StrongTypesNS.RowObject3DataTable");
		...
		validateCreate_MetaData1 = new DataTableMetaData(0, "RowObject", 201, false, 0, null, null, null, "StrongTypesNS.RowObject3DataTable");
		...
		validateCreate_MetaData1.setFieldDesc(201, "rownum", 0, Parameter.PRO_INTEGER, 0, 200, 0, "", "", 0, null, "");
	...
	public boad098q02(ProObject appObj) : base(appObj)
	{
		...
		// Run procedure
		PersistProcObj = RunPersistentProcedure("boad098q02.p", parms);
...
/// <summary>
	/// 
	/// </summary> 
	public string getBatchRecords(Rowid pRowid, bool pNext, int pRowsToReturn, out int pRowsReturned, out StrongTypesNS.RowObject3DataTable RowObjectAux)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		// Set up Out parameters
		parms.setIntegerParameter(4, 0, ParameterSet.OUTPUT, UnknownType.None);
		parms.setDataTableParameter(5, null, ParameterSet.OUTPUT, "StrongTypesNS.RowObject3DataTable");
		...
		pRowsReturned = (int)outValue;
		outValue = parms.getOutputParameter(5);
		RowObjectAux = (StrongTypesNS.RowObject3DataTable)outValue;
...
/// <summary>
	/// 
	/// </summary> 
	public string getBatchRecordsPrev(Rowid pRowid, bool pPrev, int pRowsToReturn, out int pRowsReturned, out StrongTypesNS.RowObject3DataTable RowObjectAux)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
...
/// <summary>
	/// 
	/// </summary> 
	public string getRecord(out StrongTypesNS.RowObject3DataTable RowObject)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
...
/// <summary>
	/// 
	/// </summary> 
	public string setRecord(StrongTypesNS.RowObject3DataTable RowObject)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
...
/// <summary>
	/// 
	/// </summary> 
	public string findRowidShow(Rowid pRowid, out StrongTypesNS.RowObject3DataTable RowObject)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		// Set up Out parameters
		parms.setDataTableParameter(2, null, ParameterSet.OUTPUT, "StrongTypesNS.RowObject3DataTable");
...
out StrongTypesNS.RowObject3DataTable RowObjectAux)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
...
/// <summary>
	/// 
	/// </summary> 
	public string validateCreate(StrongTypesNS.RowObject3DataTable RowObject, out StrongTypesNS.RowErrorsDataTable RowErrors, out Rowid pRowid)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
...
/// <summary>
	/// 
	/// </summary> 
	public string validateUpdate(StrongTypesNS.RowObject3DataTable RowObject, Rowid pRowid, out StrongTypesNS.RowErrorsDataTable RowErrors)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
...
/// <summary>
	/// 
	/// </summary> 
	public string OpenQueryByCodigo()
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		// Run procedure
		base.runProcedure("OpenQueryByCodigo", parms);
...
/// <summary>
	...
	public string OpenQueryByNome()
	{
		...
		// Run procedure
		base.runProcedure("OpenQueryByNome", parms);
...
/// <summary>
	/// 
	/// </summary> 
	public string SetConstraintByCodigo(int pCodEmitenteIni, int pCodEmitenteFim)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		// Run procedure
		base.runProcedure("SetConstraintByCodigo", parms);
...
/// <summary>
	/// 
	/// </summary> 
	public string SetConstraintByNome(string pNomeAbrevIni, string pNomeAbrevFim, int pCodEmitenteIni, int pCodEmitenteFim)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		// Run procedure
		base.runProcedure("SetConstraintByNome", parms);
