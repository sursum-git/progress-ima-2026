...
&Scoped-define INTERNAL-TABLES ob-param

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH ob-param NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH ob-param NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main ob-param
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main ob-param
