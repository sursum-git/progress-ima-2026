DEFINE TEMP-TABLE ttMovto NO-UNDO
    ...
    FIELD id                AS INTEGER
    FIELD numSequen         AS INTEGER                      COLUMN-LABEL "Sequˆncia"    
    FIELD codEstabel        AS CHAR                         COLUMN-LABEL "Estab."
    FIELD rRowid            AS ROWID
    FIELD nrContainer       AS INT
    FIELD numEtq            AS INT
    FIELD cubagem           AS DECIMAL
    ...
    INDEX id-docto codEstabel codEmitente serie nrDocto numSequen
    .
...
DEFINE TEMP-TABLE ttComp NO-UNDO
    ...
    .
/*DEFINE TEMP-TABLE ttMovtoContainer LIKE ttMovto
    FIELD nrContainer   AS INT
    FIELD numEtq        AS INT.*/
