...
*******************************************************************************/
{include/i-prgvrs.i B03DI135 2.04.00.000}
...
nota-fiscal.dt-emis-nota nota-fiscal.vl-tot-nota 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table 
&Scoped-define QUERY-STRING-br-table FOR EACH nota-fiscal OF emitente ~
...
&Scoped-define OPEN-QUERY-br-table OPEN QUERY br-table FOR EACH nota-fiscal OF emitente ~
      WHERE nota-fiscal.cod-rep = fi-cod-rep       ~
AND nota-fiscal.cod-estabel >= fi-ini-cod-estabel   ~
AND nota-fiscal.cod-estabel <= fi-fin-cod-estabel   ~
AND nota-fiscal.serie >= fi-ini-serie         ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      nota-fiscal.nr-nota-fis FORMAT "x(16)":U
      nota-fiscal.dt-emis-nota FORMAT "99/99/9999":U
      nota-fiscal.vl-tot-nota FORMAT ">>,>>>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 87.72 BY 10.08
         FONT 1.
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "mgmov.nota-fiscal OF mgcad.emitente"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _Where[1]         = "nota-fiscal.cod-rep = fi-cod-rep      
AND nota-fiscal.cod-estabel >= fi-ini-cod-estabel  
AND nota-fiscal.cod-estabel <= fi-fin-cod-estabel  
AND nota-fiscal.serie >= fi-ini-serie        
AND nota-fiscal.serie <= fi-fin-serie        
...
AND nota-fiscal.emite-dup = yes"
     ...
     _FldNameList[3]   = mgmov.nota-fiscal.vl-tot-nota
