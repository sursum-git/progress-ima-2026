...
&Scoped-define QUERY-STRING-Query-Main FOR EACH bc-etiqueta NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH bc-etiqueta NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main bc-etiqueta
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main bc-etiqueta
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod-estado" "bc-etiqueta" "cod-estado"}
  {src/adm/template/sndkycas.i "nr-etiq" "bc-etiqueta" "nr-etiq"}
  {src/adm/template/sndkycas.i "fm-codigo" "bc-etiqueta" "fm-codigo"}
  {src/adm/template/sndkycas.i "it-codigo" "bc-etiqueta" "it-codigo"}
  {src/adm/template/sndkycas.i "nr-contagem" "bc-etiqueta" "nr-contagem"}
  {src/adm/template/sndkycas.i "cd-trans" "bc-etiqueta" "cd-trans"}
  {src/adm/template/sndkycas.i "nr-trans" "bc-etiqueta" "nr-trans"}
