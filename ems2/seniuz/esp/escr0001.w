...
*******************************************************************************/
{include/i-prgvrs.i ESCR0001 2.04.00.000}
...
define temp-table tt-param    no-undo
       ...
       FIELD perc-juro        AS DEC FORMAT ">9,99"
...
DEFINE VARIABLE fi-dt-base-juro AS DATE FORMAT "99/99/9999":U INITIAL 01/01/001 
     LABEL "Data Base para C†lculo de Juros" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 TOOLTIP "Data base para c†lculo de Juros sobre atraso de t°tulos" NO-UNDO.

DEFINE VARIABLE fi-perc-juro AS DECIMAL FORMAT ">9.9999":U INITIAL 0 
     LABEL "Percentual Juros ao màs" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .79 TOOLTIP "Percentual de juros ao màs a ser calculado pelo atraso" NO-UNDO.
...
DEFINE VARIABLE fi-fin-cod-esp AS CHARACTER FORMAT "!!" INITIAL "ZZ" 
     VIEW-AS FILL-IN 
     SIZE 3 BY .88 TOOLTIP "EspÇcie final" NO-UNDO.
...
DEFINE VARIABLE fi-ini-cod-esp AS CHARACTER FORMAT "!!" 
     LABEL "EspÇcie":R9 
     VIEW-AS FILL-IN 
     SIZE 3 BY .88 TOOLTIP "EspÇcie inicial" NO-UNDO.
...
DEFINE FRAME f-pg-par
     fi-dt-base-juro AT ROW 3.08 COL 35 COLON-ALIGNED
     fi-perc-juro AT ROW 4.08 COL 35 COLON-ALIGNED
     tg-impr-param AT ROW 7.38 COL 25.43
     RECT-15 AT ROW 1.08 COL 1
     RECT-34 AT ROW 6.96 COL 4
     RECT-40 AT ROW 2.17 COL 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "T°tulos a Receber com C†lculo de Juros s/Atraso"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* T°tulos a Receber com C†lculo de Juros s/Atraso */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* T°tulos a Receber com C†lculo de Juros s/Atraso */
DO:
...
{utp/ut9000.i "ESCR0001" "2.04.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN fi-ep-codigo:SCREEN-VALUE IN FRAME f-pg-sel = "1" 
           ...
           fi-dt-base-juro:SCREEN-VALUE IN FRAME f-pg-par = string(TODAY)
           fi-perc-juro:SCREEN-VALUE IN FRAME f-pg-par = "1,0000".
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-dt-base-juro fi-perc-juro tg-impr-param 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE fi-dt-base-juro fi-perc-juro tg-impr-param RECT-15 RECT-34 RECT-40 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ...
  ENABLE fi-ep-codigo fi-cod-estabel fi-ini-cod-port fi-fin-cod-port 
         ...
         fi-ini-dt-vencto fi-fin-dt-vencto IMAGE-1 IMAGE-2 IMAGE-57 IMAGE-58 
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.ep-codigo        = INPUT FRAME f-pg-sel fi-ep-codigo
           ...
           tt-param.dt-base-juro     = INPUT FRAME f-pg-par fi-dt-base-juro
           tt-param.perc-juro        = INPUT FRAME f-pg-par fi-perc-juro
    ...
    {include/i-rprun.i esrp/escr0001rp.p} 
