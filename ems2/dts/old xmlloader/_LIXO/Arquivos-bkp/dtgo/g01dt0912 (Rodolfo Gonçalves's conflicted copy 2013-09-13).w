...
*******************************************************************************/
{include/i-buffer.i}
{include/i-prgvrs.i G01DT0912 2.06.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button i_ep-codigo bt-ok bt-cancela ~
bt-ajuda 
...
DEFINE FRAME d-vapara
     i_ep-codigo AT ROW 1.67 COL 30 COLON-ALIGNED WIDGET-ID 2
...
IF NOT AVAILABLE dt-empresa THEN DO:
    {utp/ut-table.i mgesp dt-empresa 1}
...
------------------------------------------------------------------------------*/
  DISPLAY i_ep-codigo 
      WITH FRAME d-vapara.
  ENABLE rt-button i_ep-codigo bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "G01DT0912" "2.06.00.001"}
