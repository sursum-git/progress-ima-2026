...
**             devolvidos.                                                       
*******************************************************************************/
{include/i-prgvrs.i IMPD030G 1.00.00.000}
...
DEF VAR i-empresa-aux AS CHAR NO-UNDO. 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-3 w-window _FREEFORM
  QUERY BROWSE-3 DISPLAY
      ...
      tt_tit_atraso.dat_vencto_tit_acr
      tt_tit_atraso.dat_liquidac_tit_acr
      tt_tit_atraso.dat_liquidac_tit_acr - tt_tit_atraso.dat_vencto_tit_acr COLUMN-LABEL 'Dias Atraso'
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 87 BY 12.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "IMPD030G" "1.00.00.000"}
