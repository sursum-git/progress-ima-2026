...
&Scoped-define INTERNAL-TABLES espec.ped-reserva

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH espec.ped-reserva NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH espec.ped-reserva NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main espec.ped-reserva
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main espec.ped-reserva
