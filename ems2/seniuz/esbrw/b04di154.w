...
&Scoped-define INTERNAL-TABLES ped-item tt-ped-item

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table tt-ped-item.it-codigo tt-ped-item.cod-refer   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table   
&Scoped-define SELF-NAME br-table
&Scoped-define QUERY-STRING-br-table FOR EACH ped-item OF ped-venda NO-LOCK.     CREATE tt-ped-item.     BUFFER-COPY ped-item TO tt-ped-item. END.  OPEN QUERY {&SELF-NAME} FOR EACH tt-ped-item NO-LOCK     ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br-table OPEN QUERY br-tableFOR EACH ped-item OF ped-venda NO-LOCK.     CREATE tt-ped-item.     BUFFER-COPY ped-item TO tt-ped-item. END.  OPEN QUERY {&SELF-NAME} FOR EACH tt-ped-item NO-LOCK     ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br-table ped-item tt-ped-item
&Scoped-define FIRST-TABLE-IN-QUERY-br-table ped-item
&Scoped-define SECOND-TABLE-IN-QUERY-br-table tt-ped-item
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _FREEFORM
  QUERY br-table NO-LOCK DISPLAY
      tt-ped-item.it-codigo FORMAT "x(16)":U
