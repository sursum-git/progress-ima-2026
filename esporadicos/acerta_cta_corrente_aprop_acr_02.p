...
FOR EACH movto_tit_acr NO-LOCK
    ...
    FOR EACH aprop_ctbl_acr OF movto_tit_acr NO-LOCK
        ...
        IF AVAIL movto_cta_corren THEN DO:
         ...
         ASSIGN aprop_ctbl_acr.cod_ccusto = ''
                aprop_ctbl_acr.cod_plano_ccusto = ''.
