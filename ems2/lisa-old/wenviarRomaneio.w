...
&Scoped-Define ENABLED-OBJECTS rt-button fiPedido btEnviar 
...
DEFINE BUTTON btEnviar 
     LABEL "Enviar Romaneio para Lisa" 
     SIZE 29 BY 1.13.
...
DEFINE FRAME f-cad
     fiPedido AT ROW 4.79 COL 32.86 COLON-ALIGNED WIDGET-ID 2
     btEnviar AT ROW 6.04 COL 25 WIDGET-ID 4
...
&Scoped-define SELF-NAME btEnviar
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btEnviar w-livre
ON CHOOSE OF btEnviar IN FRAME f-cad /* Enviar Romaneio para Lisa */
DO:
  FIND ped-venda NO-LOCK
      WHERE ped-venda.nr-pedido = INPUT FRAME {&frame-name} fiPedido
      NO-ERROR.
  IF AVAIL ped-venda THEN DO:
     ...
     IF AVAIL nota-fiscal THEN DO:
        ...
        END.
        ELSE DO:
           MESSAGE "Romaneio enviado com sucesso"
               VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
        END.
     END.
  END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE rt-button fiPedido btEnviar 
      WITH FRAME f-cad IN WINDOW w-livre.
