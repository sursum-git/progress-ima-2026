...
*******************************************************************************/
{include/i-prgvrs.i ESCE0013 2.04.00.000}
...
DEFINE VARIABLE rs-classif AS INTEGER 
     ...
     RADIO-BUTTONS 
          "Por ÷tem/Referància", 1,
"Por Referància/÷tem", 2
     SIZE 17.57 BY 3.71
     FONT 1 NO-UNDO.
...
DEFINE VARIABLE fi-fin-acabamento AS CHARACTER FORMAT "X(2)":U INITIAL "ZZ" 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88 TOOLTIP "Acabamento final" NO-UNDO.

DEFINE VARIABLE fi-fin-cod-obsoleto AS CHARACTER FORMAT "X(1)":U INITIAL "ZZ" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-fin-des-cor AS CHARACTER FORMAT "x(5)" INITIAL "ZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 TOOLTIP "Desenho/Cor-Variante final" NO-UNDO.

DEFINE VARIABLE fi-fin-fm-codigo AS CHARACTER FORMAT "x(8)" INITIAL "ZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 TOOLTIP "Fam°lia final" NO-UNDO.
...
DEFINE VARIABLE fi-fin-it-codigo AS CHARACTER FORMAT "x(16)" INITIAL "ZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 18 BY .88 TOOLTIP "÷tem final" NO-UNDO.

DEFINE VARIABLE fi-ini-acabamento AS CHARACTER FORMAT "X(2)":U 
     LABEL "Acabamento" 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88 TOOLTIP "Acabamento inicial" NO-UNDO.

DEFINE VARIABLE fi-ini-cod-obsoleto AS CHARACTER FORMAT "X(1)":U 
     LABEL "Cod.Obsoleto" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-ini-des-cor AS CHARACTER FORMAT "x(5)" 
     LABEL "Desenho/Cor-V" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 TOOLTIP "Desenho/Cor-Variante inicial" NO-UNDO.

DEFINE VARIABLE fi-ini-fm-codigo AS CHARACTER FORMAT "x(8)" 
     LABEL "Fam°lia":R9 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 TOOLTIP "Fam°lia inicial" NO-UNDO.
...
DEFINE VARIABLE fi-ini-it-codigo AS CHARACTER FORMAT "x(16)" 
     LABEL "Item":R5 
     VIEW-AS FILL-IN 
     SIZE 18 BY .88 TOOLTIP "÷tem inicial" NO-UNDO.
...
"Estampado", 2,
"Ambos", 3
     SIZE 31.14 BY .79 TOOLTIP "Tipo de artigo." NO-UNDO.
...
DEFINE FRAME f-pg-cla
     rs-classif AT ROW 2.92 COL 29 HELP
...
DEFINE FRAME f-pg-sel
     fi-ini-ge-codigo AT ROW 1.54 COL 15.57 COLON-ALIGNED HELP
          "Grupo de estoque a que pertence o item"
     fi-fin-ge-codigo AT ROW 1.54 COL 48.29 COLON-ALIGNED HELP
          "Grupo de estoque a que pertence o item" NO-LABEL
     fi-ini-fm-codigo AT ROW 2.54 COL 15.29 COLON-ALIGNED HELP
          "Fam°lia de material a que pertence o item"
     fi-fin-fm-codigo AT ROW 2.54 COL 48.29 COLON-ALIGNED HELP
     ...
     fi-ini-cod-refer AT ROW 4.54 COL 15.29 COLON-ALIGNED
     fi-fin-cod-refer AT ROW 4.54 COL 48.29 COLON-ALIGNED NO-LABEL
     fi-ini-acabamento AT ROW 5.54 COL 15.29 COLON-ALIGNED
     fi-fin-acabamento AT ROW 5.54 COL 48.29 COLON-ALIGNED NO-LABEL
     fi-ini-des-cor AT ROW 6.54 COL 15.29 COLON-ALIGNED
     fi-fin-des-cor AT ROW 6.54 COL 48.29 COLON-ALIGNED NO-LABEL
     fi-ini-cod-obsoleto AT ROW 7.54 COL 15.29 COLON-ALIGNED
     fi-fin-cod-obsoleto AT ROW 7.54 COL 48.29 COLON-ALIGNED NO-LABEL
     rs-opc-acab AT ROW 8.54 COL 17.86 NO-LABEL WIDGET-ID 8
     "Acabamento:" VIEW-AS TEXT
          SIZE 9.43 BY .54 AT ROW 8.67 COL 8 WIDGET-ID 6
     IMAGE-1 AT ROW 2.54 COL 36
     IMAGE-2 AT ROW 2.54 COL 46.72
     IMAGE-3 AT ROW 3.54 COL 36
     IMAGE-31 AT ROW 4.54 COL 36
     IMAGE-32 AT ROW 4.54 COL 46.72
     IMAGE-4 AT ROW 1.54 COL 36
     IMAGE-46 AT ROW 5.54 COL 36
     IMAGE-47 AT ROW 5.54 COL 46.72
     IMAGE-48 AT ROW 6.54 COL 36
     IMAGE-49 AT ROW 6.54 COL 46.72
     IMAGE-50 AT ROW 7.54 COL 36
     IMAGE-51 AT ROW 7.54 COL 46.72
     IMAGE-6 AT ROW 3.54 COL 46.72
     IMAGE-7 AT ROW 1.54 COL 46.72
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Cat†logo de Itens x Referàncias"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Cat†logo de Itens x Referàncias */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Cat†logo de Itens x Referàncias */
DO:
...
&Scoped-define SELF-NAME fi-fin-acabamento
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-fin-acabamento w-relat
ON MOUSE-SELECT-DBLCLICK OF fi-fin-acabamento IN FRAME f-pg-sel
DO:
   {include/zoomvar.i &prog-zoom  = eszoom/z01es068.w
                      &campo      = fi-fin-acabamento
                      &campozoom  = codigo}
END.
...
&Scoped-define SELF-NAME fi-fin-cod-obsoleto
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-fin-cod-obsoleto w-relat
ON MOUSE-SELECT-DBLCLICK OF fi-fin-cod-obsoleto IN FRAME f-pg-sel
DO:
   {include/zoomvar.i &prog-zoom  = eszoom/z01es068.w
                      &campo      = fi-fin-acabamento
                      &campozoom  = codigo}
...
&Scoped-define SELF-NAME fi-fin-cod-refer
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-fin-cod-refer w-relat
ON MOUSE-SELECT-DBLCLICK OF fi-fin-cod-refer IN FRAME f-pg-sel
DO:
    {include/zoomvar.i &prog-zoom  = inzoom/z01in375.w
                       &campo      = fi-fin-cod-refer
                       &campozoom  = cod-refer
                       &parametros = "run pi-seta-inicial in
                        wh-pesquisa(INPUT INPUT FRAME {&FRAME-NAME} fi-fin-it-codigo)."}
END.
...
&Scoped-define SELF-NAME fi-ini-acabamento
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-ini-acabamento w-relat
ON MOUSE-SELECT-DBLCLICK OF fi-ini-acabamento IN FRAME f-pg-sel /* Acabamento */
DO:
   {include/zoomvar.i &prog-zoom  = eszoom/z01es068.w
                      &campo      = fi-ini-acabamento
                      &campozoom  = codigo}
END.
...
&Scoped-define SELF-NAME fi-ini-cod-obsoleto
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-ini-cod-obsoleto w-relat
ON MOUSE-SELECT-DBLCLICK OF fi-ini-cod-obsoleto IN FRAME f-pg-sel /* Cod.Obsoleto */
DO:
   {include/zoomvar.i &prog-zoom  = eszoom/z01es068.w
                      &campo      = fi-ini-acabamento
                      &campozoom  = codigo}
...
DO:
    {include/zoomvar.i &prog-zoom  = inzoom/z01in375.w
                       &campo      = fi-ini-cod-refer
                       &campozoom  = cod-refer
                       &parametros = "run pi-seta-inicial in
                        wh-pesquisa(INPUT INPUT FRAME {&FRAME-NAME} fi-ini-it-codigo)."}
END.
...
ON MOUSE-SELECT-DBLCLICK OF fi-ini-fm-codigo IN FRAME f-pg-sel /* Fam°lia */
DO:
   {include/zoomvar.i &prog-zoom = inzoom/z01in122.w
...
{utp/ut9000.i "ESCE0013" "2.04.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    fi-ini-cod-refer:LOAD-MOUSE-POINTER("image/lupa.cur") IN FRAME f-pg-sel.
    fi-fin-cod-refer:LOAD-MOUSE-POINTER("image/lupa.cur") IN FRAME f-pg-sel.
    fi-ini-acabamento:LOAD-MOUSE-POINTER("image/lupa.cur") IN FRAME f-pg-sel.
    fi-fin-acabamento:LOAD-MOUSE-POINTER("image/lupa.cur") IN FRAME f-pg-sel.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-ini-ge-codigo fi-fin-ge-codigo fi-ini-fm-codigo fi-fin-fm-codigo 
          fi-ini-it-codigo fi-fin-it-codigo fi-ini-cod-refer fi-fin-cod-refer 
          fi-ini-acabamento fi-fin-acabamento fi-ini-des-cor fi-fin-des-cor 
          fi-ini-cod-obsoleto fi-fin-cod-obsoleto rs-opc-acab 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-31 IMAGE-32 IMAGE-4 IMAGE-46 IMAGE-47 
         IMAGE-48 IMAGE-49 IMAGE-50 IMAGE-51 IMAGE-6 IMAGE-7 fi-ini-ge-codigo 
         fi-fin-ge-codigo fi-ini-fm-codigo fi-fin-fm-codigo fi-ini-it-codigo 
         fi-fin-it-codigo fi-ini-cod-refer fi-fin-cod-refer fi-ini-acabamento 
         fi-fin-acabamento fi-ini-des-cor fi-fin-des-cor fi-ini-cod-obsoleto 
         fi-fin-cod-obsoleto rs-opc-acab 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.ini-fm-codigo    = INPUT FRAME f-pg-sel fi-ini-fm-codigo
           tt-param.fin-fm-codigo    = INPUT FRAME f-pg-sel fi-fin-fm-codigo
           ...
           tt-param.ini-des-cor      = INPUT FRAME f-pg-sel fi-ini-des-cor
           tt-param.fin-acabamento   = INPUT FRAME f-pg-sel fi-fin-acabamento
           tt-param.ini-acabamento   = INPUT FRAME f-pg-sel fi-ini-acabamento
           tt-param.fin-des-cor      = INPUT FRAME f-pg-sel fi-fin-des-cor
           tt-param.ini-cod-obsoleto = INPUT FRAME f-pg-sel fi-ini-cod-obsoleto
           tt-param.fin-cod-obsoleto = INPUT FRAME f-pg-sel fi-fin-cod-obsoleto
           tt-param.opc-acabado      = INPUT FRAME f-pg-sel rs-opc-acab
    ...
    {include/i-rprun.i esrp/esce0013rp.p}
