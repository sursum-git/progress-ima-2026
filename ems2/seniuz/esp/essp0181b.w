...
&Scoped-Define ENABLED-OBJECTS IMAGE-100 IMAGE-101 IMAGE-88 IMAGE-89 RECT-1 ~
RECT-44 RECT-50 rs-tipo-rel fi-cod-tipo-def-ini fi-cod-tipo-def-fin ~
bt-ajuda bt-ok bt-cancelar 
&Scoped-Define DISPLAYED-OBJECTS rs-tipo-rel fi-cod-tipo-def-ini ~
fi-cod-tipo-def-fin fi-it-codigo-ini fi-it-codigo-fin 
...
DEFINE FRAME F-Main
     ...
     fi-cod-tipo-def-ini AT ROW 4.25 COL 18 COLON-ALIGNED
     fi-cod-tipo-def-fin AT ROW 4.25 COL 45.29 COLON-ALIGNED NO-LABEL
     fi-it-codigo-ini AT ROW 5.25 COL 18 COLON-ALIGNED
     fi-it-codigo-fin AT ROW 5.25 COL 45.29 COLON-ALIGNED NO-LABEL
     bt-ajuda AT ROW 7.08 COL 59.86
     bt-ok AT ROW 7.13 COL 3.29
     bt-cancelar AT ROW 7.13 COL 14.29
     "Tipo do Relat¢rio" VIEW-AS TEXT
          SIZE 12 BY .54 AT ROW 1.75 COL 30.29
     " Sele‡Æo" VIEW-AS TEXT
          SIZE 7 BY .54 AT ROW 1 COL 4.29
     IMAGE-100 AT ROW 4.25 COL 30.14
     IMAGE-101 AT ROW 5.25 COL 44.29
     IMAGE-88 AT ROW 5.25 COL 30.14
     IMAGE-89 AT ROW 4.25 COL 44.29
     RECT-1 AT ROW 6.92 COL 2
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-digita ASSIGN
         HIDDEN             = YES
         TITLE              = "Sele‡Æo do Relat¢rio de  Analise dos Defeitos na Produ‡Æo"
         COLUMN             = 53.72
         ROW                = 13
         HEIGHT             = 7.46
         WIDTH              = 70.29
...
/* SETTINGS FOR FRAME F-Main
   FRAME-NAME                                                           */
/* SETTINGS FOR FILL-IN fi-cod-tipo-def-fin IN FRAME F-Main
   4                                                                    */
/* SETTINGS FOR FILL-IN fi-cod-tipo-def-ini IN FRAME F-Main
   4                                                                    */
...
ON END-ERROR OF w-digita /* Sele‡Æo do Relat¢rio de  Analise dos Defeitos na Produ‡Æo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-digita w-digita
ON WINDOW-CLOSE OF w-digita /* Sele‡Æo do Relat¢rio de  Analise dos Defeitos na Produ‡Æo */
DO:
...
DO:
  ASSIGN c-item-ini    = INPUT FRAME {&FRAME-NAME} fi-it-codigo-ini   
         ...
         i-tipo-rel    = INPUT FRAME {&FRAME-NAME} rs-tipo-rel
         l-ok          = YES. 
  APPLY "CLOSE":U TO THIS-PROCEDURE.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY rs-tipo-rel fi-cod-tipo-def-ini fi-cod-tipo-def-fin fi-it-codigo-ini 
          fi-it-codigo-fin 
      WITH FRAME F-Main IN WINDOW w-digita.
  ENABLE IMAGE-100 IMAGE-101 IMAGE-88 IMAGE-89 RECT-1 RECT-44 RECT-50 
         rs-tipo-rel fi-cod-tipo-def-ini fi-cod-tipo-def-fin bt-ajuda bt-ok 
         bt-cancelar 
      WITH FRAME F-Main IN WINDOW w-digita.
