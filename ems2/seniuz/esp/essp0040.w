...
*******************************************************************************/
{include/i-prgvrs.i ESSP0040 2.04.00.000}
...
DEFINE VARIABLE fi-fin-ano-mes AS CHARACTER FORMAT "9999/99" INITIAL "999912" 
     VIEW-AS FILL-IN 
     SIZE 7.57 BY .88 TOOLTIP "Data final, no formato AAAA/MM" NO-UNDO.
...
DEFINE VARIABLE fi-ini-ano-mes AS CHARACTER FORMAT "9999/99" INITIAL "000101" 
     LABEL "Periodo" 
     VIEW-AS FILL-IN 
     SIZE 7.57 BY .88 TOOLTIP "Data inicial, no formato AAAA/MM" NO-UNDO.
...
DEFINE FRAME f-pg-par
     rs-acabamento AT ROW 2.21 COL 9.57 NO-LABEL
     rs-tipo-relatorio AT ROW 2.25 COL 56.72 NO-LABEL
     to-imp-param AT ROW 7.38 COL 26.72
     RECT-10 AT ROW 1.5 COL 4
     RECT-11 AT ROW 1.5 COL 49
     RECT-25 AT ROW 6.67 COL 4
     " Tipo do Relat¢rio" VIEW-AS TEXT
          SIZE 13.14 BY .79 AT ROW 1.08 COL 55.86
     "  Acabamento" VIEW-AS TEXT
          SIZE 10.86 BY .79 AT ROW 1.08 COL 12.14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 75 BY 10
...
DEFINE FRAME f-pg-sel
     ...
     fi-ini-it-codigo AT ROW 2.25 COL 15 COLON-ALIGNED
     fi-fin-it-codigo AT ROW 2.25 COL 48.14 COLON-ALIGNED NO-LABEL
     fi-ini-ano-mes AT ROW 3.25 COL 15 COLON-ALIGNED HELP
          "Periodo: AAAA/MM (AAAA = Ano, MM = Mes)"
     fi-fin-ano-mes AT ROW 3.25 COL 48.14 COLON-ALIGNED HELP
          "Periodo: AAAA/MM (AAAA = Ano, MM = Mes)" NO-LABEL
     fi-ini-tipo-tear AT ROW 4.25 COL 15 COLON-ALIGNED HELP
          "Tipo tear (Nissan, Tsudakoma, Sulzer,Toyota)."
     fi-fin-tipo-tear AT ROW 4.25 COL 48.14 COLON-ALIGNED HELP
          "Tipo tear (Nissan, Howa, Sulzer)." NO-LABEL
     IMAGE-1 AT ROW 1.25 COL 31.86
     IMAGE-11 AT ROW 3.25 COL 31.86
     IMAGE-12 AT ROW 3.25 COL 47.29
     IMAGE-13 AT ROW 4.25 COL 31.86
     IMAGE-14 AT ROW 4.25 COL 47.29
     IMAGE-15 AT ROW 2.29 COL 47.29
     IMAGE-16 AT ROW 2.29 COL 31.86
...
ON END-ERROR OF w-relat /* Amostras por Fam¡lia */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Amostras por Fam¡lia */
DO:
...
{utp/ut9000.i "ESSP0040" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE fi-ini-fm-codigo fi-fin-fm-codigo fi-ini-it-codigo fi-fin-it-codigo 
         ...
         IMAGE-1 IMAGE-11 IMAGE-12 IMAGE-13 IMAGE-14 IMAGE-15 IMAGE-16 IMAGE-2 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY rs-acabamento rs-tipo-relatorio to-imp-param 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE rs-acabamento rs-tipo-relatorio to-imp-param RECT-10 RECT-11 RECT-25 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
*/    
    ...
    assign tt-param.usuario             = c-seg-usuario
           ...
           tt-param.acabamento          = INPUT FRAME f-pg-par rs-acabamento
           tt-param.desc-acabamento     = entry((tt-param.acabamento - 1) * 2 + 1, 
                                              rs-acabamento:radio-buttons in frame f-pg-par)
    ...
    {include/i-rprun.i esrp/essp0040rp.p}
