...
*******************************************************************************/
{include/i-prgvrs.i ESSP0062 2.04.00.000}
...
DEFINE VARIABLE h_q02di154 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v02di154 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-cadsi2 /* Pedidos - Reservas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsi2 w-cadsi2
ON WINDOW-CLOSE OF w-cadsi2 /* Pedidos - Reservas */
DO:
...
DO:
  RUN esdlg/d02di154.w.
  RUN adm-open-query-cases IN h_q02di154.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esvwr/v02di154.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v02di154 ).
       RUN set-position IN h_v02di154 ( 2.75 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.75 , 88.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esqry/q02di154.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = dizoom/z03di154.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q02di154 ).
       RUN set-position IN h_q02di154 ( 1.50 , 67.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsi2 , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_v02di154. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsi2 , 'TableIO':U , h_v02di154 ).
       RUN add-link IN adm-broker-hdl ( h_q02di154 , 'Record':U , h_v02di154 ).
       RUN add-link IN adm-broker-hdl ( h_v02di154 , 'State':U , THIS-PROCEDURE ).

       /* Links to SmartQuery h_q02di154. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_q02di154 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_q02di154 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_q02di154 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsi2 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v02di154 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0062" "2.04.00.000"}
