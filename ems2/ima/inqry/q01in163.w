...
&Scoped-define INTERNAL-TABLES it-doc-fisico

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH it-doc-fisico NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH it-doc-fisico NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main it-doc-fisico
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main it-doc-fisico
...
<FOREIGN-KEYS>
num-pedido||y|movind.it-doc-fisico.num-pedido
nr-ficha||y|movind.it-doc-fisico.nr-ficha
nr-ord-produ||y|movind.it-doc-fisico.nr-ord-produ
numero-ordem||y|movind.it-doc-fisico.numero-ordem
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "num-pedido,nr-ficha,nr-ord-produ,numero-ordem"':U).
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "num-pedido" "it-doc-fisico" "num-pedido"}
  {src/adm/template/sndkycas.i "nr-ficha" "it-doc-fisico" "nr-ficha"}
  {src/adm/template/sndkycas.i "nr-ord-produ" "it-doc-fisico" "nr-ord-produ"}
  {src/adm/template/sndkycas.i "numero-ordem" "it-doc-fisico" "numero-ordem"}
