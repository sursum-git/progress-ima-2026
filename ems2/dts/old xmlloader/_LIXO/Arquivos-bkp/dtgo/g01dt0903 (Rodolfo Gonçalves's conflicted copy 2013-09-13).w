...
*******************************************************************************/
{include/i-buffer.i}
{include/i-prgvrs.i G01DT0903 2.06.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button RECT-1 i_ep-codigo bt-ok ~
bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_ep-codigo 
...
DEFINE VARIABLE i_ep-codigo AS INTEGER FORMAT ">>9":U INITIAL 0 
     LABEL "Empresa" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     i_ep-codigo AT ROW 2 COL 20 COLON-ALIGNED WIDGET-ID 2
     bt-ok AT ROW 4.5 COL 2.14
     bt-cancela AT ROW 4.5 COL 13
     bt-ajuda AT ROW 4.5 COL 34
     rt-button AT ROW 4.25 COL 1
     RECT-1 AT ROW 1.21 COL 1.29 WIDGET-ID 4
     SPACE(0.42) SKIP(1.78)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "V  Para Empresas"
...
ON GO OF FRAME d-vapara /* V  Para Empresas */
DO:
FIND dt-empresa NO-LOCK
    WHERE dt-empresa.ep-codigo EQ INPUT FRAME {&FRAME-NAME} i_ep-codigo NO-ERROR.

IF NOT AVAILABLE dt-empresa THEN DO:
    {utp/ut-table.i XMLLoader dt-empresa 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(dt-empresa).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Empresas */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY i_ep-codigo 
      WITH FRAME d-vapara.
  ENABLE rt-button RECT-1 i_ep-codigo bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "G01DT0903" "2.06.00.001"}
