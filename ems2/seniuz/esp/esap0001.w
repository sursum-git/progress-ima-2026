...
*******************************************************************************/
{include/i-prgvrs.i ESAP0001 2.04.00.000}
...
DEFINE VARIABLE fi-fim-gr-forn AS INTEGER FORMAT ">9":U INITIAL 99 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88 NO-UNDO.
...
DEFINE VARIABLE fi-ini-gr-forn AS INTEGER FORMAT ">9":U INITIAL 0 
...
DEFINE FRAME f-pg-sel
     fi-ep-codigo AT ROW 2.46 COL 18 COLON-ALIGNED
     fi-nome-empresa AT ROW 2.46 COL 23.57 COLON-ALIGNED NO-LABEL
     fi-dt-corte AT ROW 3.46 COL 18 COLON-ALIGNED
     fi-ini-gr-forn AT ROW 4.46 COL 18 COLON-ALIGNED
     fi-fim-gr-forn AT ROW 4.46 COL 43.14 COLON-ALIGNED NO-LABEL
     fi-ini-cod-estabel AT ROW 5.46 COL 18 COLON-ALIGNED
     fi-fim-cod-estabel AT ROW 5.46 COL 43.14 COLON-ALIGNED NO-LABEL
     fi-ini-cod-esp AT ROW 6.46 COL 18 COLON-ALIGNED
     fi-fim-cod-esp AT ROW 6.46 COL 43.14 COLON-ALIGNED NO-LABEL
     tg-impr-param AT ROW 9.58 COL 23
     IMAGE-27 AT ROW 5.5 COL 33.29
     IMAGE-28 AT ROW 5.5 COL 40.86
     IMAGE-31 AT ROW 6.5 COL 33.29
     IMAGE-32 AT ROW 6.5 COL 40.86
     IMAGE-35 AT ROW 4.5 COL 33.29
     IMAGE-36 AT ROW 4.5 COL 40.86
     RECT-16 AT ROW 1.08 COL 1
     RECT-27 AT ROW 8.83 COL 16.29
     " Outros" VIEW-AS TEXT
          SIZE 5.43 BY .75 AT ROW 8.46 COL 19.14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "T¡tulos a Pagar por Grupo de Fornecedor"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* T¡tulos a Pagar por Grupo de Fornecedor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* T¡tulos a Pagar por Grupo de Fornecedor */
DO:
...
&Scoped-define SELF-NAME fi-fim-gr-forn
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-fim-gr-forn w-relat
ON MOUSE-SELECT-DBLCLICK OF fi-fim-gr-forn IN FRAME f-pg-sel
DO:
    {include/zoomvar.i &prog-zoom=adzoom/z01ad131.w
                       &campo=fi-fim-gr-forn
...
&Scoped-define SELF-NAME fi-ini-gr-forn
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-ini-gr-forn w-relat
ON MOUSE-SELECT-DBLCLICK OF fi-ini-gr-forn IN FRAME f-pg-sel /* Grupo Fornecedor */
DO:
    {include/zoomvar.i &prog-zoom=adzoom/z01ad131.w
                       &campo=fi-ini-gr-forn
                       &campozoom=cod-gr-forn
                       &FRAME=f-pg-sel}
END.
...
{utp/ut9000.i "ESAP0001" "2.04.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN fi-ep-codigo:SCREEN-VALUE IN FRAME f-pg-sel = "1"
           fi-dt-corte:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY,"99/99/9999")
    ...
    fi-ini-gr-forn:LOAD-MOUSE-POINTER("image/lupa.cur") IN FRAME f-pg-sel.
    fi-fim-gr-forn:LOAD-MOUSE-POINTER("image/lupa.cur") IN FRAME f-pg-sel.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-ep-codigo fi-nome-empresa fi-dt-corte fi-ini-gr-forn fi-fim-gr-forn 
          fi-ini-cod-estabel fi-fim-cod-estabel fi-ini-cod-esp fi-fim-cod-esp 
          tg-impr-param 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-ep-codigo fi-dt-corte fi-ini-gr-forn fi-fim-gr-forn 
         fi-ini-cod-estabel fi-fim-cod-estabel fi-ini-cod-esp fi-fim-cod-esp 
         tg-impr-param IMAGE-27 IMAGE-28 IMAGE-31 IMAGE-32 IMAGE-35 IMAGE-36 
         RECT-16 RECT-27 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.ep-codigo       = INPUT FRAME f-pg-sel fi-ep-codigo
           ...
           tt-param.gr-forn-ini     = INPUT FRAME f-pg-sel fi-ini-gr-forn
           tt-param.gr-forn-fim     = INPUT FRAME f-pg-sel fi-fim-gr-forn 
    ...
    {include/i-rprun.i esrp/esap0001rp.p} 
