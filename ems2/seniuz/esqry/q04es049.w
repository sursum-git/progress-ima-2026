...
DEF VAR c-situacao AS CHAR INIT "2,3,4".
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH ob-etiqueta NO-LOCK ~
    BY ob-etiqueta.cod-estabel ~
       BY ob-etiqueta.num-etiqueta INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH ob-etiqueta NO-LOCK ~
    BY ob-etiqueta.cod-estabel ~
       BY ob-etiqueta.num-etiqueta INDEXED-REPOSITION.
...
num-etiqueta||y|espec.ob-etiqueta.num-etiqueta
cod-estabel||y|espec.ob-etiqueta.cod-estabel
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "it-codigo,num-etiqueta,cod-estabel,cod-refer"':U).
...
/* Query rebuild information for QUERY Query-Main
     ...
     _OrdList          = "espec.ob-etiqueta.cod-estabel|yes,espec.ob-etiqueta.num-etiqueta|yes"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "num-etiqueta" "ob-etiqueta" "num-etiqueta"}
  {src/adm/template/sndkycas.i "cod-estabel" "ob-etiqueta" "cod-estabel"}
