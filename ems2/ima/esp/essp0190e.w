...
*******************************************************************************/
{include/i-prgvrs.i ESSP0190E 2.04.00.000}
...
DEF BUFFER b-tt-trab FOR tt-trab.
...
&GLOBAL-DEFINE SORTBY-PHRASE BY IF sort-col = 1 ~
                                 THEN tt-work.it-codigo ~
                                ELSE IF sort-col = 2 ~
                                     THEN tt-work.desc-item ~
                                    ELSE IF sort-col = 3 ~
                                         THEN tt-work.und + tt-work.it-codigo ~
                                        ELSE IF sort-col = 4 ~
...
&GLOBAL-DEFINE SORTBY-IMP-EXCEL BY IF sort-col = 1 ~
                                    THEN b-tt-work.it-codigo ~
                                   ELSE IF sort-col = 2 ~
                                        THEN b-tt-work.desc-item ~
                                       ELSE IF sort-col = 3 ~
                                            THEN b-tt-work.und + b-tt-work.it-codigo ~
                                           ELSE IF sort-col = 4 ~
...
&Scoped-define FIELDS-IN-QUERY-br-work tt-work.it-codigo tt-work.desc-item tt-work.und tt-work.qtd tt-work.vlr tt-work.desc-pratic tt-work.preco-medio tt-work.qtd-devol tt-work.vlr-devol   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-work tt-work.it-codigo   tt-work.desc-item   tt-work.und   tt-work.qtd   tt-work.vlr   tt-work.desc-pratic   tt-work.preco-medio   tt-work.qtd-devol   tt-work.vlr-devol   
...
&Scoped-Define ENABLED-OBJECTS RECT-1 rt-buttom br-work bt-vapara bt-excel ~
bt-imprime bt-exit bt-ok bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS fi-tot-qtd-m fi-tot-vlr-m fi-tot-desc-m ~
fi-media-m fi-tot-qtd-dev-m fi-tot-vlr-dev-m fi-tot-qtd-kg fi-tot-vlr-kg ~
fi-tot-desc-kg fi-media-kg fi-tot-qtd-dev-kg fi-tot-vlr-dev-kg ~
fi-tot-qtd-und fi-tot-vlr-und fi-tot-desc-und fi-media-und ~
fi-tot-qtd-dev-und fi-tot-vlr-dev-und fi-tot-geral fi-ger-qtd-dev ~
fi-ger-vlr-dev 
...
DEFINE VARIABLE fi-ger-qtd-dev AS DECIMAL FORMAT " ZZ,ZZZ,ZZ9.99":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88
     FGCOLOR 4  NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-work D-Dialog _FREEFORM
  QUERY br-work NO-LOCK DISPLAY
      tt-work.it-codigo       COLUMN-LABEL "Item"                 FORMAT "x(12)"              WIDTH 06.0
      tt-work.desc-item       COLUMN-LABEL "Descriá∆o"            FORMAT "x(35)"              WIDTH 35.6
      ...
      tt-work.vlr-devol       COLUMN-LABEL "Valor Devoluá∆o"      FORMAT ">>>,>>>,>>>,>>9.99" WIDTH 11.2
ENABLE
    tt-work.it-codigo
    tt-work.desc-item
    tt-work.und
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 119.29 BY 11.92
         FONT 1
...
DEFINE FRAME D-Dialog
     br-work AT ROW 1.08 COL 1.72
     bt-vapara AT ROW 1.38 COL 122
     bt-excel AT ROW 2.92 COL 122
     bt-imprime AT ROW 4.5 COL 122
     fi-tot-qtd-m AT ROW 13.08 COL 45.14 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-m AT ROW 13.08 COL 57.29 COLON-ALIGNED NO-LABEL
     fi-tot-desc-m AT ROW 13.08 COL 69.29 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     fi-media-m AT ROW 13.08 COL 81.43 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-dev-m AT ROW 13.08 COL 93.57 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-dev-m AT ROW 13.08 COL 105.29 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-kg AT ROW 14.08 COL 45.14 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-kg AT ROW 14.08 COL 57.29 COLON-ALIGNED NO-LABEL
     fi-tot-desc-kg AT ROW 14.08 COL 69.29 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     fi-media-kg AT ROW 14.08 COL 81.43 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-dev-kg AT ROW 14.08 COL 93.57 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-dev-kg AT ROW 14.08 COL 105.29 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-und AT ROW 15.08 COL 45.14 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-und AT ROW 15.08 COL 57.29 COLON-ALIGNED NO-LABEL
     fi-tot-desc-und AT ROW 15.08 COL 69.29 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     fi-media-und AT ROW 15.08 COL 81.43 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-dev-und AT ROW 15.08 COL 93.57 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-dev-und AT ROW 15.08 COL 105.29 COLON-ALIGNED NO-LABEL
     fi-tot-geral AT ROW 16.08 COL 57.29 COLON-ALIGNED NO-LABEL
     fi-ger-qtd-dev AT ROW 16.08 COL 93.57 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-ger-vlr-dev AT ROW 16.08 COL 105.29 COLON-ALIGNED NO-LABEL
     bt-exit AT ROW 16.79 COL 122
     bt-ok AT ROW 17.33 COL 2.57
     bt-cancela AT ROW 17.33 COL 13.57
     bt-ajuda AT ROW 17.33 COL 110
     "UND" VIEW-AS TEXT
          SIZE 3.29 BY .54 AT ROW 15.17 COL 43.43
          FGCOLOR 12 
     "TOTAL GERAL:" VIEW-AS TEXT
          SIZE 11.29 BY .71 AT ROW 16.17 COL 47.86
          FGCOLOR 4 
     "TOTAIS:" VIEW-AS TEXT
          SIZE 6.72 BY .88 AT ROW 13.17 COL 37.29
          FONT 0
     "KG" VIEW-AS TEXT
          SIZE 2 BY .54 AT ROW 14.29 COL 44.57
          FGCOLOR 12 
     "M" VIEW-AS TEXT
          SIZE 1.57 BY .54 AT ROW 13.33 COL 45.29
          FGCOLOR 12 
     RECT-1 AT ROW 1.17 COL 121.43
     rt-buttom AT ROW 17.08 COL 1.57
     SPACE(7.71) SKIP(0.07)
...
/* SETTINGS FOR BUTTON bt-excel IN FRAME D-Dialog
   6                                                                    */
/* SETTINGS FOR FILL-IN fi-ger-qtd-dev IN FRAME D-Dialog
   NO-ENABLE                                                            */
...
DO:
  ...
  IF tt-work.qtd-devol <> 0 THEN
     tt-work.qtd-devol:FGCOLOR IN BROWSE br-work = 12.
  IF tt-work.vlr-devol <> 0 THEN
...
/* ***************************  Main Block  *************************** */
 ASSIGN FRAME d-dialog:TITLE = "Totais Dos Itens  -  ESSP0190E".

 tt-work.it-codigo:READ-ONLY IN BROWSE br-work    = YES.
 tt-work.desc-item:READ-ONLY IN BROWSE br-work    = YES.
...
------------------------------------------------------------------------------*/
  DISPLAY fi-tot-qtd-m fi-tot-vlr-m fi-tot-desc-m fi-media-m fi-tot-qtd-dev-m 
          fi-tot-vlr-dev-m fi-tot-qtd-kg fi-tot-vlr-kg fi-tot-desc-kg 
          fi-media-kg fi-tot-qtd-dev-kg fi-tot-vlr-dev-kg fi-tot-qtd-und 
          fi-tot-vlr-und fi-tot-desc-und fi-media-und fi-tot-qtd-dev-und 
          fi-tot-vlr-dev-und fi-tot-geral fi-ger-qtd-dev fi-ger-vlr-dev 
      WITH FRAME D-Dialog.
  ENABLE RECT-1 rt-buttom br-work bt-vapara bt-excel bt-imprime bt-exit bt-ok 
         bt-cancela bt-ajuda 
      WITH FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
    ...
    PUT "ITEM    DESCRICAO                                UND    QUANTIDADE          VALOR    DESC PRATIC   PRECO MEDIO  QTD DEVOLUÄ«O  VLR DEVOLUÄ«O" AT 1.
    PUT "-----   ---------------------------------------  ---  ------------   ------------   ------------   -----------  -------------  -------------" AT 1. 
...
/*          PUT CONTROL "~033&l1O~033(s16H". /* ORIENTAÄ«O PAISAGEM & COMPACTA */  */
  ...
  DO i-ct = 1 TO i-num-copias.
     ...
     ASSIGN fi-tot-qtd-m      = 0 fi-tot-vlr-m      = 0 fi-tot-qtd-kg      = 0 fi-tot-qtd-dev-m   = 0
            fi-tot-vlr-kg     = 0 fi-tot-qtd-und    = 0 fi-tot-vlr-und     = 0 fi-tot-vlr-dev-m   = 0
            fi-tot-qtd-dev-kg = 0 fi-tot-vlr-dev-kg = 0 fi-tot-qtd-dev-und = 0 fi-tot-vlr-dev-und = 0
     ...
     FOR EACH b-tt-work NO-LOCK {&SORTBY-IMP-EXCEL}.
         IF i-lin > 62 THEN DO:
            ...
            ASSIGN i-lin = 7.
         END.
         PUT b-tt-work.it-codigo   FORMAT "x(6)"           AT   1
             b-tt-work.desc-item   FORMAT "x(40)"          AT   9 
             ...
             (b-tt-work.vlr /
              b-tt-work.qtd)       FORMAT "->>>,>>9.99"    AT 100
             b-tt-work.qtd-devol   FORMAT "->,>>>,>>9.99"  AT 113
             b-tt-work.vlr-devol   FORMAT "->,>>>,>>9.99"  AT 128.
     ...
     PUT fi-tot-qtd-m    FORMAT "->,>>>,>>9.99"    AT  54
         ...
         fi-tot-desc-m   FORMAT "->,>>>,>>9.99"    AT  84.
     IF fi-tot-vlr-m > 0  THEN
     PUT (fi-tot-vlr-m / 
          fi-tot-qtd-m)    FORMAT "->>>,>>9.99"       AT 100
          fi-tot-qtd-dev-m FORMAT "->,>>>,>>9.99"     AT 113
          fi-tot-vlr-dev-m FORMAT "->,>>>,>>9.99"     AT 128.

     PUT "KG" AT 51.
     PUT fi-tot-qtd-kg    FORMAT "->,>>>,>>9.99"  AT  54
         fi-tot-vlr-kg    FORMAT "->,>>>,>>9.99"  AT  69
         fi-tot-desc-kg   FORMAT "->,>>>,>>9.99"   AT  84.
     IF fi-tot-vlr-kg > 0 THEN
     PUT (fi-tot-vlr-kg / 
          fi-tot-qtd-kg)    FORMAT "->>>,>>9.99"    AT 100
          fi-tot-qtd-dev-kg FORMAT "->,>>>,>>9.99"  AT 113
          fi-tot-vlr-dev-kg FORMAT "->,>>>,>>9.99"  AT 128.
     PUT "UND" AT 50.
     PUT fi-tot-qtd-und    FORMAT "->,>>>,>>9.99"  AT  54
         fi-tot-vlr-und    FORMAT "->,>>>,>>9.99"  AT  69
         fi-tot-desc-und   FORMAT "->,>>>,>>9.99"  AT  84.

     IF fi-tot-vlr-und > 0 THEN
     PUT (fi-tot-vlr-und / 
          fi-tot-qtd-und)    FORMAT "->>>,>>9.99"    AT 100
          fi-tot-qtd-dev-und FORMAT "->,>>>,>>9.99"  AT 113
          fi-tot-vlr-dev-und FORMAT "->,>>>,>>9.99"  AT 128.
...
------------------------------------------------------------------------------*/
 ...
 chWorkSheet = chExcelapp:Sheets:ITEM(1).
 chWorkSheet:NAME = "Faturamento Por Item".
 ...
 chWorkSheet:Range("A1:I1"):FONT:ColorIndex     = 18. /* Avermelhado */
 chWorkSheet:Range("A1:I1"):Interior:ColorIndex = 2. /* Branco */
 ...
 ASSIGN chworksheet:range("A3"):VALUE = "ITEM"
        ...
        chworksheet:range("H3"):VALUE = "QTD DEVOLUÄ«O"     
        chworksheet:range("I3"):VALUE = "VALOR DEVOLUÄ«O".
 ...
 ASSIGN chworksheet:range("D:I"):NumberFormat        = "###.###.##0,00"
        Chworksheet:range("D:I"):HorizontalAlignment = 4. /* Alinhamento a Direita */
...
FOR EACH b-tt-work NO-LOCK {&SORTBY-IMP-EXCEL}.
    ASSIGN chworksheet:range("A" + STRING(i-lin)):VALUE = b-tt-work.it-codigo
           ...
           chworksheet:range("H" + STRING(i-lin)):VALUE = b-tt-work.qtd-devol
...
IF i-lin <> 4 THEN DO:
   ...
   ASSIGN chworksheet:range("D" + STRING(i-lin)):VALUE = fi-tot-qtd-m     
          ...
          chworksheet:range("H" + STRING(i-lin)):VALUE = fi-tot-qtd-dev-m 
          chworksheet:range("I" + STRING(i-lin)):VALUE = fi-tot-vlr-dev-m. 

    /* Colorir a Linha / Negrito */
   ASSIGN chWorkSheet:Range("A" + STRING(i-lin) + ":H" + STRING(i-lin)):Interior:ColorIndex = 14
   ...
   ASSIGN chworksheet:range("D" + STRING(i-lin)):VALUE = fi-tot-qtd-kg     
          ...
          chworksheet:range("H" + STRING(i-lin)):VALUE = fi-tot-qtd-dev-kg 
          chworksheet:range("I" + STRING(i-lin)):VALUE = fi-tot-vlr-dev-kg. 
    /* Colorir a Linha / Negrito */
   ASSIGN chWorkSheet:Range("A" + STRING(i-lin) + ":H" + STRING(i-lin)):Interior:ColorIndex = 14
          chWorkSheet:Range("A" + STRING(i-lin) + ":H" + STRING(i-lin)):FONT:ColorIndex     =  2
          chWorkSheet:Range("A" + STRING(i-lin) + ":H" + STRING(i-lin)):FONT:Bold           = TRUE.
   ...
   ASSIGN chworksheet:range("D" + STRING(i-lin)):VALUE = fi-tot-qtd-und     
          ...
          chworksheet:range("H" + STRING(i-lin)):VALUE = fi-tot-qtd-dev-und 
          chworksheet:range("I" + STRING(i-lin)):VALUE = fi-tot-vlr-dev-und. 
    /* Colorir a Linha / Negrito */
   ASSIGN chWorkSheet:Range("A" + STRING(i-lin) + ":I" + STRING(i-lin)):Interior:ColorIndex = 14
   ...
   ASSIGN chworksheet:range("E" + STRING(i-lin)):VALUE = fi-tot-vlr-m + fi-tot-vlr-kg + fi-tot-vlr-und
          chworksheet:range("I" + STRING(i-lin)):VALUE = fi-tot-vlr-dev-m + fi-tot-vlr-dev-kg + fi-tot-vlr-dev-und. 
            
    /* Colorir a Linha / Negrito */
   ASSIGN chWorkSheet:Range("A" + STRING(i-lin) + ":H" + STRING(i-lin)):Interior:ColorIndex = 18
          chWorkSheet:Range("A" + STRING(i-lin) + ":H" + STRING(i-lin)):FONT:ColorIndex     =  2
          chWorkSheet:Range("A" + STRING(i-lin) + ":H" + STRING(i-lin)):FONT:Bold           = TRUE.
END.
...
------------------------------------------------------------------------------*/
 ...
 FOR EACH tt-trab WHERE
     tt-trab.it-codigo <> ""  AND
     tt-trab.uf        = "ZZ"  NO-LOCK.
     FIND item WHERE
          item.it-codigo = tt-trab.it-codigo NO-LOCK NO-ERROR.
     CREATE tt-work.
     ASSIGN tt-work.it-codigo   = tt-trab.it-codigo
            tt-work.desc-item   = item.desc-item
            tt-work.Und         = tt-trab.und
            tt-work.qtd         = tt-trab.qtd
            tt-work.vlr         = tt-trab.vlr - tt-trab.desc-pratic
            tt-work.desc-pratic = tt-trab.desc-pratic
...
------------------------------------------------------------------------------*/
 ...
 ASSIGN fi-media-m     = fi-tot-vlr-m / fi-tot-qtd-m
        ...
        fi-ger-qtd-dev = fi-tot-qtd-dev-m + fi-tot-qtd-dev-kg + fi-tot-qtd-dev-und
