...
DEFINE TEMP-TABLE tt
    FIELD codigo AS CHAR FORMAT 'x(50)'
    FIELD descricao AS CHAR FORMAT 'x(400)'.
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 codigo descricao   
...
&Scoped-Define ENABLED-OBJECTS rt-button EDITOR-1 BROWSE-2 
...
DEFINE FRAME f-cad
     EDITOR-1 AT ROW 4 COL 5 NO-LABEL WIDGET-ID 2
     BROWSE-2 AT ROW 7.75 COL 5 WIDGET-ID 200
...
/* SETTINGS FOR FRAME f-cad
   L-To-R                                                               */
/* BROWSE-TAB BROWSE-2 EDITOR-1 f-cad */
...
------------------------------------------------------------------------------*/
  ...
  ENABLE rt-button EDITOR-1 BROWSE-2 
      WITH FRAME f-cad IN WINDOW w-livre.
