...
/*------------------------------------------------------------------------
File.............: imcb01a.w
Description......: Relatorio de Cheques Pendentes
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 29/08/03 - 15:53 - super
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "IMCB01A".
...
define temp-table tt-param
    ...
    field da-dt-deposito-ini like cheque.dt-deposito
    field da-dt-deposito-fim like cheque.dt-deposito
    field c-agencia-ini like cheque.agencia
    field c-agencia-fim like cheque.agencia
.
...
def new shared var da-dt-deposito-ini like cheque.dt-deposito format "99/99/9999" initial "01/01/1800" no-undo.
def new shared var da-dt-deposito-fim like cheque.dt-deposito format "99/99/9999" initial "12/31/9999" no-undo.
def new shared var c-agencia-ini like cheque.agencia format "x(8)" initial "" no-undo.
def new shared var c-agencia-fim like cheque.agencia format "x(8)" initial "ZZZZZZZZ" no-undo.
...
DEFINE FRAME f-pg-sel
   da-dt-deposito-ini label "Data Dep¢sito"
     at row 1 col 18 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   da-dt-deposito-fim no-label
     at row 1 col 39 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   c-agencia-ini label "Agˆncia"
     at row 2 col 18 colon-aligned
     view-as fill-in 
     size 9 by .88
     font 1

   c-agencia-fim no-label
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Relatorio de Cheques Pendentes - imcb01a"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "imcb01a".
...
PROCEDURE enable_UI :
   ...
   DISPLAY  
   da-dt-deposito-ini da-dt-deposito-fim
   c-agencia-ini c-agencia-fim
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "imcb01a" + ".tmp".

    assign tt-param.da-dt-deposito-ini = input frame f-pg-sel da-dt-deposito-ini
           tt-param.da-dt-deposito-fim = input frame f-pg-sel da-dt-deposito-fim
           tt-param.da-dt-deposito-fim = input frame f-pg-sel da-dt-deposito-fim
           tt-param.c-agencia-ini = input frame f-pg-sel c-agencia-ini
           tt-param.c-agencia-fim = input frame f-pg-sel c-agencia-fim
.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "esp/imcb011.p".
