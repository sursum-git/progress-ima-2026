...
&Scoped-define QUERY-STRING-Query-Main FOR EACH mov-man ~
      WHERE mov-man.num-os >= fi-ini-num-os ~
 AND mov-man.num-os <= fi-fin-num-os ~
 AND mov-man.data-abe >= fi-ini-data-abe ~
 AND mov-man.data-abe <= fi-fin-data-abe NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH mov-man ~
      WHERE mov-man.num-os >= fi-ini-num-os ~
 AND mov-man.num-os <= fi-fin-num-os ~
 AND mov-man.data-abe >= fi-ini-data-abe ~
 AND mov-man.data-abe <= fi-fin-data-abe NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main mov-man
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main mov-man
...
/* Query rebuild information for QUERY Query-Main
 ...
 AND espec.mov-man.data-abe >= fi-ini-data-abe
...
/* ***************************  Main Block  *************************** */
  ASSIGN fi-ini-num-os = "AA00000"
         fi-fin-num-os = "ZZ99999"
         fi-ini-data-abe = 01/01/0001
         fi-fin-data-abe = 12/31/9999.
