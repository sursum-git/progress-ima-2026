...
DEFINE VARIABLE h_b01im001 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Parƒmetros */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Parƒmetros */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b01im001.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01im001 ).
       RUN set-position IN h_b01im001 ( 2.50 , 2.29 ) NO-ERROR.
       /* Size in UIB:  ( 12.00 , 87.00 ) */

       /* Links to SmartBrowser h_b01im001. */
       RUN add-link IN adm-broker-hdl ( h_b01im001 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b01im001 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
