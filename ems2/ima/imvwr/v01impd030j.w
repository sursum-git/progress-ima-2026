...
**             Dever† mostrar os t°tulos que s∆o reabertos em decorrància da 
**             devoluá∆o de cheques sem condiá∆o de representaá∆o. 
**             PorÇm para selecionar os t°tulos n∆o mais buscar† uma AVA no por-
**             tador 100 e sim uma AVA cujo campo mov-tit.char-1, tenha nas suas
**             6 primeiras posiá‰es a literal "DEV_CH".
**
...
&Scoped-define INTERNAL-TABLES tt_titulos

/* Definitions for BROWSE BROWSE-3                                      */
&Scoped-define FIELDS-IN-QUERY-BROWSE-3 tt_titulos.cod_estab tt_titulos.cod_espec_docto tt_titulos.cod_ser_docto tt_titulos.cod_tit_acr tt_titulos.cod_parcela tt_titulos.cod_portador tt_titulos.val_sdo_tit_acr tt_titulos.val_origin_tit_acr tt_titulos.dat_emis_docto tt_titulos.dat_vencto_tit_acr   
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-3   
&Scoped-define SELF-NAME BROWSE-3
&Scoped-define QUERY-STRING-BROWSE-3 FOR EACH tt_titulos
&Scoped-define OPEN-QUERY-BROWSE-3 OPEN QUERY {&SELF-NAME} FOR EACH tt_titulos.
&Scoped-define TABLES-IN-QUERY-BROWSE-3 tt_titulos
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-3 tt_titulos
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-3 V-table-Win _FREEFORM
  ...
  tt_titulos.val_origin_tit_acr
  tt_titulos.dat_emis_docto
