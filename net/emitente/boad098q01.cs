...
//
    ...
    public class boad098q01 : Procedure
    {
	...
	static DataTableMetaData validateUpdate_MetaData2;
        ...
        static boad098q01()
        {
		getCurrent_MetaData1 = new DataTableMetaData(0, "RowObject", 201, false, 0, null, null, null, "StrongTypesNS.RowObject3DataTable");
		...
		getCurrent_MetaData1.setFieldDesc(201, "rownum", 0, Parameter.PRO_INTEGER, 0, 200, 0, "", "", 0, null, "");

		serverSendRows_MetaData1 = new DataTableMetaData(0, "RowObject", 201, false, 0, null, null, null, "StrongTypesNS.RowObject3DataTable");
		...
		serverSendRows_MetaData1.setFieldDesc(201, "rownum", 0, Parameter.PRO_INTEGER, 0, 200, 0, "", "", 0, null, "");

		NewServerSendRows_MetaData1 = new DataTableMetaData(0, "RowObject", 201, false, 0, null, null, null, "StrongTypesNS.RowObject3DataTable");
		...
		NewServerSendRows_MetaData1.setFieldDesc(201, "rownum", 0, Parameter.PRO_INTEGER, 0, 200, 0, "", "", 0, null, "");

		validateUpdate_MetaData1 = new DataTableMetaData(0, "RowObject", 201, false, 2, "1,cod-emitente:codigo.nome-abrev:nome", null, null, "StrongTypesNS.RowObject3DataTable");
		...
		validateUpdate_MetaData1.setFieldDesc(201, "rownum", 0, Parameter.PRO_INTEGER, 0, 200, 0, "", "", 0, null, "");
	...
	public boad098q01(ProObject appObj) : base(appObj)
	{
		...
		// Run procedure
		PersistProcObj = RunPersistentProcedure("boad098q01.p", parms);
...
/// <summary>
	/// 
	/// </summary> 
	public string getCurrent(out StrongTypesNS.RowObject3DataTable RowObject)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		// Set up Out parameters
		parms.setDataTableParameter(1, null, ParameterSet.OUTPUT, "StrongTypesNS.RowObject3DataTable");
		...
		// Get output parameters
		outValue = parms.getOutputParameter(1);
		RowObject = (StrongTypesNS.RowObject3DataTable)outValue;
...
out StrongTypesNS.RowObject3DataTable RowObject)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		parms.setDataTableParameter(6, null, ParameterSet.OUTPUT, "StrongTypesNS.RowObject3DataTable");
...
/// <summary>
	/// 
	/// </summary> 
	public string validateUpdate(StrongTypesNS.RowObject3DataTable RowObject, Rowid rChave, out StrongTypesNS.ttBoErroDataTable ttBoErro)
	{
		RqContext rqCtx = null;
		if (isSessionAvailable() == false)
			throw new Open4GLException(NotAvailable, null);
		...
		// Set up input parameters
		parms.setDataTableParameter(1, RowObject, ParameterSet.INPUT, "StrongTypesNS.RowObject3DataTable");
