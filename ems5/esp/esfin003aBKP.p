...
DEFINE BUFFER b_tit_ap      FOR ems5bkp.tit_ap.
...
IF p-analise = 1 THEN DO.  // Transa‡Æo
   FOR EACH ems5bkp.tit_ap WHERE
            ems5bkp.tit_ap.dat_transacao >= pDtIni AND
            ems5bkp.tit_ap.dat_transacao <= pDtFim NO-LOCK
         BY ems5bkp.tit_ap.dat_transacao.
    
       // J  Baixou, ser  tratado pelo Realizado
       IF ems5bkp.tit_ap.dat_liquidac_tit_ap <> 12.31.9999 THEN NEXT. 

       RUN pi-acompanhar IN h-acomp (INPUT "Data: " + STRING(ems5bkp.tit_ap.dat_transacao,"99/99/9999") + " Titulo:" + STRING(ems5bkp.tit_ap.cod_tit_ap) ).
    
       FIND FIRST ems5bkp.espec_docto OF ems5bkp.tit_ap NO-LOCK NO-ERROR.
    
       IF ems5bkp.espec_docto.ind_tip_espec_docto = 'IMPOSTO RETIDO' THEN NEXT.
    
       FIND FIRST ems5bkp.fornecedor WHERE 
                  ems5bkp.fornecedor.cdn_fornecedor = ems5bkp.tit_ap.cdn_fornecedor NO-LOCK NO-ERROR. 
    
       IF AVAIL fornecedor THEN
          FIND FIRST ems5bkp.grp_fornec where
                     ems5bkp.grp_fornec.cod_grp_fornec = fornecedor.cod_grp_fornec NO-LOCK NO-ERROR.
    
       FOR EACH ems5bkp.movto_tit_ap OF ems5bkp.tit_ap WHERE 
                ems5bkp.movto_tit_ap.ind_trans_ap_abrev = 'IMPL' NO-LOCK:
    
           IF ems5bkp.tit_ap.ind_origin_tit_ap <> "REC" THEN DO:
              FOR EACH ems5bkp.aprop_ctbl_ap OF ems5bkp.movto_tit_ap WHERE
                       ems5bkp.aprop_ctbl_ap.ind_natur_lancto_ctbl = 'DB' NO-LOCK.
                   
                  CREATE tt.
                  ASSIGN tt.cod_modulo        = 'APB'
                         tt.cod_empresa       = ems5bkp.tit_ap.cod_empresa 
                         tt.cod_estab         = ems5bkp.tit_ap.cod_estab
                         tt.cod_emitente      = STRING(ems5bkp.tit_ap.cdn_fornecedor)
                         tt.desc_emitente     = fornecedor.nom_pessoa
                         tt.data              = ems5bkp.tit_ap.dat_transacao
                         tt.conta_contabil    = aprop_ctbl_ap.cod_cta_ctbl
                         tt.valor             = ems5bkp.tit_ap.val_origin_tit_ap * -1 
                         tt.base              = '12'
                         tt.origem            = 'Contas a Pagar'
                         tt.ccusto_gerencial  = aprop_ctbl_ap.cod_ccusto
                         tt.id_movto_corren   = ems5bkp.tit_ap.num_id_tit_ap
                         tt.tipo              = 'Aberto'.
    
                  FOR EACH ems5bkp.compl_impto_retid_ap WHERE 
                           ems5bkp.compl_impto_retid_ap.num_id_movto_tit_ap_pai = ems5bkp.movto_tit_ap.num_id_movto_tit_ap AND
                           ems5bkp.compl_impto_retid_ap.cod_estab               = ems5bkp.movto_tit_ap.cod_estab NO-LOCK.
                      FIND b_tit_ap WHERE 
                           b_tit_ap.cod_estab     = ems5bkp.compl_impto_retid_ap.cod_estab AND 
                           b_tit_ap.num_id_tit_ap = ems5bkp.compl_impto_retid_ap.num_id_tit_ap
                           NO-LOCK NO-ERROR.
           ...
           ELSE DO:
               CASE i-ep-codigo-usuario:
                    WHEN '5' THEN
                         RUN piBuscarNotasRateioEms2 (INPUT ems5bkp.tit_ap.cod_ser_docto,
                                                      INPUT ems5bkp.tit_ap.cod_tit_ap,
                                                      INPUT ems5bkp.tit_ap.cdn_fornecedor,
                                                      INPUT ems5bkp.tit_ap.cod_parcela, 
                                                      OUTPUT rRowidNota ).
                    WHEN '1' THEN
                         RUN piBuscarNotasRateioems2Aux (INPUT ems5bkp.tit_ap.cod_ser_docto,
                                                         INPUT ems5bkp.tit_ap.cod_tit_ap,
                                                         INPUT ems5bkp.tit_ap.cdn_fornecedor,
                                                         INPUT ems5bkp.tit_ap.cod_parcela, 
                                                         OUTPUT rRowidNota ).
               ...
               FOR EACH ttApropRateio WHERE 
                   ...
                   ASSIGN tt.cod_modulo        = 'APB'
                          ...
                          tt.valor             = ems5bkp.tit_ap.val_origin_tit_ap * -1 * ttApropRateio.perc     
                          tt.base              = '12'
                          tt.origem            = 'Contas Pagar - REC'                                                                                                                     
                          tt.cc                = ttApropRateio.cc
                          tt.ccusto_gerencial  = tt.cc
                          tt.id_movto_corren   = ems5bkp.tit_ap.num_id_tit_ap
                          tt.tipo              = 'Aberto'
                          /*
                          tt.historico         = replace(ems5bkp.movto_tit_ap.des_histor_ems5bkp.tit_ap,chr(13),";")
                          tt.historico         = replace(ems5bkp.movto_tit_ap.des_histor_ems5bkp.tit_ap,chr(10),";") */ .
    ...
    FOR EACH ems5bkp.tit_acr WHERE
             ems5bkp.tit_acr.dat_transacao >= pDtIni AND
             ems5bkp.tit_acr.dat_transacao <= pDtFim AND
             ems5bkp.tit_acr.val_origin_tit_acr > 0 NO-LOCK
          BY ems5bkp.tit_acr.dat_transacao.
    
        // J  Baixou, ser  tratado pelo Realizado
        IF ems5bkp.tit_acr.dat_liquidac <> 12.31.9999 THEN NEXT. 

        RUN pi-acompanhar IN h-acomp (INPUT "Data: " + STRING(ems5bkp.tit_acr.dat_transacao,"99/99/9999") + " Titulo:" + STRING(ems5bkp.tit_acr.cod_tit_acr) ).
    
        FIND FIRST ems5bkp.cliente WHERE 
                   ems5bkp.cliente.cdn_cliente = ems5bkp.tit_acr.cdn_cliente NO-LOCK NO-ERROR. 
    
        FOR EACH ems5bkp.movto_tit_acr OF ems5bkp.tit_acr NO-LOCK:
    
            FOR EACH ems5bkp.aprop_ctbl_acr OF ems5bkp.movto_tit_acr WHERE
                     ems5bkp.aprop_ctbl_acr.ind_natur_lancto_ctbl = 'CR' NO-LOCK.
               
                CREATE tt.
                ASSIGN tt.cod_modulo        = 'ACR'
                       tt.cod_empresa       = ems5bkp.tit_acr.cod_empresa
                       tt.cod_estab         = ems5bkp.tit_acr.cod_estab
                       tt.cod_emitente      = STRING(ems5bkp.tit_acr.cdn_cliente)
                       tt.desc_emitente     = ems5bkp.cliente.nom_pessoa
                       tt.data              = ems5bkp.tit_acr.dat_transacao                                                                                                          
                       tt.conta_contabil    = ems5bkp.aprop_ctbl_acr.cod_cta_ctbl
                       tt.valor             = ems5bkp.tit_acr.val_origin_tit_acr
                       tt.base              = '12'
                       tt.origem            = 'Contas a Receber'
                       tt.ccusto_gerencial  = ems5bkp.aprop_ctbl_acr.cod_ccusto
                       tt.id_movto_corren   = ems5bkp.tit_acr.num_id_tit_acr
                       tt.tipo              = 'Aberto'.
            END.
        END.
    END.
...
ELSE DO.
    FOR EACH ems5bkp.tit_ap WHERE
             ems5bkp.tit_ap.dat_vencto_tit_ap >= pDtIni AND
             ems5bkp.tit_ap.dat_vencto_tit_ap <= pDtFim NO-LOCK
          BY ems5bkp.tit_ap.dat_vencto_tit_ap.

        // J  Baixou, ser  tratado pelo Realizado
        IF ems5bkp.tit_ap.dat_liquidac_tit_ap <> 12.31.9999 THEN NEXT. 

        RUN pi-acompanhar IN h-acomp (INPUT "Data: " + STRING(ems5bkp.tit_ap.dat_liquidac_tit_ap,"99/99/9999") + " Titulo:" + STRING(ems5bkp.tit_ap.cod_tit_ap) ).
        ...
        FOR EACH ems5bkp.movto_tit_ap OF ems5bkp.tit_ap WHERE 
            ...
            IF ems5bkp.tit_ap.ind_origin_tit_ap <> "REC" THEN DO:
               FOR EACH ems5bkp.aprop_ctbl_ap OF ems5bkp.movto_tit_ap WHERE
                   ...
                   ASSIGN tt.cod_modulo        = 'APB'
                          ...
                          tt.cod_emitente      = STRING(ems5bkp.tit_ap.cdn_fornecedor)
                          tt.desc_emitente     = fornecedor.nom_pessoa
                          tt.data              = ems5bkp.tit_ap.dat_liquidac_tit_ap
                          tt.conta_contabil    = ems5bkp.aprop_ctbl_ap.cod_cta_ctbl
                          tt.valor             = ems5bkp.tit_ap.val_origin_tit_ap * -1 
                          tt.base              = '12'
                          tt.origem            = 'Contas a Pagar'
                          tt.ccusto_gerencial  = ems5bkp.aprop_ctbl_ap.cod_ccusto
                          tt.id_movto_corren   = ems5bkp.tit_ap.num_id_tit_ap
                          tt.tipo              = 'Aberto'.
            ...
            ELSE DO:
                ...
                FOR EACH ttApropRateio WHERE 
                    ...
                    CREATE tt.                                                                                                                                                   
                    ASSIGN tt.cod_modulo        = 'APB'
                           tt.cod_empresa       = IF AVAIL ems5bkp.tit_ap THEN ems5bkp.tit_ap.cod_empresa ELSE ''                                                                                                             
                           tt.cod_estab         = IF AVAIL ems5bkp.tit_ap THEN ems5bkp.tit_ap.cod_estab   ELSE ''                                                                                                             
                           tt.cod_emitente      = IF AVAIL ems5bkp.tit_ap THEN string(ems5bkp.tit_ap.cdn_fornecedor) ELSE '0'                                                                          
                           tt.desc_emitente     = IF AVAIL ems5bkp.fornecedor THEN fornecedor.nom_pessoa  ELSE ''                                                                                  
                           tt.data              = ems5bkp.tit_ap.dat_liquidac_tit_ap
                           tt.conta_contabil    = ttApropRateio.conta                                                                                                           
                           tt.valor             = ems5bkp.tit_ap.val_origin_tit_ap * -1 * ttApropRateio.perc     
                           tt.base              = '12'
    ...
    FOR EACH ems5bkp.tit_acr WHERE
             ems5bkp.tit_acr.dat_liquidac_tit_acr >= pDtIni AND
             ems5bkp.tit_acr.dat_liquidac_tit_acr <= pDtFim NO-LOCK
          BY ems5bkp.tit_acr.dat_liquidac_tit_acr.

        // J  Baixou, ser  tratado pelo Realizado
        IF ems5bkp.tit_acr.dat_liquidac <> 12.31.9999 THEN NEXT. 

         RUN pi-acompanhar IN h-acomp (INPUT "Data: " + STRING(ems5bkp.tit_acr.dat_liquidac_tit_acr,"99/99/9999") + " Titulo:" + STRING(ems5bkp.tit_acr.cod_tit_acr) ).
         ...
         FOR EACH ems5bkp.movto_tit_acr OF ems5bkp.tit_acr NO-LOCK:
             ...
             FOR EACH ems5bkp.aprop_ctbl_acr OF ems5bkp.movto_tit_acr WHERE
                 ...
                 ASSIGN tt.cod_modulo        = 'ACR'
                        ...
                        tt.cod_emitente      = STRING(ems5bkp.tit_acr.cdn_cliente)
                        tt.desc_emitente     = ems5bkp.cliente.nom_pessoa
                        tt.data              = ems5bkp.tit_acr.dat_liquidac_tit_acr
                        tt.conta_contabil    = ems5bkp.aprop_ctbl_acr.cod_cta_ctbl
                        tt.valor             = ems5bkp.tit_acr.val_origin_tit_acr
                        tt.base              = '12'
                        tt.origem            = 'Contas a Receber'
...
DEFINE INPUT  PARAMETER pDataContaCorrente              LIKE ems5bkp.movto_cta_corren.dat_transacao              NO-UNDO.
DEFINE INPUT  PARAMETER p_ind_fluxo_movto_cta_corren    LIKE ems5bkp.movto_cta_corren.ind_fluxo_movto_cta_corren NO-UNDO.
DEFINE INPUT  PARAMETER p_val_movto_ap                  LIKE bf_movto_tit_ap_02.val_movto_ap                     NO-UNDO.
DEFINE INPUT  PARAMETER p_cod_cta_corren                LIKE ems5bkp.movto_cta_corren.cod_cta_corren             NO-UNDO.
DEFINE INPUT  PARAMETER p_num_seq_movto_cta_corren      LIKE ems5bkp.movto_cta_corren.num_seq_movto_cta_corren   NO-UNDO.
DEFINE INPUT  PARAMETER p_num_id_movto_cta_corren       LIKE ems5bkp.movto_cta_corren.num_id_movto_cta_corren    NO-UNDO.
