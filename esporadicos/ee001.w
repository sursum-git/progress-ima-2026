...
&Scoped-Define ENABLED-OBJECTS rt-button bt 
...
DEFINE BUTTON bt 
     LABEL "Sincronizar contas integra‡Æo CMG com APB" 
     SIZE 51 BY 1.13.
...
DEFINE FRAME f-cad
     bt AT ROW 3.25 COL 14 WIDGET-ID 2
...
ON CHOOSE OF bt IN FRAME f-cad /* Sincronizar contas integra‡Æo CMG com APB */
DO:
   OUTPUT TO u:\contas_sincronismo_cmg_apb.txt.        
    ...
    FOR EACH tt:
        ...
        ASSIGN cta_ctbl_integr.cod_modul_dtsul                  = 'CMG'
                cta_ctbl_integr.cod_plano_cta_ctbl             = 'fiscal'
                cta_ctbl_integr.cod_cta_ctbl                   = tt.conta
                cta_ctbl_integr.dat_inic_valid                 = 01.01.0001
                cta_ctbl_integr.dat_fim_valid                  = 12.31.9999
                cta_ctbl_integr.ind_finalid_ctbl               = 'd‚bito padrÆo'
                cta_ctbl_integr.dat_livre_1                    = TODAY 
                cta_ctbl_integr.dat_livre_2                    = TODAY.
        ...
        ASSIGN cta_ctbl_integr.cod_modul_dtsul                  = 'CMG'
               ...
               cta_ctbl_integr.dat_inic_valid                   = 01.01.0001
               cta_ctbl_integr.dat_fim_valid                    = 12.31.9999
               cta_ctbl_integr.ind_finalid_ctbl                 = 'cr‚dito padrÆo'
               cta_ctbl_integr.dat_livre_1                      = TODAY
               cta_ctbl_integr.dat_livre_2                      = TODAY .
