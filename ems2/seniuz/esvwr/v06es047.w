...
&Scoped-Define ENABLED-FIELDS ordem-benefic.nr-ob ordem-benefic.it-codigo ~
...
&Scoped-Define DISPLAYED-FIELDS ordem-benefic.nr-ob ordem-benefic.it-codigo ~
ordem-benefic.cod-refer 
...
DEFINE FRAME f-main
     ordem-benefic.nr-ob AT ROW 1.17 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9.14 BY .88
     ordem-benefic.it-codigo AT ROW 2.17 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.14 BY .88
     ordem-benefic.cod-refer AT ROW 3.17 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .88
