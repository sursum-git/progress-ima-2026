...
&Scoped-define QUERY-STRING-Query-Main FOR EACH espec.malote-mov NO-LOCK ~
    BY espec.malote-mov.cod-malote-mov INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH espec.malote-mov NO-LOCK ~
    BY espec.malote-mov.cod-malote-mov INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main espec.malote-mov
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main espec.malote-mov
...
num-malote||y|espec.malote.cod-barras-dest
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "cod-estabel-aux,num-malote,cod-malote-mov"':U).
...
/* Query rebuild information for QUERY Query-Main
     ...
     _OrdList          = "espec.malote-mov.cod-malote-mov|yes"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "num-malote" "espec.malote" "cod-barras-dest"}
