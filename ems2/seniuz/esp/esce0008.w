...
*******************************************************************************/
{include/i-prgvrs.i ESCD0008 2.04.00.000} 
...
DEFINE VARIABLE fi-fin-cod-obsoleto AS INTEGER FORMAT "9" INITIAL 9 
     VIEW-AS FILL-IN 
     SIZE 2 BY .88 TOOLTIP "C¢digo de obsoleto final" NO-UNDO.
...
DEFINE VARIABLE fi-ini-cod-obsoleto AS INTEGER FORMAT "9" INITIAL 0 
     LABEL "Obsoleto":R10 
     VIEW-AS FILL-IN 
     SIZE 2 BY .88 TOOLTIP "C¢digo de obsoleto inicial" NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Saldo F°sico Atual por ÷tem"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Saldo F°sico Atual por ÷tem */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Saldo F°sico Atual por ÷tem */
DO:
...
{utp/ut9000.i "ESCE0008" "2.04.00.000"}
...
*/    
    ...
    {include/i-rprun.i esrp/esce0008rp.p}
