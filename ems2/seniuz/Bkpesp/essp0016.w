...
*******************************************************************************/
{include/i-prgvrs.i ESSP0016 2.04.00.000}
...
ON END-ERROR OF w-consim /* Testes de ASTM */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-consim w-consim
ON WINDOW-CLOSE OF w-consim /* Testes de ASTM */
DO:
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_p-exihel ).
       RUN set-position IN h_p-exihel ( 1.33 , 74.72 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es041.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01es041 ).
       RUN set-position IN h_q01es041 ( 1.50 , 67.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0016" "2.04.00.000"}
