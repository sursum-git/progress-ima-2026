...
**   Programa: ESPD044.P  =>  ESFT0039RP.P
**   Autor...: Gilvando de Souza Araujo
**   Data....: 05/04/2011
*/

/* include de controle de versÆo */
{include/i-prgvrs.i ESFT0039RP 2.04.00.000}
...
form
    ...
    w-work.cod-refer FORMAT "x(7)"
    item.desc-item   FORMAT "x(35)"  
    i-prazo                         
    w-work.quantidade               
    de-perc-qtd
    w-work.un
...
for each item where
    ...
    for each it-nota-fisc
       ...
       ASSIGN c-cod-refer = IF AVAIL ped-item THEN ped-item.cod-refer ELSE "".
                         
       find first w-work
            where w-work.it-codigo    = item.it-codigo
              AND w-work.cod-refer    = c-cod-refer
