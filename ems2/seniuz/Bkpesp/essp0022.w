...
*******************************************************************************/
{include/i-prgvrs.i ESSP0022 2.04.00.000}
...
ON END-ERROR OF w-concom /* Controles de SAC */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-concom w-concom
ON WINDOW-CLOSE OF w-concom /* Controles de SAC */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Complementos|Observa‡äes' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 7.50 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 10.50 , 88.57 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es004.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01es004 ).
       RUN set-position IN h_q01es004 ( 1.75 , 63.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v02es004 ).
       RUN set-position IN h_v02es004 ( 8.75 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.75 , 87.00 ) */
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v03es004 ).
       RUN set-position IN h_v03es004 ( 8.75 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.00 , 87.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0022" "2.04.00.000"}
