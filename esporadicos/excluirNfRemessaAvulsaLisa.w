...
&Scoped-Define ENABLED-OBJECTS rt-button RECT-1 btGetNFs fiDtIni ~
brNfRemessa btExcluir btExcluirPackList 
&Scoped-Define DISPLAYED-OBJECTS fiDtIni 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 78 BY 8.25
         FONT 1.
...
DEFINE FRAME f-cad
     ...
     fiDtIni AT ROW 3.58 COL 22 COLON-ALIGNED WIDGET-ID 2
     brNfRemessa AT ROW 5.5 COL 5 WIDGET-ID 200
     btExcluir AT ROW 13.79 COL 5 WIDGET-ID 6
     btExcluirPackList AT ROW 13.79 COL 26.86 WIDGET-ID 8
...
/* SETTINGS FOR FRAME f-cad
   FRAME-NAME L-To-R                                                    */
/* BROWSE-TAB brNfRemessa fiDtIni f-cad */
...
DO:
    IF AVAIL ttRemessas THEN DO:
       ...
       RUN lisa/excluirPackList.p(ttRemessas.rROWID, OUTPUT cErros).
       IF cErros <> '' THEN   DO:
          MESSAGE 
             "ERROS:" SKIP
             cErros
...
DO:
  ...
  RUN getNfsRemessaAvulsas IN hBO(INPUT FRAME {&FRAME-NAME} fiDtIni,
                                  OUTPUT TABLE ttRemessas).
  RUN getErros IN hBO(OUTPUT cErros).
  IF cErros <> '' THEN DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE rt-button RECT-1 btGetNFs fiDtIni brNfRemessa btExcluir 
         btExcluirPackList 
      WITH FRAME f-cad IN WINDOW w-livre.
