...
*******************************************************************************/
{include/i-prgvrs.i Q01IN172 2.04.00.000}
...
DEF NEW GLOBAL SHARED VAR fi-ini-it-codigo LIKE ITEM.it-codigo.
DEF NEW GLOBAL SHARED VAR fi-fin-it-codigo LIKE ITEM.it-codigo.
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH item ~
      WHERE item.it-codigo >= fi-ini-it-codigo ~
 AND item.it-codigo <= fi-fin-it-codigo NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH item ~
      WHERE item.it-codigo >= fi-ini-it-codigo ~
 AND item.it-codigo <= fi-fin-it-codigo NO-LOCK INDEXED-REPOSITION.
...
<FOREIGN-KEYS>
fm-codigo||y|ems206cad.item.fm-codigo
it-codigo||y|ems206cad.item.it-codigo
class-fiscal||y|ems206cad.item.class-fiscal
cod-comprado||y|ems206cad.item.cod-comprado
ct-codigo||y|ems206cad.item.ct-codigo
cod-estabel||y|ems206cad.item.cod-estabel
cod-tax||y|ems206cad.item.cod-tax
fm-cod-com||y|ems206cad.item.fm-cod-com
ge-codigo||y|ems206cad.item.ge-codigo
nr-linha||y|ems206cad.item.nr-linha
cd-planejado||y|ems206cad.item.cd-planejado
cod-refer||y|ems206cad.item.cod-refer
sc-codigo||y|ems206cad.item.sc-codigo
un||y|ems206cad.item.un
cd-tag||y|ems206cad.item.cd-tag
nat-despesa||y|ems206cad.item.nat-despesa
cod-servico||y|ems206cad.item.cod-servico
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "fm-codigo,it-codigo,class-fiscal,cod-comprado,ct-codigo,cod-estabel,cod-tax,fm-cod-com,ge-codigo,nr-linha,cd-planejado,cod-refer,sc-codigo,un,cd-tag,nat-despesa,cod-servico"':U).
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems206cad.item"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _Where[1]         = "ems206cad.item.it-codigo >= fi-ini-it-codigo
 AND ems206cad.item.it-codigo <= fi-fin-it-codigo"
