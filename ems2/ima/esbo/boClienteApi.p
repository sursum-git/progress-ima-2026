...
DEFINE VARIABLE protocolo           AS CHARACTER EXTENT 1  NO-UNDO.
DEFINE VARIABLE cripto              AS CHARACTER EXTENT 1 NO-UNDO.
...
PROCEDURE setProtocolosSSL:

        DEFINE INPUT  PARAMETER pProtocolo  AS CHARACTER EXTENT 1   NO-UNDO.        
        ASSIGN protocolo = pProtocolo .

END PROCEDURE.

PROCEDURE setTipoCriptosSSL:
        
        DEFINE INPUT  PARAMETER pCripto     AS CHARACTER  EXTENT  1 NO-UNDO.        
        ASSIGN cripto = pCripto.
...
PROCEDURE exec:
   ...
   /* MESSAGE "request:"  oRequest:toString()
    ...
    DO TRANSACTION:
       ...
       //inicio tratamento https
       /*IMPORTANTE:os certificados devem aplicados em todas as maquinas. Para pegar os certificados instalar o openssl e rodar o comando abaixo:
       //  openssl s_client -connect endereco:porta -showcerts <NUL > c:\temp\infs_certs.txt
       // extraia os valores dos certificados em arquivos e importe com certutil -import nomedoarquivo
       // certutil fica na pasta bin do progress
       */
