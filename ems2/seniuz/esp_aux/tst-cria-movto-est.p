DEF VAR p-cod-estabel AS CHAR.
DEF VAR p-it-codigo   AS CHAR.
DEF VAR p-cod-refer   AS CHAR.
DEF VAR p-lote        AS CHAR.
DEF VAR p-qtde        AS DEC.
DEF VAR p-esp-docto   AS INT.
DEF VAR p-tipo-trans  AS INT.
DEF VAR p-justif      AS CHAR.
DEF VAR p-erro        AS CHAR.
