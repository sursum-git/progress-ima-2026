...
&Scoped-Define ENABLED-OBJECTS tg-tab-x tg_comis_neg fi-vlr-frete ~
cb-tp-pedido fi-cliente cb-fin-venda fi-ped-repres fi-cod-cond-pag ~
fi-nome-transp fi-nome-tr-red cb-tp-frete cb-aprov-ped fi-cod-rota ~
fi-data-base fi-cod-estabel ed-obs br-ped-item bt-inc fi-nr-pedido bt-sair ~
bt-preco-frete bt-log bt-cons-cliente-tri fi-observ-nf tg_vl_frete_negoc ~
RECT-1 RECT-2 RECT-3 RECT-4 RECT-7 
&Scoped-Define DISPLAYED-OBJECTS tg-tab-x tg-oc-cliente tg_comis_neg ~
fi-vlr-frete fi-dt-implant cb-tp-pedido cb-ext-tp-pedido fi-nr-container ~
fi-cliente fi-cliente-tri cb-fin-venda fi-cod-rep fi-vendedor cb-preposto ~
...
DEFINE FRAME F-Main
     tg-tab-x AT ROW 12.67 COL 85 WIDGET-ID 106
     tg-oc-cliente AT ROW 13.38 COL 85 WIDGET-ID 104
     ...
     tg-nao-aprovar AT ROW 14.04 COL 85 WIDGET-ID 42
     tg-bloqueio AT ROW 14.71 COL 85
...
DO:
   ...
   IF fi-cod-estabel:SCREEN-VALUE = '505' AND  cb-tp-frete:SCREEN-VALUE <> 'FOB Total' THEN DO:
...
DO:
   CASE SELF:SCREEN-VALUE.
       ...
       WHEN 'PE' THEN DO.
            ...
            ASSIGN tg-tab-x:SCREEN-VALUE = 'NO' 
...
------------------------------------------------------------------------------*/
  DISPLAY tg-tab-x tg-oc-cliente tg_comis_neg fi-vlr-frete fi-dt-implant 
          cb-tp-pedido cb-ext-tp-pedido fi-nr-container fi-cliente 
          ...
          fi-sit-cred fi-observ-nf tg_vl_frete_negoc 
      WITH FRAME F-Main IN WINDOW w-window.
  ENABLE tg-tab-x tg_comis_neg fi-vlr-frete cb-tp-pedido fi-cliente 
         cb-fin-venda fi-ped-repres fi-cod-cond-pag fi-nome-transp 
         ...
         bt-preco-frete bt-log bt-cons-cliente-tri fi-observ-nf 
         tg_vl_frete_negoc RECT-1 RECT-2 RECT-3 RECT-4 RECT-7 
      WITH FRAME F-Main IN WINDOW w-window.
...
------------------------------------------------------------------------------*/
    ...
    RUN setPedRubiX     IN h-bo-preco-item ( logical(tg-tab-x:SCREEN-VALUE IN FRAME {&FRAME-NAME})) . 
   ...
   IF AVAIL ped-venda THEN DO.
      ...
      IF AVAIL ped-venda-ext THEN DO.
         ASSIGN cb-tp-pedido:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ped-venda-ext.tp-pedido 
                ...
                tg-tab-x:SCREEN-VALUE IN FRAME {&FRAME-NAME} = STRING(ped-venda-ext.l_tab_x) 
...
------------------------------------------------------------------------------*/
    ...
    DO TRANSACTION:
        ...
        ASSIGN ped-venda-ext.tb_preco_id = INTEGER(INPUT FRAME {&FRAME-NAME} cb-tab-preco)
               ...
               ped-venda-ext.l_tab_x = INPUT FRAME {&FRAME-NAME} tg-tab-x
