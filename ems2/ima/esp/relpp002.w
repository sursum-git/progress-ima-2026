...
*******************************************************************************/
{include/i-prgvrs.i RelPP002 2.00.04.001}
...
DEFINE VARIABLE fi-comprador-fim AS CHARACTER FORMAT "X(50)":U INITIAL "zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fi-comprador-ini AS CHARACTER FORMAT "X(50)":U 
     LABEL "Comprador" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fi-dt-chegada-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fi-dt-chegada-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/07 
     LABEL "Data Chegada" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fi-dt-compra-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fi-dt-compra-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/07 
     LABEL "Data Compra" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fi-estabel-fim AS INTEGER FORMAT ">>9":U INITIAL 999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fi-estabel-ini AS INTEGER FORMAT ">>9":U INITIAL 0 
     LABEL "Estabel" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fi-fornecedor-fim AS CHARACTER FORMAT "X(50)":U INITIAL "zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fi-fornecedor-ini AS CHARACTER FORMAT "X(50)":U 
     LABEL "Fornecedor" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fi-processo-fim AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 99999999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fi-processo-ini AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 0 
     LABEL "Nß Processo" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     fi-estabel-ini AT ROW 1.38 COL 18.43 COLON-ALIGNED WIDGET-ID 172
     fi-estabel-fim AT ROW 1.38 COL 42.86 COLON-ALIGNED NO-LABEL WIDGET-ID 170
     fi-processo-ini AT ROW 2.5 COL 18.43 COLON-ALIGNED WIDGET-ID 156
     fi-processo-fim AT ROW 2.5 COL 42.86 COLON-ALIGNED NO-LABEL WIDGET-ID 154
     fi-dt-compra-ini AT ROW 3.63 COL 18.43 COLON-ALIGNED WIDGET-ID 164
     fi-dt-compra-fim AT ROW 3.63 COL 42.86 COLON-ALIGNED NO-LABEL WIDGET-ID 162
     fi-dt-chegada-ini AT ROW 4.79 COL 18.43 COLON-ALIGNED WIDGET-ID 84
     fi-dt-chegada-fim AT ROW 4.79 COL 42.86 COLON-ALIGNED NO-LABEL WIDGET-ID 82
     fi-fornecedor-ini AT ROW 5.92 COL 18.43 COLON-ALIGNED WIDGET-ID 96
     fi-fornecedor-fim AT ROW 5.92 COL 42.86 COLON-ALIGNED NO-LABEL WIDGET-ID 94
     fi-comprador-ini AT ROW 7.04 COL 18.43 COLON-ALIGNED WIDGET-ID 108
     fi-comprador-fim AT ROW 7.04 COL 42.86 COLON-ALIGNED NO-LABEL WIDGET-ID 106
     IMAGE-19 AT ROW 5.92 COL 35.43 WIDGET-ID 124
     IMAGE-20 AT ROW 5.92 COL 42 WIDGET-ID 128
     IMAGE-21 AT ROW 4.79 COL 35.43 WIDGET-ID 130
     IMAGE-22 AT ROW 4.79 COL 42 WIDGET-ID 132
     IMAGE-27 AT ROW 7.04 COL 35.43 WIDGET-ID 142
     IMAGE-28 AT ROW 7.04 COL 42 WIDGET-ID 144
     IMAGE-31 AT ROW 2.5 COL 35.43 WIDGET-ID 158
     IMAGE-32 AT ROW 2.5 COL 42 WIDGET-ID 160
     IMAGE-35 AT ROW 3.63 COL 35.43 WIDGET-ID 166
     IMAGE-36 AT ROW 3.63 COL 42 WIDGET-ID 168
     IMAGE-37 AT ROW 1.38 COL 35.43 WIDGET-ID 174
     IMAGE-38 AT ROW 1.38 COL 42 WIDGET-ID 176
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
DEFINE FRAME f-pg-cla
     ...
     "Classificar Por" VIEW-AS TEXT
          SIZE 11 BY .54 AT ROW 1.25 COL 4 WIDGET-ID 4
...
{utp/ut9000.i "RelPP002" "2.00.04.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-estabel-ini fi-estabel-fim fi-processo-ini fi-processo-fim 
          fi-dt-compra-ini fi-dt-compra-fim fi-dt-chegada-ini fi-dt-chegada-fim 
          fi-fornecedor-ini fi-fornecedor-fim fi-comprador-ini fi-comprador-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-19 IMAGE-20 IMAGE-21 IMAGE-22 IMAGE-27 IMAGE-28 IMAGE-31 
         IMAGE-32 IMAGE-35 IMAGE-36 IMAGE-37 IMAGE-38 fi-estabel-ini 
         fi-estabel-fim fi-processo-ini fi-processo-fim fi-dt-compra-ini 
         fi-dt-compra-fim fi-dt-chegada-ini fi-dt-chegada-fim fi-fornecedor-ini 
         fi-fornecedor-fim fi-comprador-ini fi-comprador-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    ASSIGN tt-param.fi-estabel-ini      = INPUT FRAME f-pg-sel fi-estabel-ini 
           tt-param.fi-estabel-fim      = INPUT FRAME f-pg-sel fi-estabel-fim 
           tt-param.fi-processo-ini     = INPUT FRAME f-pg-sel fi-processo-ini    
           tt-param.fi-processo-fim     = INPUT FRAME f-pg-sel fi-processo-fim    
           tt-param.fi-dt-compra-ini    = INPUT FRAME f-pg-sel fi-dt-compra-ini   
           tt-param.fi-dt-compra-fim    = INPUT FRAME f-pg-sel fi-dt-compra-fim   
           tt-param.fi-dt-chegada-ini   = INPUT FRAME f-pg-sel fi-dt-chegada-ini  
           tt-param.fi-dt-chegada-fim   = INPUT FRAME f-pg-sel fi-dt-chegada-fim  
           tt-param.fi-fornecedor-ini   = INPUT FRAME f-pg-sel fi-fornecedor-ini  
           tt-param.fi-fornecedor-fim   = INPUT FRAME f-pg-sel fi-fornecedor-fim  
           tt-param.fi-comprador-ini    = INPUT FRAME f-pg-sel fi-comprador-ini   
           tt-param.fi-comprador-fim    = INPUT FRAME f-pg-sel fi-comprador-fim.
    ...
    {include/i-rprun.i esrp/relpp002rp.p}
