...
*******************************************************************************/
{include/i-prgvrs.i esimft05ab 2.06.00.001}
...
DEFINE FRAME f-pg-sel
     fi-cod-estab-ini AT ROW 4.04 COL 19 COLON-ALIGNED WIDGET-ID 36
     fi-cod-estab-fim AT ROW 4.04 COL 44 COLON-ALIGNED NO-LABEL WIDGET-ID 44
     fi-it-codigo-ini AT ROW 5.04 COL 19 COLON-ALIGNED
     fi-it-codigo-fim AT ROW 5.04 COL 44 COLON-ALIGNED NO-LABEL
     fi-cod-refer-ini AT ROW 6.04 COL 19 COLON-ALIGNED WIDGET-ID 28
     fi-cod-refer-fim AT ROW 6.04 COL 44 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     fi-ge-codigo-ini AT ROW 7.04 COL 19 COLON-ALIGNED WIDGET-ID 14
     fi-ge-codigo-fim AT ROW 7.04 COL 44 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     fi-dt-trans-ini AT ROW 8.04 COL 19 COLON-ALIGNED WIDGET-ID 4
     fi-dt-trans-fim AT ROW 8.04 COL 44 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     tgSoFaturaveis AT ROW 9.75 COL 21 WIDGET-ID 46
     IMAGE-1 AT ROW 5 COL 37
     IMAGE-2 AT ROW 5 COL 42.29
     IMAGE-9 AT ROW 8 COL 37 WIDGET-ID 6
     IMAGE-10 AT ROW 8 COL 42.29 WIDGET-ID 8
     IMAGE-11 AT ROW 7 COL 37 WIDGET-ID 18
     IMAGE-12 AT ROW 7 COL 42.29 WIDGET-ID 16
     IMAGE-13 AT ROW 6 COL 37 WIDGET-ID 30
     IMAGE-14 AT ROW 6 COL 42.29 WIDGET-ID 32
     IMAGE-15 AT ROW 4 COL 37 WIDGET-ID 40
     IMAGE-16 AT ROW 4 COL 42.29 WIDGET-ID 42
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "esimft05ab" "2.06.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-cod-estab-ini fi-cod-estab-fim fi-it-codigo-ini fi-it-codigo-fim 
          ...
          fi-dt-trans-ini fi-dt-trans-fim tgSoFaturaveis 
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/esimft05abrp.p}
