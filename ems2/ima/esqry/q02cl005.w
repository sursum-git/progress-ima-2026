...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH mgcld.bc-etiqueta NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main mgcld.bc-etiqueta
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main mgcld.bc-etiqueta
...
<FOREIGN-KEYS>
cod-estado||y|mgcld.bc-etiqueta.cod-estado
nr-etiq||y|mgcld.bc-etiqueta.nr-etiq
fm-codigo||y|mgcld.bc-etiqueta.fm-codigo
it-codigo||y|mgcld.bc-etiqueta.it-codigo
nr-contagem||y|mgcld.bc-etiqueta.nr-contagem
cd-trans||y|mgcld.bc-etiqueta.cd-trans
nr-trans||y|mgcld.bc-etiqueta.nr-trans
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "cod-estado,nr-etiq,fm-codigo,it-codigo,nr-contagem,cd-trans,nr-trans"':U).
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod-estado" "mgcld.bc-etiqueta" "cod-estado"}
  {src/adm/template/sndkycas.i "nr-etiq" "mgcld.bc-etiqueta" "nr-etiq"}
  {src/adm/template/sndkycas.i "fm-codigo" "mgcld.bc-etiqueta" "fm-codigo"}
  {src/adm/template/sndkycas.i "it-codigo" "mgcld.bc-etiqueta" "it-codigo"}
  {src/adm/template/sndkycas.i "nr-contagem" "mgcld.bc-etiqueta" "nr-contagem"}
  {src/adm/template/sndkycas.i "cd-trans" "mgcld.bc-etiqueta" "cd-trans"}
  {src/adm/template/sndkycas.i "nr-trans" "mgcld.bc-etiqueta" "nr-trans"}
