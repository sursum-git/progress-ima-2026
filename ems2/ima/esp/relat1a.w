...
/*------------------------------------------------------------------------
File.............: relat1a.w
Description......: Relatorio de Entrada
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 06/05/04 - 11:06 - CDIAS
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/
DEF BUFFER empresa FOR mgcad.empresa.
define variable c-prog-gerado as character no-undo initial "RELAT1A".
...
define temp-table tt-param
    ...
    field c-cod-refer-ini like movto-estoq.cod-refer
    field c-cod-refer-fim like movto-estoq.cod-refer
    field c-nro-docto-ini like movto-estoq.nro-docto
    field c-nro-docto-fim like movto-estoq.nro-docto
    field c-serie-docto-ini like movto-estoq.serie-docto
    field c-serie-docto-fim like movto-estoq.serie-docto
...
def new shared var da-dt-trans-ini like movto-estoq.dt-trans format "99/99/9999" initial "01/01/1800" no-undo.
def new shared var da-dt-trans-fim like movto-estoq.dt-trans format "99/99/9999" initial "12/31/9999" no-undo.
def new shared var c-it-codigo-ini like movto-estoq.it-codigo format "x(16)" initial "" no-undo.
def new shared var c-it-codigo-fim like movto-estoq.it-codigo format "x(16)" initial "ZZZZZZZZZZZZZZZZ" no-undo.
def new shared var c-cod-refer-ini like movto-estoq.cod-refer format "x(8)" initial "" no-undo.
def new shared var c-cod-refer-fim like movto-estoq.cod-refer format "x(8)" initial "ZZZZZZZZ" no-undo.
def new shared var c-nro-docto-ini like movto-estoq.nro-docto format "x(16)" initial "" no-undo.
def new shared var c-nro-docto-fim like movto-estoq.nro-docto format "x(16)" initial "ZZZZZZZZZZZZZZZZ" no-undo.
def new shared var c-serie-docto-ini like movto-estoq.serie-docto format "x(5)" initial "" no-undo.
def new shared var c-serie-docto-fim like movto-estoq.serie-docto format "x(5)" initial "ZZZZZ" no-undo.
def new shared var c-cod-estabel-ini like movto-estoq.cod-estabel format "x(3)" initial "" no-undo.
def new shared var c-cod-estabel-fim like movto-estoq.cod-estabel format "x(3)" initial "ZZZ" no-undo.
...
DEFINE FRAME f-pg-sel
   da-dt-trans-ini label "Data Transa‡Æo"
   ...
   c-cod-refer-ini label "Referˆncia"
     at row 3 col 20 colon-aligned
     view-as fill-in 
     size 9 by .88
     font 1

   c-cod-refer-fim no-label
     at row 3 col 47 colon-aligned
     view-as fill-in 
     size 9 by .88
     font 1

   c-nro-docto-ini label "Documento"
     at row 4 col 20 colon-aligned
     view-as fill-in 
     size 17 by .88
     font 1

   c-nro-docto-fim no-label
     at row 4 col 47 colon-aligned
     view-as fill-in 
     size 17 by .88
     font 1

   c-serie-docto-ini label "S‚rie Documento"
     at row 5 col 20 colon-aligned
     view-as fill-in 
     size 6 by .88
     font 1

   c-serie-docto-fim no-label
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Relatorio de Entrada - relat1a"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "relat1a".
...
PROCEDURE enable_UI :
   ...
   c-cod-refer-ini c-cod-refer-fim
   c-nro-docto-ini c-nro-docto-fim
   c-serie-docto-ini c-serie-docto-fim
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "relat1a" + ".tmp".

    assign tt-param.da-dt-trans-ini = input frame f-pg-sel da-dt-trans-ini
           ...
           tt-param.c-cod-refer-ini = input frame f-pg-sel c-cod-refer-ini
           tt-param.c-cod-refer-fim = input frame f-pg-sel c-cod-refer-fim
           tt-param.c-nro-docto-ini = input frame f-pg-sel c-nro-docto-ini
           tt-param.c-nro-docto-fim = input frame f-pg-sel c-nro-docto-fim
           tt-param.c-serie-docto-ini = input frame f-pg-sel c-serie-docto-ini
           tt-param.c-serie-docto-fim = input frame f-pg-sel c-serie-docto-fim
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "esp/relat11.p".
