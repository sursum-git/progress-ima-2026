...
*******************************************************************************/
{include/i-prgvrs.i B02IN172 2.04.00.000}
...
&Scoped-define FIELDS-IN-QUERY-br-table item.desc-item item.it-codigo ~
item.un 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table 
&Scoped-define QUERY-STRING-br-table FOR EACH item WHERE ~{&KEY-PHRASE} ~
      AND item.desc-item >= fi-ini-desc-item ~
 AND item.desc-item <= fi-fin-desc-item ~
 AND item.it-codigo >= "5" ~
 AND item.it-codigo <= "5Z" NO-LOCK ~
    BY item.desc-item INDEXED-REPOSITION
...
&Scoped-Define ENABLED-OBJECTS fi-ini-desc-item fi-fin-desc-item ~
bt-confirma br-table IMAGE-1 IMAGE-2 
&Scoped-Define DISPLAYED-OBJECTS fi-ini-desc-item fi-fin-desc-item 
...
DEFINE VARIABLE fi-fin-desc-item AS CHARACTER FORMAT "x(60)" INITIAL "ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 35.57 BY .88 TOOLTIP "Descri‡Æo do item final."
     FONT 1 NO-UNDO.

DEFINE VARIABLE fi-ini-desc-item AS CHARACTER FORMAT "x(60)" 
     VIEW-AS FILL-IN 
     SIZE 32.57 BY .88 TOOLTIP "Descri‡Æo do item inicial."
     FONT 1 NO-UNDO.
...
DEFINE FRAME F-Main
     fi-ini-desc-item AT ROW 1 COL 2.43 COLON-ALIGNED NO-LABEL
     fi-fin-desc-item AT ROW 1 COL 42.43 COLON-ALIGNED NO-LABEL
...
/* Query rebuild information for BROWSE br-table
     ...
     _Where[1]         = "mgcad.item.desc-item >= fi-ini-desc-item
 AND mgcad.item.desc-item <= fi-fin-desc-item
 AND mgcad.item.it-codigo >= ""5""
 AND mgcad.item.it-codigo <= ""5Z"""
     _FldNameList[1]   = mgcad.item.desc-item
     _FldNameList[2]   = mgcad.item.it-codigo
...
DO:
  assign input frame {&frame-name} fi-ini-desc-item fi-fin-desc-item.
