...
*******************************************************************************/
{include/i-prgvrs.i ESSP0160A 2.04.00.000}
...
&Scoped-define FIELDS-IN-QUERY-br-pedidos tt-itens-ped.nr-pedcli tt-itens-ped.nome-abrev tt-itens-ped.nr-sequencia tt-itens-ped.dt-entrega tt-itens-ped.qt-pedida tt-itens-ped.qt-reservada tt-itens-ped.nome-transp   
...
bt-modifica bt-etiquetas bt-ok bt-cancela bt-ajuda 
...
DEFINE VARIABLE fi-tot-saldo AS DECIMAL FORMAT "-ZZZ,ZZ9.99":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 13 BY .88
     FONT 2 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-pedidos D-Dialog _FREEFORM
  QUERY br-pedidos NO-LOCK DISPLAY
      tt-itens-ped.nr-pedcli  FORMAT "x(12)":U
tt-itens-ped.nome-abrev FORMAT "x(12)":U  WIDTH 15
tt-itens-ped.nr-sequencia
tt-itens-ped.dt-entrega
tt-itens-ped.qt-pedida                              COLUMN-LABEL "Qt Pedida" WIDTH 12
tt-itens-ped.qt-reservada                           COLUMN-LABEL "Qt Reservada" WIDTH 12
tt-itens-ped.nome-transp                            COLUMN-LABEL "Transportadora" WIDTH 13
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 81 BY 12
         FONT 1.
...
DEFINE FRAME D-Dialog
     ...
     fi-tot-pedida AT ROW 13.63 COL 39.14 COLON-ALIGNED NO-LABEL
     fi-tot-reserva AT ROW 13.63 COL 52.29 COLON-ALIGNED NO-LABEL
     fi-tot-saldo AT ROW 13.63 COL 65.43 COLON-ALIGNED NO-LABEL
     bt-etiquetas AT ROW 14.75 COL 2
     bt-ok AT ROW 16.29 COL 3
     bt-cancela AT ROW 16.29 COL 13.43
     bt-ajuda AT ROW 16.29 COL 72.29
     rt-buttom AT ROW 16.04 COL 2
     SPACE(0.71) SKIP(0.11)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 1
         TITLE "Pedidos Selecionados - ESSP0160A"
...
ON ENTRY OF FRAME D-Dialog /* Pedidos Selecionados - ESSP0160A */
DO:
   APPLY 'cursor-left' TO br-pedidos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL D-Dialog D-Dialog
ON WINDOW-CLOSE OF FRAME D-Dialog /* Pedidos Selecionados - ESSP0160A */
DO:  
...
DO:
   ...
   ASSIGN FRAME {&FRAME-NAME}:VISIBLE = NO.
   RUN esp\essp0160c.w (INPUT TABLE tt-etiquetas).
   ASSIGN FRAME {&FRAME-NAME}:VISIBLE = YES.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY fi-tot-pedida fi-tot-reserva fi-tot-saldo 
      WITH FRAME D-Dialog.
  ENABLE rt-buttom br-pedidos bt-detalhe bt-imprime bt-modifica bt-etiquetas 
...
------------------------------------------------------------------------------*/
 ...
 CASE i-saida:
     ...
     WHEN 3 THEN DO.
         ASSIGN c-saida = SESSION:TEMP-DIRECTORY + "essp0160a.tmp".
         OUTPUT TO VALUE(c-saida).
     END.
 END CASE.
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH tt-itens-ped WHERE
      ...
      ASSIGN fi-tot-pedida = fi-tot-pedida + tt-itens-ped.qt-pedida                   
             fi-tot-reserva = fi-tot-reserva + tt-itens-ped.qt-reservada                       
             fi-tot-saldo = fi-tot-saldo + (tt-itens-ped.qt-pedida - tt-itens-ped.qt-reservada).
  END.
  DISP fi-tot-pedida
       fi-tot-reserva
       fi-tot-saldo
