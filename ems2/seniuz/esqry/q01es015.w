...
&Scoped-define INTERNAL-TABLES item-ext

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH item-ext NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH item-ext NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main item-ext
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main item-ext
...
<FOREIGN-KEYS>
it-codigo||y|espec.item-ext.it-codigo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "it-codigo" "item-ext" "it-codigo"}
