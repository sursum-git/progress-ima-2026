...
&Scoped-define QUERY-STRING-Query-Main FOR EACH im-param NO-LOCK ~
    BY im-param.cod-param INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH im-param NO-LOCK ~
    BY im-param.cod-param INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main im-param
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main im-param
...
/* Query rebuild information for QUERY Query-Main
     ...
     _OrdList          = "espec.im-param.cod-param|yes"
