...
&Scoped-define QUERY-STRING-br-msg FOR EACH mensagem NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br-msg OPEN QUERY br-msg FOR EACH mensagem NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br-msg mensagem
...
&Scoped-Define ENABLED-OBJECTS br-msg edt-msg bt-ok bt-cancela bt-ajuda ~
RECT-1 RECT-2 rt-buttom 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-msg D-Dialog _STRUCTURED
  QUERY br-msg NO-LOCK DISPLAY
      ...
      mensagem.descricao FORMAT "X(20)":U WIDTH 23.86 LABEL-FGCOLOR 12 LABEL-BGCOLOR 8 LABEL-FONT 6
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"mensagem.cod-mensagem" ? ">>>9" "integer" ? ? ? 8 12 6 no ? no no "6.14" yes no no "U" "" ""
     _FldNameList[2]   > mgcad.mensagem.descricao
"mensagem.descricao" ? ? "character" ? ? ? 8 12 6 no ? no no "23.86" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE br-msg */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  DISPLAY edt-msg 
      WITH FRAME D-Dialog.
  ENABLE br-msg edt-msg bt-ok bt-cancela bt-ajuda RECT-1 RECT-2 rt-buttom 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
