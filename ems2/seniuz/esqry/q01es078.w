...
&Scoped-define INTERNAL-TABLES param-dis

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH param-dis NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH param-dis NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main param-dis
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main param-dis
