...
&Scoped-Define ENABLED-OBJECTS br-ped-item fi-cod-estabel cb-tp-pedido ~
fi-cliente fi-pedido-cli fi-fat-max fi-cod-rep fi-ped-repres fi-natur-oper ~
fi-nr-pedido fi-cod-cond-pag cb-tab-preco cb-tp-entrega bt-log ~
cb-prioridade fi-nome-transp fi-nome-tr-red fi-cod-rota cb-tp-frete ~
fi-observ-nf fi-data-base ed-obs tg-bloqueio tg-fat-parcial bt-inc bt-sair ~
bt-cons-cliente-tri RECT-1 RECT-2 RECT-3 RECT-4 
&Scoped-Define DISPLAYED-OBJECTS tg-nao-aprovar fi-cod-estabel ~
fi-nome-estabel fi-dt-implant cb-tp-pedido fi-reserva fi-cliente ~
fi-pedido-cli fi-cliente-tri fi-sit-cred fi-fat-max fi-cod-rep fi-nome-rep ~
fi-perc-comis fi-ped-repres fi-natur-oper fi-denominacao fi-moeda ~
fi-desc-moeda fi-nr-pedido fi-cod-cond-pag fi-desc-cond-pag cb-tp-preco ~
cb-tab-preco cb-tp-entrega fi-dt-entrega cb-tipo-pagto cb-prioridade ~
fi-nome-transp fi-nome-tr-red fi-cod-rota fi-desc-rota cb-tp-frete ~
fi-observ-nf fi-data-base ed-obs tg-bloqueio tg-fat-parcial fi-tot-qtd-ped ~
fi-tot-qtd-res fi-tot-qtd-fat fi-tot-vlr-ped fi-tot-vlr-fat fi-tot-vlr-abe ~
fi-cidade-cli fi-cidade-cli-tri fi-uf fi-uf-tri fi-completo fi-sit-preco 

/* Custom List Definitions                                              */
/* List-1,List-2,List-3,List-4,List-5,List-6                            */
&Scoped-define List-4 fi-pedido-cli fi-fat-max fi-cod-rep fi-ped-repres ~
fi-natur-oper fi-moeda fi-cod-cond-pag cb-tp-entrega fi-nome-transp ~
fi-nome-tr-red fi-cod-rota cb-tp-frete fi-observ-nf ed-obs bt-msg bt-inc ~
bt-can bt-bloq 
&Scoped-define List-5 fi-cod-estabel cb-tp-pedido fi-cliente 
&Scoped-define List-6 tg-nao-aprovar cb-tipo-pagto fi-data-base tg-bloqueio ~
tg-fat-parcial 
...
DEFINE VARIABLE cb-tp-pedido AS CHARACTER FORMAT "X(256)":U INITIAL "Normal" 
     ...
     LIST-ITEMS "Normal","Exportaá∆o","Reserva","Amostra","∑ Vista","Operaá∆o Triangular","Bonificaá∆o","Doaá∆o","Bancado","Refaturamento","Amostra Exportaá∆o","Rem.Industrializaá∆o","Venda Confec." 
     DROP-DOWN-LIST
...
DEFINE VARIABLE tg-bloqueio AS LOGICAL INITIAL no 
     LABEL "Bloq. Fat. Pedido" 
     VIEW-AS TOGGLE-BOX
     SIZE 14.29 BY .54 NO-UNDO.

DEFINE VARIABLE tg-fat-parcial AS LOGICAL INITIAL no 
     LABEL "Fat. Parcial" 
     VIEW-AS TOGGLE-BOX
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-ped-item w-window _FREEFORM
 ...
 tt-itens-ped.cod-refer     FORMAT "x(7)"  WIDTH 6
...
DEFINE FRAME F-Main
     ...
     tg-nao-aprovar AT ROW 11.38 COL 87.86 WIDGET-ID 42
     ...
     fi-cod-rep AT ROW 5.25 COL 12 COLON-ALIGNED HELP
          "C¢digo do representante direto"
     fi-nome-rep AT ROW 5.25 COL 24.57 COLON-ALIGNED NO-LABEL
     fi-perc-comis AT ROW 5.25 COL 66 COLON-ALIGNED WIDGET-ID 16
     fi-ped-repres AT ROW 5.25 COL 86 COLON-ALIGNED
     fi-natur-oper AT ROW 6.25 COL 12 COLON-ALIGNED
     fi-denominacao AT ROW 6.25 COL 21.57 COLON-ALIGNED NO-LABEL
     fi-moeda AT ROW 6.25 COL 86 COLON-ALIGNED
     fi-desc-moeda AT ROW 6.25 COL 90.43 COLON-ALIGNED NO-LABEL
     fi-nr-pedido AT ROW 1.71 COL 1.14 COLON-ALIGNED HELP
          "C¢digo do cliente" NO-LABEL NO-TAB-STOP 
     fi-cod-cond-pag AT ROW 7.25 COL 12 COLON-ALIGNED HELP
          "C¢digo da condiá∆o de pagamento"
     bt-cond-esp AT ROW 7.25 COL 19.14
     fi-desc-cond-pag AT ROW 7.25 COL 21.57 COLON-ALIGNED NO-LABEL
     cb-tp-preco AT ROW 7.25 COL 58.14 COLON-ALIGNED WIDGET-ID 14
     cb-tab-preco AT ROW 7.25 COL 86 COLON-ALIGNED WIDGET-ID 24
     cb-tp-entrega AT ROW 8.25 COL 12 COLON-ALIGNED
     fi-dt-entrega AT ROW 8.25 COL 27.43 COLON-ALIGNED NO-LABEL
     cb-tipo-pagto AT ROW 8.25 COL 58.29 COLON-ALIGNED
     bt-log AT ROW 3.17 COL 18.29 NO-TAB-STOP 
     cb-prioridade AT ROW 8.25 COL 86 COLON-ALIGNED WIDGET-ID 12
     fi-cod-informado AT ROW 8.25 COL 95 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     fi-nome-transp AT ROW 9.25 COL 12 COLON-ALIGNED
     fi-nome-tr-red AT ROW 9.25 COL 36.14 COLON-ALIGNED
     fi-cod-rota AT ROW 9.25 COL 58.29 COLON-ALIGNED WIDGET-ID 2
     fi-desc-rota AT ROW 9.25 COL 62.72 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     cb-tp-frete AT ROW 9.25 COL 86 COLON-ALIGNED
     fi-observ-nf AT ROW 12.63 COL 12 COLON-ALIGNED NO-TAB-STOP 
     fi-data-base AT ROW 10.25 COL 86 COLON-ALIGNED
     ed-obs AT ROW 10.25 COL 14 NO-LABEL
     bt-msg AT ROW 12.54 COL 77.29
     tg-bloqueio AT ROW 12.25 COL 87.86
     tg-fat-parcial AT ROW 13.04 COL 87.86
...
DEFINE FRAME F-Main
     ...
     fi-uf AT ROW 3.08 COL 75.43 COLON-ALIGNED NO-LABEL WIDGET-ID 34 NO-TAB-STOP 
     fi-uf-tri AT ROW 4.04 COL 75.43 COLON-ALIGNED NO-LABEL WIDGET-ID 36 NO-TAB-STOP 
     fi-completo AT ROW 1.17 COL 82.57 WIDGET-ID 38
     fi-sit-preco AT ROW 3.21 COL 2.43 WIDGET-ID 40
     "Observaá∆o:" VIEW-AS TEXT
          SIZE 9 BY .54 AT ROW 10.21 COL 4.72
     "Qt Tot Faturada" VIEW-AS TEXT
          SIZE 11 BY .54 AT ROW 23.46 COL 35.43
          BGCOLOR 8 
     "Vl Tot Faturado" VIEW-AS TEXT
          SIZE 11 BY .54 AT ROW 23.5 COL 66.43
          BGCOLOR 8 
...
DO:
  ...
  IF AVAIL tt-itens-ped AND 
     ...
     ASSIGN bt-mod:SENSITIVE IN FRAME {&FRAME-NAME} = YES
            ...
            bt-can:SENSITIVE IN FRAME {&FRAME-NAME} = YES
            bt-bloq:SENSITIVE IN FRAME {&FRAME-NAME} = YES.
...
DO:
   ...
   ELSE DO:
      ...
      FOR EACH saldo-estoq WHERE
               ...
               NO-LOCK.
          ASSIGN de-qtidade-atu = de-qtidade-atu + saldo-estoq.qtidade-atu - saldo-estoq.qt-alocada -
...
DO:
  ...
  ASSIGN fi-cod-informado:SCREEN-VALUE = '0'.
...
DO:
   ...
   IF KEYFUNCTION(LASTKEY) <> 'back-tab' THEN DO.
      IF (SELF:SCREEN-VALUE = "Na Data" OR
         ...
         SELF:SCREEN-VALUE = "AtÇ a Data") THEN DO.
...
DO:
   ...
   ASSIGN fi-reserva:SCREEN-VALUE = '0'
          ...
          tg-fat-parcial:SCREEN-VALUE = 'NO'
   ...
   IF SELF:SCREEN-VALUE = 'Reserva' OR
      ...
      SELF:SCREEN-VALUE = 'Rem.Industrializaá∆o' OR
...
DO:
  ...
  ELSE DO.
     ...
     ELSE DO.
         IF tt-ped-venda.cod-estabel = '1' THEN DO.
         ...
         IF AVAIL im-param THEN
            ASSIGN cb-tab-preco:SCREEN-VALUE IN FRAME {&FRAME-NAME} = im-param.val-param.
     END.
     ASSIGN tt-itens-ped.vl-preori:READ-ONLY IN BROWSE {&browse-name} = YES.
  END.
  ASSIGN c-tab-preco = cb-tab-preco:SCREEN-VALUE IN FRAME {&FRAME-NAME}.
...
DO:
   ...
   IF emitente.identific  = 2 THEN DO:
      MESSAGE "Esse c¢digo Ç de um fornecedor e n∆o de um cliente..."
          VIEW-AS ALERT-BOX INFO BUTTONS OK.
      APPLY 'ENTRY' TO SELF.
      RETURN NO-APPLY.
   END.
...
DO:
    ...
    IF AVAIL cond-pagto THEN DO.
       IF (cb-tp-pedido:SCREEN-VALUE = '∑ Vista' AND cond-pagto.cod-cond-pag >= 3) OR
          (LOOKUP(cb-tp-pedido:SCREEN-VALUE,"∑ Vista,Exportaá∆o,Amostra,Amostra Exportaá∆o") = 0 AND
...
DO:
   ...
   IF cb-tp-pedido:SCREEN-VALUE MATCHES 'Rem.Industrializaá∆o' AND 
...
DO:
   IF SELF:INPUT-VALUE > 5 THEN DO.
      MESSAGE 'Comiss∆o Superior a 5%...'
          VIEW-AS ALERT-BOX INFO BUTTONS OK.
      APPLY 'ENTRY' TO SELF.
      RETURN NO-APPLY.
   END.
...
/*
ASSIGN c-tipos-ped = ' '.
FOR EACH im-user-tipo-ped WHERE
         im-user-tipo-ped.usuario = c-seg-usuario NO-LOCK.
    ASSIGN c-tipos-ped = IF c-tipos-ped = ''
                         THEN im-user-tipo-ped.cod-tipo-ped 
                         ELSE c-tipos-ped + "," + im-user-tipo-ped.cod-tipo-ped.
END.
ASSIGN cb-tipo-ped:LIST-ITEMS = c-tipos-ped.

IF LOOKUP("PE",c-tipos-ped) > 0 THEN
   ASSIGN cb-tipo-ped = "PE".
*/
...
ON 'leave':U OF tt-itens-ped.qt-pedida IN BROWSE {&browse-name} DO:
    ...
    ELSE DO.
       IF  tt-itens-ped.qt-pedida <> INPUT BROWSE {&BROWSE-NAME} tt-itens-ped.qt-pedida AND
          INPUT BROWSE {&BROWSE-NAME} tt-itens-ped.qt-pedida > (tt-itens-ped.qt-pedida + 
                                                                DEC(tt-itens-ped.dec-2:SCREEN-VALUE IN BROWSE {&browse-name})) THEN DO.
          MESSAGE 'Quantidade Informada Maior que a Dispon°vel...'
              VIEW-AS ALERT-BOX ERROR BUTTONS OK.
          APPLY 'entry' TO SELF.
          RETURN NO-APPLY.
...
ON 'leave':U OF tt-itens-ped.cod-refer IN BROWSE {&browse-name} DO:
    ...
    IF item.tipo-con-est <> 4 AND INPUT BROWSE {&BROWSE-NAME} tt-itens-ped.cod-refer <> "" THEN DO:
    ...
    IF INPUT FRAME {&FRAME-NAME} fi-cod-estabel = "1" THEN DO:
        RUN pi-estoque (INPUT INPUT FRAME {&FRAME-NAME} fi-cod-estabel,
    ...
    ELSE DO:
        ...
        /* Subtrai Pedidos de Importaá∆o em aberto */
        FOR EACH pp-ped-venda WHERE
                 pp-ped-venda.cod-estabel = INPUT FRAME {&FRAME-NAME} fi-cod-estabel AND
                 pp-ped-venda.cod-sit-ped = 1 NO-LOCK.

            FIND pp-container WHERE
                 pp-container.nr-container = pp-ped-venda.nr-container NO-LOCK NO-ERROR.

            IF NOT AVAIL pp-container THEN NEXT.
            IF pp-container.situacao <> 3 THEN NEXT.

            FOR EACH pp-ped-item WHERE 
                     pp-ped-item.nr-pedcli = pp-ped-venda.nr-pedcli AND 
                     pp-ped-item.nome-abrev = pp-ped-venda.nome-abrev AND 
                     pp-ped-item.it-codigo = item.it-codigo AND 
                     pp-ped-item.cod-refer = INPUT BROWSE {&BROWSE-NAME} tt-itens-ped.cod-refer
                     NO-LOCK.
                ASSIGN de-qtidade-atu = de-qtidade-atu - pp-ped-item.qt-pedida.
            END.
        END.
    END.
...
ON 'F5':U, 'mouse-select-dblclick':U OF tt-itens-ped.cod-refer IN BROWSE {&browse-name} DO:
   /*IF bt-can-item:SENSITIVE IN FRAME {&FRAME-NAME} = NO THEN RETURN NO-APPLY.*/
   ...
   RUN esp/espd4000f.w (INPUT-OUTPUT TABLE tt-ref-item,
                        INPUT tt-itens-ped.it-codigo:SCREEN-VALUE IN BROWSE {&browse-name},
                        INPUT c-tab-preco,
                        INPUT de-ind-finan,
      ...
      FOR EACH tt-ref-item WHERE
          ...
          ASSIGN tt-itens-ped.tp-acao = 'Incluir'
                 tt-itens-ped.nr-sequencia = IF AVAIL b-itens-ped
                                             ...
                                             ELSE 10
                 tt-itens-ped.it-codigo = tt-itens-ped.it-codigo:INPUT-VALUE IN BROWSE {&browse-name}
...
ON 'F5':U, 'mouse-select-dblclick':U OF tt-itens-ped.cod-refer IN BROWSE {&browse-name} DO:
    {include/zoomvar.i &prog-zoom  = inzoom/z01in375.w
                       &campo      = tt-itens-ped.cod-refer
                       &campozoom  = cod-refer
                       &BROWSE     = br-ped-item
                       &parametros = "run pi-seta-inicial in wh-pesquisa(input input BROWSE {&browse-name} tt-itens-ped.it-codigo)."}
END.
*/
...
------------------------------------------------------------------------------*/
  DISPLAY tg-nao-aprovar fi-cod-estabel fi-nome-estabel fi-dt-implant 
          cb-tp-pedido fi-reserva fi-cliente fi-pedido-cli fi-cliente-tri 
          fi-sit-cred fi-fat-max fi-cod-rep fi-nome-rep fi-perc-comis 
          fi-ped-repres fi-natur-oper fi-denominacao fi-moeda fi-desc-moeda 
          fi-nr-pedido fi-cod-cond-pag fi-desc-cond-pag cb-tp-preco cb-tab-preco 
          cb-tp-entrega fi-dt-entrega cb-tipo-pagto cb-prioridade fi-nome-transp 
          fi-nome-tr-red fi-cod-rota fi-desc-rota cb-tp-frete fi-observ-nf 
          fi-data-base ed-obs tg-bloqueio tg-fat-parcial fi-tot-qtd-ped 
          fi-tot-qtd-res fi-tot-qtd-fat fi-tot-vlr-ped fi-tot-vlr-fat 
          fi-tot-vlr-abe fi-cidade-cli fi-cidade-cli-tri fi-uf fi-uf-tri 
          fi-completo fi-sit-preco 
      WITH FRAME F-Main IN WINDOW w-window.
  ENABLE br-ped-item fi-cod-estabel cb-tp-pedido fi-cliente fi-pedido-cli 
         fi-fat-max fi-cod-rep fi-ped-repres fi-natur-oper fi-nr-pedido 
         fi-cod-cond-pag cb-tab-preco cb-tp-entrega bt-log cb-prioridade 
         fi-nome-transp fi-nome-tr-red fi-cod-rota cb-tp-frete fi-observ-nf 
         fi-data-base ed-obs tg-bloqueio tg-fat-parcial bt-inc bt-sair 
         bt-cons-cliente-tri RECT-1 RECT-2 RECT-3 RECT-4 
      WITH FRAME F-Main IN WINDOW w-window.
...
------------------------------------------------------------------------------*/
  ...
  IF NOT AVAIL user-coml THEN DO.
     MESSAGE 'Usuaerio Comercial n∆o Cadastrado para ' c-seg-usuario
         VIEW-AS ALERT-BOX INFO BUTTONS OK.
     RETURN 'ADM-ERROR'.
  END.
...
------------------------------------------------------------------------------*/
   CASE cb-tp-pedido:SCREEN-VALUE IN FRAME {&FRAME-NAME}:
       ...
       WHEN 'Rem.Industrializaá∆o' THEN DO.
          IF emitente.estado = 'MG' THEN 
...
------------------------------------------------------------------------------*/
   IF AVAIL ped-venda THEN DO.
      ...
      ASSIGN fi-data-base:SCREEN-VALUE IN FRAME {&FRAME-NAME} = STRING(ped-venda.dt-base-ft)
             ...
             tg-fat-parcial:SCREEN-VALUE = STRING(ped-venda.ind-fat-par).
        ...
        IF p-acao = 'Modificar' THEN DO.
           ...
           IF ped-venda-ext.tp-frete <> INPUT FRAME {&FRAME-NAME} cb-tp-frete THEN
              RUN esapi/cria-log-pedvenda.p (INPUT ped-venda.nr-pedcli,
                                             ...
                                             INPUT NO).
           IF AVAIL ped-venda THEN DO.
               IF l-fat-parcial <> INPUT FRAME {&FRAME-NAME} tg-fat-parcial THEN
                  RUN esapi/cria-log-pedvenda.p (INPUT ped-venda.nr-pedcli,
                                                 INPUT ped-venda.nome-abrev,
                                                 INPUT "Alterado Faturamento Parcial, para: " + INPUT FRAME {&FRAME-NAME} tg-fat-parcial,
                                                 INPUT NO).
           END.
        END.
END PROCEDURE.
            ...
            WHEN 'Modificar' THEN DO.
               ...
               IF AVAIL ped-item THEN DO.
                             ...
                             WHEN 'qt-pedida' THEN
                                  RUN esapi/cria-log-pedvenda.p (INPUT tt-itens-ped.nr-pedcli,
                                                                 ...
                                                                 INPUT "Sequencia " + TRIM(STRING(tt-itens-ped.nr-sequencia,">>>9")) +
                                                                       ": Alterada a Quantidade Pedida, Para: " + TRIM(STRING(tt-itens-ped.qt-pedida,">>>,>>9.99")),
                                                                 INPUT YES).
                             WHEN 'vl-preori' THEN DO.
                                  RUN esapi/cria-log-pedvenda.p (INPUT tt-itens-ped.nr-pedcli,
                                                                 INPUT tt-itens-ped.nome-abrev,
                                                                 INPUT "Sequencia " + TRIM(STRING(tt-itens-ped.nr-sequencia,">>>9")) +
                                                                       ": Alterado o Preáo, Para: " + TRIM(STRING(tt-itens-ped.vl-preori,">>>,>>9.99")),
                                                                 INPUT YES).
                  ...
                  FIND ped-item-ext WHERE
                       ped-item-ext.cod-estabel  = tt-itens-ped.cod-estabel AND  /* daf */
...
------------------------------------------------------------------------------*/
    ...
    DO TRANSACTION:
        ...
        IF AVAIL ped-venda THEN DO.
           ...
           ASSIGN l-fat-parcial = tt-ped-venda.ind-fat-par.
        END.
        ELSE DO.
        ...
        ASSIGN tt-ped-venda.cod-estabel = INPUT FRAME {&FRAME-NAME} fi-cod-estabel
               ...
               tt-ped-venda.ind-fat-par = INPUT FRAME {&FRAME-NAME} tg-fat-parcial 
        ...
        IF NOT AVAIL ped-venda THEN DO.
           ...
           IF NOT AVAIL ped-venda-ext THEN DO.
              ...
              ASSIGN ped-venda-ext.cod-estabel = tt-ped-venda.cod-estabel  /* daf */
        ...
        ASSIGN ped-venda-ext.cod-estabel = INPUT FRAME {&FRAME-NAME} fi-cod-estabel  /*  daf  */
        ...
        IF ped-venda-ext.l-etiqueta = NO THEN DO.    /* Permite Alterar apenas Pedidos que n∆o est∆o sendo Separados */
        ...
        IF p-acao = 'Incluir' OR 
           ...
           IF ped-venda.tp-preco = 1 THEN DO.
              ...
              IF l-ok = NO THEN DO.
                 RUN esapi/cria-log-pedvenda.p (INPUT ped-venda.nr-pedcli,
                                                INPUT ped-venda.nome-abrev,
                                                INPUT "Preáo Inv†lido, Pedido N«O ser† Completo",
                                                INPUT NO).
                 RETURN "ADM-ERROR".
              END.
           END.
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH ped-item OF ped-venda NO-LOCK,
        ...
        ASSIGN fi-tot-qtd-ped = fi-tot-qtd-ped + ped-item.qt-pedida
               fi-tot-vlr-ped = fi-tot-vlr-ped + ped-item.vl-liq-abe.
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH tt-itens-ped WHERE
       ...
       /* FIND ped-item-res OF tt-itens-ped NO-LOCK NO-ERROR. */   /*  DAF  */ 
        FIND ped-item-res WHERE
             ped-item-res.cod-estabel = ped-venda.cod-estabel AND  
             ped-item-res.nome-abrev = ped-item.nome-abrev AND   
             ped-item-res.nr-pedcli = ped-item.nr-pedcli AND    
