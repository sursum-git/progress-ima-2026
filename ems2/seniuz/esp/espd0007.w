...
*******************************************************************************/
{include/i-prgvrs.i ESPD0007 2.04.00.000}
...
define temp-table tt-param no-undo
    ...
    field da-ini           LIKE item-prog.dt-trans
    field da-fim           LIKE item-prog.dt-trans
    field c-item-ini       LIKE item-prog.it-codigo
    field c-item-fim       LIKE item-prog.it-codigo
    FIELD c-ref-ini        LIKE item-prog.cod-refer
    FIELD c-ref-fim        LIKE item-prog.cod-refer
...
DEFINE VARIABLE tg-salta AS LOGICAL INITIAL no 
     LABEL "Salta P gina por Desenho" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME f-pg-sel
     fi-ini-data AT ROW 1.96 COL 14.86 COLON-ALIGNED
     fi-fim-data AT ROW 1.96 COL 45.14 COLON-ALIGNED NO-LABEL
     fi-ini-it-codigo AT ROW 3 COL 14.86 COLON-ALIGNED
     fi-fim-it-codigo AT ROW 3 COL 45.14 COLON-ALIGNED NO-LABEL
     fi-ini-cod-refer AT ROW 4 COL 14.86 COLON-ALIGNED
     fi-fim-cod-refer AT ROW 4 COL 45.14 COLON-ALIGNED NO-LABEL
     ed-observ AT ROW 5.5 COL 17 NO-LABEL
     tg-salta AT ROW 8.88 COL 23.57
     tg-impr-param AT ROW 9.92 COL 23.57
     IMAGE-1 AT ROW 1.96 COL 35.57
     IMAGE-15 AT ROW 4 COL 35.57
     IMAGE-16 AT ROW 4 COL 43.14
     IMAGE-2 AT ROW 1.96 COL 43.14
     IMAGE-3 AT ROW 3 COL 35.57
     IMAGE-4 AT ROW 3 COL 43.14
     RECT-16 AT ROW 1 COL 1
     RECT-27 AT ROW 8.38 COL 17
     " Outros" VIEW-AS TEXT
          SIZE 5.43 BY .75 AT ROW 8 COL 18.86
     "Observa‡Æo:" VIEW-AS TEXT
          SIZE 9 BY .75 AT ROW 5.5 COL 7.72
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Aviso de Pograma‡Æo do Beneficiamento"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Aviso de Pograma‡Æo do Beneficiamento */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Aviso de Pograma‡Æo do Beneficiamento */
DO:
...
{utp/ut9000.i "ESPD0007" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-ini-data fi-fim-data fi-ini-it-codigo fi-fim-it-codigo 
          fi-ini-cod-refer fi-fim-cod-refer ed-observ tg-salta tg-impr-param 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-ini-data fi-fim-data fi-ini-it-codigo fi-fim-it-codigo 
         fi-ini-cod-refer fi-fim-cod-refer ed-observ tg-salta tg-impr-param 
         IMAGE-1 IMAGE-15 IMAGE-16 IMAGE-2 IMAGE-3 IMAGE-4 RECT-16 RECT-27 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.da-ini     = INPUT FRAME f-pg-sel fi-ini-data
           tt-param.da-fim     = INPUT FRAME f-pg-sel fi-fim-data
           ...
           tt-param.l-salta    = INPUT FRAME f-pg-sel tg-salta
           tt-param.c-observ   = INPUT FRAME f-pg-sel ed-observ
    ...
    {include/i-rprun.i esrp/espd0007rp.p} 
