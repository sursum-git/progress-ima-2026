...
OPEN QUERY {&SELF-NAME} FOR EACH dt-docum-est NO-LOCK
    WHERE dt-docum-est.ep-codigo = dt-empresa.ep-codigo
      ...
      AND dt-docum-est.dt-emissao   <= d-data-fim use-index idx-pesq-princ,
    FIRST emitente
