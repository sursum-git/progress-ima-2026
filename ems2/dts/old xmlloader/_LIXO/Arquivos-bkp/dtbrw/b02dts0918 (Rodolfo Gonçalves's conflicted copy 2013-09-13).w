...
fi-forn-fim IMAGE-1 fi-num-docto-ini IMAGE-2 fi-num-docto-fim dt-emis-ini ~
IMAGE-5 dt-emis-fim tg-importado IMAGE-6 bt-pesquisa-xml br-arquivo ~
bt-importado IMAGE-7 bt-revalida IMAGE-8 IMAGE-9 IMAGE-10 
...
"log-situacao" "Atual" "Sim/NÆo" "logical" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = xmlloader.dt-docum-est.cod-estabel
     _FldNameList[3]   > xmlloader.dt-docum-est.serie-docto
"serie-docto" ? ? "character" ? ? ? ? ? ? no ? no no "4.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > xmlloader.dt-docum-est.nro-docto
"nro-docto" ? ? "character" ? ? ? ? ? ? no ? no no "12.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > xmlloader.dt-docum-est.cod-emitente
"cod-emitente" "Fornec" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"dt-emissao" ? ? "date" ? ? ? ? ? ? no ? no no "10.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > xmlloader.dt-docum-est.tot-peso
"tot-peso" "Peso" ? "decimal" ? ? ? ? ? ? no ? no no "12.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > xmlloader.dt-docum-est.valor-mercad
"valor-mercad" "Vl Mercad" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > xmlloader.dt-docum-est.dec-1
"dec-1" "Vl Total" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
