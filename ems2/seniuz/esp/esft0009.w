...
*******************************************************************************/
{include/i-prgvrs.i ESFT0009 2.04.00.000}
...
DEFINE VARIABLE fi-qtd-clientes AS INTEGER FORMAT ">>9":U INITIAL 100 
     LABEL "Quantidade de Clientes a Imprimir (10-100)" 
     VIEW-AS FILL-IN 
     SIZE 6.57 BY .79 TOOLTIP "Quantidade de Clientes a imprimir (10 a 100)" NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Os maiores Clientes do Faturamento/C.Receber"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Os maiores Clientes do Faturamento/C.Receber */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Os maiores Clientes do Faturamento/C.Receber */
DO:
...
ON LEAVE OF fi-qtd-clientes IN FRAME f-pg-par /* Quantidade de Clientes a Imprimir (10-100) */
DO:
  IF INPUT FRAME {&FRAME-NAME} fi-qtd-clientes < 10 or
     INPUT FRAME {&FRAME-NAME} fi-qtd-clientes > 100 THEN DO:
     MESSAGE "Esse parÉmetro deve estar entre 10 e 100." VIEW-AS ALERT-BOX.
     ASSIGN fi-qtd-clientes:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "100".
...
{utp/ut9000.i "ESFT0009" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE fi-cod-estabel fi-ini-dt-emissao fi-fin-dt-emissao fi-ini-cod-emitente 
         fi-fin-cod-emitente fi-ini-cod-rep fi-fin-cod-rep fi-ini-dt-acumulo 
         IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-6 IMAGE-7 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/esft0009rp.p}
