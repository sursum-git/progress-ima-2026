...
&Scoped-define INTERNAL-TABLES param-pef

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH param-pef NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH param-pef NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main param-pef
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main param-pef
...
<FOREIGN-KEYS>
cod-gr-cli||y|espec.param-pef.cod-gr-cli
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod-gr-cli" "param-pef" "cod-gr-cli"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "param-pef"}
