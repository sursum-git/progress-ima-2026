...
&Scoped-define QUERY-STRING-Query-Main FOR EACH ob-trf ~
      WHERE ob-trf.situacao = i-situacao AND  ~
espec.ob-trf.num-trf >= i-num-trf-ini AND ~
espec.ob-trf.num-trf <= i-num-trf-fim AND ~
espec.ob-trf.dt-solic >= da-dt-solic-ini AND ~
espec.ob-trf.dt-solic <= da-dt-solic-fim /*AND  ~
SUBSTR(espec.ob-trf.char-1,100,1) = c-cod-estabel*/ ~
 NO-LOCK ~
    BY ob-trf.num-trf INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH ob-trf ~
      WHERE ob-trf.situacao = i-situacao AND  ~
espec.ob-trf.num-trf >= i-num-trf-ini AND ~
espec.ob-trf.num-trf <= i-num-trf-fim AND ~
espec.ob-trf.dt-solic >= da-dt-solic-ini AND ~
...
SUBSTR(espec.ob-trf.char-1,100,1) = c-cod-estabel*/ ~
 NO-LOCK ~
    BY ob-trf.num-trf INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main ob-trf
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main ob-trf
...
/* Query rebuild information for QUERY Query-Main
     ...
     _OrdList          = "espec.ob-trf.num-trf|yes"
     _Where[1]         = "espec.ob-trf.situacao = i-situacao AND 
espec.ob-trf.num-trf >= i-num-trf-ini AND
espec.ob-trf.num-trf <= i-num-trf-fim AND
espec.ob-trf.dt-solic >= da-dt-solic-ini AND
espec.ob-trf.dt-solic <= da-dt-solic-fim /*AND 
