...
set
java -version
REM INICIANDO CONSULTA IMA ######
java -jar %ARQCONFDIR%\LoaderParamCripto.jar %ARQCONFDIR%\ima.cfg

REM INICIANDO CONSULTA MED ######
java -jar %ARQCONFDIR%\LoaderParamCripto.jar %ARQCONFDIR%\med.cfg
