...
**  ACRA 021 - 09/07/2013 
**           - CRIADA A VARIµVEL p-lista-oc-assoc QUE ê CARREGADA NO EVENTO
**             mouse-select-dblclick E F5 DO CAMPO dt-it-docum-est.numero-ordem
**             NO main-block. ESTA VARIµVEL ê PREENCHIDA COM TODAS AS ORDENS DE 
**             COMPRA Jµ ASSOCIADAS NO DOCUMENTO. NO ZOOM DE ORDENS DE COMPRA
**             Hµ UM FILTRO PARA QUE AS ORDENS CONSTANTES NESTA LISTA N«O APAREÄAM
**             NA PESQUISA.
**  ACRA 022 - 09/08/2013 
...
**  ACRA 024 - 20/08/2013 
**           - AJUSTE NA ASSOCIAÄ«O DE DEVOLUÄ«O NO BOT«O DE GERAR DEVOLUÄ«O PARA
**             N«O FILTRAR A NATUREZA DE OPERAÄ«O

*******************************************************************************/
{include/i-prgvrs.i B01DT0912C 2.06.00.024}
{dtp/dts0101.i}
...
&Scoped-Define ENABLED-OBJECTS br-itens bt-lote bt-rateio-oc bt-rateio-op 
...
/* SETTINGS FOR BUTTON bt-devol IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR BUTTON bt-gera-estrut IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
       bt-gera-estrut:HIDDEN IN FRAME F-Main           = TRUE.
    ...
    ON 'mouse-select-dblclick' OF dt-it-docum-est.numero-ordem DO:
        ...
        FOR EACH bDtItDocumEst
           WHERE bDtItDocumEst.nro-docto    = dt-docum-est.nro-docto
             ...
             and rowid(bDtItDocumEst)       <> rowid(dt-it-docum-est) no-lock:
                assign p-lista-oc-assoc = p-lista-oc-assoc + string(bDtItDocumEst.numero-ordem) + "|" .
...
DEFINE OUTPUT PARAM TABLE FOR tt-dt-docum-est.
    ...
    DEFINE VARIABLE l-pendente      as logical no-undo.    empty temp-table tt-dt-docum-est.       
    empty temp-table tt-dt-it-docum-est.
