...
*******************************************************************************/
{include/i-prgvrs.i ESCR0002 2.04.00.000}
...
&Scoped-Define ENABLED-OBJECTS RECT-17 RECT-7 RECT-9 rs-destino rs-tipo-rel ~
...
DEFINE VARIABLE tg-apenas-resumo AS LOGICAL INITIAL no 
     LABEL "Imprimir Apenas o Resumo" 
     VIEW-AS TOGGLE-BOX
     SIZE 21.14 BY .88 TOOLTIP "Imprimir Parƒmetros/Sele‡Æo ao final do relat¢rio."
     FONT 1 NO-UNDO.
...
DEFINE VARIABLE fi-fin-cod-esp AS CHARACTER FORMAT "!!" INITIAL "ZZ" 
     VIEW-AS FILL-IN 
     SIZE 3.57 BY .88 TOOLTIP "Esp‚cie final" NO-UNDO.

DEFINE VARIABLE fi-fin-cod-estabel AS CHARACTER FORMAT "X(3)":U INITIAL "999" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-ini-cod-esp AS CHARACTER FORMAT "!!" 
     LABEL "Esp‚cie":R9 
     VIEW-AS FILL-IN 
     SIZE 3.57 BY .88 TOOLTIP "Esp‚cie inicial" NO-UNDO.

DEFINE VARIABLE fi-ini-cod-estabel AS CHARACTER FORMAT "X(3)":U INITIAL "1" 
...
DEFINE FRAME f-pg-par
     tg-impr-param AT ROW 2.13 COL 11.86
     tg-apenas-resumo AT ROW 2.13 COL 45.14
     to-enviar-e-mail AT ROW 4 COL 3.86
     fi-assunto-e-mail AT ROW 5.83 COL 12.29 COLON-ALIGNED
     fi-texto-e-mail AT ROW 6.83 COL 13 NO-LABEL
     " Dados da Mensagem" VIEW-AS TEXT
          SIZE 16 BY .75 AT ROW 5.04 COL 6
     RECT-13 AT ROW 5.33 COL 3.86
     RECT-15 AT ROW 1.08 COL 1
     RECT-34 AT ROW 1.71 COL 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
DEFINE FRAME f-pg-sel
     ...
     fi-fin-cod-estabel AT ROW 2.79 COL 49.29 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     fi-ini-cod-rep AT ROW 3.83 COL 18.43 COLON-ALIGNED HELP
          "C¢digo do representante principal"
     fi-fin-cod-rep AT ROW 3.83 COL 49.29 COLON-ALIGNED HELP
          "C¢digo do representante principal" NO-LABEL
     fi-ini-cod-port AT ROW 4.83 COL 18.43 COLON-ALIGNED
     fi-fin-cod-port AT ROW 4.83 COL 49.29 COLON-ALIGNED NO-LABEL
     fi-ini-cod-esp AT ROW 5.83 COL 18.43 COLON-ALIGNED HELP
          "C¢digo da esp‚cie do documento"
     fi-fin-cod-esp AT ROW 5.83 COL 49.29 COLON-ALIGNED HELP
          "C¢digo da esp‚cie do documento" NO-LABEL
     fi-ini-dt-vencto AT ROW 6.83 COL 18.43 COLON-ALIGNED
     fi-fin-dt-vencto AT ROW 6.83 COL 49.29 COLON-ALIGNED NO-LABEL
     fi-dt-corte AT ROW 7.83 COL 18.43 COLON-ALIGNED
     IMAGE-1 AT ROW 4.83 COL 31.57
     IMAGE-2 AT ROW 4.83 COL 47.14
     IMAGE-57 AT ROW 6.83 COL 31.57
     IMAGE-58 AT ROW 6.83 COL 47.14
     IMAGE-59 AT ROW 5.83 COL 31.57
     IMAGE-60 AT ROW 5.83 COL 47.14
     IMAGE-61 AT ROW 3.83 COL 31.57
     IMAGE-62 AT ROW 3.83 COL 47.14
     IMAGE-63 AT ROW 2.83 COL 31.57 WIDGET-ID 4
     IMAGE-64 AT ROW 2.83 COL 47.14 WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 2.72 ROW 2.83
         SIZE 77.43 BY 10.83
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "T¡tulos a Receber por Representante"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* T¡tulos a Receber por Representante */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* T¡tulos a Receber por Representante */
DO:
...
ON MOUSE-SELECT-DBLCLICK OF fi-fin-cod-estabel IN FRAME f-pg-sel /* Estabelecimento */
DO:
...
DO:
  IF INPUT FRAME {&frame-name} to-enviar-e-mail = YES THEN DO:
     ...
     ASSIGN fi-assunto-e-mail:SCREEN-VALUE IN FRAME f-pg-par = "Titulos a Receber - #PER-INI a #PER-FIN".

     ASSIGN fi-texto-e-mail:SCREEN-VALUE IN FRAME f-pg-par = 
            "Segue anexo Rela‡Æo de Titulos a Receber, com vencimento de #PER-INI a #PER-FIN." +
...
{utp/ut9000.i "ESCR0002" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-17 RECT-7 RECT-9 rs-destino rs-tipo-rel bt-arquivo bt-config-impr 
         c-arquivo rs-execucao 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-imp}
  DISPLAY tg-impr-param tg-apenas-resumo to-enviar-e-mail fi-texto-e-mail 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-13 RECT-15 RECT-34 tg-impr-param tg-apenas-resumo 
         to-enviar-e-mail 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-par}
  DISPLAY fi-ep-codigo fi-razao-social fi-ini-cod-estabel fi-fin-cod-estabel 
          fi-ini-cod-rep fi-fin-cod-rep fi-ini-cod-port fi-fin-cod-port 
          fi-ini-cod-esp fi-fin-cod-esp fi-ini-dt-vencto fi-fin-dt-vencto 
          fi-dt-corte 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-57 IMAGE-58 IMAGE-59 IMAGE-60 IMAGE-61 IMAGE-62 
         IMAGE-63 IMAGE-64 fi-ep-codigo fi-ini-cod-estabel fi-fin-cod-estabel 
         fi-ini-cod-rep fi-fin-cod-rep fi-ini-cod-port fi-fin-cod-port 
         fi-ini-cod-esp fi-fin-cod-esp fi-ini-dt-vencto fi-fin-dt-vencto 
         fi-dt-corte 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.ep-codigo       = INPUT FRAME f-pg-sel fi-ep-codigo
           ...
           tt-param.apenas-resumo   = INPUT FRAME f-pg-par tg-apenas-resumo
    ...
    {include/i-rprun.i esrp/escr0002rp.p} 
