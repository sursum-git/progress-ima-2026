...
*******************************************************************************/
{include/i-prgvrs.i Q01im026 2.04.00.001}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH tb-preco WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH tb-preco WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
...
<FOREIGN-KEYS>
cd-gr-preco||y|tb-preco.cd-gr-preco
nr-tabpre||y|tb-preco.nr-tabpre
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
