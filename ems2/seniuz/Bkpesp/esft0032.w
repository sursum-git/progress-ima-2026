...
DEFINE VARIABLE fi-ini-dt-emissao AS DATE FORMAT "99/99/9999":U INITIAL 01/01/001 
     ...
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 TOOLTIP "Data de emissÆo inicial" NO-UNDO.
...
DEFINE FRAME f-pg-sel
     fi-ini-dt-emissao AT ROW 1.5 COL 19 COLON-ALIGNED
     fi-fin-dt-emissao AT ROW 1.5 COL 48 COLON-ALIGNED NO-LABEL
     fi-ini-ge-codigo AT ROW 2.5 COL 19 COLON-ALIGNED HELP
          "Grupo de estoque a que pertence o item"
     fi-fin-ge-codigo AT ROW 2.5 COL 48 COLON-ALIGNED HELP
          "Grupo de estoque a que pertence o item" NO-LABEL
     IMAGE-35 AT ROW 2.5 COL 32.57
     IMAGE-5 AT ROW 1.5 COL 32.57
     IMAGE-6 AT ROW 1.5 COL 46.57
     IMAGE-8 AT ROW 2.5 COL 46.57
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.83
         SIZE 77.43 BY 10.83
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Resumo do Faturamento, Carteira e Reserva"
         COLUMN             = 13.14
         ROW                = 6.83
         HEIGHT             = 15.04
         WIDTH              = 80.72
...
ON END-ERROR OF w-relat /* Resumo do Faturamento, Carteira e Reserva */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Resumo do Faturamento, Carteira e Reserva */
DO:
...
{utp/ut9000.i "ESFT0032" "2.04.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN fi-ini-dt-emissao:SCREEN-VALUE IN FRAME f-pg-sel = STRING(DATE(MONTH(TODAY),1,YEAR(TODAY)),"99/99/9999")
           ...
           fi-fin-ge-codigo:SCREEN-VALUE IN FRAME f-pg-sel = "70".
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-ini-dt-emissao fi-fin-dt-emissao fi-ini-ge-codigo fi-fin-ge-codigo 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-ini-dt-emissao fi-fin-dt-emissao fi-ini-ge-codigo fi-fin-ge-codigo 
         IMAGE-35 IMAGE-5 IMAGE-6 IMAGE-8 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    /*:T Coloque aqui a l¢gica de grava‡Æo dos demais campos que devem ser passados
     ...
     ASSIGN tt-param.dt-emissao-ini = input frame f-pg-sel fi-ini-dt-emissao
    ...
    {include/i-rprun.i esrp/esft0032rp.p} 
