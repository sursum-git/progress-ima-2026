...
RECT-45 RECT-46 fi-nr-pedcli tg-todos-itens tg-copia-reservas ~
tg-copia-observ fi-it-codigo-ini fi-it-codigo-fin fi-cod-refer-ini ~
fi-cod-refer-fin tg-aberto tg-suspenso tg-atendido-parcial tg-cancelado ~
tg-atendido-total tg-fat-balcao tg-pendente bt-ok bt-cancelar bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS fi-nr-pedcli fi-nome-abrev tg-todos-itens ~
tg-copia-reservas tg-copia-observ fi-it-codigo-ini fi-it-codigo-fin ~
fi-cod-refer-ini fi-cod-refer-fin tg-aberto tg-suspenso tg-atendido-parcial ~
...
DEFINE FRAME F-Main
     ...
     tg-todos-itens AT ROW 2.5 COL 16 WIDGET-ID 46
     tg-copia-reservas AT ROW 2.5 COL 44.86 WIDGET-ID 38
     tg-copia-observ AT ROW 3.5 COL 16 WIDGET-ID 36
     ...
     bt-ajuda AT ROW 13.38 COL 58.86
...
------------------------------------------------------------------------------*/
  DISPLAY fi-nr-pedcli fi-nome-abrev tg-todos-itens tg-copia-reservas 
          tg-copia-observ fi-it-codigo-ini fi-it-codigo-fin fi-cod-refer-ini 
  ...
  ENABLE RECT-1 IMAGE-1 IMAGE-2 IMAGE-51 IMAGE-52 RECT-45 RECT-46 fi-nr-pedcli 
         tg-todos-itens tg-copia-reservas tg-copia-observ fi-it-codigo-ini 
         ...
         tg-fat-balcao tg-pendente bt-ok bt-cancelar bt-ajuda 
      WITH FRAME F-Main IN WINDOW w-digita.
