...
DEFINE BUTTON bt-desenho 
     ...
     LABEL "Des" 
     SIZE 8.86 BY 6.42 TOOLTIP "Visualiza Imagem do Desenho".
...
DEFINE FRAME Dialog-Frame
     ...
     cb-qualidade AT ROW 12.5 COL 38.14 COLON-ALIGNED NO-LABEL
     fi-nuance AT ROW 14.46 COL 38 COLON-ALIGNED NO-LABEL
     fi-qt-cortes AT ROW 16.21 COL 38.14 COLON-ALIGNED NO-LABEL
     ...
     bt-desenho AT ROW 14.29 COL 68 WIDGET-ID 2
     "Qtde Cortes:" VIEW-AS TEXT
          SIZE 24.14 BY 1.38 AT ROW 16.25 COL 38.14 RIGHT-ALIGNED
          FONT 10
...
DEFINE FRAME Dialog-Frame
     ...
     "Qualidade:" VIEW-AS TEXT
          SIZE 20.57 BY 1.38 AT ROW 12.58 COL 38.57 RIGHT-ALIGNED
          FONT 10
     "Estab.:" VIEW-AS TEXT
          SIZE 13 BY 1.25 AT ROW 1.5 COL 65.43
          FONT 10
     "Nuance:" VIEW-AS TEXT
          SIZE 16 BY 1.38 AT ROW 14.46 COL 38 RIGHT-ALIGNED
          FONT 10
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-desenho Dialog-Frame
ON CHOOSE OF bt-desenho IN FRAME Dialog-Frame /* Des */
DO:
   RUN esdlg/d01-desenho.w (INPUT ordem-benefic.cod-refer).
END.
...
END.
ELSE MESSAGE "d01es047.wrx":U SKIP(1)
...
------------------------------------------------------------------------------*/
  ...
  ENABLE cb-qualidade fi-nuance fi-qt-cortes fi-quantidade cb-classe1 
         ...
         c-hora RECT-2 RECT-3 RECT-4 rt-buttom bt-desenho 
      WITH FRAME Dialog-Frame.
