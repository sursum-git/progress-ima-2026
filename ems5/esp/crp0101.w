...
define temp-table tt-param
    ...
    field da-dt-prev-pag-ini   like tit_ap.dat_prev_pagto
    field da-dt-prev-pag-fim   like tit_ap.dat_prev_pagto
...
DEFINE VARIABLE fi_cdn_fornec_fin AS INTEGER FORMAT ">>>,>>9" INITIAL 999999 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88 NO-UNDO.

DEFINE VARIABLE fi_cdn_fornec_ini AS INTEGER FORMAT ">>>,>>9" INITIAL 0 
     LABEL "Fornecedor" 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88 NO-UNDO.

DEFINE VARIABLE fi_cod_espec_docto_fin AS CHARACTER FORMAT "x(3)" INITIAL "ZZZ" 
     VIEW-AS FILL-IN 
     SIZE 6 BY .88 NO-UNDO.

DEFINE VARIABLE fi_cod_espec_docto_ini AS CHARACTER FORMAT "x(3)" 
     LABEL "Esp‚cie Documento" 
     VIEW-AS FILL-IN 
     SIZE 6 BY .88 NO-UNDO.

DEFINE VARIABLE fi_cod_portador_fin AS CHARACTER FORMAT "x(5)" INITIAL "ZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 8.86 BY .88 NO-UNDO.

DEFINE VARIABLE fi_cod_portador_ini AS CHARACTER FORMAT "x(5)" 
     LABEL "Portador" 
     VIEW-AS FILL-IN 
     SIZE 8.86 BY .88 NO-UNDO.

DEFINE VARIABLE fi_dat_prev_pagto_fin AS DATE FORMAT "99/99/9999" INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.

DEFINE VARIABLE fi_dat_prev_pagto_ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/00 
...
DEFINE FRAME f-pg-sel
     fi_cdn_fornec_ini AT ROW 1.75 COL 20 COLON-ALIGNED HELP
          "C¢digo Fornecedor"
     fi_cdn_fornec_fin AT ROW 1.75 COL 49 COLON-ALIGNED HELP
          "C¢digo Fornecedor" NO-LABEL WIDGET-ID 2
     fi_dat_prev_pagto_ini AT ROW 2.75 COL 20 COLON-ALIGNED HELP
          "Data Prevista Pagamento" WIDGET-ID 4
     fi_dat_prev_pagto_fin AT ROW 2.75 COL 49 COLON-ALIGNED HELP
          "Data Prevista Pagamento" NO-LABEL WIDGET-ID 10
     fi_cod_portador_ini AT ROW 3.75 COL 20 COLON-ALIGNED HELP
          "C¢digo Portador" WIDGET-ID 12
     fi_cod_portador_fin AT ROW 3.75 COL 49 COLON-ALIGNED HELP
          "C¢digo Portador" NO-LABEL WIDGET-ID 18
     fi_cod_espec_docto_ini AT ROW 4.75 COL 20 COLON-ALIGNED HELP
          "C¢digo Esp‚cie Documento" WIDGET-ID 22
     fi_cod_espec_docto_fin AT ROW 4.75 COL 49 COLON-ALIGNED HELP
          "C¢digo Esp‚cie Documento" NO-LABEL WIDGET-ID 28
     IMAGE-1 AT ROW 1.75 COL 34
     IMAGE-2 AT ROW 1.75 COL 46.86
     IMAGE-3 AT ROW 2.75 COL 34 WIDGET-ID 6
     IMAGE-4 AT ROW 2.75 COL 46.86 WIDGET-ID 8
     IMAGE-5 AT ROW 3.75 COL 34 WIDGET-ID 14
     IMAGE-6 AT ROW 3.75 COL 46.86 WIDGET-ID 16
     IMAGE-7 AT ROW 4.75 COL 34 WIDGET-ID 24
     IMAGE-8 AT ROW 4.75 COL 46.86 WIDGET-ID 26
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi_cdn_fornec_ini fi_cdn_fornec_fin fi_dat_prev_pagto_ini 
          fi_dat_prev_pagto_fin fi_cod_portador_ini fi_cod_portador_fin 
          fi_cod_espec_docto_ini fi_cod_espec_docto_fin 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         fi_cdn_fornec_ini fi_cdn_fornec_fin fi_dat_prev_pagto_ini 
         fi_dat_prev_pagto_fin fi_cod_portador_ini fi_cod_portador_fin 
         fi_cod_espec_docto_ini fi_cod_espec_docto_fin 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
