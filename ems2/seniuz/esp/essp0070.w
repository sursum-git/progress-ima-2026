...
*******************************************************************************/
{include/i-prgvrs.i ESSP0070 2.04.00.000}
...
DEFINE VARIABLE fi-fin-coef-ph AS DECIMAL FORMAT ">9.99" INITIAL 99.99 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-fin-mat-seca AS DECIMAL FORMAT ">>9.99" INITIAL 999.99 
     VIEW-AS FILL-IN 
     SIZE 13 BY .79 NO-UNDO.

DEFINE VARIABLE fi-fin-num-of AS CHARACTER FORMAT "x(12)" INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .79 NO-UNDO.

DEFINE VARIABLE fi-ini-coef-ph AS DECIMAL FORMAT ">9.99" INITIAL 0 
     LABEL "Coeficiente pH" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .79 NO-UNDO.
...
DEFINE VARIABLE fi-ini-mat-seca AS DECIMAL FORMAT ">>9.99" INITIAL 0 
     LABEL "Materia Seca" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .79 NO-UNDO.

DEFINE VARIABLE fi-ini-num-of AS CHARACTER FORMAT "x(12)" 
     LABEL "Ordem de Fabricaá∆o" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .79 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     fi-ini-num-of AT ROW 1.25 COL 17 COLON-ALIGNED HELP
          "Numero da OF - Ordem de Fabricacao"
     fi-fin-num-of AT ROW 1.25 COL 48.14 COLON-ALIGNED HELP
          "Numero da OF - Ordem de Fabricacao" NO-LABEL
     fi-ini-data-teste AT ROW 2.25 COL 17 COLON-ALIGNED HELP
     ...
     fi-ini-coef-ph AT ROW 3.25 COL 17 COLON-ALIGNED HELP
          "Coeficiente de pH - potencial Hidrogenionico"
     fi-fin-coef-ph AT ROW 3.25 COL 48.14 COLON-ALIGNED HELP
          "Coeficiente de pH - potencial Hidrogenionico" NO-LABEL
     fi-ini-mat-seca AT ROW 4.25 COL 17 COLON-ALIGNED HELP
          "Materia seca - percentual"
     fi-fin-mat-seca AT ROW 4.25 COL 48.14 COLON-ALIGNED HELP
          "Materia seca - percentual" NO-LABEL
...
DEFINE FRAME f-pg-par
     ...
     to-imp-param AT ROW 3.75 COL 43
     RECT-11 AT ROW 1.5 COL 4.29
     RECT-25 AT ROW 3 COL 33
...
ON END-ERROR OF w-relat /* Testes de Produtos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Testes de Produtos */
DO:
...
{utp/ut9000.i "ESSP0070" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-ini-num-of fi-fin-num-of fi-ini-data-teste fi-fin-data-teste 
          fi-ini-coef-ph fi-fin-coef-ph fi-ini-mat-seca fi-fin-mat-seca 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-ini-num-of fi-fin-num-of fi-ini-data-teste fi-fin-data-teste 
         fi-ini-coef-ph fi-fin-coef-ph fi-ini-mat-seca fi-fin-mat-seca IMAGE-1 
         IMAGE-11 IMAGE-12 IMAGE-13 IMAGE-14 IMAGE-15 IMAGE-16 IMAGE-2 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  ENABLE rs-tipo-relatorio to-imp-param RECT-11 RECT-25 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
*/    
    ...
    assign tt-param.usuario             = c-seg-usuario
           ...
           tt-param.fi-ini-num-of       = INPUT FRAME f-pg-sel fi-ini-num-of   
           tt-param.fi-fin-num-of       = INPUT FRAME f-pg-sel fi-fin-num-of    
           ...
           tt-param.fi-ini-coef-ph      = INPUT FRAME f-pg-sel fi-ini-coef-ph    
           tt-param.fi-fin-coef-ph      = INPUT FRAME f-pg-sel fi-fin-coef-ph    
           tt-param.fi-ini-mat-seca     = INPUT FRAME f-pg-sel fi-ini-mat-seca   
           tt-param.fi-fin-mat-seca     = INPUT FRAME f-pg-sel fi-fin-mat-seca   
    ...
    {include/i-rprun.i esrp/essp0070rp.p}
