...
&Scoped-define QUERY-STRING-br-pedidos FOR EACH tt-itens-ped WHERE                                  tt-itens-ped.visualiza NO-LOCK                                  BY {&BREAK-BY}
&Scoped-define OPEN-QUERY-br-pedidos OPEN QUERY {&SELF-NAME} FOR EACH tt-itens-ped WHERE                                  tt-itens-ped.visualiza NO-LOCK                                  BY {&BREAK-BY}.
...
DEFINE FRAME D-Dialog
     ...
     bt-imprime AT ROW 13.5 COL 13
     BUTTON-1 AT ROW 13.5 COL 24.29
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         FONT 1
         TITLE "Pedidos N«O Reservados por Regra - ESSP0160D"
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Pedidos N«O Reservados por Regra - ESSP0160D */
DO:  
...
------------------------------------------------------------------------------*/
 ...
 PUT "RELATORIO DE PEDIDOS N«O RESERVADOS POR REGRA" AT 42 SKIP(1).
...
------------------------------------------------------------------------------*/
 ...
 CASE i-saida:
     ...
     WHEN 3 THEN DO.
         ASSIGN c-saida = SESSION:TEMP-DIRECTORY + "essp0160d.tmp".
         OUTPUT TO VALUE(c-saida).
     END.
 END CASE.
