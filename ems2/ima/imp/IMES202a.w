...
&Scoped-Define ENABLED-OBJECTS bt-ok bt-save bt-cancela bt-ajuda rt-button 
...
DEFINE VARIABLE h_q01imes202a AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v01imes202a AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 3.42 COL 2.57 HELP
          "Salva e sai"
     bt-save AT ROW 3.42 COL 13 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 3.42 COL 23.57 HELP
          "Cancela"
     bt-ajuda AT ROW 3.42 COL 70.72
     rt-button AT ROW 3.25 COL 1.57
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Inclui/Modifica Usu rio X Tipo de Pedido"
         HEIGHT             = 3.92
         WIDTH              = 80.72
         MAX-HEIGHT         = 26.75
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-cadsim /* Inclui/Modifica Usu rio X Tipo de Pedido */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Inclui/Modifica Usu rio X Tipo de Pedido */
DO:
...
DO:
{include/salvafil.i h_v01imes202a}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'imvwr/v01imes202a.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v01imes202a ).
       RUN set-position IN h_v01imes202a ( 1.75 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 80.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'imqry/q01imes202a.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q01imes202a ).
       RUN set-position IN h_q01imes202a ( 1.25 , 71.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_v01imes202a. */
       RUN add-link IN adm-broker-hdl ( h_q01imes202a , 'Record':U , h_v01imes202a ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_v01imes202a ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v01imes202a ,
...
------------------------------------------------------------------------------*/
  ...
  run pi-atualiza-parent in h_v01imes202a (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_q01imes202a (input v-row-table).
