...
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-2 tt.conta tt.ccusto   
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-2 tt
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-2 tt
...
&Scoped-Define ENABLED-OBJECTS rt-button RECT-1 fiNumLote fiNumLancto ~
fiNumSeqLancto btExecutar BROWSE-2 fictaCtbl ficcusto btAlterar 
...
ON VALUE-CHANGED OF BROWSE-2 IN FRAME f-cad /* Browse 1 */
DO:
  FIND FIRST cta_ctbl
...
------------------------------------------------------------------------------*/
  ...
  ENABLE rt-button RECT-1 fiNumLote fiNumLancto fiNumSeqLancto btExecutar 
         BROWSE-2 fictaCtbl ficcusto btAlterar 
      WITH FRAME f-cad IN WINDOW w-livre.
