...
*******************************************************************************/
{include/i-prgvrs.i G02CL005 1.00.00.000}
...
&Scoped-Define ENABLED-FIELDS mgcld.bc-etiqueta.progressivo 
&Scoped-define ENABLED-TABLES mgcld.bc-etiqueta
&Scoped-define FIRST-ENABLED-TABLE mgcld.bc-etiqueta
&Scoped-define DISPLAYED-TABLES mgcld.bc-etiqueta
&Scoped-define FIRST-DISPLAYED-TABLE mgcld.bc-etiqueta
&Scoped-Define ENABLED-OBJECTS bt-ok bt-cancela bt-ajuda rt-button 
&Scoped-Define DISPLAYED-FIELDS mgcld.bc-etiqueta.progressivo 
...
DEFINE FRAME d-vapara
     mgcld.bc-etiqueta.progressivo AT ROW 1.5 COL 10.86
          LABEL "Nr Etiqueta":R21
          VIEW-AS FILL-IN 
          SIZE 15 BY .88
     bt-ok AT ROW 3.17 COL 2.14
     bt-cancela AT ROW 3.17 COL 13
     bt-ajuda AT ROW 3.17 COL 58
     rt-button AT ROW 2.92 COL 1
     SPACE(0.13) SKIP(0.03)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "V  Para Etiqueta"
...
/* SETTINGS FOR FILL-IN mgcld.bc-etiqueta.progressivo IN FRAME d-vapara
   ALIGN-L EXP-LABEL                                                    */
...
ON GO OF FRAME d-vapara /* V  Para Etiqueta */
DO:
  FIND bc-etiqueta USE-INDEX ch-progressivo no-lock 
      WHERE bc-etiqueta.progressivo = trim(bc-etiqueta.progressivo:SCREEN-VALUE IN FRAME {&FRAME-NAME})
        /*AND bc-etiqueta.nr-etiq-pai = 0*/
      NO-ERROR.
  IF  NOT AVAIL bc-etiqueta THEN DO:
      {utp/ut-table.i mgcld bc-etiqueta 1}
      RUN utp/ut-msgs.p (INPUT "show",
                         INPUT 2,
                         INPUT RETURN-VALUE).
      RETURN NO-APPLY.
  END.
  ASSIGN p-row-tabela = ROWID(bc-etiqueta).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Etiqueta */
DO:  
...
------------------------------------------------------------------------------*/
  IF AVAILABLE mgcld.bc-etiqueta THEN 
    DISPLAY mgcld.bc-etiqueta.progressivo 
      WITH FRAME d-vapara.
  ENABLE mgcld.bc-etiqueta.progressivo bt-ok bt-cancela bt-ajuda rt-button 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "G02ICL001" "1.00.00.000"}
