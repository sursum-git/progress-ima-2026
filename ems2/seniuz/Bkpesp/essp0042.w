...
*******************************************************************************/
{include/i-prgvrs.i ESSP0042 2.04.00.000}
...
ON END-ERROR OF w-consim /* Testes de Goma */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-consim w-consim
ON WINDOW-CLOSE OF w-consim /* Testes de Goma */
DO:
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es031.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01es031 ).
       RUN set-position IN h_q01es031 ( 1.50 , 64.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0042" "2.04.00.000"}
