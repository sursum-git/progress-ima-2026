...
*******************************************************************************/
{include/i-prgvrs.i ESSP0068 2.04.00.000}
...
DEFINE FRAME f-pg-sel
     ...
     IMAGE-11 AT ROW 2.29 COL 47.29
     IMAGE-12 AT ROW 2.29 COL 31.86
...
ON END-ERROR OF w-relat /* Testes de Pick-Up */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Testes de Pick-Up */
DO:
...
{utp/ut9000.i "ESSP0068" "2.04.00.000"}
...
if tt-param.destino = 1 
    ...
    {include/i-rprun.i esrp/essp0068rp.p}
