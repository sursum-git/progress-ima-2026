...
DEF INPUT PARAMETER p-cod-refer LIKE ITEM.cod-refer.
...
&Scoped-Define ENABLED-OBJECTS RECT-50 rt-buttom bt-ok bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS fi-it-codigo fi-desc-item fi-cod-refer ~
fi-desc-refer fi-prog fi-proc fi-pronto 
...
DEFINE FRAME D-Dialog
     fi-it-codigo AT ROW 2 COL 14 COLON-ALIGNED
     fi-desc-item AT ROW 2 COL 24.43 COLON-ALIGNED NO-LABEL
     fi-cod-refer AT ROW 3 COL 14 COLON-ALIGNED
     fi-desc-refer AT ROW 3 COL 24.43 COLON-ALIGNED NO-LABEL
     fi-prog AT ROW 4.75 COL 14 COLON-ALIGNED
     fi-proc AT ROW 6.25 COL 14 COLON-ALIGNED
     fi-pronto AT ROW 7.75 COL 14 COLON-ALIGNED
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         FONT 1
         TITLE "Consulta Beneficiamento - ESSP0150G"
...
/* SETTINGS FOR FILL-IN fi-desc-item IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN fi-desc-refer IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN fi-it-codigo IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN fi-proc IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN fi-prog IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN fi-pronto IN FRAME D-Dialog
   NO-ENABLE                                                            */
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Consulta Beneficiamento - ESSP0150G */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY fi-it-codigo fi-desc-item fi-cod-refer fi-desc-refer fi-prog fi-proc 
          fi-pronto 
      WITH FRAME D-Dialog.
  ENABLE RECT-50 rt-buttom bt-ok bt-ajuda 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  FIND referencia WHERE
       referencia.cod-refer = p-cod-refer NO-LOCK NO-ERROR.

  ASSIGN fi-it-codigo = p-it-codigo
         fi-desc-item = ITEM.desc-item
         fi-cod-refer = p-cod-refer
         fi-desc-refer = referencia.descricao.

  FOR EACH ref-item-ext WHERE
           ref-item-ext.it-codigo = p-it-codigo AND
           ref-item-ext.cod-refer = p-cod-refer NO-LOCK.
