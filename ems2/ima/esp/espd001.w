...
DEFINE VARIABLE tg-email AS LOGICAL INITIAL no 
     LABEL "Envia e-mail" 
     VIEW-AS TOGGLE-BOX
     SIZE 11.86 BY .83 TOOLTIP "Enviar e-mail com a planilha gerada?" NO-UNDO.
...
DEFINE FRAME f-pg-par
     tg-email AT ROW 4 COL 29 HELP
          "Enviar e-mails?" WIDGET-ID 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 77.14 BY 10.5
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Integra Pedidos WEB com ERP"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Integra Pedidos WEB com ERP */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Integra Pedidos WEB com ERP */
DO:
...
DO:
    /*
  IF INPUT FRAME f-pg-par tg-email = YES THEN DO:
     ASSIGN fi-destinatarios:SENSITIVE = YES
            fi-destinatarios:SCREEN-VALUE = 'ti@imatextil.com.br' .
  END.
  ELSE
     ASSIGN fi-destinatarios:SENSITIVE = NO
            fi-destinatarios:SCREEN-VALUE = ''. */
END.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           //tt-param.destinatarios   = INPUT FRAME f-pg-par fi-destinatarios
           tt-param.l-batch         = IF INPUT FRAME f-pg-imp rs-execucao = 1 THEN NO
                                                                              ELSE YES
           tt-param.enviar-e-mail = INPUT FRAME f-pg-par tg-email.
    ...
    {include/i-rprun.i esrp/espd001rp.p} 
