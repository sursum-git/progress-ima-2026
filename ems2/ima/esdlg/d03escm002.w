...
*******************************************************************************/
{include/i-prgvrs.i D01ESSP0225 2.04.00.000}
...
DEF INPUT-OUTPUT PARAMETER p-arq-saida AS CHAR FORMAT "x(51)".
...
DEFINE VARIABLE fi-arq-saida AS CHARACTER FORMAT "X(51)":U 
     LABEL "Arquivo Sa¡da" 
     VIEW-AS FILL-IN 
     SIZE 62.57 BY .88 TOOLTIP "Caminho/nome da planilha de sa¡da."
     FONT 1 NO-UNDO.
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Definir Nome da Planilha */
DO:  
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "D03ESCM002" "2.04.00.000"} 
