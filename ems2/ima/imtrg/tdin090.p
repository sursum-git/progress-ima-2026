/****************************************************************************
** Programa : TWIN090 - trigger de delete para a tabela docum-est
** Data     : 06/2024
** Objetivo : trigger de delete para a tabela docum-est
** Empresa  : IMA 
** Autor    : Tadeu Silva
** Alterado : 
** *************************************************************************/
...
{include/i-prgvrs.i tdin090 2.06.00.001}
...
IF natur-oper.tipo-compra = 3 THEN DO: //devolu‡Æo de cliente
    ...
    RUN setProgOrigem   IN hBoFats99('tdin090').
