...
*******************************************************************************/
{include/i-prgvrs.i ESSP0017 2.04.00.000}
...
ON END-ERROR OF w-cadsim /* µreas da Mecƒnica */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* µreas da Mecƒnica */
DO:
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es002.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01es002 ).
       RUN set-position IN h_q01es002 ( 1.50 , 64.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.00 , 8.00 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_v01es002. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_v01es002 ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0017" "2.04.00.000"}
