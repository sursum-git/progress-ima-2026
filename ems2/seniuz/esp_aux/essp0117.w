...
&Scoped-Define ENABLED-OBJECTS fi-cod-emit fi-nro-docto fi-nro-contrato ~
...
fi-padrao4 fi-qtd-fardos4 fi-padrao5 fi-qtd-fardos5 
...
DEFINE FRAME F-Main
     ...
     fi-padrao1 AT ROW 9.75 COL 17 COLON-ALIGNED NO-LABEL
     fi-qtd-fardos1 AT ROW 9.75 COL 50 COLON-ALIGNED NO-LABEL
     fi-padrao2 AT ROW 10.75 COL 17 COLON-ALIGNED NO-LABEL
     fi-qtd-fardos2 AT ROW 10.75 COL 50 COLON-ALIGNED NO-LABEL
     fi-padrao3 AT ROW 11.75 COL 17 COLON-ALIGNED NO-LABEL
     fi-qtd-fardos3 AT ROW 11.75 COL 50 COLON-ALIGNED NO-LABEL
     fi-padrao4 AT ROW 12.75 COL 17 COLON-ALIGNED NO-LABEL
     fi-qtd-fardos4 AT ROW 12.75 COL 50 COLON-ALIGNED NO-LABEL
     fi-padrao5 AT ROW 13.75 COL 17 COLON-ALIGNED NO-LABEL
     fi-qtd-fardos5 AT ROW 13.75 COL 50 COLON-ALIGNED NO-LABEL
     bt-ok AT ROW 15.46 COL 3.29
     bt-cancelar AT ROW 15.46 COL 14.29
     bt-ajuda AT ROW 15.5 COL 60.14
     RECT-1 AT ROW 15.25 COL 2
     RECT-13 AT ROW 1.25 COL 2
     RECT-14 AT ROW 4.75 COL 2
     "Padr∆o" VIEW-AS TEXT
          SIZE 8 BY .75 AT ROW 9 COL 19
          FGCOLOR 9 FONT 8
     "Qt Fardos" VIEW-AS TEXT
          SIZE 11 BY .75 AT ROW 9 COL 52
          FGCOLOR 9 FONT 8
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-digita ASSIGN
         HIDDEN             = YES
         TITLE              = "Entrada de  Estoque Algod∆o Paraopeba"
         HEIGHT             = 15.79
         WIDTH              = 70.86
         MAX-HEIGHT         = 28.54
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-digita /* Entrada de  Estoque Algod∆o Paraopeba */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-digita w-digita
ON WINDOW-CLOSE OF w-digita /* Entrada de  Estoque Algod∆o Paraopeba */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY fi-placa fi-dt-entrada fi-hora fi-peso-bruto fi-cod-emit fi-nome-emit 
          ...
          fi-procedencia fi-peso-nf fi-padrao1 fi-qtd-fardos1 fi-padrao2 
          fi-qtd-fardos2 fi-padrao3 fi-qtd-fardos3 fi-padrao4 fi-qtd-fardos4 
          fi-padrao5 fi-qtd-fardos5 
      WITH FRAME F-Main IN WINDOW w-digita.
  ENABLE fi-cod-emit fi-nro-docto fi-nro-contrato fi-dt-emissao 
         fi-dt-recebimento fi-procedencia fi-peso-nf fi-padrao1 fi-qtd-fardos1 
         fi-padrao2 fi-qtd-fardos2 fi-padrao3 fi-qtd-fardos3 fi-padrao4 
         fi-qtd-fardos4 fi-padrao5 fi-qtd-fardos5 bt-ok bt-cancelar bt-ajuda 
         RECT-1 RECT-13 RECT-14 
      WITH FRAME F-Main IN WINDOW w-digita.
