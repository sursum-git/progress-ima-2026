...
*******************************************************************************/
{include/i-prgvrs.i ESPD501 9.99.99.999}
...
&Scoped-Define ENABLED-OBJECTS rt-button RECT-7 btExec fiPedido cbAtualiza ~
fiUsuarioPortal BROWSE-4 BROWSE-5 
&Scoped-Define DISPLAYED-OBJECTS fiPedido cbAtualiza fiUsuarioPortal 
...
DEFINE VARIABLE cbAtualiza AS LOGICAL FORMAT "yes/no" INITIAL YES 
     LABEL "Atualiza?" 
     VIEW-AS COMBO-BOX 
...
DEFINE VARIABLE fiUsuarioPortal AS CHARACTER FORMAT "X(256)":U 
     LABEL "Usuar." 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-cad
     btExec AT ROW 2.75 COL 63 WIDGET-ID 22
     fiPedido AT ROW 2.83 COL 16.57 COLON-ALIGNED WIDGET-ID 2
     cbAtualiza AT ROW 2.83 COL 33.57 COLON-ALIGNED WIDGET-ID 6
     fiUsuarioPortal AT ROW 2.88 COL 48.14 COLON-ALIGNED WIDGET-ID 28
     BROWSE-4 AT ROW 5.5 COL 11 WIDGET-ID 200
     BROWSE-5 AT ROW 10.25 COL 11 WIDGET-ID 300
     "Resultados" VIEW-AS TEXT
          SIZE 16 BY .88 AT ROW 4.38 COL 10.57 WIDGET-ID 26
     rt-button AT ROW 1 COL 1
     RECT-7 AT ROW 4.25 COL 10 WIDGET-ID 24
...
/* SETTINGS FOR FRAME f-cad
   FRAME-NAME L-To-R                                                    */
/* BROWSE-TAB BROWSE-4 fiUsuarioPortal f-cad */
...
ON END-ERROR OF w-livre /* Simula‡Æo API Aa */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-livre w-livre
ON WINDOW-CLOSE OF w-livre /* Simula‡Æo API Aa */
DO:
...
DO:
  ...
  RUN esapi/calcComisPedWeb.p(INPUT FRAME {&FRAME-NAME} fiPedido,
                              0, //transacao
                              IF fiUsuarioPOrtal:SCREEN-VALUE <> '' THEN
                                 fiUsuarioPOrtal:SCREEN-VALUE ELSE c-seg-usuario,
                              INPUT FRAME {&FRAME-NAME} cbAtualiza,
                              INPUT 'espd501',
...
------------------------------------------------------------------------------*/
  DISPLAY fiPedido cbAtualiza fiUsuarioPortal 
      WITH FRAME f-cad IN WINDOW w-livre.
  ENABLE rt-button RECT-7 btExec fiPedido cbAtualiza fiUsuarioPortal BROWSE-4 
         BROWSE-5 
      WITH FRAME f-cad IN WINDOW w-livre.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "espd501" "9.99.99.999"}
