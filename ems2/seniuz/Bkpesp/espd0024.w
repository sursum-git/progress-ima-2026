...
*******************************************************************************/
{include/i-prgvrs.i ESPD0024 2.04.00.000}
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Situa‡Æo de Desenhos x Pedidos em Aberto"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Situa‡Æo de Desenhos x Pedidos em Aberto */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Situa‡Æo de Desenhos x Pedidos em Aberto */
DO:
...
{utp/ut9000.i "ESPD0024" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ENABLE bt-executar bt-cancelar bt-ajuda im-pg-dig im-pg-imp 
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/espd0024rp.p}
