...
*******************************************************************************/
{include/i-prgvrs.i ESCE0007 2.04.00.000}
...
DEFINE VARIABLE rs-tipo-estoque AS INTEGER 
     VIEW-AS RADIO-SET VERTICAL
     RADIO-BUTTONS 
          "Saldo Maior Que Zero", 1,
"Saldo Igual a Zero  ", 2,
"Saldo Menor Que Zero", 3,
"Todos               ", 4
     SIZE 25 BY 4.5 NO-UNDO.
...
DEFINE VARIABLE fi-fin-cod-depos AS CHARACTER FORMAT "x(3)" INITIAL "ZZZ" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-par
     rs-tipo-estoque AT ROW 2.25 COL 24.72 NO-LABEL
     to-imp-param AT ROW 9.25 COL 28
     RECT-11 AT ROW 1.5 COL 4
     RECT-25 AT ROW 8.5 COL 4
     "Saldo de Estoque" VIEW-AS TEXT
          SIZE 12.72 BY .79 AT ROW 1.13 COL 33.29
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 75 BY 10
...
DEFINE FRAME f-pg-sel
     ...
     fi-nome-estabel AT ROW 1.54 COL 19.57 COLON-ALIGNED NO-LABEL
     fi-ini-it-codigo AT ROW 2.54 COL 15.29 COLON-ALIGNED HELP
          "C¢digo do Item"
     fi-fin-it-codigo AT ROW 2.54 COL 46.14 COLON-ALIGNED HELP
          "C¢digo do Item" NO-LABEL
     fi-ini-cod-obsoleto AT ROW 3.54 COL 15.29 COLON-ALIGNED
     fi-fin-cod-obsoleto AT ROW 3.54 COL 46.14 COLON-ALIGNED NO-LABEL
     fi-ini-cod-depos AT ROW 4.54 COL 15.29 COLON-ALIGNED
     fi-fin-cod-depos AT ROW 4.54 COL 46.14 COLON-ALIGNED NO-LABEL
     IMAGE-1 AT ROW 2.54 COL 35.72
     IMAGE-11 AT ROW 3.54 COL 35.72
     IMAGE-12 AT ROW 3.54 COL 45.14
     IMAGE-13 AT ROW 4.54 COL 35.72
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Necessidade de Compra por Itens"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Necessidade de Compra por Itens */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Necessidade de Compra por Itens */
DO:
...
&Scoped-define SELF-NAME fi-fin-cod-depos
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-fin-cod-depos w-relat
ON MOUSE-SELECT-DBLCLICK OF fi-fin-cod-depos IN FRAME f-pg-sel
DO:
   {include/zoomvar.i &prog-zoom = inzoom/z01in084.w
                      &campo     = fi-fin-cod-depos
                      &campozoom = cod-depos
                      &FRAME     = f-pg-sel}
END.
...
&Scoped-define SELF-NAME fi-ini-cod-depos
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-ini-cod-depos w-relat
ON MOUSE-SELECT-DBLCLICK OF fi-ini-cod-depos IN FRAME f-pg-sel /* Dep¢sito */
DO:
   {include/zoomvar.i &prog-zoom = inzoom/z01in084.w
                      &campo     = fi-ini-cod-depos
                      &campozoom = cod-depos
                      &FRAME     = f-pg-sel}
END.
...
{utp/ut9000.i "ESCE0007" "2.04.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    fi-ini-cod-depos:LOAD-MOUSE-POINTER("image/lupa.cur") IN FRAME f-pg-sel.
    fi-fin-cod-depos:LOAD-MOUSE-POINTER("image/lupa.cur") IN FRAME f-pg-sel.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-cod-estabel fi-nome-estabel fi-ini-it-codigo fi-fin-it-codigo 
          fi-ini-cod-obsoleto fi-fin-cod-obsoleto fi-ini-cod-depos 
          fi-fin-cod-depos 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-cod-estabel fi-ini-it-codigo fi-fin-it-codigo fi-ini-cod-obsoleto 
         fi-fin-cod-obsoleto fi-ini-cod-depos fi-fin-cod-depos IMAGE-1 IMAGE-11 
         IMAGE-12 IMAGE-13 IMAGE-14 IMAGE-2 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY rs-tipo-estoque to-imp-param 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE rs-tipo-estoque to-imp-param RECT-11 RECT-25 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario             = c-seg-usuario
           ...
           tt-param.ini-cod-depos       = INPUT FRAME f-pg-sel fi-ini-cod-depos  
           tt-param.fin-cod-depos       = INPUT FRAME f-pg-sel fi-fin-cod-depos
           tt-param.tipo-estoque        = INPUT FRAME f-pg-par rs-tipo-estoque
           tt-param.desc-tipo-estoq     = entry((tt-param.tipo-estoque - 1) * 2 + 1, 
                                              rs-tipo-estoque:radio-buttons in frame f-pg-par)
    ...
    {include/i-rprun.i esrp/esce0007rp.p}
