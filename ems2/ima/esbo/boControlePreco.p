/*
 ...
 05/2024 - tadeu - acrescimo de procedimento setPedRubiX para informar se o pedido Ç rubix ou n∆o - tsp03          
 03/2025 - tadeu/thiago - acrescimo de procedimento para buscar classe de comiss∆o do preco - tsp04
 */            
{esbo/boMsg.i}
{utp/ut-glob.i}
...
PROCEDURE getPercClasseComis:
    ...
    FOR FIRST controle_preco FIELDS(cod_controle_preco classe_comissao_id) NO-LOCK
        WHERE controle_preco.cod_controle_preco = pId,
        EACH classes_comissao NO-LOCK 
        WHERE classes_comissao.classes_comissao_id = controle_preco.classe_comissao_id.
        ASSIGN pPerc = comissao.        
    END.  
...
PROCEDURE getIdClasseComis:
    ...
    FOR FIRST controle_preco FIELDS(cod_controle_preco classe_comissao_id) NO-LOCK
        WHERE controle_preco.cod_controle_preco = pId.        
        ASSIGN pIdClasse =  controle_preco.classe_comissao_id.
    END.   
