...
*******************************************************************************/
{include/i-prgvrs.i Z01AD098 2.04.00.000}
...
DEFINE VARIABLE h_b01ad098 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b02ad098 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b03ad098 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b04ad098 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b05ad098 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-pesquisa /* Pesquisa Cliente */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa Cliente */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'C¢digo|Nome Abrev|CNPJ|Raz∆o Social|Contenha' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b01ad098.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01ad098 ).
       RUN set-position IN h_b01ad098 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.25 , 87.00 ) */

       /* Links to SmartBrowser h_b01ad098. */
       RUN add-link IN adm-broker-hdl ( h_b01ad098 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b01ad098 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b02ad098.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b02ad098 ).
       RUN set-position IN h_b02ad098 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.25 , 87.00 ) */

       /* Links to SmartBrowser h_b02ad098. */
       RUN add-link IN adm-broker-hdl ( h_b02ad098 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b02ad098 ,
             h_folder , 'AFTER':U ).
    END. /* Page 2 */
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b03ad098.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b03ad098 ).
       RUN set-position IN h_b03ad098 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.25 , 87.00 ) */

       /* Links to SmartBrowser h_b03ad098. */
       RUN add-link IN adm-broker-hdl ( h_b03ad098 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b03ad098 ,
             h_folder , 'AFTER':U ).
    END. /* Page 3 */
    WHEN 4 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b04ad098.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b04ad098 ).
       RUN set-position IN h_b04ad098 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.25 , 87.14 ) */

       /* Links to SmartBrowser h_b04ad098. */
       RUN add-link IN adm-broker-hdl ( h_b04ad098 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b04ad098 ,
             h_folder , 'AFTER':U ).
    END. /* Page 4 */
    WHEN 5 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b05ad098.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b05ad098 ).
       RUN set-position IN h_b05ad098 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.25 , 87.14 ) */

       /* Links to SmartBrowser h_b05ad098. */
       RUN add-link IN adm-broker-hdl ( h_b05ad098 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b05ad098 ,
             h_folder , 'AFTER':U ).
    END. /* Page 5 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "Z01AD098" "2.04.00.000"}
