...
DEFINE VARIABLE h_b01es088 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 13.17 COL 1.57
     bt-ok AT ROW 14.58 COL 3
     bt-cancela AT ROW 14.58 COL 14
     bt-ajuda AT ROW 14.58 COL 73
     rt-button AT ROW 14.33 COL 2
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b01es088.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01es088 ).
       RUN set-position IN h_b01es088 ( 2.50 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_b01es088. */
       RUN add-link IN adm-broker-hdl ( h_b01es088 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b01es088 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
