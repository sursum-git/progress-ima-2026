/*******************************************************************************
    ...
    Description:    Illustrates how to interact Progress reporting requirements
                    with PDFinclude
    ...
    History:        G Campbell - Updated Aug 26, 2003
                    ...
                    Added Code to illustrate how Bookmarks work.
...
RUN pdf_new  IN h_PDFinc ("Spdf","\gord\pdfinclude\samples\persistent\custlist.pdf").
...
FOR EACH customer WHERE NAME BEGINS "A" NO-LOCK 
  ...
  RUN pdf_link IN h_PDFinc 
               ("Spdf",
                ...
                "http://www.epro-sys.com/scripts/cgiip.exe/WService=sports2000/custorderspdf.p?CustNum=" + STRING(Customer.CustNum),
                0,
                0,
                0,
                1,
  ...
  */
  ...
  RUN pdf_set_font IN h_PDFinc ("Spdf","Code39",10.0).
  ...
  FOR EACH Order WHERE Order.CustNum = Customer.CustNum NO-LOCK:
    ...
    RUN pdf_bookmark IN h_PDFinc ("Spdf", Order.OrderNum, vCustBook, FALSE, OUTPUT vNullBook).
...
------------------------------------------------------------------------------*/
  ...
  RUN pdf_skip IN h_PDFinc ("Spdf").
  RUN pdf_skip IN h_PDFinc ("Spdf").
  RUN pdf_text_to IN h_PDFinc ("Spdf",  "Page: " 
