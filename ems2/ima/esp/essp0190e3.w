...
*******************************************************************************/
{include/i-prgvrs.i ESSP0190E3 2.04.00.000}
...
&GLOBAL-DEFINE SORTBY-PHRASE BY IF sort-col = 1 ~
                                 THEN STRING(tt-work.cod-emit, ">>>,>>9") ~
                                ELSE IF sort-col = 2 ~
                                     THEN tt-work.nome-abrev ~
                                    ELSE IF sort-col = 3 ~
                                         THEN tt-work.und + STRING(tt-work.cod-emit, ">>>,>>9") ~
                                        ELSE IF sort-col = 4 ~
...
&GLOBAL-DEFINE SORTBY-IMP-EXCEL BY IF sort-col = 1 ~
                                 THEN STRING(b-tt-work.cod-emit, ">>>,>>9") ~
                                ELSE IF sort-col = 2 ~
                                     THEN b-tt-work.nome-abrev ~
                                    ELSE IF sort-col = 3 ~
                                         THEN b-tt-work.und + STRING(b-tt-work.cod-emit, ">>>,>>9") ~
                                        ELSE IF sort-col = 4 ~
...
&Scoped-define FIELDS-IN-QUERY-br-work tt-work.cod-emit tt-work.nome-abrev tt-work.und tt-work.qtd tt-work.vlr tt-work.desc-pratic tt-work.preco-medio tt-work.qtd-devol tt-work.vlr-devol   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-work tt-work.cod-emit   tt-work.nome-abrev   tt-work.und   tt-work.qtd   tt-work.vlr   tt-work.desc-pratic   tt-work.preco-medio   tt-work.qtd-devol   tt-work.vlr-devol   
...
&Scoped-Define DISPLAYED-OBJECTS fi-media-m fi-tot-qtd-dev-m ~
fi-tot-vlr-dev-m fi-tot-desc-m fi-tot-qtd-m fi-tot-vlr-m fi-media-kg ~
fi-tot-qtd-dev-kg fi-tot-vlr-dev-kg fi-tot-qtd-kg fi-tot-vlr-kg ~
fi-tot-desc-kg fi-media-und fi-tot-qtd-dev-und fi-tot-vlr-dev-und ~
fi-tot-desc-und fi-tot-qtd-und fi-tot-vlr-und fi-ger-vlr-dev fi-tot-geral 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-work D-Dialog _FREEFORM
  QUERY br-work NO-LOCK DISPLAY
      ...
      tt-work.nome-abrev      COLUMN-LABEL "Nome do Cliente"      FORMAT "x(40)"              WIDTH 36.2
...
DEFINE FRAME D-Dialog
     ...
     bt-vapara AT ROW 1.38 COL 111.86
     bt-excel AT ROW 2.92 COL 111.86
     bt-imprime AT ROW 4.5 COL 111.86
     fi-media-m AT ROW 13.08 COL 70.57 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-dev-m AT ROW 13.08 COL 82.43 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-dev-m AT ROW 13.08 COL 93.86 COLON-ALIGNED NO-LABEL
     fi-tot-desc-m AT ROW 13.13 COL 58.57 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     fi-tot-qtd-m AT ROW 13.17 COL 34.14 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-m AT ROW 13.17 COL 46.29 COLON-ALIGNED NO-LABEL
     fi-media-kg AT ROW 14.08 COL 70.57 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-dev-kg AT ROW 14.08 COL 82.43 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-dev-kg AT ROW 14.08 COL 93.86 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-kg AT ROW 14.17 COL 34.14 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-kg AT ROW 14.17 COL 46.29 COLON-ALIGNED NO-LABEL
     ...
     fi-tot-qtd-dev-und AT ROW 15.08 COL 82.43 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-dev-und AT ROW 15.08 COL 93.86 COLON-ALIGNED NO-LABEL
     fi-tot-desc-und AT ROW 15.13 COL 58.72 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     fi-tot-qtd-und AT ROW 15.17 COL 34.14 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-und AT ROW 15.17 COL 46.29 COLON-ALIGNED NO-LABEL
     fi-ger-vlr-dev AT ROW 16.08 COL 93.86 COLON-ALIGNED NO-LABEL
     fi-tot-geral AT ROW 16.17 COL 46.29 COLON-ALIGNED NO-LABEL
     bt-exit AT ROW 16.83 COL 111.86
     bt-ok AT ROW 17.42 COL 2.57
     bt-cancela AT ROW 17.42 COL 13.57
     bt-ajuda AT ROW 17.42 COL 100.43
     "TOTAIS:" VIEW-AS TEXT
          SIZE 6.72 BY .88 AT ROW 13.25 COL 26.29
          FONT 0
     "UND" VIEW-AS TEXT
          SIZE 3.29 BY .54 AT ROW 15.25 COL 32.43
          FGCOLOR 12 
     "KG" VIEW-AS TEXT
          SIZE 2 BY .54 AT ROW 14.38 COL 33.57
          FGCOLOR 12 
     "TOTAL GERAL:" VIEW-AS TEXT
          SIZE 11.29 BY .71 AT ROW 16.25 COL 36.57
          FGCOLOR 4 
     "M" VIEW-AS TEXT
          SIZE 1.57 BY .54 AT ROW 13.42 COL 34.29
          FGCOLOR 12 
     RECT-1 AT ROW 1.17 COL 111.29
     rt-buttom AT ROW 17.17 COL 1.57
     SPACE(7.42) SKIP(0.15)
...
DO:
   ...
   IF c-codigo <> "" THEN DO:
      FIND FIRST tt-work WHERE
                 tt-work.cod-emit = INT(c-codigo) NO-LOCK NO-ERROR.
...
/* ***************************  Main Block  *************************** */
 ASSIGN FRAME d-dialog:TITLE = "Totais Dos Clientes  -  ESSP0190E3".

 tt-work.cod-emit:READ-ONLY IN BROWSE br-work     = YES.
 tt-work.nome-abrev:READ-ONLY IN BROWSE br-work   = YES.
...
------------------------------------------------------------------------------*/
  DISPLAY fi-media-m fi-tot-qtd-dev-m fi-tot-vlr-dev-m fi-tot-desc-m 
          fi-tot-qtd-m fi-tot-vlr-m fi-media-kg fi-tot-qtd-dev-kg 
          fi-tot-vlr-dev-kg fi-tot-qtd-kg fi-tot-vlr-kg fi-tot-desc-kg 
          fi-media-und fi-tot-qtd-dev-und fi-tot-vlr-dev-und fi-tot-desc-und 
          fi-tot-qtd-und fi-tot-vlr-und fi-ger-vlr-dev fi-tot-geral 
      WITH FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
    ...
    PUT "CODIGO  NOME DO CLIENTE                          UND    QUANTIDADE          VALOR    DESC PRATIC   PRECO MEDIO  QTD DEVOLUÄ«O  VLR DEVOLUÄ«O" AT 1.
    PUT "------  ---------------------------------------  ---  ------------   ------------   ------------   -----------  -------------  -------------" AT 1.
  ...
  DO i-ct = 1 TO i-num-copias.
     ...
     FOR EACH b-tt-work NO-LOCK {&SORTBY-IMP-EXCEL}.
         IF i-lin > 62 THEN DO:
            ...
            ASSIGN i-lin = 7.
         END.
         PUT b-tt-work.cod-emit     FORMAT ">>>>>9"         AT   1
             b-tt-work.nome-abrev   FORMAT "x(40)"          AT   9 
     ...
     PUT (fi-tot-vlr-m +
         ...
         (fi-tot-vlr-dev-m  +
          ...
          fi-tot-vlr-dev-und)  FORMAT "->,>>>,>>9.99"  AT 113.
...
------------------------------------------------------------------------------*/
 ...
 chWorkSheet = chExcelapp:Sheets:ITEM(1).
 chWorkSheet:NAME = "Faturamento Por Cliente".
 ...
 ASSIGN chworksheet:range("A3"):VALUE = "CODIGO"
        chworksheet:range("B3"):VALUE = "NOME DO CLIENTE"    
        ...
        chworksheet:range("I3"):VALUE = "VLR DEVOLUÄ«O". 
 ...
 chWorkSheet:Range("A3:H3"):SELECT().
...
FOR EACH b-tt-work NO-LOCK {&SORTBY-IMP-EXCEL}.
    ASSIGN chworksheet:range("A" + STRING(i-lin)):VALUE = b-tt-work.cod-emit
           chworksheet:range("B" + STRING(i-lin)):VALUE = b-tt-work.nome-abrev
...
IF i-lin <> 4 THEN DO:
   ...
   ASSIGN chworksheet:range("E" + STRING(i-lin)):VALUE = fi-tot-vlr-m + fi-tot-vlr-kg + fi-tot-vlr-und     
          chworksheet:range("H" + STRING(i-lin)):VALUE = fi-tot-vlr-dev-m + fi-tot-vlr-dev-kg + fi-tot-vlr-dev-und.  
...
ASSIGN FRAME {&FRAME-NAME}:VISIBLE = NO.
 ...
 FOR EACH tt-trab WHERE
     tt-trab.nome-abrev <> "" AND
     tt-trab.uf         = "ZZ" NO-LOCK.
     FIND emitente WHERE
          emitente.nome-abrev = tt-trab.nome-abrev NO-LOCK NO-ERROR. 
     CREATE tt-work.
     ASSIGN tt-work.cod-emit    = emitente.cod-emit
            tt-work.nome-abrev  = emitente.nome-emit
