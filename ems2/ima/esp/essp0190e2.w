...
*******************************************************************************/
{include/i-prgvrs.i ESSP0190E2 2.04.00.000}
...
&GLOBAL-DEFINE SORTBY-PHRASE BY IF sort-col = 1 ~
                                 THEN STRING(tt-work.matriz) ~
                                ELSE IF sort-col = 2 ~
                                     THEN tt-work.und + string(tt-work.matriz) ~
                                    ELSE IF sort-col = 3 ~
...
&GLOBAL-DEFINE SORTBY-IMP-EXCEL BY IF sort-col = 1 ~
                                    THEN string(b-tt-work.matriz) ~
                                   ELSE IF sort-col = 2 ~
                                        THEN b-tt-work.und + string(b-tt-work.matriz) ~
                                       ELSE IF sort-col = 3 ~
...
&Scoped-define FIELDS-IN-QUERY-br-work tt-work.matriz tt-work.und tt-work.qtd tt-work.vlr tt-work.desc-pratic tt-work.preco-medio tt-work.qtd-devol tt-work.vlr-devol   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-work tt-work.matriz   tt-work.und   tt-work.qtd   tt-work.vlr   tt-work.desc-pratic   tt-work.preco-medio   tt-work.qtd-devol   tt-work.vlr-devol   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-work D-Dialog _FREEFORM
  QUERY br-work NO-LOCK DISPLAY
      tt-work.matriz          COLUMN-LABEL "Aliquota ICM"         FORMAT ">>9.99"              WIDTH 43.1
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 120.29 BY 11.92
         FONT 1
...
DEFINE FRAME D-Dialog
     br-work AT ROW 1.08 COL 1.14
     bt-vapara AT ROW 1.38 COL 122.43
     bt-excel AT ROW 2.92 COL 122.43
     bt-imprime AT ROW 4.5 COL 122.43
     ...
     fi-tot-desc-m AT ROW 13.08 COL 69.86 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     fi-media-m AT ROW 13.08 COL 81.14 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-dev-m AT ROW 13.08 COL 93 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-dev-m AT ROW 13.08 COL 104.29 COLON-ALIGNED NO-LABEL
     ...
     fi-tot-desc-kg AT ROW 14.08 COL 69.86 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     fi-media-kg AT ROW 14.08 COL 81.14 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-dev-kg AT ROW 14.08 COL 93 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-dev-kg AT ROW 14.08 COL 104.29 COLON-ALIGNED NO-LABEL
     ...
     fi-tot-desc-und AT ROW 15.08 COL 69.86 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     fi-media-und AT ROW 15.08 COL 81.14 COLON-ALIGNED NO-LABEL
     fi-tot-qtd-dev-und AT ROW 15.08 COL 93 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi-tot-vlr-dev-und AT ROW 15.08 COL 104.29 COLON-ALIGNED NO-LABEL
     fi-tot-geral AT ROW 16.25 COL 57.86 COLON-ALIGNED NO-LABEL
     fi-ger-vlr-dev AT ROW 16.25 COL 104.29 COLON-ALIGNED NO-LABEL
     bt-exit AT ROW 16.83 COL 122.43
     bt-ok AT ROW 17.42 COL 2.57
     bt-cancela AT ROW 17.42 COL 13.57
     bt-ajuda AT ROW 17.42 COL 110
     "KG" VIEW-AS TEXT
     ...
     "TOTAL GERAL:" VIEW-AS TEXT
          SIZE 11.29 BY .71 AT ROW 16.33 COL 48.14
          FGCOLOR 4 
     "TOTAIS:" VIEW-AS TEXT
          SIZE 6.72 BY .88 AT ROW 13.17 COL 37.86
          FONT 0
     RECT-1 AT ROW 1.17 COL 121.86
     rt-buttom AT ROW 17.17 COL 1.57
     SPACE(8.13) SKIP(0.07)
...
/* ***************************  Main Block  *************************** */
 ASSIGN FRAME d-dialog:TITLE = "Totais Dos Grupos de Clientes  -  ESSP0190E2".

 tt-work.matriz:READ-ONLY IN BROWSE br-work       = YES.
...
------------------------------------------------------------------------------*/
    ...
    PUT "GRUPOS DE CLIENTES                               UND    QUANTIDADE          VALOR    DESC PRATIC   PRECO MEDIO  QTD DEVOLUÄ«O  VLR DEVOLUÄ«O" AT 1.
    PUT "-----------------------------------------------  ---  ------------   ------------   ------------   -----------   ------------   ------------" AT 1.
  ...
  DO i-ct = 1 TO i-num-copias.
     ...
     FOR EACH b-tt-work NO-LOCK {&SORTBY-IMP-EXCEL}.
         IF i-lin > 62 THEN DO:
            ...
            ASSIGN i-lin = 7.
         END.
         PUT b-tt-work.matriz       FORMAT "x(40)"          AT   1 
     ...
     PUT (fi-tot-vlr-und / 
          fi-tot-qtd-und)   FORMAT "->>>,>>9.99"   AT  85
         fi-tot-qtd-dev-und FORMAT "->,>>>,>>9.99" AT  98
...
------------------------------------------------------------------------------*/
 ...
 /* Titulo das Colunas */
 ASSIGN chworksheet:range("A3"):VALUE = "GRUPOS DE CLIENTES"
        ...
        chworksheet:range("H3"):VALUE = "VALOR DEVOLUÄ«O". 
...
IF i-lin <> 4 THEN DO:
   ...
   ASSIGN chworksheet:range("C" + STRING(i-lin)):VALUE = fi-tot-qtd-kg     
          ...
          chworksheet:range("G" + STRING(i-lin)):VALUE = fi-tot-qtd-dev-kg
          chworksheet:range("H" + STRING(i-lin)):VALUE = fi-tot-vlr-dev-kg.
   ...
   ASSIGN chworksheet:range("C" + STRING(i-lin)):VALUE = fi-tot-qtd-und     
          ...
          chworksheet:range("G" + STRING(i-lin)):VALUE = fi-tot-qtd-dev-und
          chworksheet:range("H" + STRING(i-lin)):VALUE = fi-tot-vlr-dev-und.
...
FOR EACH tt-trab WHERE
     tt-trab.matriz <> 0 AND
     tt-trab.uf      = "ZZ" NO-LOCK.
     CREATE tt-work.
     ASSIGN tt-work.matriz      = tt-trab.matriz
