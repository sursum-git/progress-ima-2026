...
PROCEDURE pi-envio-email-erro:

DEFINE INPUT  PARAMETER pErro AS CHARACTER   NO-UNDO.

    CREATE tt-mensagem.
    ASSIGN tt-mensagem.seq-mensagem =  10
           tt-mensagem.mensagem     = pErro.    
    RUN esapi/EnviarEmail.p(getEmailErroIntegrPedPortal(),
                            'espd001@imatextil.com.br',
                             'Erro de Integraá∆o - Pedido Corrente:' + STRING(nrPedidoCorrente),
                             '',
                             TABLE tt-mensagem
                            ).
