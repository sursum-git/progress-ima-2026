...
*******************************************************************************/
{include/i-prgvrs.i Z01ES049 2.04.00.000}
...
DEFINE VARIABLE h_b05es049 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-ok AT ROW 17.42 COL 3
     bt-cancela AT ROW 17.42 COL 14
     bt-ajuda AT ROW 17.42 COL 79
     rt-button AT ROW 17.17 COL 2
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Etiqueta */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Etiqueta */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_folder ( 15.83 , 88.57 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b05es049.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b05es049 ).
       RUN set-position IN h_b05es049 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 14.25 , 87.00 ) */

       /* Links to SmartBrowser h_b05es049. */
       RUN add-link IN adm-broker-hdl ( h_b05es049 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b05es049 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "Z01ES049" "2.04.00.000"}
