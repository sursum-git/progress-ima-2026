...
*******************************************************************************/
{include/i-prgvrs.i ESSP0184 2.04.00.000}
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-consim ASSIGN
         HIDDEN             = YES
         TITLE              = "Consulta Itens - Dados Complementares"
         HEIGHT             = 8.13
         WIDTH              = 90
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 90
...
ON END-ERROR OF w-consim /* Consulta Itens - Dados Complementares */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-consim w-consim
ON WINDOW-CLOSE OF w-consim /* Consulta Itens - Dados Complementares */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-parametro w-consim
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v01in172 ).
       RUN set-position IN h_v01in172 ( 3.00 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = inzoom/z01in172.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01in172 ).
       RUN set-position IN h_q01in172 ( 1.50 , 63.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0184" "2.04.00.000"}
