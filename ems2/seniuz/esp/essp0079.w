...
*******************************************************************************/
{include/i-prgvrs.i ESSP0079 2.04.00.000}
...
DEFINE VARIABLE fi-fin-ssist-exec AS CHARACTER FORMAT "!!999" INITIAL "ZZ999" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 TOOLTIP "Sub-sistema final" NO-UNDO.
...
DEFINE VARIABLE fi-ini-ssist-exec AS CHARACTER FORMAT "!!999" INITIAL "AA000" 
     LABEL "Subsistema" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 TOOLTIP "Sub-sistema inicial" NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Incidˆncia de Manuten‡Æo por M quina"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Incidˆncia de Manuten‡Æo por M quina */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Incidˆncia de Manuten‡Æo por M quina */
DO:
...
{utp/ut9000.i "ESSP0079" "2.04.00.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/essp0079rp.p}
