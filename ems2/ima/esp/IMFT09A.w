...
/*------------------------------------------------------------------------
File.............: imft09a.w
Description......: Pre‡os dos produtos faturados
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 15/07/05 - 18:18 - super
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "IMFT09A".
...
DEFINE FRAME f-pg-sel
   ...
   c-no-ab-reppri-ini label "Representante"
     at row 5 col 20 colon-aligned
     view-as fill-in 
     size 13 by .88
     font 1

   c-no-ab-reppri-fim no-label
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Pre‡os dos produtos faturados - imft09a"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "imft09a".
...
PROCEDURE enable_UI :
   ...
   c-no-ab-reppri-ini c-no-ab-reppri-fim
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "imft09a" + ".tmp".
    ...
    assign tt-param.da-dt-emis-nota-ini = input frame f-pg-sel da-dt-emis-nota-ini
           ...
           tt-param.c-no-ab-reppri-ini = input frame f-pg-sel c-no-ab-reppri-ini
           tt-param.c-no-ab-reppri-fim = input frame f-pg-sel c-no-ab-reppri-fim
.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "ftp/imft091.p".
