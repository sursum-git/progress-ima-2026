...
IMAGE-97 RECT-1 RECT-49 fi-cod-estabel fi-dt-limite fi-nr-pedcli-ini ~
fi-nr-pedcli-fin fi-nome-abrev-ini fi-nome-abrev-fin fi-no-ab-reppri-ini ~
fi-no-ab-reppri-fin fi-it-codigo-ini fi-it-codigo-fin fi-cod-refer-ini ~
fi-cod-refer-fin tg-lote-todos rs-opc-artigo bt-ok bt-cancelar bt-ajuda 
...
------------------------------------------------------------------------------*/
  ...
  ENABLE IMAGE-106 IMAGE-107 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-51 IMAGE-52 IMAGE-73 
         ...
         fi-cod-estabel fi-dt-limite fi-nr-pedcli-ini fi-nr-pedcli-fin 
         fi-nome-abrev-ini fi-nome-abrev-fin fi-no-ab-reppri-ini 
         fi-no-ab-reppri-fin fi-it-codigo-ini fi-it-codigo-fin fi-cod-refer-ini 
         fi-cod-refer-fin tg-lote-todos rs-opc-artigo bt-ok bt-cancelar 
         bt-ajuda 
      WITH FRAME F-Main IN WINDOW w-window.
