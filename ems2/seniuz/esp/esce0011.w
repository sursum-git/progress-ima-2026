...
*******************************************************************************/
{include/i-prgvrs.i ESCE0011 2.04.00.000}
...
DEFINE VARIABLE fi-ini-fm-codigo LIKE familia.fm-codigo
     VIEW-AS FILL-IN 
     SIZE 12.14 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     ...
     fi-ini-fm-codigo AT ROW 2.79 COL 18 COLON-ALIGNED
     fi-fim-fm-codigo AT ROW 2.79 COL 42.86 COLON-ALIGNED HELP
          "C¢digo da Fam°lia de Material" NO-LABEL
     tg-impr-param AT ROW 7.63 COL 28
     IMAGE-1 AT ROW 2.79 COL 33.14
     IMAGE-2 AT ROW 2.79 COL 40.72
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Estoque Dispon°vel por Familia"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR FILL-IN fi-ini-fm-codigo IN FRAME f-pg-sel
   LIKE = mgind.familia.fm-codigo EXP-SIZE                              */
...
ON END-ERROR OF w-relat /* Estoque Dispon°vel por Familia */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Estoque Dispon°vel por Familia */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-fim-fm-codigo w-relat
ON MOUSE-SELECT-DBLCLICK OF fi-fim-fm-codigo IN FRAME f-pg-sel
DO:
...
{utp/ut9000.i "ESCE0011" "2.04.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    fi-fim-fm-codigo:LOAD-MOUSE-POINTER("image/lupa.cur") IN FRAME f-pg-sel.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-cod-estabel fi-nome-estabel fi-ini-fm-codigo fi-fim-fm-codigo 
          tg-impr-param 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-cod-estabel fi-ini-fm-codigo fi-fim-fm-codigo tg-impr-param IMAGE-1 
         IMAGE-2 RECT-16 RECT-27 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.cod-estabel = INPUT FRAME f-pg-sel fi-cod-estabel
           tt-param.c-fam-ini   = INPUT FRAME f-pg-sel fi-ini-fm-codigo
           tt-param.c-fam-fim   = INPUT FRAME f-pg-sel fi-fim-fm-codigo
    ...
    {include/i-rprun.i esrp/esce0011rp.p} 
