...
/* PRD */
DEF VAR c-arq-dump  AS CHAR INIT "/dados/totvs/datasul/dump".
DEF VAR c-arq-load  AS CHAR INIT "/dados/totvs/datasul/dump".
DEF VAR c-temp-dump AS CHAR INIT "c:\temp\dump\gera-dump-".
DEF VAR c-temp-load AS CHAR INIT "c:\temp\dump\gera-load-".

/*
====> Para os bancos emsdev, finance, mdmerge, mdtfrw e payroll sÆo SQL -> o dump ‚ feito por outro processo.
*/
