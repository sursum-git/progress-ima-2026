...
DEFINE VARIABLE h_q01estabel-aux AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v01estabel-aux AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esvwr/v01estabel-aux.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v01estabel-aux ).
       RUN set-position IN h_v01estabel-aux ( 2.75 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 11.75 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esqry/q01estabel-aux.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q01estabel-aux ).
       RUN set-position IN h_q01estabel-aux ( 1.25 , 60.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_v01estabel-aux. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_v01estabel-aux ).
       RUN add-link IN adm-broker-hdl ( h_q01estabel-aux , 'Record':U , h_v01estabel-aux ).

       /* Links to SmartQuery h_q01estabel-aux. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_q01estabel-aux ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_q01estabel-aux ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_q01estabel-aux ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v01estabel-aux ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
