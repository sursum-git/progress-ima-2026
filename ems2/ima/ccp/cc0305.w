...
DEFINE VARIABLE fi-fim-comprador AS CHARACTER FORMAT "X(12)":U INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-ini-comprador AS CHARACTER FORMAT "X(12)":U 
     LABEL "Comprador" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     fi-ini-num-pedido AT ROW 1.96 COL 16 COLON-ALIGNED
     fi-fim-num-pedido AT ROW 1.96 COL 45.14 COLON-ALIGNED NO-LABEL
     fi-ini-comprador AT ROW 2.96 COL 16 COLON-ALIGNED
     fi-fim-comprador AT ROW 2.96 COL 45 COLON-ALIGNED NO-LABEL
     IMAGE-5 AT ROW 1.96 COL 31.72
     IMAGE-6 AT ROW 1.96 COL 43.57
     IMAGE-7 AT ROW 2.96 COL 31.72
     IMAGE-8 AT ROW 2.96 COL 43.57
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
DEFINE FRAME f-pg-par
     ...
     tg-nar-itordem AT ROW 2.17 COL 3.29
     tg-descricao AT ROW 3.08 COL 3.29
     tg-email AT ROW 4 COL 3.29
     fi-assunto AT ROW 6.08 COL 11.72 COLON-ALIGNED
     fi-texto AT ROW 7.13 COL 13.72 NO-LABEL
     "Texto:" VIEW-AS TEXT
          SIZE 4.29 BY .75 AT ROW 7.13 COL 9
     " Dados da Mensagem" VIEW-AS TEXT
          SIZE 16 BY .75 AT ROW 5.29 COL 5.43
     RECT-13 AT ROW 5.63 COL 3.29
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 76.57 BY 10.54
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Emiss∆o de Pedido de Compras"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
/* SETTINGS FOR FILL-IN fi-assunto IN FRAME f-pg-par
   NO-DISPLAY NO-ENABLE                                                 */
/* SETTINGS FOR EDITOR fi-texto IN FRAME f-pg-par
   NO-ENABLE                                                            */
...
ON END-ERROR OF w-relat /* Emiss∆o de Pedido de Compras */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Emiss∆o de Pedido de Compras */
DO:
...
&Scoped-define SELF-NAME fi-ini-num-pedido
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-ini-num-pedido w-relat
ON LEAVE OF fi-ini-num-pedido IN FRAME f-pg-sel /* Pedido */
DO:
    
    ASSIGN fi-fim-num-pedido:SCREEN-VALUE IN FRAME f-pg-sel = INPUT FRAME f-pg-sel fi-ini-num-pedido.
END.
...
DO:
  IF INPUT FRAME {&frame-name} tg-email = YES THEN DO.
     ASSIGN fi-assunto:SENSITIVE IN FRAME f-pg-par = YES 
            fi-texto:SENSITIVE IN FRAME f-pg-par = YES.

     ASSIGN fi-assunto:SCREEN-VALUE IN FRAME f-pg-par = "Confirmaá∆o de Compra".

     ASSIGN fi-texto:SCREEN-VALUE IN FRAME f-pg-par = "Segue anexo Confirmaá∆o do Pedido de Compra #PED." +
                                                      CHR(13) + CHR(13) + "Atenciosamente," + CHR(13) + CHR(13) +
                                                      "IMA TECIDOS DA MODA LTDA" + CHR(13) + 
                                                      "#COMP" + CHR(13) + "DEPTO. COMPRAS" + CHR(13) +
                                                      "#FONE". 
     ...
     ASSIGN c-arquivo:SCREEN-VALUE IN FRAME f-pg-imp = "PDF995:Padr∆o_172_R".
     APPLY 'mouse-select-click' TO im-pg-par.

  END.
  ELSE DO.
     ASSIGN fi-assunto:SENSITIVE IN FRAME f-pg-par = NO 
            fi-texto:SENSITIVE IN FRAME f-pg-par = NO.

     ASSIGN fi-assunto:SCREEN-VALUE IN FRAME f-pg-par = ""
            fi-texto:SCREEN-VALUE IN FRAME f-pg-par = "".
  END.
END.
...
{utp/ut9000.i "CC0305" "2.04.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-ini-num-pedido fi-fim-num-pedido fi-ini-comprador fi-fim-comprador 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 fi-ini-num-pedido fi-fim-num-pedido 
         fi-ini-comprador fi-fim-comprador 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY tg-narrat-ordem tg-nar-itordem tg-descricao tg-email fi-texto 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-13 tg-narrat-ordem tg-nar-itordem tg-descricao tg-email 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.pedido-ini      = INPUT FRAME f-pg-sel fi-ini-num-pedido
           tt-param.pedido-fin      = INPUT FRAME f-pg-sel fi-fim-num-pedido
           tt-param.comprador-ini   = INPUT FRAME f-pg-sel fi-ini-comprador
           tt-param.comprador-fim   = INPUT FRAME f-pg-sel fi-fim-comprador
           tt-param.e-mail          = INPUT FRAME f-pg-par tg-email
           tt-param.subject         = INPUT FRAME f-pg-par fi-assunto
           tt-param.texto           = INPUT FRAME f-pg-par fi-texto
           tt-param.tg-descricao    = INPUT FRAME f-pg-par tg-descricao    
           tt-param.tg-nar-itordem  = INPUT FRAME f-pg-par tg-nar-itordem  
           tt-param.tg-narrat-ordem = INPUT FRAME f-pg-par tg-narrat-ordem 
