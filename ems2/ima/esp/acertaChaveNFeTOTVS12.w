...
finrNotaFisc fiChave btAtualizar bt-ok bt-cancelar bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS fiCodEstabel fiserie finrNotaFisc fiChave 
...
DEFINE FRAME F-Main
     ...
     fiChave AT ROW 3.75 COL 7 COLON-ALIGNED WIDGET-ID 14
     btAtualizar AT ROW 5.25 COL 9 WIDGET-ID 12
     bt-ok AT ROW 6.96 COL 2
     bt-cancelar AT ROW 6.96 COL 13
     bt-ajuda AT ROW 6.96 COL 68
...
DO:
  ...
  IF AVAIL nota-fiscal THEN DO:
     ASSIGN nota-fiscal.cod-chave-aces-nf-eletro = fichave:SCREEN-VALUE .
...
DO:
  ...
  IF AVAIL nota-fiscal THEN DO:
     ASSIGN fiChave:SCREEN-VALUE = cod-chave-aces-nf-eletro.
  END.
  ELSE
...
------------------------------------------------------------------------------*/
  DISPLAY fiCodEstabel fiserie finrNotaFisc fiChave 
      WITH FRAME F-Main IN WINDOW w-window.
  ENABLE RECT-1 btBuscar fiCodEstabel fiserie finrNotaFisc fiChave btAtualizar 
