...
DEF TEMP-TABLE tt_peds_web LIKE peds_web
    ...
    FIELD log-aprov-workflow AS LOG.
...
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-itens itens_ped_web.qt_pedida   
&Scoped-define ENABLED-TABLES-IN-QUERY-br-itens itens_ped_web
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-br-itens itens_ped_web
...
&Scoped-define FIELDS-IN-QUERY-br-pedidos-web tt_peds_web.cod_estab tt_peds_web.ped_web_id tt_peds_web.nome-rep tt_peds_web.dt_hr_registro tt_peds_web.cod_tipo_pedido tt_peds_web.nr_pedido_erp tt_peds_web.nome-abrev tt_peds_web.desc-situacao tt_peds_web.nr_container //tt-ped-venda.desc-cond-pag   
...
&Scoped-define QUERY-STRING-br-pedidos-web FOR EACH tt_peds_web WHERE                                  tt_peds_web.dt_hr_registro >= da-dt-trans-ini AND                                  tt_peds_web.dt_hr_registro <= da-dt-trans-fin AND                                  LOOKUP(STRING(tt_peds_web.ind_sit_ped_web), ~
      c-sit-web) > 0 AND                                  (tt_peds_web.log-aprov-workflow = rs-sit-com OR rs-sit-com = ?)                                  NO-LOCK BY tt_peds_web.ind_sit_ped_web DESCENDING BY tt_peds_web.ped_web_id
...
IMAGE-89 IMAGE-96 IMAGE-97 RECT-75 RECT-76 fi-dt-trans-ini fi-dt-trans-fin ~
bt-sel rs-sit-com tg-digita tg-integrado tg-efetivado tg-rejeitado ~
cb-tp-pedido tg-cancelado tg-vencido br-pedidos-web bt-modifica bt-efetiva ~
bt-log bt-status FILL-IN-6 FILL-IN-8 FILL-IN-3 FILL-IN-10 FILL-IN-2 ~
FILL-IN-9 FILL-IN-11 FILL-IN-12 FILL-IN-15 FILL-IN-16 FILL-IN-13 FILL-IN-14 ~
br-itens ed-descr-rejeicao bt-mod-seq bt-ajuda bt-ok 
...
FILL-IN-16 FILL-IN-13 FILL-IN-14 ed-descr-rejeicao fi-vl-tot-ped 
...
DEFINE BUTTON bt-can-seq AUTO-GO 
     IMAGE-UP FILE "image/im-cance.bmp":U
     LABEL "" 
     SIZE 5.86 BY 1.29 TOOLTIP "Cancelar Sequencia"
     BGCOLOR 8 FONT 10.
...
DEFINE BUTTON bt-efetiva AUTO-GO 
     IMAGE-UP FILE "image/im-reini.bmp":U
     LABEL "" 
     SIZE 5.86 BY 1.29 TOOLTIP "Reativa o Pedido"
     BGCOLOR 8 FONT 10.
...
DEFINE BUTTON bt-mod-seq 
     IMAGE-UP FILE "image/im-mod.bmp":U
     LABEL "&Sair" 
     SIZE 5.86 BY 1.29 TOOLTIP "Modificar Sequencia"
     BGCOLOR 8 FONT 10.
...
DEFINE BUTTON bt-status 
     ...
     LABEL "" 
     SIZE 5.86 BY 2.08 TOOLTIP "Status do Pedido / Confirma Pedido"
     BGCOLOR 8 FONT 10.
...
DEFINE VARIABLE ed-descr-rejeicao AS CHARACTER 
...
DEFINE VARIABLE FILL-IN-8 AS CHARACTER FORMAT "X(256)":U INITIAL "em Digitaá∆o" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .79
...
DEFINE VARIABLE tg-digita AS LOGICAL INITIAL yes 
     LABEL "em Digitaá∆o" 
     VIEW-AS TOGGLE-BOX
     SIZE 11.57 BY .83
     FGCOLOR 12  NO-UNDO.

DEFINE VARIABLE tg-efetivado AS LOGICAL INITIAL yes 
     LABEL "Efetivado" 
     VIEW-AS TOGGLE-BOX
     SIZE 11.57 BY .83 NO-UNDO.
...
DEFINE VARIABLE tg-rejeitado AS LOGICAL INITIAL yes 
     LABEL "Rejeitado" 
     VIEW-AS TOGGLE-BOX
     SIZE 9.72 BY .83 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-itens w-digita _FREEFORM
  QUERY br-itens NO-LOCK DISPLAY
      ...
      fn-desc-item() @ c-desc-item    FORMAT "x(30)"            COLUMN-LABEL "Descriá∆o"    WIDTH 36
      itens_ped_web.cod_refer         FORMAT "x(5)"             COLUMN-LABEL "Ref"
      itens_ped_web.qt_pedida         FORMAT ">>,>>9.99"        COLUMN-LABEL "Qtde" 
      fn-preco-item() @ de-vl-preori  FORMAT ">>,>>9.99"        COLUMN-LABEL "Preáo Un"     WIDTH 10
ENABLE 
      itens_ped_web.qt_pedida
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 68 BY 8.25
         FONT 1
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-pedidos-web w-digita _FREEFORM
  QUERY br-pedidos-web NO-LOCK DISPLAY
      tt_peds_web.cod_estab                  FORMAT "x(3)"          COLUMN-LABEL "Est"           COLUMN-FONT 6
      ...
      tt_peds_web.desc-situacao              FORMAT "x(15)"         COLUMN-LABEL "Situaá∆o"      COLUMN-FONT 6  WIDTH  16
...
DEFINE FRAME F-Main
     ...
     tg-integrado AT ROW 2.17 COL 82.14 WIDGET-ID 36
          ...
          "Codigo do ÷tem no EMS" WIDGET-ID 422
     fi-no-ab-reppri-fin AT ROW 2.5 COL 39.57 COLON-ALIGNED HELP
          "Codigo do ÷tem no EMS" NO-LABEL WIDGET-ID 420
     ...
     bt-modifica AT ROW 5.46 COL 103 WIDGET-ID 444
     bt-cancela AT ROW 6.79 COL 103 WIDGET-ID 446
     bt-efetiva AT ROW 8.13 COL 103 WIDGET-ID 454
     bt-log AT ROW 9.46 COL 103 WIDGET-ID 24
     bt-status AT ROW 10.79 COL 103 WIDGET-ID 20
     FILL-IN-6 AT ROW 13.25 COL 1.86 NO-LABEL WIDGET-ID 396
     FILL-IN-8 AT ROW 13.25 COL 2 COLON-ALIGNED NO-LABEL WIDGET-ID 404
     FILL-IN-3 AT ROW 13.25 COL 17.29 NO-LABEL WIDGET-ID 154
     FILL-IN-10 AT ROW 13.25 COL 17.43 COLON-ALIGNED NO-LABEL WIDGET-ID 408
     ...
     ed-descr-rejeicao AT ROW 15.38 COL 71 NO-LABEL WIDGET-ID 448
     bt-mod-seq AT ROW 23 COL 2 WIDGET-ID 462
     bt-can-seq AT ROW 23 COL 8 WIDGET-ID 460
     fi-vl-tot-ped AT ROW 23.25 COL 54 COLON-ALIGNED NO-LABEL WIDGET-ID 16
     bt-ajuda AT ROW 24.67 COL 99.43
     bt-ok AT ROW 24.71 COL 3.14
     "Motivo Rejeiá∆o" VIEW-AS TEXT
          SIZE 14 BY .63 AT ROW 14.63 COL 71.86 WIDGET-ID 450
          FONT 6
     " Situaá∆o WEB" VIEW-AS TEXT
          SIZE 12.14 BY .5 AT ROW 1.5 COL 66.29 WIDGET-ID 114
     "Vlr Total Pedido WEB:" VIEW-AS TEXT
          SIZE 15.29 BY .71 AT ROW 23.33 COL 40.43 WIDGET-ID 442
          FONT 1
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 109.29 BY 25.08
         FONT 1 WIDGET-ID 100.

/* DEFINE FRAME statement is approaching 4K Bytes.  Breaking it up   */
DEFINE FRAME F-Main
     RECT-76 AT ROW 14.46 COL 71 WIDGET-ID 452
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 109.29 BY 25.08
...
/* SETTINGS FOR BUTTON bt-can-seq IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR BUTTON bt-cancela IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
       ed-descr-rejeicao:READ-ONLY IN FRAME F-Main        = TRUE.
...
OPEN QUERY {&SELF-NAME} FOR EACH tt_peds_web WHERE
                                 ...
                                 (tt_peds_web.log-aprov-workflow = rs-sit-com OR rs-sit-com = ?)
                                 NO-LOCK BY tt_peds_web.ind_sit_ped_web DESCENDING BY tt_peds_web.ped_web_id.
     _END_FREEFORM
     _Options          = "NO-LOCK INDEXED-REPOSITION"
...
DO:
   ...
   ASSIGN i-cor = ?.
   IF itens_ped_web.ind_sit_itens_ped_web = 3 THEN
      ASSIGN i-cor = 12.

   ASSIGN itens_ped_web.it_codigo:FGCOLOR IN BROWSE br-itens = i-cor        
          c-desc-item:FGCOLOR = i-cor
          itens_ped_web.cod_refer:FGCOLOR = i-cor
          itens_ped_web.qt_pedida:FGCOLOR = i-cor
          de-vl-preori:FGCOLOR = i-cor.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br-itens w-digita
ON ROW-LEAVE OF br-itens IN FRAME F-Main /* Itens do Pedido */
DO:
  ASSIGN INPUT BROWSE br-itens itens_ped_web.qt_pedida. 
  ASSIGN itens_ped_web.qt_pedida:READ-ONLY IN BROWSE br-itens = YES. 
END.
...
DO:
   ASSIGN bt-can-seq:SENSITIVE = NO
          bt-mod-seq:SENSITIVE = NO.
   IF AVAIL tt_peds_web THEN DO.
     IF tt_peds_web.ind_sit_ped_web = 5 AND 
        itens_ped_web.ind_sit_itens_ped_web <> 3 THEN DO.
        FIND usuar_grp_usuar WHERE 
             usuar_grp_usuar.cod_usuar     = c-seg-usuario AND
             (usuar_grp_usuar.cod_grp_usuar = "SUP" OR
              usuar_grp_usuar.cod_grp_usuar = "ADV") 
             NO-LOCK NO-ERROR.
         IF AVAIL usuar_grp_usuar THEN
            ASSIGN bt-can-seq:SENSITIVE = YES
                   bt-mod-seq:SENSITIVE = YES.
     END.
   END.
END.
...
DO:
  CASE tt_peds_web.ind_sit_ped_web.
      ...
      WHEN 2 OR WHEN 8 THEN ASSIGN i-cor = 2.  /* Verde */
      WHEN 3 THEN ASSIGN i-cor = 16. /* Laranja */
      WHEN 4 OR WHEN 7 THEN ASSIGN i-cor = 9.  /* Azul */ 
      WHEN 5 OR WHEN 9 THEN ASSIGN i-cor = 5.  /* Vinho */ 
      WHEN 6 THEN ASSIGN i-cor = 0.  /* Preto */ 
  END CASE.

  ASSIGN tt_peds_web.cod_estab:FGCOLOR IN BROWSE br-pedidos-web = i-cor
         tt_peds_web.ped_web_id:FGCOLOR IN BROWSE br-pedidos-web = i-cor
...
DO:
   ASSIGN bt-modifica:SENSITIVE = NO
          ...
          bt-efetiva:SENSITIVE = NO.

   ASSIGN ed-descr-rejeicao:SCREEN-VALUE = ''.

   bt-status:LOAD-IMAGE-INSENSITIVE("image/imt-smate.bmp").
   IF AVAIL tt_peds_web THEN DO.
      ASSIGN ed-descr-rejeicao:SCREEN-VALUE = tt_peds_web.descr_rejeicao.

      IF tt_peds_web.ind_sit_ped_web = 5 THEN DO.
         ASSIGN bt-efetiva:SENSITIVE = YES.
         FIND usuar_grp_usuar WHERE 
              usuar_grp_usuar.cod_usuar     = c-seg-usuario AND
              (usuar_grp_usuar.cod_grp_usuar = "SUP" OR
               usuar_grp_usuar.cod_grp_usuar = "ADV") 
...
&Scoped-define SELF-NAME bt-can-seq
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-can-seq w-digita
ON CHOOSE OF bt-can-seq IN FRAME F-Main
DO:
    MESSAGE 'Confirma Cancelamento da Referànciao ' itens_ped_web.cod_refer ' ? '
        VIEW-AS ALERT-BOX QUESTION BUTTONS YES-NO UPDATE l-conf-can-seq AS LOGICAL.

    IF l-conf-can-seq THEN DO.
       FIND CURRENT itens_ped_web SHARE-LOCK NO-ERROR.
       ASSIGN itens_ped_web.ind_sit_itens_ped_web = 3.
       FIND CURRENT itens_ped_web NO-LOCK NO-ERROR.
...
DO:
  ...
  IF tt_peds_web.nr_pedido_erp <> 0 THEN DO.
     MESSAGE 'Pedido j† foi Integrado com o ERP, Cancelamento n∆o Permitido...' SKIP
             'Essa situaá∆o Ç at°pica, Verifique...'
         VIEW-AS ALERT-BOX ERROR BUTTONS OK.
     RETURN NO-APPLY.
  END.

  FIND FIRST ped-venda-ext WHERE
             ped-venda-ext.cod-estab = tt_peds_web.cod_estabel AND
             ped-venda-ext.ped_web_id = tt_peds_web.ped_web_id NO-LOCK NO-ERROR.
  IF AVAIL ped-venda-ext THEN DO.
     MESSAGE 'Pedido j† foi Integrado com o ERP, com o Pedido: ' ped-venda-ext.nr-pedido SKIP
             'Cancelamento n∆o Permitido...' SKIP(1)
             'Essa situaá∆o Ç at°pica, Verifique...'
         VIEW-AS ALERT-BOX ERROR BUTTONS OK.
     RETURN NO-APPLY.
  END.
...
&Scoped-define SELF-NAME bt-efetiva
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-efetiva w-digita
ON CHOOSE OF bt-efetiva IN FRAME F-Main
DO:
   FIND peds_web WHERE
        peds_web.ped_web_id = tt_peds_web.ped_web_id SHARE-LOCK NO-ERROR.
   IF AVAIL peds_web THEN
      ASSIGN peds_web.ind_sit_ped_web = 2.
...
&Scoped-define SELF-NAME bt-mod-seq
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-mod-seq w-digita
ON CHOOSE OF bt-mod-seq IN FRAME F-Main /* Sair */
DO:
   ASSIGN itens_ped_web.qt_pedida:READ-ONLY IN BROWSE br-itens = NO. 
   APPLY 'ENTRY' TO itens_ped_web.qt_pedida IN BROWSE br-itens.
...
DO:
   ...
   FIND FIRST repres WHERE
              repres.nome-abrev = fi-no-ab-reppri-ini NO-LOCK NO-ERROR.
   IF AVAIL repres THEN
      ASSIGN i-cod-reppri-ini = repres.cod-rep.

   FIND FIRST repres WHERE
              repres.nome-abrev = fi-no-ab-reppri-fin NO-LOCK NO-ERROR.
   IF AVAIL repres THEN
      ASSIGN i-cod-reppri-fin = repres.cod-rep.
   ...
   DO i-ct = 1 TO NUM-ENTRIES(c-sit-web).
      RUN pi-popula-ped (INPUT INT(ENTRY(i-ct,c-sit-web))).
   END.
...
DO:
   ...
   ASSIGN ped-venda.completo = NO
          ped-venda.log-aprov-workflow = NO.

   IF ped-venda.tp-pedido = "PE" THEN 
      RUN esapi/completa-pedvenda.p (INPUT ped-venda.nr-pedcli).
   
   IF ped-venda.tp-pedido = 'PI' OR ped-venda.completo THEN
      ASSIGN ped-venda.log-aprov-workflow = YES.

   ASSIGN tt_peds_web.log-aprov-workflow = ped-venda.log-aprov-workflow
          tt_peds_web.ind_sit_ped_web = 7.

   FIND peds_web WHERE
        peds_web.ped_web_id = tt_peds_web.ped_web_id SHARE-LOCK NO-ERROR.
   ASSIGN peds_web.ind_sit_ped_web = 7.
   FIND CURRENT peds_web NO-LOCK NO-ERROR.

   SESSION:SET-WAIT-STATE("":U).

   ASSIGN i-row = CURRENT-RESULT-ROW("br-pedidos-web").

   {&OPEN-QUERY-br-pedidos-web}
   br-pedidos-web:query:REPOSITION-TO-ROW(i-row) NO-ERROR.
   APPLY 'VALUE-CHANGED' TO br-pedidos-web IN FRAME {&FRAME-NAME}.
...
ON VALUE-CHANGED OF tg-digita IN FRAME F-Main /* em Digitaá∆o */
DO:
  RUN pi-monta-sit.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-1 rt-buttom-2 RECT-9 RECT-74 IMAGE-88 IMAGE-89 IMAGE-96 IMAGE-97 
         RECT-75 RECT-76 fi-dt-trans-ini fi-dt-trans-fin bt-sel rs-sit-com 
         tg-digita tg-integrado tg-efetivado tg-rejeitado cb-tp-pedido 
         tg-cancelado tg-vencido br-pedidos-web bt-modifica bt-efetiva bt-log 
         bt-status FILL-IN-6 FILL-IN-8 FILL-IN-3 FILL-IN-10 FILL-IN-2 FILL-IN-9 
         FILL-IN-11 FILL-IN-12 FILL-IN-15 FILL-IN-16 FILL-IN-13 FILL-IN-14 
         br-itens ed-descr-rejeicao bt-mod-seq bt-ajuda bt-ok 
      WITH FRAME F-Main IN WINDOW w-digita.
...
//  {utp/ut9000.i "XX9999" "9.99.99.999"}
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  ASSIGN ed-descr-rejeicao:FONT IN FRAME {&FRAME-NAME} = 6.
  ...
  ASSIGN i-cod-reppri-ini = 0
         ...
         da-dt-trans-ini = DATETIME(TODAY - 90)
  ...
  ASSIGN fi-dt-trans-ini:SCREEN-VALUE IN FRAME {&FRAME-NAME} = STRING(TODAY - 90)
...
------------------------------------------------------------------------------*/
   ASSIGN c-sit-web = ''.
   IF INPUT FRAME {&FRAME-NAME} tg-digita     THEN ASSIGN c-sit-web = '1,8,9'.
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH peds_web WHERE
             peds_web.ind_sit_ped_web = p-situacao NO-LOCK. 

        IF peds_web.repres_id < i-cod-reppri-ini OR
           peds_web.repres_id > i-cod-reppri-fin THEN NEXT.

        IF cb-tp-pedido <> 'Todos' AND
           peds_web.cod_tipo_pedido <> cb-tp-pedido THEN NEXT.

        FIND tt_peds_web WHERE
             tt_peds_web.ped_web_id = peds_web.ped_web_id NO-LOCK NO-ERROR.
        IF NOT AVAIL tt_peds_web THEN DO.
           CREATE tt_peds_web.
           BUFFER-COPY peds_web TO tt_peds_web
            ...
            IF AVAIL emitente THEN DO.
               ...
               IF emitente.cod-emit = 0 THEN DO.
                  ...
                  ELSE
                     ASSIGN c-nome-abrev = 'N«O INFORMADO'.
               END.
            END.
        ...
        CASE tt_peds_web.ind_sit_ped_web.
            WHEN 1 THEN ASSIGN c-situacao = 'Em Digitaá∆o'.
            ...
            WHEN 7 THEN ASSIGN c-situacao = 'Aprovado'.
            WHEN 8 THEN ASSIGN c-situacao = 'Pend. Aprovaá∆o'.
            WHEN 9 THEN ASSIGN c-situacao = 'Solic. Alteraá∆o'.
        ...
        IF tt_peds_web.ind_sit_ped_web = 4 THEN DO.
           ...
           IF tt_peds_web.log-aprov-workflow THEN
