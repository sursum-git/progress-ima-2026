...
*******************************************************************************/
{include/i-buffer.i}
{include/i-prgvrs.i G01DT0911 2.06.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button i_cod-emitente c_nat-operacao ~
c_serie-docto c_nro-docto bt-ok bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cod-emitente c_nat-operacao ~
c_serie-docto c_nro-docto 
...
DEFINE VARIABLE c_nro-docto AS CHARACTER FORMAT "x(16)":U 
     LABEL "Documento" 
     VIEW-AS FILL-IN 
     SIZE 16 BY .88 NO-UNDO.

DEFINE VARIABLE c_serie-docto AS CHARACTER FORMAT "x(5)":U 
     LABEL "S‚rie" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     i_cod-emitente AT ROW 1.17 COL 27.86 COLON-ALIGNED WIDGET-ID 2
     c_nat-operacao AT ROW 2.17 COL 27.86 COLON-ALIGNED WIDGET-ID 4
     c_serie-docto AT ROW 3.17 COL 27.86 COLON-ALIGNED WIDGET-ID 6
     c_nro-docto AT ROW 4.17 COL 27.86 COLON-ALIGNED WIDGET-ID 8
     bt-ok AT ROW 5.58 COL 2.14
     bt-cancela AT ROW 5.58 COL 13
     bt-ajuda AT ROW 5.58 COL 58
     rt-button AT ROW 5.33 COL 1
     SPACE(0.13) SKIP(0.20)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 1
         TITLE "V  Para Documento"
...
ON GO OF FRAME d-vapara /* V  Para Documento */
DO:
FIND dt-docum-est NO-LOCK
    WHERE dt-docum-est.cod-emitente EQ INPUT FRAME {&FRAME-NAME} i_cod-emitente
      AND dt-docum-est.nat-operacao EQ INPUT FRAME {&FRAME-NAME} c_nat-operacao
      AND dt-docum-est.serie-docto EQ INPUT FRAME {&FRAME-NAME} c_serie-docto
      AND dt-docum-est.nro-docto EQ INPUT FRAME {&FRAME-NAME} c_nro-docto NO-ERROR.

IF NOT AVAILABLE dt-docum-est THEN DO:
    {utp/ut-table.i xmlloader dt-docum-est 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(dt-docum-est).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Documento */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY i_cod-emitente c_nat-operacao c_serie-docto c_nro-docto 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cod-emitente c_nat-operacao c_serie-docto c_nro-docto 
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "G01DT0911" "2.06.00.001"}
