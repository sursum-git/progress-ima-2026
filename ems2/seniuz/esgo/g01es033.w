...
&Scoped-Define ENABLED-FIELDS teste-nip.cod-maq teste-nip.num-foulard ~
teste-nip.data-teste teste-nip.num-seq 
...
DEFINE FRAME d-vapara
     teste-nip.cod-maq AT ROW 1.17 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9.14 BY .88
     fi-desc-maq AT ROW 1.17 COL 26.43 COLON-ALIGNED NO-LABEL
     teste-nip.num-foulard AT ROW 2.17 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 7.14 BY .88
     teste-nip.data-teste AT ROW 3.17 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12.57 BY .88
     teste-nip.num-seq AT ROW 4.17 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 2.29 BY .88
...
ON GO OF FRAME d-vapara /* V  Para Teses de NIP */
DO:
  find teste-nip no-lock 
      where teste-nip.cod-maq     = input frame {&frame-name} teste-nip.cod-maq 
        ...
        AND teste-nip.num-seq     = input frame {&frame-name} teste-nip.num-seq
      no-error.
  if  not avail teste-nip then do:
      {utp/ut-table.i espec teste-nip 1}
      run utp/ut-msgs.p (input "show":U,
                         input 2,
                         input RETURN-VALUE).
      return no-apply.
  end.
  assign p-row-tabela = rowid(teste-nip).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Teses de NIP */
DO:  
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL teste-nip.cod-maq d-vapara
ON LEAVE OF teste-nip.cod-maq IN FRAME d-vapara /* Maquina */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY fi-desc-maq 
      WITH FRAME d-vapara.
  IF AVAILABLE teste-nip THEN 
    DISPLAY teste-nip.cod-maq teste-nip.num-foulard teste-nip.data-teste 
          teste-nip.num-seq 
      WITH FRAME d-vapara.
  ENABLE teste-nip.cod-maq teste-nip.num-foulard teste-nip.data-teste 
         teste-nip.num-seq bt-ok bt-cancela bt-ajuda rt-button 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
