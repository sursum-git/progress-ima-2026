...
*******************************************************************************/
{include/i-prgvrs.i Z01ES041 2.04.00.000}
...
DEFINE VARIABLE h_b01es041 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b02es041 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     ...
     bt-cancela AT ROW 16.25 COL 14
     bt-ajuda AT ROW 16.25 COL 79
     rt-button AT ROW 16 COL 2
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Testes de ASTM"
         HEIGHT             = 16.42
         WIDTH              = 90
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 90
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Testes de ASTM */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Testes de ASTM */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Fam¡ia|Data' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b01es041.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01es041 ).
       RUN set-position IN h_b01es041 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.00 , 87.00 ) */

       /* Links to SmartBrowser h_b01es041. */
       RUN add-link IN adm-broker-hdl ( h_b01es041 , 'State':U , THIS-PROCEDURE ).

    END. /* Page 1 */

    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b02es041.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b02es041 ).
       RUN set-position IN h_b02es041 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.00 , 87.00 ) */

       /* Links to SmartBrowser h_b02es041. */
       RUN add-link IN adm-broker-hdl ( h_b02es041 , 'State':U , THIS-PROCEDURE ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "Z01ES041" "2.04.00.000"}
