...
&Scoped-define QUERY-STRING-Query-Main FOR EACH emitente ~
      WHERE emitente.identific <> 2 NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH emitente ~
      WHERE emitente.identific <> 2 NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main emitente
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main emitente
...
<FOREIGN-KEYS>
cod-banco||y|ems2ima.emitente.cod-banco
cod-canal-venda||y|ems2ima.emitente.cod-canal-venda
nome-abrev||y|ems2ima.emitente.nome-abrev
cod-cond-pag||y|ems2ima.emitente.cod-cond-pag
cod-emitente||y|ems2ima.emitente.cod-emitente
nat-operacao||y|ems2ima.emitente.nat-operacao
cod-rep||y|ems2ima.emitente.cod-rep
cod-tax||y|ems2ima.emitente.cod-tax
cod-gr-cli||y|ems2ima.emitente.cod-gr-cli
cod-gr-forn||y|ems2ima.emitente.cod-gr-forn
cod-isencao||y|ems2ima.emitente.cod-isencao
cod-mensagem||y|ems2ima.emitente.cod-mensagem
cod-pulmao||y|ems2ima.emitente.cod-pulmao
nr-tab-progr||y|ems2ima.emitente.nr-tab-progr
nr-tabpre||y|ems2ima.emitente.nr-tabpre
cod-tip-ent||y|ems2ima.emitente.cod-tip-ent
cod-transp||y|ems2ima.emitente.cod-transp
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "cod-banco,cod-canal-venda,nome-abrev,cod-cond-pag,cod-emitente,nat-operacao,cod-rep,cod-tax,cod-gr-cli,cod-gr-forn,cod-isencao,cod-mensagem,cod-pulmao,nr-tab-progr,nr-tabpre,cod-tip-ent,cod-transp"':U).
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems2ima.emitente"
     _Options          = "NO-LOCK"
     _Where[1]         = "ems2ima.emitente.identific <> 2"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod-pulmao" "emitente" "cod-pulmao"}
