...
*******************************************************************************/
{include/i-prgvrs.i D01DI154 2.04.00.000}
...
&Scoped-Define ENABLED-OBJECTS fi-ini-nr-pedcli1 fi-fin-nr-pedcli1 ~
fi-ini-it-codigo1 fi-fin-it-codigo1 fi-ini-dt-entrega1 fi-fin-dt-entrega1 ~
to-abe1 to-sus1 to-atp1 to-can1 to-att1 to-bal1 to-pen1 bt-ok bt-cancela ~
bt-ajuda IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 RECT-1 rt-buttom 
&Scoped-Define DISPLAYED-OBJECTS fi-ini-nr-pedcli1 fi-fin-nr-pedcli1 ~
fi-ini-it-codigo1 fi-fin-it-codigo1 fi-ini-dt-entrega1 fi-fin-dt-entrega1 ~
to-abe1 to-sus1 to-atp1 to-can1 to-att1 to-bal1 to-pen1 
...
DEFINE RECTANGLE RECT-1
     ...
     SIZE 47 BY 5 TOOLTIP "Seleá∆o das Situaá‰es de ÷tens de Pedido a serem mostradas.".
...
DEFINE FRAME D-Dialog
     fi-ini-nr-pedcli1 AT ROW 1.25 COL 13 COLON-ALIGNED HELP
          "N£mero do pedido do cliente"
     fi-fin-nr-pedcli1 AT ROW 1.25 COL 46.14 COLON-ALIGNED HELP
          "N£mero do pedido do cliente" NO-LABEL
     fi-ini-it-codigo1 AT ROW 2.25 COL 13 COLON-ALIGNED HELP
          "Codigo do ÷tem no EMS"
     fi-fin-it-codigo1 AT ROW 2.25 COL 46.14 COLON-ALIGNED HELP
          "Codigo do ÷tem no EMS" NO-LABEL
     fi-ini-dt-entrega1 AT ROW 3.25 COL 13 COLON-ALIGNED HELP
          "Data de Entrega inicial"
     fi-fin-dt-entrega1 AT ROW 3.08 COL 46 COLON-ALIGNED HELP
          "Data de Entrega final" NO-LABEL
     to-abe1 AT ROW 5.25 COL 17.29
     to-sus1 AT ROW 5.25 COL 39.29
     to-atp1 AT ROW 6.25 COL 17.29
     to-can1 AT ROW 6.25 COL 39.29
     to-att1 AT ROW 7.25 COL 17.29
     to-bal1 AT ROW 7.25 COL 39.29
     to-pen1 AT ROW 8.25 COL 17.29
     bt-ok AT ROW 10.29 COL 3
     bt-cancela AT ROW 10.29 COL 14
     bt-ajuda AT ROW 10.29 COL 59
     IMAGE-3 AT ROW 1.25 COL 30.43
     IMAGE-4 AT ROW 1.25 COL 44.72
     IMAGE-5 AT ROW 2.25 COL 30.43
     IMAGE-6 AT ROW 2.25 COL 44.72
     IMAGE-7 AT ROW 3.25 COL 30.43
     IMAGE-8 AT ROW 3.25 COL 44.72
     RECT-1 AT ROW 4.75 COL 12.29
     rt-buttom AT ROW 10.04 COL 2
     "Situaá∆o dos ÷tens de Pedido" VIEW-AS TEXT
          SIZE 20.57 BY .54 AT ROW 4.5 COL 24.86
     SPACE(25.42) SKIP(6.70)
...
DO:
  ASSIGN fi-ini-nr-pedcli  = INPUT FRAME {&FRAME-NAME} fi-ini-nr-pedcli1
...
------------------------------------------------------------------------------*/
  DISPLAY fi-ini-nr-pedcli1 fi-fin-nr-pedcli1 fi-ini-it-codigo1 
          fi-fin-it-codigo1 fi-ini-dt-entrega1 fi-fin-dt-entrega1 to-abe1 
          to-sus1 to-atp1 to-can1 to-att1 to-bal1 to-pen1 
      WITH FRAME D-Dialog.
  ENABLE fi-ini-nr-pedcli1 fi-fin-nr-pedcli1 fi-ini-it-codigo1 
         fi-fin-it-codigo1 fi-ini-dt-entrega1 fi-fin-dt-entrega1 to-abe1 
         to-sus1 to-atp1 to-can1 to-att1 to-bal1 to-pen1 bt-ok bt-cancela 
         bt-ajuda IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 RECT-1 
         rt-buttom 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "D01DI154" "2.04.00.000"}
  ...
  ASSIGN fi-ini-nr-pedcli1:SCREEN-VALUE IN FRAME {&FRAME-NAME} = fi-ini-nr-pedcli
