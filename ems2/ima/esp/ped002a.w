...
DEFINE VARIABLE c-nr-nota-fis-fim AS CHARACTER FORMAT "X(256)":U INITIAL "ZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88 NO-UNDO.

DEFINE VARIABLE c-nr-nota-fis-ini AS CHARACTER FORMAT "X(256)":U 
     LABEL "Nr Nota Fiscal" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88 NO-UNDO.

DEFINE VARIABLE da-dt-devol-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE da-dt-devol-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/1800 
     LABEL "Dt Devoluá∆o" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE da-dt-emis-nota-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE da-dt-emis-nota-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/1800 
     LABEL "Dt Emiss∆o" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     i-cod-emitente-ini AT ROW 1.25 COL 17 COLON-ALIGNED
     i-cod-emitente-fim AT ROW 1.25 COL 41.72 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     c-nr-nota-fis-ini AT ROW 2.25 COL 17 COLON-ALIGNED WIDGET-ID 4
     c-nr-nota-fis-fim AT ROW 2.25 COL 42 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     da-dt-emis-nota-ini AT ROW 3.25 COL 17 COLON-ALIGNED WIDGET-ID 12
     da-dt-emis-nota-fim AT ROW 3.25 COL 42 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     da-dt-devol-ini AT ROW 4.25 COL 17 COLON-ALIGNED WIDGET-ID 20
     da-dt-devol-fim AT ROW 4.25 COL 42 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     i-cod-rep-ini AT ROW 5.25 COL 17 COLON-ALIGNED WIDGET-ID 28
     i-cod-rep-fim AT ROW 5.25 COL 42 COLON-ALIGNED NO-LABEL WIDGET-ID 30
     IMAGE-1 AT ROW 1.25 COL 33
     IMAGE-2 AT ROW 1.25 COL 40
     IMAGE-3 AT ROW 2.25 COL 33 WIDGET-ID 6
     IMAGE-4 AT ROW 2.25 COL 40 WIDGET-ID 8
     IMAGE-5 AT ROW 3.25 COL 33 WIDGET-ID 14
     IMAGE-6 AT ROW 3.25 COL 40 WIDGET-ID 16
     IMAGE-7 AT ROW 4.25 COL 33 WIDGET-ID 24
     IMAGE-8 AT ROW 4.25 COL 40 WIDGET-ID 26
     IMAGE-9 AT ROW 5.25 COL 33 WIDGET-ID 32
     IMAGE-10 AT ROW 5.25 COL 40 WIDGET-ID 34
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Devoluá∆o de Clientes - ped002a"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.33
         MAX-WIDTH          = 194.86
...
ON END-ERROR OF w-relat /* Devoluá∆o de Clientes - ped002a */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Devoluá∆o de Clientes - ped002a */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY i-cod-emitente-ini i-cod-emitente-fim c-nr-nota-fis-ini 
          c-nr-nota-fis-fim da-dt-emis-nota-ini da-dt-emis-nota-fim 
          da-dt-devol-ini da-dt-devol-fim i-cod-rep-ini i-cod-rep-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         IMAGE-9 IMAGE-10 i-cod-emitente-ini i-cod-emitente-fim 
         c-nr-nota-fis-ini c-nr-nota-fis-fim da-dt-emis-nota-ini 
         da-dt-emis-nota-fim da-dt-devol-ini da-dt-devol-fim i-cod-rep-ini 
         i-cod-rep-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    /*:T Coloque aqui a/l¢gica de gravaá∆o dos demais campos que devem ser passados
     ...
     assign tt-param.i-cod-emitente-ini = input frame f-pg-sel i-cod-emitente-ini
            ...
            tt-param.da-dt-devol-ini = input frame f-pg-sel da-dt-devol-ini
            tt-param.da-dt-devol-fim = input frame f-pg-sel da-dt-devol-fim
            tt-param.i-cod-rep-ini = input frame f-pg-sel i-cod-rep-ini
            tt-param.i-cod-rep-fim = input frame f-pg-sel i-cod-rep-fim.
    ...
    {include/i-rprun.i esrp/ped002arp.p}
