...
&Scoped-define QUERY-STRING-Query-Main FOR EACH cm-descontos NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH cm-descontos NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main cm-descontos
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main cm-descontos
