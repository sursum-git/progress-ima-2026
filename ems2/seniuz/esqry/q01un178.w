...
&Scoped-define QUERY-STRING-Query-Main FOR EACH usuar_mestre NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH usuar_mestre NO-LOCK INDEXED-REPOSITION.
...
cod_usuario||y|mgcad.usuar_mestre.cod_usuario
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "cod_servid_exec,cod_usuario"':U).
