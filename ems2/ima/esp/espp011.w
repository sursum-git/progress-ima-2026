...
DEFINE VARIABLE fi-us-dolar AS DECIMAL FORMAT "->>,>>9.99":U INITIAL 0 
     LABEL "Cotaá∆o US$" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE rs-sit-container AS INTEGER 
...
DEFINE FRAME f-pg-sel
     ...
     fi-nr-container-ini AT ROW 2.5 COL 18 COLON-ALIGNED WIDGET-ID 6
     fi-nr-container-fim AT ROW 2.5 COL 47.86 COLON-ALIGNED NO-LABEL WIDGET-ID 16
     fi-it-codigo-ini AT ROW 3.5 COL 18 COLON-ALIGNED
     fi-it-codigo-fim AT ROW 3.5 COL 47.86 COLON-ALIGNED NO-LABEL
     fi-cod-refer-ini AT ROW 4.5 COL 18 COLON-ALIGNED WIDGET-ID 30
     fi-cod-refer-fim AT ROW 4.5 COL 47.86 COLON-ALIGNED NO-LABEL WIDGET-ID 28
     fi-no-ab-reppri-ini AT ROW 5.5 COL 18 COLON-ALIGNED HELP
          "Codigo do ÷tem no EMS" WIDGET-ID 46
     fi-no-ab-reppri-fim AT ROW 5.5 COL 48 COLON-ALIGNED HELP
          "Codigo do ÷tem no EMS" NO-LABEL WIDGET-ID 44
     fi-us-dolar AT ROW 6.54 COL 18 COLON-ALIGNED WIDGET-ID 26
     tg-detalhado AT ROW 7.67 COL 20 WIDGET-ID 60
     rs-situacao AT ROW 9.46 COL 29 NO-LABEL WIDGET-ID 36
     rs-sit-container AT ROW 10.38 COL 29 NO-LABEL WIDGET-ID 52
     " Situaá∆o" VIEW-AS TEXT
          SIZE 8 BY .54 AT ROW 8.67 COL 21.72 WIDGET-ID 58
     "Pedidos:" VIEW-AS TEXT
          SIZE 6 BY .79 AT ROW 9.33 COL 22.86 WIDGET-ID 42
     "Container:" VIEW-AS TEXT
          SIZE 7 BY .79 AT ROW 10.25 COL 21.86 WIDGET-ID 56
     ...
     IMAGE-5 AT ROW 4.5 COL 35.43 WIDGET-ID 32
     IMAGE-6 AT ROW 4.5 COL 46.43 WIDGET-ID 34
     RECT-53 AT ROW 8.92 COL 20 WIDGET-ID 40
     IMAGE-96 AT ROW 5.5 COL 35.57 WIDGET-ID 48
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Produtos Vendidos - ESSP011.W"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Produtos Vendidos - ESSP011.W */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Produtos Vendidos - ESSP011.W */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-cod-estabel fi-desc-estab fi-nr-container-ini fi-nr-container-fim 
          ...
          fi-no-ab-reppri-ini fi-no-ab-reppri-fim fi-us-dolar tg-detalhado 
          rs-situacao rs-sit-container 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 RECT-53 IMAGE-96 
         IMAGE-97 fi-cod-estabel fi-desc-estab fi-nr-container-ini 
         fi-nr-container-fim fi-it-codigo-ini fi-it-codigo-fim fi-cod-refer-ini 
         fi-cod-refer-fim fi-no-ab-reppri-ini fi-no-ab-reppri-fim fi-us-dolar 
         tg-detalhado rs-situacao rs-sit-container 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.cod-estabel = INPUT FRAME f-pg-sel fi-cod-estabel
           ...
           tt-param.cod-sit-ped = INPUT FRAME f-pg-sel rs-situacao
           tt-param.cod-sit-ctner = INPUT FRAME f-pg-sel rs-sit-container
           tt-param.us-dolar = INPUT FRAME f-pg-sel fi-us-dolar
    ...
    {include/i-rprun.i esrp/espp011rp.p}
