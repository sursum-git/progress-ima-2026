...
PROCEDURE criarInfNotaVenda.
    ...
    ASSIGN infNotaVenda.nfid            = i-id
           ...
           infNotaVenda.nota            = IF AVAIL nota-fiscal THEN nota-fiscal.nr-nota-fis ELSE ''
           infNotaVenda.serie           = IF AVAIL nota-fiscal THEN nota-fiscal.serie ELSE ''.
    ...
    IF pAcao = 'aprovar' THEN DO:
      ...
      RUN pi-gera-danfe (INPUT ROWID(nota-fiscal) ).
