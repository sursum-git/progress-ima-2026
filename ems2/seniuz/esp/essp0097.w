...
*******************************************************************************/
{include/i-prgvrs.i ESSP0097 2.04.00.000}
...
DEFINE VARIABLE tg-sem-ped AS LOGICAL INITIAL no 
     LABEL "Sem Pedido" 
     VIEW-AS TOGGLE-BOX
...
DEFINE VARIABLE fi-ini-dt-trans AS DATE FORMAT "99/99/9999" INITIAL 01/01/001 
     LABEL "Dt Transacao" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 TOOLTIP "Data da transa‡Æo inicial" NO-UNDO.
...
DEFINE FRAME f-pg-par
     tg-imp-param AT ROW 10 COL 25.43
     tg-sit-abe AT ROW 1.83 COL 30
     tg-sit-sus AT ROW 5.83 COL 30
     tg-sit-atp AT ROW 2.83 COL 30
     tg-sit-can AT ROW 6.83 COL 30
     tg-sit-att AT ROW 3.83 COL 30
     tg-sit-pen AT ROW 4.83 COL 30
     tg-sem-ped AT ROW 7.83 COL 30
     RECT-34 AT ROW 9.58 COL 4
     RECT-35 AT ROW 1.5 COL 4
     "Situa‡äes das Reservas x Pedidos" VIEW-AS TEXT
          SIZE 24 BY .54 AT ROW 1.21 COL 25.86
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 77.14 BY 10.5
...
DEFINE FRAME f-pg-sel
     ...
     fi-ini-dt-trans AT ROW 3.25 COL 19 COLON-ALIGNED
     fi-fin-dt-trans AT ROW 3.25 COL 50.14 COLON-ALIGNED NO-LABEL
     IMAGE-1 AT ROW 1.25 COL 38.43
     IMAGE-2 AT ROW 1.25 COL 48.43
     IMAGE-27 AT ROW 3.25 COL 38.43
     IMAGE-28 AT ROW 3.25 COL 48.43
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Reservas de Pedidos por Data/Situa‡Æo"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Reservas de Pedidos por Data/Situa‡Æo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Reservas de Pedidos por Data/Situa‡Æo */
DO:
...
ON MOUSE-SELECT-DBLCLICK OF fi-ini-cod-refer IN FRAME f-pg-sel /* Referˆncia */
DO:
    {include/zoomvar.i &prog-zoom  = inzoom/z01in375.w
...
{utp/ut9000.i "ESSP0097" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY tg-imp-param tg-sit-abe tg-sit-sus tg-sit-atp tg-sit-can tg-sit-att 
          tg-sit-pen tg-sem-ped 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE tg-imp-param tg-sit-abe tg-sit-sus tg-sit-atp tg-sit-can tg-sit-att 
         tg-sit-pen tg-sem-ped RECT-34 RECT-35 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-par}
  DISPLAY fi-ini-it-codigo fi-fin-it-codigo fi-ini-cod-refer fi-fin-cod-refer 
          fi-ini-dt-trans fi-fin-dt-trans 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-ini-it-codigo fi-fin-it-codigo fi-ini-cod-refer fi-fin-cod-refer 
         fi-ini-dt-trans fi-fin-dt-trans IMAGE-1 IMAGE-2 IMAGE-27 IMAGE-28 
         IMAGE-31 IMAGE-32 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario       = c-seg-usuario
           ...
           tt-param.sit-abe       = INPUT FRAME f-pg-par tg-sit-abe
           tt-param.sit-atp       = INPUT FRAME f-pg-par tg-sit-atp
           tt-param.sit-att       = INPUT FRAME f-pg-par tg-sit-att
           tt-param.sit-pen       = INPUT FRAME f-pg-par tg-sit-pen
           tt-param.sit-sus       = INPUT FRAME f-pg-par tg-sit-sus
           tt-param.sit-can       = INPUT FRAME f-pg-par tg-sit-can
           tt-param.sem-ped       = INPUT FRAME f-pg-par tg-sem-ped
    ...
    {include/i-rprun.i esrp/essp0097rp.p}
