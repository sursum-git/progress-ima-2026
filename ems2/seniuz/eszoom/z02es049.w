...
*******************************************************************************/
{include/i-prgvrs.i Z02ES049 2.04.00.000}
...
DEFINE VARIABLE h_b06es049 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Etiquetas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Etiquetas */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b06es049.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b06es049 ).
       RUN set-position IN h_b06es049 ( 1.25 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 14.75 , 89.00 ) */

       /* Links to SmartBrowser h_b06es049. */
       RUN add-link IN adm-broker-hdl ( h_b06es049 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b06es049 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "Z02ES049" "2.04.00.000"}
