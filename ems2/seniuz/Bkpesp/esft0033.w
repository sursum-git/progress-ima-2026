...
*******************************************************************************/
{include/i-prgvrs.i ESFT0033 2.04.00.000}
...
ON END-ERROR OF w-relat /* Rank Vendas por Produto */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Rank Vendas por Produto */
DO:
...
DO:
    ...
    IF AVAIL usuar_mestre THEN
       ASSIGN c-arquivo:SCREEN-VALUE IN FRAME f-pg-imp = usuar_mestre.nom_dir_spool +
                                              usuar_mestre.nom_subdir_spool + "RANK-VENDAS-PRD.XLS".
   */                                              
END.
  ...
  IF SELF:SCREEN-VALUE = '2' THEN DO.
     ...
     IF AVAIL usuar_mestre THEN
        ASSIGN c-arquivo:SCREEN-VALUE IN FRAME f-pg-imp = usuar_mestre.nom_dir_spool + "/" +
                                               usuar_mestre.nom_subdir_spool + "RANK-VENDAS-PRD.XLS".
     ELSE
        ASSIGN c-arquivo:SCREEN-VALUE = "spool\RANK-VENDAS-PRD.XLS".
...
{utp/ut9000.i "ESFT0033" "2.04.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN fi-fin-periodo:SCREEN-VALUE IN FRAME f-pg-sel = STRING(MONTH(TODAY),"99") + 
    ...
    FIND usuar_mestre WHERE usuar_mestre.cod_usuario = c-seg-usuario NO-LOCK NO-ERROR.
    IF AVAIL usuar_mestre THEN
       ASSIGN c-arquivo:SCREEN-VALUE IN FRAME f-pg-imp = usuar_mestre.nom_dir_spool + "RANK-VENDAS-PRD.XLS".
...
do on error undo, return error on stop  undo, return error:
   ...
   END.
    ...
    {include/i-rprun.i esrp/esft0033rp.p}
