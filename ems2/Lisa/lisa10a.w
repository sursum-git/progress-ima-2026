...
*******************************************************************************/
{include/i-prgvrs.i lisa10a 9.99.99.999}
...
DEFINE FRAME f-pg-sel
     fidtIni AT ROW 3.04 COL 15 COLON-ALIGNED
     fiDtFim AT ROW 3.04 COL 48.14 COLON-ALIGNED NO-LABEL
     fiNrPedidoIni AT ROW 4.04 COL 15 COLON-ALIGNED WIDGET-ID 4
     fiNrPedidoFim AT ROW 4.04 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     IMAGE-1 AT ROW 3.04 COL 31.86
     IMAGE-2 AT ROW 3.04 COL 47.29
     IMAGE-3 AT ROW 4.04 COL 31.86 WIDGET-ID 6
     IMAGE-4 AT ROW 4.04 COL 47.29 WIDGET-ID 8
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Integraá∆o de Pedidos LISA Finalizados"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Integraá∆o de Pedidos LISA Finalizados */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Integraá∆o de Pedidos LISA Finalizados */
DO:
...
{utp/ut9000.i "Lisa10a" "9.99.99.999"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fidtIni fiDtFim fiNrPedidoIni fiNrPedidoFim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 fidtIni fiDtFim fiNrPedidoIni 
         fiNrPedidoFim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    /*:T Coloque aqui as validaá‰es da p†gina de Digitaá∆o, lembrando que elas devem
       apret81215122sentar uma mensagem de erro cadastrada, posicionar nesta p†gina e colocar
    ...
    create tt-param.
    assign tt-param.dt_ini_nf       = INPUT FRAME f-pg-sel fiDtIni
           tt-param.dt_fim_nf       = INPUT FRAME f-pg-sel fiDtFim
           tt-param.nr_pedido_ini   = INPUT FRAME f-pg-sel fiNrPedidoIni
           tt-param.nr_pedido_fim   = INPUT FRAME f-pg-sel fiNrPedidoFim
    ...
    {include/i-rprun.i lisa/lisa10arp.p}
...
ASSIGN fiDtIni:SCREEN-VALUE IN FRAME f-pg-sel = string(TODAY - 30) .
{include/i-rptrp.i}
