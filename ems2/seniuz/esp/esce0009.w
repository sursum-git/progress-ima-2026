...
*******************************************************************************/
{include/i-prgvrs.i ESCE0009 2.04.00.000}
...
DEFINE VARIABLE to-imp-des-comp AS LOGICAL INITIAL no 
     LABEL "Imprimir Descriá∆o da composiá∆o" 
     VIEW-AS TOGGLE-BOX
     SIZE 26.72 BY .83 TOOLTIP "Imprimir Descriá∆o da composiá∆o."
     FONT 1 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     fi-ini-ge-codigo AT ROW 1.54 COL 15.29 COLON-ALIGNED HELP
...
DEFINE FRAME f-pg-par
     to-imp-des-comp AT ROW 2.08 COL 13.29 WIDGET-ID 2
     to-imp-param AT ROW 2.08 COL 43.86
...
ON END-ERROR OF w-relat /* Cat†logo de Itens */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Cat†logo de Itens */
DO:
...
{utp/ut9000.i "ESCE0009" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-6 IMAGE-7 fi-ini-ge-codigo 
  ...
  DISPLAY to-imp-des-comp to-imp-param 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-27 to-imp-des-comp to-imp-param 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.imp-des-comp    = INPUT FRAME f-pg-par to-imp-des-comp
    ...
    {include/i-rprun.i esrp/esce0009rp.p}
