...
*******************************************************************************/
{include/i-prgvrs.i D02ESSP0166 2.04.00.000}
...
/* ***************************  Main Block  *************************** */
ASSIGN c-periodo = SUBSTR(p-periodo,1,2) + "-" + SUBSTR(p-periodo,3,4).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "D02ESSP0166" "2.04.00.000"}
  ...
  ASSIGN fi-arq-saida:SCREEN-VALUE IN FRAME {&FRAME-NAME} = SESSION:TEMP-DIRECTORY + "Programa‡Æo Produ‡Æo Periodo.xls".
END PROCEDURE.
