...
*******************************************************************************/
{INCLUDE/I-BUFFER.I}
{include/i-prgvrs.i G01DT0914 2.06.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod-usuario c_cod-estabel bt-ok ~
bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod-usuario c_cod-estabel 
...
DEFINE FRAME d-vapara
     c_cod-usuario AT ROW 1.42 COL 27.43 COLON-ALIGNED WIDGET-ID 2
     c_cod-estabel AT ROW 2.42 COL 27.43 COLON-ALIGNED WIDGET-ID 4
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         FONT 1
         TITLE "V  Para Usu rio do Estabelecimento"
...
ON GO OF FRAME d-vapara /* V  Para Usu rio do Estabelecimento */
DO:
FIND dt-usuario-estab NO-LOCK
    WHERE dt-usuario-estab.cod-usuario EQ INPUT FRAME {&FRAME-NAME} c_cod-usuario
      AND dt-usuario-estab.cod-estabel EQ INPUT FRAME {&FRAME-NAME} c_cod-estabel NO-ERROR.

IF NOT AVAILABLE dt-usuario-estab THEN DO:
    {utp/ut-table.i xmlloader dt-usuario-estab 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(dt-usuario-estab).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Usu rio do Estabelecimento */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod-usuario c_cod-estabel 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod-usuario c_cod-estabel bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "G01DT0914" "2.06.00.001"}
