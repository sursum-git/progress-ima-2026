...
*******************************************************************************/
{include/i-prgvrs.i ESFT0019 2.04.00.000}
...
DEFINE VARIABLE to-imp-val-adic AS LOGICAL INITIAL no 
     LABEL "Imprimir Coluna com Valor Adicional" 
     VIEW-AS TOGGLE-BOX
     SIZE 28.29 BY .83 TOOLTIP "Imprimir ParÉmetros/Seleá∆o ao final do relat¢rio."
     FONT 1 NO-UNDO.
...
DEFINE FRAME f-pg-par
     to-imp-param AT ROW 6.54 COL 46.86
     to-imp-val-adic AT ROW 6.54 COL 10.29
     ...
     tg-tp-pedido AT ROW 2.21 COL 25.29
          ...
          "Dispon°vel para classificaá∆o/indicaá∆o pr¢pria do usu†rio" NO-LABEL
     fi-arq-excel AT ROW 9.29 COL 32.86 COLON-ALIGNED
     tg-gerar-excel AT ROW 9.29 COL 8
     RECT-27 AT ROW 6 COL 6.29
     RECT-28 AT ROW 1.5 COL 6.29
     RECT-29 AT ROW 8.75 COL 6.29
     "Pedidos do Tipo:" VIEW-AS TEXT
          SIZE 12 BY .75 AT ROW 3.21 COL 13.29
     "Planilha para Excel" VIEW-AS TEXT
          SIZE 13.57 BY .54 AT ROW 8.46 COL 31
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 77.14 BY 10.5
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Ranking do Faturamento por Representante/Estado"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Ranking do Faturamento por Representante/Estado */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Ranking do Faturamento por Representante/Estado */
DO:
...
{utp/ut9000.i "ESFT0019" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY to-imp-param to-imp-val-adic tg-tp-normal tg-tp-pedido fi-tp-pedido-1 
          fi-tp-pedido-2 fi-tp-pedido-3 fi-tp-pedido-4 fi-tp-pedido-5 
          fi-arq-excel tg-gerar-excel 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE to-imp-param to-imp-val-adic tg-tp-pedido tg-gerar-excel RECT-27 
         RECT-28 RECT-29 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ...
  ENABLE fi-cod-estabel fi-ini-dt-emissao fi-fin-dt-emissao fi-ini-cod-emitente 
         fi-fin-cod-emitente fi-ini-cod-rep fi-fin-cod-rep IMAGE-1 IMAGE-2 
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.imp-val          = INPUT FRAME f-pg-par to-imp-val-adic
    ...
    {include/i-rprun.i esrp/esft0019rp.p}
