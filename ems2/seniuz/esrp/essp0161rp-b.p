...
ASSIGN c-arquivo = SESSION:TEMP-DIRECTORY + "FT0518" + REPLACE(STRING(TODAY),"/","") + REPLACE(STRING(TIME,"HH:MM:SS"),":","") + ".DOC".
...
ASSIGN tt-param.usuario           = c-seg-usuario
       ...
       tt-param.destino           = 1 /*IF AVAIL layout_impres_padr 
                                    THEN 1 ELSE 3 */
       ...
       tt-param.i-nr-embarque-fim = 9999999          
