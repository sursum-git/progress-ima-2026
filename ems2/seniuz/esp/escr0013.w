...
*******************************************************************************/
{include/i-prgvrs.i ESCR0013 2.04.00.000}
...
DEFINE FRAME f-pg-sel
     fi-ep-codigo AT ROW 1.92 COL 18 COLON-ALIGNED
     fi-nome-empresa AT ROW 1.92 COL 23.14 COLON-ALIGNED NO-LABEL
     fi-ini-cod-estabel AT ROW 2.92 COL 18 COLON-ALIGNED
     fi-fim-cod-estabel AT ROW 2.92 COL 47.43 COLON-ALIGNED NO-LABEL
     fi-ini-cod-esp AT ROW 3.92 COL 18 COLON-ALIGNED
     fi-fim-cod-esp AT ROW 3.92 COL 47.43 COLON-ALIGNED NO-LABEL
     fi-ini-cod-port AT ROW 4.92 COL 18 COLON-ALIGNED
     fi-fim-cod-port AT ROW 4.92 COL 47.43 COLON-ALIGNED NO-LABEL
     fi-ini-dt-emissao AT ROW 5.92 COL 18 COLON-ALIGNED
     fi-fim-dt-emissao AT ROW 5.92 COL 47.43 COLON-ALIGNED HELP
          "C¢digo do Item" NO-LABEL
     fi-ini-dt-vencimen AT ROW 6.92 COL 18 COLON-ALIGNED
     fi-fim-dt-vencimen AT ROW 6.92 COL 47.43 COLON-ALIGNED HELP
          "C¢digo do Item" NO-LABEL
     tg-impr-param AT ROW 9.42 COL 23
     IMAGE-1 AT ROW 5.96 COL 37.72
     IMAGE-2 AT ROW 5.96 COL 45.29
     IMAGE-27 AT ROW 2.96 COL 37.57
     IMAGE-28 AT ROW 2.96 COL 45.14
     IMAGE-29 AT ROW 6.96 COL 37.72
     IMAGE-30 AT ROW 6.96 COL 45.29
     IMAGE-31 AT ROW 3.96 COL 37.57
     IMAGE-32 AT ROW 3.96 COL 45.14
     IMAGE-33 AT ROW 4.96 COL 37.57
     IMAGE-34 AT ROW 4.96 COL 45.14
     RECT-16 AT ROW 1.08 COL 1
     RECT-27 AT ROW 8.67 COL 16.29
     " Outros" VIEW-AS TEXT
          SIZE 5.43 BY .75 AT ROW 8.29 COL 19.14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Titulos a Receber por Cep de Cobran‡a"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Titulos a Receber por Cep de Cobran‡a */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Titulos a Receber por Cep de Cobran‡a */
DO:
...
{utp/ut9000.i "ESCR0013" "2.04.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-ep-codigo fi-nome-empresa fi-ini-cod-estabel fi-fim-cod-estabel 
          ...
          fi-fim-dt-vencimen tg-impr-param 
  ...
  ENABLE fi-ep-codigo fi-ini-cod-estabel fi-fim-cod-estabel fi-ini-cod-esp 
         ...
         fi-fim-dt-emissao fi-ini-dt-vencimen fi-fim-dt-vencimen tg-impr-param 
         IMAGE-1 IMAGE-2 IMAGE-27 IMAGE-28 IMAGE-29 IMAGE-30 IMAGE-31 IMAGE-32 
         IMAGE-33 IMAGE-34 RECT-16 RECT-27 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/escr0013rp.p} 
