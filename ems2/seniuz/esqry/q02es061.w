...
&Scoped-define QUERY-STRING-Query-Main FOR EACH mp-fardo NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH mp-fardo NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main mp-fardo
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main mp-fardo
...
<FOREIGN-KEYS>
nr-cdr||y|espec.mp-fardo.nr-cdr
