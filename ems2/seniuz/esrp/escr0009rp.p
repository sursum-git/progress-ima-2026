...
** Objetivo: Listar titulos por Portador/Data de Pagamento
** Autor...: Gilvando de Souza Araujo - Maio/96
** Obs.....: Especifico da CIA.RENASCENCA INDUSTRIAL
**
** Conversao para EMS 2.04:
**   Programa: ESCR013.P  =>  ESCR0009RP.P
**   Autor...: Gilvando Souza Araujo
**   Data....: 07/02/2005
*/

/* include de controle de versÆo */
{include/i-prgvrs.i ESCR0009RP 2.04.00.000}
...
form header
   ...
   "Emissao    Pagamento           Valor Pago"                          at 67
   "------------------------------------------------------------------" at  1
   "-----------------------------------------"                          at 67
...
{utp/ut-liter.i T¡tulos_Pagos_por_Portador/Data_Pagamento * r}
