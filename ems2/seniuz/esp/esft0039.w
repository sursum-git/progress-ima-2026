...
*******************************************************************************/
{include/i-prgvrs.i ESFT0039 2.04.00.000}
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Relat¢rio Resumo Faturamento P/Ref/Aliq.ICMS"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Relat¢rio Resumo Faturamento P/Ref/Aliq.ICMS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Relat¢rio Resumo Faturamento P/Ref/Aliq.ICMS */
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         fi-cod-estabel fi-ini-dt-emissao fi-fin-dt-emissao fi-ini-dt-precoant 
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/esft0039rp.p}
