...
DEFINE VARIABLE h_im00b001 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-pesquisa /* Zoom de Produto */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Zoom de Produto */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/imbrw/im00b001.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_im00b001 ).
       RUN set-position IN h_im00b001 ( 2.75 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.75 , 84.57 ) */

       /* Links to SmartBrowser h_im00b001. */
       RUN add-link IN adm-broker-hdl ( h_im00b001 , 'State':U , THIS-PROCEDURE ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "IM05Z002" "2.04.00.001"}
