...
"Outros", "O",
"Ambos", "A"
     SIZE 37.72 BY .75 TOOLTIP "Tipos de artigos: Indigo, Outros ou Ambos." NO-UNDO.
...
DEFINE VARIABLE fi-cod-estabel-fin AS CHARACTER FORMAT "x(3)" INITIAL "999" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-dt-emissao-ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/001 
     LABEL "Dt EmissÆo Etiqueta" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.
...
DEFINE VARIABLE fi-nr-lote-fin AS CHARACTER FORMAT "XX" INITIAL "ZZ" 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88 NO-UNDO.

DEFINE VARIABLE fi-nr-lote-ini AS CHARACTER FORMAT "XX" 
     LABEL "Lote" 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     ...
     fi-cod-estabel-fin AT ROW 1.54 COL 48.29 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     fi-localizacao-ini AT ROW 2.54 COL 17.43 COLON-ALIGNED
     fi-localizacao-fin AT ROW 2.54 COL 48.29 COLON-ALIGNED NO-LABEL
     fi-dt-emissao-ini AT ROW 3.54 COL 17.43 COLON-ALIGNED
     fi-dt-emissao-fin AT ROW 3.54 COL 48.29 COLON-ALIGNED NO-LABEL
     fi-ini-it-codigo AT ROW 4.54 COL 17.43 COLON-ALIGNED
     fi-fin-it-codigo AT ROW 4.58 COL 48.29 COLON-ALIGNED NO-LABEL
     fi-ini-cod-refer AT ROW 5.54 COL 17.43 COLON-ALIGNED
     fi-fin-cod-refer AT ROW 5.58 COL 48.29 COLON-ALIGNED NO-LABEL
     fi-nr-lote-ini AT ROW 6.54 COL 17.57 COLON-ALIGNED
     fi-nr-lote-fin AT ROW 6.54 COL 48.43 COLON-ALIGNED NO-LABEL
     fi-un-ini AT ROW 7.54 COL 17.57 COLON-ALIGNED WIDGET-ID 14
     fi-un-fin AT ROW 7.54 COL 48.43 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     fi-desenho AT ROW 8.54 COL 17.43 COLON-ALIGNED
     rs-desenho AT ROW 8.58 COL 24.86 NO-LABEL
     IMAGE-1 AT ROW 3.54 COL 36
     IMAGE-2 AT ROW 3.54 COL 46.72
     IMAGE-3 AT ROW 6.54 COL 36.14
     IMAGE-34 AT ROW 4.54 COL 36
     IMAGE-35 AT ROW 5.54 COL 36
     IMAGE-36 AT ROW 5.54 COL 46.72
     IMAGE-37 AT ROW 4.54 COL 46.72
     IMAGE-5 AT ROW 2.54 COL 36
     IMAGE-6 AT ROW 6.54 COL 46.86
     IMAGE-7 AT ROW 2.54 COL 46.72
     IMAGE-38 AT ROW 1.54 COL 36 WIDGET-ID 8
     IMAGE-39 AT ROW 1.54 COL 46.72 WIDGET-ID 10
     IMAGE-40 AT ROW 7.54 COL 36.14 WIDGET-ID 16
     IMAGE-41 AT ROW 7.54 COL 46.86 WIDGET-ID 18
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 4 ROW 3
         SIZE 75.86 BY 10.46
...
DEFINE FRAME f-pg-par
     fi-qtd-maxima AT ROW 3.25 COL 14.14 COLON-ALIGNED WIDGET-ID 16
     rs-situacao AT ROW 1.25 COL 18.29 NO-LABEL WIDGET-ID 10
     to-imp-param AT ROW 3.25 COL 27.29
     rs-opc-artigo AT ROW 2.25 COL 18.29 NO-LABEL
     to-enviar-e-mail AT ROW 5.13 COL 13.14 WIDGET-ID 8
     fi-assunto-e-mail AT ROW 6.04 COL 11 COLON-ALIGNED WIDGET-ID 2
     fi-texto-e-mail AT ROW 7.21 COL 13 NO-LABEL WIDGET-ID 4
     to-imp-layout AT ROW 3.29 COL 51.72 WIDGET-ID 18
     "Tipos de Artigos:" VIEW-AS TEXT
          SIZE 12 BY .54 AT ROW 2.33 COL 6
     "Situa‡Æo:" VIEW-AS TEXT
          SIZE 7 BY .54 AT ROW 1.33 COL 11 WIDGET-ID 14
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN fi-cod-estabel-ini:SCREEN-VALUE IN FRAME f-pg-sel = para-ped.estab-padr
           fi-cod-estabel-fin:SCREEN-VALUE IN FRAME f-pg-sel = para-ped.estab-padr.

    ASSIGN fi-dt-emissao-fin:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY,"99/99/9999")
           to-imp-layout:SENSITIVE IN FRAME f-pg-par = NO.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-qtd-maxima rs-situacao to-imp-param rs-opc-artigo to-enviar-e-mail 
          fi-texto-e-mail to-imp-layout 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE fi-qtd-maxima rs-situacao to-imp-param rs-opc-artigo to-enviar-e-mail 
         RECT-43 RECT-13 to-imp-layout 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-par}
  DISPLAY fi-cod-estabel-ini fi-cod-estabel-fin fi-localizacao-ini 
          fi-localizacao-fin fi-dt-emissao-ini fi-dt-emissao-fin 
          fi-ini-it-codigo fi-fin-it-codigo fi-ini-cod-refer fi-fin-cod-refer 
          fi-nr-lote-ini fi-nr-lote-fin fi-un-ini fi-un-fin fi-desenho 
          rs-desenho 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-34 IMAGE-35 IMAGE-36 IMAGE-37 IMAGE-5 
         IMAGE-6 IMAGE-7 IMAGE-38 IMAGE-39 IMAGE-40 IMAGE-41 fi-cod-estabel-ini 
         fi-cod-estabel-fin fi-localizacao-ini fi-localizacao-fin 
         fi-dt-emissao-ini fi-dt-emissao-fin fi-ini-it-codigo fi-fin-it-codigo 
         fi-ini-cod-refer fi-fin-cod-refer fi-nr-lote-ini fi-nr-lote-fin 
         fi-un-ini fi-un-fin fi-desenho rs-desenho 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.nr-lote-ini      = INPUT FRAME f-pg-sel fi-nr-lote-ini                    
           tt-param.nr-lote-fin      = INPUT FRAME f-pg-sel fi-nr-lote-fin
