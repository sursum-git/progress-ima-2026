...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡Æo de Etiquetas de Pano Cru"
         HEIGHT             = 5.88
         WIDTH              = 90
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 90
...
ON END-ERROR OF w-cadsim /* Manuten‡Æo de Etiquetas de Pano Cru */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo de Etiquetas de Pano Cru */
DO:
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es083.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01es083 ).
       RUN set-position IN h_q01es083 ( 1.50 , 63.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_v01es083 ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0177" "2.04.00.000"}
