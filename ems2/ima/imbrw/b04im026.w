...
&Scoped-define FIELDS-IN-QUERY-br-table cm-descontos.deduz-ir ~
cm-descontos.descricao cm-descontos.codigo 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      cm-descontos.deduz-ir FORMAT "yes/no":U
      cm-descontos.descricao FORMAT "x(25)":U
      cm-descontos.codigo FORMAT "999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br-table
     ...
     _FldNameList[1]   = espec.cm-descontos.deduz-ir
     _FldNameList[2]   = espec.cm-descontos.descricao
     _FldNameList[3]   = espec.cm-descontos.codigo
