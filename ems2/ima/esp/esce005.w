...
*******************************************************************************/
{include/i-prgvrs.i esce005 9.99.99.999}
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Vencer Preáos sem estoque"
         HEIGHT             = 14.83
         WIDTH              = 81.14
         MAX-HEIGHT         = 33.83
         MAX-WIDTH          = 205.72
...
ON END-ERROR OF w-relat /* Vencer Preáos sem estoque */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Vencer Preáos sem estoque */
DO:
...
{utp/ut9000.i "esce005" "9.99.99.999"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esrp/esce005rp.p}
