...
&Scoped-Define ENABLED-OBJECTS fi-dt-limite fi-nr-pedcli-ini ~
...
fi-no-ab-reppri-fin tg-lote-todos rs-opc-artigo bt-ok bt-cancelar bt-ajuda ~
fi-cod-estabel IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-51 IMAGE-52 IMAGE-73 IMAGE-94 ~
IMAGE-95 IMAGE-96 IMAGE-97 RECT-1 RECT-49 
&Scoped-Define DISPLAYED-OBJECTS fi-nome-estabel fi-dt-limite ~
...
fi-no-ab-reppri-ini fi-no-ab-reppri-fin tg-lote-todos tg-lote-pp tg-lote-pd ~
tg-lote-rp tg-lote-rd tg-lote-sc tg-lote-ca rs-opc-artigo fi-cod-estabel 
...
DEFINE FRAME F-Main
     fi-nome-estabel AT ROW 1.96 COL 18.86 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     fi-dt-limite AT ROW 2.96 COL 14.43 COLON-ALIGNED
     fi-nr-pedcli-ini AT ROW 3.96 COL 14.43 COLON-ALIGNED HELP
          "N£mero do pedido do cliente"
     fi-nr-pedcli-fin AT ROW 3.96 COL 42.86 COLON-ALIGNED HELP
          "N£mero do pedido do cliente" NO-LABEL
     fi-it-codigo-ini AT ROW 4.96 COL 14.43 COLON-ALIGNED
     fi-it-codigo-fin AT ROW 4.96 COL 42.86 COLON-ALIGNED NO-LABEL
     fi-cod-refer-ini AT ROW 5.96 COL 14.43 COLON-ALIGNED
     fi-cod-refer-fin AT ROW 5.96 COL 42.86 COLON-ALIGNED NO-LABEL
     fi-nome-abrev-ini AT ROW 6.96 COL 14.43 COLON-ALIGNED HELP
          "Nome abreviado do cliente"
     fi-nome-abrev-fin AT ROW 6.96 COL 42.86 COLON-ALIGNED HELP
          "Nome abreviado do cliente" NO-LABEL
     fi-no-ab-reppri-ini AT ROW 7.96 COL 14.43 COLON-ALIGNED HELP
          "Codigo do Ötem no EMS"
     fi-no-ab-reppri-fin AT ROW 7.96 COL 42.86 COLON-ALIGNED HELP
          "Codigo do Ötem no EMS" NO-LABEL
     tg-lote-todos AT ROW 9.17 COL 16.43
     tg-lote-pp AT ROW 9.17 COL 28.29
     tg-lote-pd AT ROW 9.17 COL 34.29
     tg-lote-rp AT ROW 9.17 COL 40.29
     tg-lote-rd AT ROW 9.17 COL 46.29
     tg-lote-sc AT ROW 9.17 COL 52.29
     tg-lote-ca AT ROW 9.17 COL 58.29
     rs-opc-artigo AT ROW 10.25 COL 16.29 NO-LABEL
     bt-ok AT ROW 11.63 COL 3
     bt-cancelar AT ROW 11.63 COL 14
     bt-ajuda AT ROW 11.63 COL 57.29
     fi-cod-estabel AT ROW 1.96 COL 14.43 COLON-ALIGNED WIDGET-ID 6
     "Tipo de Artigo:" VIEW-AS TEXT
          SIZE 10.57 BY 1 AT ROW 10.13 COL 6
     "Lote:" VIEW-AS TEXT
          SIZE 3.57 BY .54 AT ROW 9.29 COL 12.43
     " Sele‡Æo" VIEW-AS TEXT
          SIZE 7 BY .54 AT ROW 1 COL 4
     IMAGE-2 AT ROW 4.96 COL 41.43
     IMAGE-3 AT ROW 3.96 COL 33.43
     IMAGE-4 AT ROW 3.96 COL 41.43
     IMAGE-51 AT ROW 5.96 COL 33.43
     IMAGE-52 AT ROW 5.96 COL 41.43
     IMAGE-73 AT ROW 4.96 COL 33.43
     IMAGE-94 AT ROW 6.96 COL 33.43
     IMAGE-95 AT ROW 6.96 COL 41.43
     IMAGE-96 AT ROW 7.96 COL 33.43
     IMAGE-97 AT ROW 7.96 COL 41.43
     RECT-1 AT ROW 11.42 COL 2
     RECT-49 AT ROW 1.25 COL 2.14
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-window ASSIGN
         HIDDEN             = YES
         TITLE              = "Parƒmetros Faturamento Autom tico - ESSP0161a"
         HEIGHT             = 12
         WIDTH              = 68
         MAX-HEIGHT         = 29
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-window /* Parƒmetros Faturamento Autom tico - ESSP0161a */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-window w-window
ON WINDOW-CLOSE OF w-window /* Parƒmetros Faturamento Autom tico - ESSP0161a */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY fi-nome-estabel fi-dt-limite fi-nr-pedcli-ini fi-nr-pedcli-fin 
          ...
          fi-no-ab-reppri-fin tg-lote-todos tg-lote-pp tg-lote-pd tg-lote-rp 
          tg-lote-rd tg-lote-sc tg-lote-ca rs-opc-artigo fi-cod-estabel 
      WITH FRAME F-Main IN WINDOW w-window.
  ENABLE fi-dt-limite fi-nr-pedcli-ini fi-nr-pedcli-fin fi-it-codigo-ini 
         ...
         tg-lote-todos rs-opc-artigo bt-ok bt-cancelar bt-ajuda fi-cod-estabel 
         IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-51 IMAGE-52 IMAGE-73 IMAGE-94 IMAGE-95 
         IMAGE-96 IMAGE-97 RECT-1 RECT-49 
      WITH FRAME F-Main IN WINDOW w-window.
