...
*******************************************************************************/
{include/i-prgvrs.i Z01imes204 2.04.00.001}
...
DEFINE VARIABLE h_b02imes204 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b03imes204 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b04imes204 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b05imes204 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Itens Pedido PI"
         HEIGHT             = 17
         WIDTH              = 94.14
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 94.14
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Itens Pedido PI */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Itens Pedido PI */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Ped. Compra|Nome Abrev|Fornecedor|Item' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 14.83 , 93.43 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'imbrw/b02imes204.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b02imes204 ).
       RUN set-position IN h_b02imes204 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 13.25 , 90.00 ) */

       /* Links to SmartBrowser h_b02imes204. */
       RUN add-link IN adm-broker-hdl ( h_b02imes204 , 'State':U , THIS-PROCEDURE ).

    END. /* Page 1 */

    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'imbrw/b03imes204.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b03imes204 ).
       RUN set-position IN h_b03imes204 ( 2.75 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 13.25 , 90.00 ) */

       /* Links to SmartBrowser h_b03imes204. */
       RUN add-link IN adm-broker-hdl ( h_b03imes204 , 'State':U , THIS-PROCEDURE ).

    END. /* Page 2 */

    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'imbrw/b04imes204.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b04imes204 ).
       RUN set-position IN h_b04imes204 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 13.25 , 90.00 ) */

       /* Links to SmartBrowser h_b04imes204. */
       RUN add-link IN adm-broker-hdl ( h_b04imes204 , 'State':U , THIS-PROCEDURE ).

    END. /* Page 3 */

    WHEN 4 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'imbrw/b05imes204.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b05imes204 ).
       RUN set-position IN h_b05imes204 ( 2.75 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 13.25 , 90.00 ) */

       /* Links to SmartBrowser h_b05imes204. */
       RUN add-link IN adm-broker-hdl ( h_b05imes204 , 'State':U , THIS-PROCEDURE ).
...
------------------------------------------------------------------------------*/
  ENABLE bt-ok bt-cancela bt-ajuda rt-button 
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "Z01imes204" "2.04.00.001"}
