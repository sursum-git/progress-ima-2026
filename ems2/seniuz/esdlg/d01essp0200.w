...
DEF INPUT-OUTPUT PARAMETER p-arq-saida AS CHAR FORMAT "x(50)".
...
DEFINE VARIABLE fi-arq-saida AS CHARACTER FORMAT "X(45)":U 
     LABEL "Arquivo Sa¡da" 
     VIEW-AS FILL-IN 
     SIZE 50 BY .88 TOOLTIP "Caminho/nome do arquivo de sa¡da."
     FONT 1 NO-UNDO.
...
DEFINE FRAME D-Dialog
     ...
     bt-arq-sai AT ROW 1.29 COL 66.72 HELP
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "D01ESSP0204" "2.04.00.000"}
