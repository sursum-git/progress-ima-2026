...
*******************************************************************************/
{include/i-prgvrs.i V02AD098 2.04.00.000}
...
DEF VAR i-cod-rep-ini LIKE repres.cod-rep.
DEF VAR i-cod-rep-fin LIKE repres.cod-rep.
...
emitente.nome-abrev emitente.cod-rep emitente.cgc emitente.endereco ~
emitente.cep emitente.cidade emitente.estado 
...
&Scoped-Define DISPLAYED-OBJECTS c-nom-ab-rep 
...
DEFINE VARIABLE c-nom-ab-rep AS CHARACTER FORMAT "x(12)" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-main
     emitente.cod-emitente AT ROW 1.17 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.43 BY .88
          FONT 1
     emitente.nome-emit AT ROW 1.17 COL 29.57 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 51.43 BY .88
          FONT 1
     emitente.nome-abrev AT ROW 2.67 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
          FONT 1
     emitente.cod-rep AT ROW 2.67 COL 57 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.86 BY .88
          FONT 1
     c-nom-ab-rep AT ROW 2.67 COL 64 COLON-ALIGNED HELP
          "Nome abreviado do representante" NO-LABEL
     emitente.cgc AT ROW 3.67 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 20.14 BY .88
          FONT 1
     emitente.endereco AT ROW 4.67 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 41.14 BY .88
          FONT 1
     emitente.cep AT ROW 5.67 COL 18 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY .88
          FONT 1
     emitente.cidade AT ROW 5.67 COL 30.14 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 28.86 BY .88
          FONT 1
     emitente.estado AT ROW 5.67 COL 59.14 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 5 BY .88
          FONT 1
     rt-key AT ROW 1 COL 1
     rt-mold AT ROW 2.42 COL 1.14
...
/* SETTINGS FOR FILL-IN c-nom-ab-rep IN FRAME f-main
   NO-ENABLE                                                            */
...
------------------------------------------------------------------------------*/
    ...
    IF AVAIL emitente THEN DO.
       ...
       IF AVAIL repres THEN
          ASSIGN c-nom-ab-rep:SCREEN-VALUE IN FRAME {&FRAME-NAME} = repres.nome-abrev.
    
       RUN pi-popula-browse IN h-b02di159 (INPUT emitente.nome-abrev).
    END.
