...
*******************************************************************************/
{include/i-prgvrs.i B07AD098 2.04.00.000}
...
&Scoped-define FIELDS-IN-QUERY-br-digita tt-item.it-codigo tt-item.desc-item tt-item.quantidade tt-item.valor   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-digita   
&Scoped-define SELF-NAME br-digita
&Scoped-define QUERY-STRING-br-digita FOR EACH tt-item NO-LOCK
&Scoped-define OPEN-QUERY-br-digita OPEN QUERY {&self-name} FOR EACH tt-item NO-LOCK.
&Scoped-define TABLES-IN-QUERY-br-digita tt-item
&Scoped-define FIRST-TABLE-IN-QUERY-br-digita tt-item
...
&Scoped-Define DISPLAYED-OBJECTS fi-tot-prod-quant fi-tot-prod-valor 
...
DEFINE BUTTON bt-detalhar 
     LABEL "&Detalhar" 
     SIZE 10 BY 1 TOOLTIP "Mostrar as Notas Fiscais do montate do Item."
     FONT 1.

DEFINE VARIABLE fi-tot-prod-quant AS DECIMAL FORMAT "ZZ,ZZZ,ZZ9.99":U INITIAL 0 
      VIEW-AS TEXT 
     SIZE 14.57 BY .88
     FONT 2 NO-UNDO.

DEFINE VARIABLE fi-tot-prod-valor AS DECIMAL FORMAT "ZZ,ZZZ,ZZ9.99":U INITIAL 0 
      VIEW-AS TEXT 
     SIZE 14.57 BY .88
     FONT 2 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-digita B-table-Win _FREEFORM
  QUERY br-digita NO-LOCK DISPLAY
      ...
      tt-item.desc-item    COLUMN-LABEL "Descri‡Æo" FORMAT "x(36)"
      tt-item.quantidade   COLUMN-LABEL "Quantidade"
      tt-item.valor        COLUMN-LABEL "Valor"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     ...
     fi-tot-prod-quant AT ROW 11.17 COL 69 RIGHT-ALIGNED NO-LABEL
     fi-tot-prod-valor AT ROW 11.17 COL 83.71 RIGHT-ALIGNED NO-LABEL
     "Totais:" VIEW-AS TEXT
...
/* SETTINGS FOR FILL-IN fi-tot-prod-quant IN FRAME F-Main
   NO-ENABLE ALIGN-R                                                    */
/* SETTINGS FOR FILL-IN fi-tot-prod-valor IN FRAME F-Main
   NO-ENABLE ALIGN-R                                                    */
...
DO:
  ...
  run esp/esft0037.w (INPUT ROWID(ITEM)).
END.
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH nota-fiscal 
      ...
      FOR EACH it-nota-fisc OF nota-fiscal NO-LOCK:
          FIND tt-item WHERE tt-item.it-codigo = it-nota-fisc.it-codigo
                       NO-LOCK NO-ERROR.
          ...
          ASSIGN tt-item.quantidade = tt-item.quantidade + it-nota-fisc.qt-faturada[1]
                 tt-item.valor      = tt-item.valor + it-nota-fisc.vl-tot-item
                 de-tot-prod-quant  = de-tot-prod-quant + it-nota-fisc.qt-faturada[1]
                 de-tot-prod-valor  = de-tot-prod-valor + it-nota-fisc.vl-tot-item.
      END.
  END.

  ASSIGN fi-tot-prod-quant:SCREEN-VALUE IN FRAME {&FRAME-NAME} = string(de-tot-prod-quant)
         fi-tot-prod-valor:SCREEN-VALUE IN FRAME {&FRAME-NAME} = string(de-tot-prod-valor).
