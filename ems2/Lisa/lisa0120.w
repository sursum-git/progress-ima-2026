...
&Scoped-Define ENABLED-OBJECTS rt-button brLog brLogTrans Ed-descricao ~
fiPedido 
&Scoped-Define DISPLAYED-OBJECTS Ed-descricao fiPedido 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 113 BY 11.75
         FONT 1
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 113 BY 11.25
         FONT 1
...
DEFINE FRAME f-cad
     ...
     brLogTrans AT ROW 16.25 COL 3 WIDGET-ID 300
     Ed-descricao AT ROW 27.71 COL 3.29 NO-LABEL WIDGET-ID 4
     btLog AT ROW 28 COL 96 WIDGET-ID 6
     fiPedido AT ROW 2.75 COL 14 COLON-ALIGNED WIDGET-ID 2
     rt-button AT ROW 1 COL 1
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 117.14 BY 28.92
...
/* SETTINGS FOR BUTTON btLog IN FRAME f-cad
   NO-ENABLE                                                            */
ASSIGN 
       btLog:HIDDEN IN FRAME f-cad           = TRUE.

ASSIGN 
       Ed-descricao:READ-ONLY IN FRAME f-cad        = TRUE.
...
&Scoped-define BROWSE-NAME brLogTrans
&Scoped-define SELF-NAME brLogTrans
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL brLogTrans w-livre
ON VALUE-CHANGED OF brLogTrans IN FRAME f-cad /* Log Detalhado */
DO:
  IF AVAIL ttLogCalc THEN
  DO:
    ASSIGN  ed-descricao:SCREEN-VALUE = ttLogCalc.descricao.    
  END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btLog w-livre
ON CHOOSE OF btLog IN FRAME f-cad /* Exportar LOG */
DO:
  {esp/exportarEAbrirTabelaCsv3.i ttLogCalc " "  " " "log_detalhado_corte"}
END.
...
------------------------------------------------------------------------------*/
  DISPLAY Ed-descricao fiPedido 
      WITH FRAME f-cad IN WINDOW w-livre.
  ENABLE rt-button brLog brLogTrans Ed-descricao fiPedido 
      WITH FRAME f-cad IN WINDOW w-livre.
...
------------------------------------------------------------------------------*/
  ...
  {&open-query-brlogtrans}
  APPLY 'value-changed' TO BROWSE brLogTrans.
  ASSIGN btLog:SENSITIVE = NUM-RESULTS('brLogTrans') > 0.
END PROCEDURE.
