...
*******************************************************************************/
{include/i-prgvrs.i Z02CL005 1.00.00.000}
...
DEFINE VARIABLE h_b05im001 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Etiquetas Avulsas"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 27.96
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Etiquetas Avulsas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Etiquetas Avulsas */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'clbrw/b05cl005.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b05im001 ).
       RUN set-position IN h_b05im001 ( 3.25 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 84.57 ) */

       /* Links to SmartBrowser h_b05im001. */
       RUN add-link IN adm-broker-hdl ( h_b05im001 , 'State':U , THIS-PROCEDURE ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "Z02CL005" "1.00.00.000"}
