...
DEFINE INPUT  PARAMETER dtRefer   AS DATE        NO-UNDO.
...
FIND FIRST repres_sit_cli
    WHERE repres_sit_cli.dt_referencia = dtRefer
...
IF NOT AVAIL repres_sit_cli THEN DO:
    ...
    ASSIGN repres_sit_cli.dt_referencia = dtRefer
