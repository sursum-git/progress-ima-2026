...
*******************************************************************************/
{include/i-prgvrs.i D02ESSP0192 2.04.00.000}
...
DEFINE INPUT-OUTPUT PARAMETER p-arq-saida        AS CHAR FORMAT "x(50)".
...
DEFINE VARIABLE fi-arq-saida AS CHARACTER FORMAT "X(50)":U 
     LABEL "Arquivo Sa¡da" 
     VIEW-AS FILL-IN 
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "D02ESSP0192" "2.04.00.000"}
...
/*
  ASSIGN fi-arq-saida:SCREEN-VALUE IN FRAME {&FRAME-NAME} = SESSION:TEMP-DIRECTORY +
                     "Analise Gerencial PRODU€ÇO X ESTOQUE.XLS".
*/
  ASSIGN fi-arq-saida:SCREEN-VALUE IN FRAME {&FRAME-NAME} = p-arq-saida.
