...
&Scoped-Define ENABLED-OBJECTS RECT-6 RECT-7 rt-buttom br-itens bt-param ~
...
DO:
   ...
   ASSIGN c-win:SENSITIVE = NO.
   RUN esppl/essp0191a.w (INPUT-OUTPUT c-cod-estabel,   
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-6 RECT-7 rt-buttom br-itens bt-param bt-vapara bt-excel 
...
/*
     FIND ITEM WHERE
          ITEM.it-codigo = item.it-codigo NO-LOCK NO-ERROR.
     IF NOT AVAIL ITEM THEN DO:
        MESSAGE "Item " item.it-codigo "N∆o Cadastrado ! ! !"
            VIEW-AS ALERT-BOX INFO BUTTONS OK.
        NEXT.
     END.  
...
/*
     ...
     FIND ob-etiqueta WHERE
          ob-etiqueta.cod-estabel = ITEM.cod-estabel AND
          ob-etiqueta.it-codigo   = ITEM.it-codigo   AND
          ob-etiqueta.cod-refer   = ITEM.cod-refer   NO-LOCK NO-ERROR.
     ...
     IF NOT AVAIL ob-etiqueta THEN NEXT.
        ...
        IF LOOKUP(ob-etiqueta.nr-lote,c-lotes) = 0 THEN NEXT.
...
*/
     ...
     FOR EACH saldo-estoq WHERE
              ...
              saldo-estoq.cod-refer   = ITEM.cod-refer */ NO-LOCK.
