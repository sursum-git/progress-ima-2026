...
*******************************************************************************/
{include/i-prgvrs.i ESSP0202 - ESSP0202}
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 90 BY 11.13 WIDGET-ID 100.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v01es065 ).
       RUN set-position IN h_v01es065 ( 3.00 , 1.57 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es065.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01es065 ).
       RUN set-position IN h_q01es065 ( 1.25 , 63.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 8.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0202" "2.04.00.000"}
