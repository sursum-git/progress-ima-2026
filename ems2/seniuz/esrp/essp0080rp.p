...
** Setor...: Mecanica
** Objetivo: Imprimir o Relatorio de Incidencia de Manutencao por Subsistema
** Autor...: Gilvando Souza Araujo - Julho/2000
**
** Conversao para EMS 2.04:
**   Programa: ESMECR02.P  =>  ESSP0079RP.P
**   Autor...: Gilvando Souza Araujo
**   Data....: 08/02/2004
*/

/* include de controle de versÆo */
{include/i-prgvrs.i ESSP0080RP 2.04.00.000}
...
def TEMP-TABLE w-work
    ...
    field num-os     like mov-man.num-os
    field qtd-os     as int
...
def var i-qtd-os-ssist  as int.
def var i-min-man-ssist as int.
def var i-min-par-ssist as int.
...
{utp/ut-liter.i Incidˆncia_de_Manuten‡Æo_por_Subsistema * r}
      ...
      or i-min-par <> 0 then do:
         find first w-work
              where w-work.ssist-exec = mov-man.ssist-exec[i-cont]
                ...
                and w-work.num-os     = mov-man.num-os
              no-error.
...
for each w-work break by w-work.ssist-exec
                      by w-work.cod-area
                      by w-work.cod-maq
                      by w-work.num-os:
   if first-of(w-work.ssist-exec) then do:
      for each b-w-work where b-w-work.ssist-exec = w-work.ssist-exec:
          assign i-qtd-os-ssist  = i-qtd-os-ssist +  b-w-work.qtd-os
                 i-min-man-ssist = i-min-man-ssist + b-w-work.min-man
                 i-min-par-ssist = i-min-par-ssist + b-w-work.min-par.
      end.
   ...
   assign i-perc1 = w-work.qtd-os / i-qtd-os-ssist * 100
          i-perc2 = w-work.min-man / i-min-man-ssist * 100
          i-perc3 = w-work.min-par / i-min-par-ssist * 100.
   ...
   if last-of(w-work.ssist-exec) then do:
      assign i-perc1 = i-qtd-os-ssist / i-qtd-os-ger * 100
             i-perc2 = i-min-man-ssist / i-min-man-ger * 100
             i-perc3 = i-min-par-ssist / i-min-par-ger * 100.
          
      assign c-hor-man = string((i-min-man-ssist - 
                                (i-min-man-ssist MODULO 60)) / 
                                 60,"99999") + 
                         string((i-min-man-ssist MODULO 60),"99")
             c-hor-par = string((i-min-par-ssist - 
                                (i-min-par-ssist MODULO 60)) / 
                                 60,"99999") + 
                         string((i-min-par-ssist MODULO 60),"99").
   
      display "Total"        @ w-work.ssist-exec
              i-qtd-os-ssist @ w-work.qtd-os
              i-perc1
              c-hor-man
              i-perc2
              c-hor-par
