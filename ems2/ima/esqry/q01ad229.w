...
&Scoped-define QUERY-STRING-Query-Main FOR EACH repres NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH repres NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main repres
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main repres
...
nome-ab-reg||y|mgcom.repres.nome-ab-reg
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "nome-abrev,cod-emitente,nome-ab-reg,cod-rep"':U).
