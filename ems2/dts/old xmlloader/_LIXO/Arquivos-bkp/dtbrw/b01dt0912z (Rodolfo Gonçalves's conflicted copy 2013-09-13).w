...
*******************************************************************************/
{include/i-buffer.i}    
{include/i-prgvrs.i B01DT0912Z 2.06.00.006}
...
prazo-compra.situacao  = 2 ~
 ...
 AND ordem-compra.cod-estabel = p-estabelec-xmlloader NO-LOCK, ~
...
&Scoped-Define ENABLED-OBJECTS bt-narrativa c-inicial-3 c-inicial c-final ~
c-inicial-2 c-final-2 bt-confirma c-final-3 IMAGE-1 IMAGE-2 br-table ~
IMAGE-3 IMAGE-4 IMAGE-19 IMAGE-20 
&Scoped-Define DISPLAYED-OBJECTS c-inicial-3 c-inicial c-final c-inicial-2 ~
c-final-2 c-final-3 
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "mgmov.prazo-compra,mgmov.ordem-compra OF mgmov.prazo-compra,mgcad.item OF mgmov.ordem-compra"
     _Options          = "NO-LOCK"
     _TblOptList       = ", FIRST,"
...
"prazo-compra.it-codigo" "Item" ? "character" ? ? ? ? ? ? no ? no no "19.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   = mgcad.item.desc-item
