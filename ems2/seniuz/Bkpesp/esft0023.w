...
*******************************************************************************/
{include/i-prgvrs.i ESFT0023 2.04.00.000}
...
DEFINE VARIABLE h_q01di135 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v01di135 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsi2 ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡Æo de Notas Fiscais - Data de Sa¡da"
         HEIGHT             = 8.63
         WIDTH              = 90
         MAX-HEIGHT         = 20.71
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-cadsi2 /* Manuten‡Æo de Notas Fiscais - Data de Sa¡da */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsi2 w-cadsi2
ON WINDOW-CLOSE OF w-cadsi2 /* Manuten‡Æo de Notas Fiscais - Data de Sa¡da */
DO:
...
DO:
  RUN esdlg/d02di135.w.
  RUN adm-open-query-cases IN h_q01di135.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esvwr/v01di135.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v01di135 ).
       RUN set-position IN h_v01di135 ( 3.00 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.50 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esqry/q01di135.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = dizoom/z03di135.w,
                     ProgVaPara = digo/g01di135.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_q01di135 ).
       RUN set-position IN h_q01di135 ( 1.50 , 60.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsi2 , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_v01di135. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsi2 , 'TableIO':U , h_v01di135 ).
       RUN add-link IN adm-broker-hdl ( h_q01di135 , 'Record':U , h_v01di135 ).

       /* Links to SmartQuery h_q01di135. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_q01di135 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_q01di135 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_q01di135 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsi2 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v01di135 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESFT0023" "2.04.00.000"}
