...
*******************************************************************************/
{include/i-prgvrs.i ESFT0030 2.04.00.000}
...
DEFINE VARIABLE tg-imp-las AS LOGICAL INITIAL yes 
     LABEL "Salta Folhas Impares na Quebra de Representante" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME f-pg-par
     to-imp-param AT ROW 6.54 COL 28
     tg-imp-las AT ROW 2.67 COL 20.29
     RECT-27 AT ROW 6 COL 6.29
     RECT-28 AT ROW 2.08 COL 6.29
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 77.14 BY 10.5
...
DEFINE FRAME f-pg-sel
     ...
     fi-ini-dt-emis-nota AT ROW 2.54 COL 15.29 COLON-ALIGNED HELP
          "Data de emiss∆o da nota fiscal"
     fi-fin-dt-emis-nota AT ROW 2.54 COL 43.29 COLON-ALIGNED HELP
          "Data de emiss∆o da nota fiscal" NO-LABEL
     IMAGE-1 AT ROW 1.54 COL 29
     IMAGE-2 AT ROW 1.54 COL 41.72
     IMAGE-3 AT ROW 2.54 COL 29
     IMAGE-6 AT ROW 2.54 COL 41.72
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 4 ROW 3.21
         SIZE 75.86 BY 10.25
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Cadastro de Clientes Ativos por Representante"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.63
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Cadastro de Clientes Ativos por Representante */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Cadastro de Clientes Ativos por Representante */
DO:
...
{utp/ut9000.i "ESFT0030" "2.04.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN fi-ini-dt-emis-nota:SCREEN-VALUE IN FRAME f-pg-sel = STRING(DATE(MONTH(TODAY),1,YEAR(TODAY)),"99/99/9999")
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY to-imp-param tg-imp-las 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE to-imp-param tg-imp-las RECT-27 RECT-28 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-par}
  DISPLAY fi-ini-cod-rep fi-fin-cod-rep fi-ini-dt-emis-nota fi-fin-dt-emis-nota 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-ini-cod-rep fi-fin-cod-rep fi-ini-dt-emis-nota fi-fin-dt-emis-nota 
         IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-6 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.ini-dt-emis-nota = INPUT FRAME f-pg-sel fi-ini-dt-emis-nota                
           tt-param.fin-dt-emis-nota = INPUT FRAME f-pg-sel fi-fin-dt-emis-nota             
           tt-param.ini-cod-rep      = INPUT FRAME f-pg-sel fi-ini-cod-rep                 
           tt-param.fin-cod-rep      = INPUT FRAME f-pg-sel fi-fin-cod-rep
           tt-param.imp-las          = INPUT FRAME f-pg-par tg-imp-las
    ...
    {include/i-rprun.i esrp/esft0030rp.p}
