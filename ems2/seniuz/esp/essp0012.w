...
*******************************************************************************/
{include/i-prgvrs.i ESSP0012 2.04.00.000}
...
ON END-ERROR OF w-consim /* Produtos do Beneficiamento */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-consim w-consim
ON WINDOW-CLOSE OF w-consim /* Produtos do Beneficiamento */
DO:
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = eszoom/z01es024.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01es024 ).
       RUN set-position IN h_q01es024 ( 1.50 , 65.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESSP0012" "2.04.00.000"}
