...
br-ped-item bt-inc bt-sair bt-log bt-cons-cliente-tri fi-observ-nf RECT-1 ~
RECT-2 RECT-3 RECT-4 RECT-7 
&Scoped-Define DISPLAYED-OBJECTS fi-dt-implant cb-tp-pedido ~
...
bt-copia-it-ped bt-inc bt-can fi-observ-nf 
...
DEFINE FRAME F-Main
     ...
     ed-obs AT ROW 10.79 COL 14 NO-LABEL
     fi-data-base AT ROW 11.38 COL 76 COLON-ALIGNED NO-LABEL
     fi-cod-estabel AT ROW 1.29 COL 29 COLON-ALIGNED WIDGET-ID 6 NO-TAB-STOP 
     cb-origem AT ROW 11.38 COL 90 COLON-ALIGNED NO-LABEL WIDGET-ID 70
     fi-denominacao AT ROW 6.79 COL 24.29 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     bt-msg AT ROW 13 COL 73.14
     fi-nome-estabel AT ROW 1.29 COL 34.29 COLON-ALIGNED NO-LABEL WIDGET-ID 8 NO-TAB-STOP 
     tg-nao-aprovar AT ROW 13.42 COL 91.14 WIDGET-ID 42
     fi-desc-moeda AT ROW 6.75 COL 90.43 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     tg-em-espera AT ROW 13.38 COL 78 WIDGET-ID 56
     tg-bloqueio AT ROW 12.63 COL 78
     ...
     br-ped-item AT ROW 14.33 COL 2
     bt-imp-res AT ROW 14.5 COL 98.14
     bt-copia-it-ped AT ROW 15.67 COL 98.14
     bt-inc AT ROW 17.04 COL 98.14
     fi-desc-cond-pag AT ROW 7.79 COL 21.57 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     bt-mod AT ROW 18.21 COL 98.14
     bt-del AT ROW 19.38 COL 98.29 WIDGET-ID 28
     bt-can AT ROW 20.58 COL 98.14
     bt-bloq AT ROW 21.71 COL 98.14 WIDGET-ID 10
     fi-cidade-cli AT ROW 3.33 COL 52 COLON-ALIGNED WIDGET-ID 30 NO-TAB-STOP 
     bt-ok AT ROW 23.04 COL 98.14
     fi-uf AT ROW 3.33 COL 75.14 COLON-ALIGNED NO-LABEL WIDGET-ID 34 NO-TAB-STOP 
     bt-sair AT ROW 24.21 COL 98.14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 103.86 BY 24.75
         FONT 1.

/* DEFINE FRAME statement is approaching 4K Bytes.  Breaking it up   */
DEFINE FRAME F-Main
     fi-tot-qtd-ped AT ROW 24.5 COL 2.43 COLON-ALIGNED HELP
          "C¢digo do cliente" NO-LABEL
     fi-tot-qtd-res AT ROW 24.5 COL 17.57 COLON-ALIGNED HELP
          "C¢digo do cliente" NO-LABEL
     bt-log AT ROW 3.33 COL 18.29 NO-TAB-STOP 
     fi-tot-qtd-fat AT ROW 24.5 COL 33.43 COLON-ALIGNED HELP
          "C¢digo do cliente" NO-LABEL
     fi-sit-preco AT ROW 3.33 COL 2.43 WIDGET-ID 40 NO-TAB-STOP 
     fi-tot-vlr-ped AT ROW 24.5 COL 48.57 COLON-ALIGNED HELP
          "C¢digo do cliente" NO-LABEL
     fi-tot-desconto AT ROW 24.5 COL 64.43 COLON-ALIGNED HELP
          "C¢digo do cliente" NO-LABEL
     fi-tot-vlr-abe AT ROW 24.5 COL 80 COLON-ALIGNED HELP
          "C¢digo do cliente" NO-LABEL
     ...
     "Dt Base Fat." VIEW-AS TEXT
          SIZE 8 BY .54 AT ROW 10.79 COL 78 WIDGET-ID 78
     "Origem" VIEW-AS TEXT
          SIZE 8 BY .54 AT ROW 10.79 COL 92 WIDGET-ID 80
     "Observaá∆o:" VIEW-AS TEXT
          SIZE 9 BY .54 AT ROW 10.75 COL 4.72
     "Nß Pedido" VIEW-AS TEXT
          SIZE 7 BY .54 AT ROW 1.25 COL 3.29
     "Qt Total Pedido" VIEW-AS TEXT
          SIZE 11 BY .54 AT ROW 23.88 COL 4.43
          BGCOLOR 8 
     "Vl Total Pedido" VIEW-AS TEXT
          SIZE 11 BY .54 AT ROW 23.92 COL 50.57
          BGCOLOR 8 
     RECT-1 AT ROW 23.71 COL 2
     RECT-2 AT ROW 14.33 COL 97
     RECT-3 AT ROW 5.5 COL 2
     RECT-4 AT ROW 1 COL 2
     RECT-7 AT ROW 12.38 COL 77.43 WIDGET-ID 82
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 103.86 BY 24.75
  ...
  IF br-ped-item:NEW-ROW IN FRAME {&FRAME-NAME} THEN DO.
     ...
     IF AVAIL b-itens-ped THEN DO.
        ASSIGN tt-itens-ped.it-codigo:SCREEN-VALUE IN BROWSE {&browse-name} = STRING(b-itens-ped.it-codigo)
               ...
               tt-itens-ped.retirar-corte:SCREEN-VALUE IN BROWSE {&browse-name} = 'NO'.
...
DO:
   CASE SELF:SCREEN-VALUE.
       WHEN 'PI' THEN 
            ASSIGN fi-reserva:VISIBLE = NO
                   fi-reserva:SENSITIVE = NO
                   fi-nr-container:VISIBLE = YES
                   fi-nr-container:SENSITIVE = YES
                   tg-em-espera:SENSITIVE = YES
                   tg-nao-aprovar:SCREEN-VALUE = 'YES'
                   tg-em-espera:SCREEN-VALUE = 'YES'.
       WHEN 'PE' THEN
            ASSIGN fi-reserva:VISIBLE = YES
                   fi-reserva:SENSITIVE = YES
                   fi-nr-container:VISIBLE = NO
...
DO:
   ...
   IF LOOKUP(cb-tp-pedido:SCREEN-VALUE,"Amostra,Bonificaá∆o,Doaá∆o") > 0 THEN DO.
...
DO:
    ...
    IF AVAIL cond-pagto THEN DO.
       ...
       IF cond-pagto.cod-cond-pag <= 3 THEN DO.
          ASSIGN tg-bloqueio:SENSITIVE = NO.
          ASSIGN tg-bloqueio:SCREEN-VALUE = 'YES'.
       END.
       ELSE DO.
...
DO:
   ...
   IF adm-new-record OR fi-perc-comis:INPUT-VALUE = 0 THEN
...
ON LEAVE OF fi-data-base IN FRAME F-Main
DO:
   IF KEYFUNCTION(LASTKEY) = 'BACK-TAB' THEN DO.
...
DO:
   ...
   FIND ped-venda WHERE
        ped-venda.nr-pedido = INPUT FRAME {&FRAME-NAME} fi-reserva
        NO-LOCK NO-ERROR.
   ...
   FOR EACH tt-itens-ped.
       ASSIGN tt-itens-ped.qt-pedida = 0.
       IF tt-itens-ped.retirar-corte = NO THEN
          DELETE tt-itens-ped.
   END.
...
------------------------------------------------------------------------------*/
  DISPLAY fi-dt-implant cb-tp-pedido cb-ext-tp-pedido fi-nr-container fi-cliente 
          fi-cliente-tri cb-fin-venda fi-cod-rep fi-ped-repres cb-preposto 
          fi-natur-oper fi-perc-comis fi-moeda fi-cod-cond-pag cb-tp-preco 
          cb-tab-preco fi-nome-rep cb-tp-entrega fi-dt-entrega cb-tipo-pagto 
          cb-prioridade fi-nome-transp fi-nome-tr-red fi-cod-rota cb-tp-frete 
          ed-obs fi-data-base fi-cod-estabel cb-origem fi-denominacao 
          fi-nome-estabel tg-nao-aprovar fi-desc-moeda tg-em-espera tg-bloqueio 
          fi-completo fi-nr-pedido fi-desc-cond-pag fi-cidade-cli fi-uf 
          fi-tot-qtd-ped fi-tot-qtd-res fi-tot-qtd-fat fi-sit-preco 
          fi-tot-vlr-ped fi-tot-desconto fi-tot-vlr-abe fi-cidade-cli-tri 
          fi-desc-rota fi-uf-tri fi-sit-cred fi-observ-nf fi-reserva 
  ...
  ENABLE cb-tp-pedido fi-cliente cb-fin-venda fi-ped-repres fi-perc-comis 
         ...
         bt-sair bt-log bt-cons-cliente-tri fi-observ-nf RECT-1 RECT-2 RECT-3 
         RECT-4 RECT-7 
      WITH FRAME F-Main IN WINDOW w-window.
