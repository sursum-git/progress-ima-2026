...
/*------------------------------------------------------------------------
File.............: imft07a.w
Description......: Rela‡Æo de Custos de Frete por Cidade
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 30/06/05 - 16:31 - super
...
define variable c-prog-gerado as character no-undo initial "IMFT07A".
...
def new global shared var i-ep-codigo-usuario  like ems5.empresa.cod_empresa no-undo.
...
def new global shared var v_cdn_empres_usuar   like ems5.empresa.cod_empresa        no-undo.
...
def new shared var rs-tipo AS INTEGER INITIAL 1
...
DEFINE FRAME f-pg-sel
   ...
   IMAGE-1 AT ROW 01.00 COL 44
   IMAGE-2 AT ROW 01.00 COL 49

   c-cod-estabel-fim no-label
     at row 1 col 51 colon-aligned
     view-as fill-in 
     size 4 by .88
     font 1
   ...
   c-nome-transp-ini label "Transportador"
     at row 3 col 20 colon-aligned
     view-as fill-in 
     size 13 by .88
     font 1
                               
   c-nome-transp-fim no-label
     at row 3 col 51 colon-aligned
     view-as fill-in 
     size 13 by .88
     font 1

   c-estado-ini label "UF"
   ...
   c-cidade-ini label "Cidade"
     at row 5 col 20 colon-aligned
     view-as fill-in 
     size 20 by .88
     font 1
                               
   c-cidade-fim no-label
     at row 5 col 51 colon-aligned
     view-as fill-in 
     size 20 by .88
     font 1

    c-bairro-ini label "Bairro"
    ...
    c-bairro-fim no-label
      at row 6 col 51 colon-aligned
      view-as fill-in 
      size 20 by .88
      font 1
...
"Terminal", 3
    ...
    rs-tipo AS INTEGER INITIAL 2 at row 7 col 20 
    VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Impressora", 1,
          "Arquivo", 2,
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Rela‡Æo de Custos de Frete por Cidade - imft07a"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "imft07a".
...
PROCEDURE enable_UI :
   ...
   c-cidade-ini c-cidade-fim
   c-bairro-ini c-bairro-fim
   rs-tipo
...
*/
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "imft07a" + ".tmp".
...
if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "esrp/imft07rp.p".
