...
DEFINE TEMP-TABLE tt-layout NO-UNDO
       FIELD localizacao AS CHAR FORMAT "x(06)"
       FIELD peca        AS CHAR FORMAT "x(03)"
       FIELD quantidade  AS CHAR FORMAT "x(06)".
...
/*       ASSIGN tt-layout.localizacao = 
              tt-layout.peca        = 
              tt-layout.quantidade  = */
...
/*IF tt-param.l-imp-layout THEN DO:
    RUN esrp/essp0147arp.p (INPUT TABLE tt-param).
END. */
